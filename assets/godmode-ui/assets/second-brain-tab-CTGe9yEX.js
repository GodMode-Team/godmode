import{b as s,A as c,o as x,d as C,g as E,r as l,t as _}from"./lit-core-CTInmNPB.js";import{o as A}from"./index-BwcWOA_Q.js";import{a as $}from"./event-bus-4tWT8iFZ.js";import{a as T}from"./views-settings-DYz1PRA4.js";import{f as D}from"./ctrl-settings-C6VcoKY4.js";import{loadSecondBrain as R,loadSecondBrainEntry as L,browseFolder as N,syncSecondBrain as P}from"./second-brain-cP3vM8ym.js";import"./markdown-i_gIkIP3.js";function p(e){if(!e)return"";try{return D(new Date(e).getTime())}catch{return""}}function m(e){return s`<div class="second-brain-md-body">${x(T(e))}</div>`}function H(e){const{identity:n}=e;return!n||n.files.length===0?s`
