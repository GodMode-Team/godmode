...
`}function Lc(e,t,n){if(t.length===0)return;let s=e;for(let i=0;i<t.length-1;i+=1){const o=t[i],l=t[i+1];if(typeof o=="number"){if(!Array.isArray(s))return;s[o]==null&&(s[o]=typeof l=="number"?[]:{}),s=s[o]}else{if(typeof s!="object"||s==null)return;const c=s;c[o]==null&&(c[o]=typeof l=="number"?[]:{}),s=c[o]}}const a=t[t.length-1];if(typeof a=="number"){Array.isArray(s)&&(s[a]=n);return}typeof s=="object"&&s!=null&&(s[a]=n)}function Rc(e,t){if(t.length===0)return;let n=e;for(let a=0;a<t.length-1;a+=1){const i=t[a];if(typeof i=="number"){if(!Array.isArray(n))return;n=n[i]}else{if(typeof n!="object"||n==null)return;n=n[i]}if(n==null)return}const s=t[t.length-1];if(typeof s=="number"){Array.isArray(n)&&n.splice(s,1);return}typeof n=="object"&&n!=null&&delete n[s]}async function Je(e){if(!(!e.client||!e.connected)){e.configLoading=!0,e.lastError=null;try{const t=await e.client.request("config.get",{});oh(e,t)}catch(t){e.lastError=String(t)}finally{e.configLoading=!1}}}async function Pc(e){if(!(!e.client||!e.connected)&&!e.configSchemaLoading){e.configSchemaLoading=!0;try{const t=await e.client.request("config.schema",{});ih(e,t)}catch(t){e.lastError=String(t)}finally{e.configSchemaLoading=!1}}}function ih(e,t){e.configSchema=t.schema??null,e.configUiHints=t.uiHints??{},e.configSchemaVersion=t.version??null}function oh(e,t){e.configSnapshot=t;const n=typeof t.raw=="string"?t.raw:t.config&&typeof t.config=="object"?rn(t.config):e.configRaw;!e.configFormDirty||e.configFormMode==="raw"?e.configRaw=n:e.configForm?e.configRaw=rn(e.configForm):e.configRaw=n,e.configValid=typeof t.valid=="boolean"?t.valid:null,e.configIssues=Array.isArray(t.issues)?t.issues:[],e.configFormDirty||(e.configForm=Pt(t.config??{}),e.configFormOriginal=Pt(t.config??{}),e.configRawOriginal=n)}async function Bs(e){if(!(!e.client||!e.connected)){e.configSaving=!0,e.lastError=null;try{const t=e.configFormMode==="form"&&e.configForm?rn(e.configForm):e.configRaw,n=e.configSnapshot?.hash;if(!n){e.lastError="Config hash missing; reload and retry.";return}await e.client.request("config.set",{raw:t,baseHash:n}),e.configFormDirty=!1,await Je(e)}catch(t){e.lastError=String(t)}finally{e.configSaving=!1}}}async function rh(e){if(!(!e.client||!e.connected)){e.configApplying=!0,e.lastError=null;try{const t=e.configFormMode==="form"&&e.configForm?rn(e.configForm):e.configRaw,n=e.configSnapshot?.hash;if(!n){e.lastError="Config hash missing; reload and retry.";return}await e.client.request("config.apply",{raw:t,baseHash:n,sessionKey:e.applySessionKey}),e.configFormDirty=!1,await Je(e)}catch(t){e.lastError=String(t)}finally{e.configApplying=!1}}}async function Sr(e){if(!(!e.client||!e.connected)){e.updateRunning=!0,e.lastError=null;try{await e.client.request("godmode.update.run",{})}catch(t){e.lastError=String(t)}finally{e.updateRunning=!1}}}function en(e,t,n){const s=Pt(e.configForm??e.configSnapshot?.config??{});Lc(s,t,n),e.configForm=s,e.configFormDirty=!0,e.configFormMode==="form"&&(e.configRaw=rn(s))}function Ar(e,t){const n=Pt(e.configForm??e.configSnapshot?.config??{});Rc(n,t),e.configForm=n,e.configFormDirty=!0,e.configFormMode==="form"&&(e.configRaw=rn(n))}async function lh(e,t,n){en(e,["agents","defaults","model","primary"],t),en(e,["agents","defaults","model","fallbacks"],n),await Bs(e)}function ch(e){const{values:t,original:n}=e;return t.name!==n.name||t.displayName!==n.displayName||t.about!==n.about||t.picture!==n.picture||t.banner!==n.banner||t.website!==n.website||t.nip05!==n.nip05||t.lud16!==n.lud16}function dh(e){const{state:t,callbacks:n,accountId:s}=e,a=ch(t),i=(l,c,u={})=>{const{type:p="text",placeholder:f,maxLength:m,help:g}=u,w=t.values[l]??"",S=t.fieldErrors[l],T=`nostr-profile-${l}`;return p==="textarea"?r`
        <div class="form-field" style="margin-bottom: 12px;">
          ...
          <textarea
            ...
            @input=${x=>{const d=x.target;n.onFieldChange(l,d.value)}}
            ?disabled=${t.saving}
          ></textarea>
...
… truncated (${s.total} chars, showing first ${s.text.length}).`:s.text}function Oh(e){const t=[];return t.push({type:"toolcall",name:e.name,arguments:e.args??{}}),e.output&&t.push({type:"toolresult",name:e.name,text:e.output}),{role:"assistant",toolCallId:e.toolCallId,runId:e.runId,content:t,timestamp:e.startedAt}}function Nh(e){if(e.toolStreamOrder.length<=_r)return;const t=e.toolStreamOrder.length-_r,n=e.toolStreamOrder.splice(0,t);for(const s of n)e.toolStreamById.delete(s)}function Fh(e){e.chatToolMessages=e.toolStreamOrder.map(t=>e.toolStreamById.get(t)?.message).filter(t=>!!t)}function fi(e){e.toolStreamSyncTimer!=null&&(clearTimeout(e.toolStreamSyncTimer),e.toolStreamSyncTimer=null),Fh(e)}function Bh(e,t=!1){if(t){fi(e);return}e.toolStreamSyncTimer==null&&(e.toolStreamSyncTimer=window.setTimeout(()=>fi(e),Ih))}function Gi(e){e.toolStreamById.clear(),e.toolStreamOrder=[],e.chatToolMessages=[],e.currentToolName=null,e.currentToolInfo=null;const t=e;t.compactionStatus&&(t.compactionStatus=null),t.compactionClearTimer!=null&&(window.clearTimeout(t.compactionClearTimer),t.compactionClearTimer=null),fi(e)}const Uh=5e3;function zh(e,t){const n=t.data??{},s=typeof n.phase=="string"?n.phase:"";e.compactionClearTimer!=null&&(window.clearTimeout(e.compactionClearTimer),e.compactionClearTimer=null),s==="start"?e.compactionStatus={active:!0,startedAt:Date.now(),completedAt:null}:s==="end"&&(e.compactionStatus={active:!1,startedAt:e.compactionStatus?.startedAt??null,completedAt:Date.now()},e.compactionClearTimer=window.setTimeout(()=>{e.compactionStatus=null,e.compactionClearTimer=null},Uh))}function Kh(e,t){if(!t)return;if(t.stream==="compaction"){zh(e,t);return}if(t.stream!=="tool")return;const n=typeof t.sessionKey=="string"?t.sessionKey:void 0;if(n&&n!==e.sessionKey||!n&&e.chatRunId&&t.runId!==e.chatRunId||e.chatRunId&&t.runId!==e.chatRunId||!e.chatRunId)return;const s=t.data??{},a=typeof s.toolCallId=="string"?s.toolCallId:"";if(!a)return;const i=typeof s.name=="string"?s.name:"tool",o=typeof s.phase=="string"?s.phase:"",l=o==="start"?s.args:void 0,c=o==="update"?Lr(s.partialResult):o==="result"?Lr(s.result):void 0,u=Date.now();let p=e.toolStreamById.get(a);p?(p.name=i,l!==void 0&&(p.args=l,p.displayArgs=xr(i,l)),c!==void 0&&(p.output=c,p.resultSummary=Cr(i,c),p.success=Er(c)),p.updatedAt=u):(p={toolCallId:a,runId:t.runId,sessionKey:n,name:i,args:l,output:c,startedAt:typeof t.ts=="number"?t.ts:u,updatedAt:u,message:{},displayArgs:l?xr(i,l):void 0},e.toolStreamById.set(a,p),e.toolStreamOrder.push(a)),o==="start"?(e.currentToolName=i,e.currentToolInfo={name:i,details:p.displayArgs||void 0,startedAt:p.startedAt}):o==="result"&&(e.currentToolName=null,e.currentToolInfo=null,p.completedAt=u,p.resultSummary=Cr(i,p.output),p.success=Er(p.output)),p.message=Oh(p),Nh(e),Bh(e,o==="result")}const Qi={CHILD:2},Yi=e=>(...t)=>({_$litDirective$:e,values:t});let Ji=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,n,s){this._$Ct=t,this._$AM=n,this._$Ci=s}_$AS(t,n){return this.update(t,n)}update(t,n){return this.render(...n)}};class gi extends Ji{constructor(t){if(super(t),this.it=h,t.type!==Qi.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===h||t==null)return this._t=void 0,this.it=t;if(t===ut)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const n=[t];return n.raw=n,this._t={_$litType$:this.constructor.resultType,strings:n,values:[]}}}gi.directiveName="unsafeHTML",gi.resultType=1;const Ce=Yi(gi);const{entries:Bc,setPrototypeOf:Rr,isFrozen:Wh,getPrototypeOf:qh,getOwnPropertyDescriptor:Hh}=Object;let{freeze:me,seal:Ee,create:mi}=Object,{apply:vi,construct:yi}=typeof Reflect<"u"&&Reflect;me||(me=function(t){return t});Ee||(Ee=function(t){return t});vi||(vi=function(t,n){for(var s=arguments.length,a=new Array(s>2?s-2:0),i=2;i<s;i++)a[i-2]=arguments[i];return t.apply(n,a)});yi||(yi=function(t){for(var n=arguments.length,s=new Array(n>1?n-1:0),a=1;a<n;a++)s[a-1]=arguments[a];return new t(...s)});const bs=ve(Array.prototype.forEach),Vh=ve(Array.prototype.lastIndexOf),Pr=ve(Array.prototype.pop),Sn=ve(Array.prototype.push),jh=ve(Array.prototype.splice),Cs=ve(String.prototype.toLowerCase),Oa=ve(String.prototype.toString),Na=ve(String.prototype.match),An=ve(String.prototype.replace),Gh=ve(String.prototype.indexOf),Qh=ve(String.prototype.trim),Le=ve(Object.prototype.hasOwnProperty),he=ve(RegExp.prototype.test),Tn=Yh(TypeError);function ve(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);for(var n=arguments.length,s=new Array(n>1?n-1:0),a=1;a<n;a++)s[a-1]=arguments[a];return vi(e,t,s)}}function Yh(e){return function(){for(var t=arguments.length,n=new Array(t),s=0;s<t;s++)n[s]=arguments[s];return yi(e,n)}}function W(e,t){let n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:Cs;Rr&&Rr(e,null);let s=t.length;for(;s--;){let a=t[s];if(typeof a=="string"){const i=n(a);i!==a&&(Wh(t)||(t[s]=i),a=i)}e[a]=!0}return e}function Jh(e){for(let t=0;t<e.length;t++)Le(e,t)||(e[t]=null);return e}function Ue(e){const t=mi(null);for(const[n,s]of Bc(e))Le(e,n)&&(Array.isArray(s)?t[n]=Jh(s):s&&typeof s=="object"&&s.constructor===Object?t[n]=Ue(s):t[n]=s);return t}function _n(e,t){for(;e!==null;){const s=Hh(e,t);if(s){if(s.get)return ve(s.get);if(typeof s.value=="function")return ve(s.value)}e=qh(e)}function n(){return null}return n}const Ir=me(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","search","section","select","shadow","slot","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),Fa=me(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","enterkeyhint","exportparts","filter","font","g","glyph","glyphref","hkern","image","inputmode","line","lineargradient","marker","mask","metadata","mpath","part","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),Ba=me(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Xh=me(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),Ua=me(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),Zh=me(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),Mr=me(["#text"]),Dr=me(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","exportparts","face","for","headers","height","hidden","high","href","hreflang","id","inert","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","part","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","slot","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns","slot"]),za=me(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","mask-type","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),Or=me(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),ws=me(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),ef=Ee(/\{\{[\w\W]*|[\w\W]*\}\}/gm),tf=Ee(/<%[\w\W]*|[\w\W]*%>/gm),nf=Ee(/\$\{[\w\W]*/gm),sf=Ee(/^data-[\-\w.\u00B7-\uFFFF]+$/),af=Ee(/^aria-[\-\w]+$/),Uc=Ee(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),of=Ee(/^(?:\w+script|data):/i),rf=Ee(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),zc=Ee(/^html$/i),lf=Ee(/^[a-z][.\w]*(-[.\w]+)+$/i);var Nr=Object.freeze({__proto__:null,ARIA_ATTR:af,ATTR_WHITESPACE:rf,CUSTOM_ELEMENT:lf,DATA_ATTR:sf,DOCTYPE_NAME:zc,ERB_EXPR:tf,IS_ALLOWED_URI:Uc,IS_SCRIPT_OR_DATA:of,MUSTACHE_EXPR:ef,TMPLIT_EXPR:nf});const xn={element:1,text:3,progressingInstruction:7,comment:8,document:9},cf=function(){return typeof window>"u"?null:window},df=function(t,n){if(typeof t!="object"||typeof t.createPolicy!="function")return null;let s=null;const a="data-tt-policy-suffix";n&&n.hasAttribute(a)&&(s=n.getAttribute(a));const i="dompurify"+(s?"#"+s:"");try{return t.createPolicy(i,{createHTML(o){return o},createScriptURL(o){return o}})}catch{return console.warn("TrustedTypes policy "+i+" could not be created."),null}},Fr=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function Kc(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:cf();const t=O=>Kc(O);if(t.version="3.3.1",t.removed=[],!e||!e.document||e.document.nodeType!==xn.document||!e.Element)return t.isSupported=!1,t;let{document:n}=e;const s=n,a=s.currentScript,{DocumentFragment:i,HTMLTemplateElement:o,Node:l,Element:c,NodeFilter:u,NamedNodeMap:p=e.NamedNodeMap||e.MozNamedAttrMap,HTMLFormElement:f,DOMParser:m,trustedTypes:g}=e,w=c.prototype,S=_n(w,"cloneNode"),T=_n(w,"remove"),x=_n(w,"nextSibling"),d=_n(w,"childNodes"),k=_n(w,"parentNode");if(typeof o=="function"){const O=n.createElement("template");O.content&&O.content.ownerDocument&&(n=O.content.ownerDocument)}let A,_="";const{implementation:L,createNodeIterator:R,createDocumentFragment:z,getElementsByTagName:j}=n,{importNode:J}=s;let K=Fr();t.isSupported=typeof Bc=="function"&&typeof k=="function"&&L&&L.createHTMLDocument!==void 0;const{MUSTACHE_EXPR:ie,ERB_EXPR:de,TMPLIT_EXPR:D,DATA_ATTR:B,ARIA_ATTR:U,IS_SCRIPT_OR_DATA:M,ATTR_WHITESPACE:N,CUSTOM_ELEMENT:Oe}=Nr;let{IS_ALLOWED_URI:Se}=Nr,F=null;const vn=W({},[...Ir,...Fa,...Ba,...Ua,...Mr]);let X=null;const yn=W({},[...Dr,...za,...Or,...ws]);let Q=Object.seal(mi(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),st=null,ft=null;const at=Object.seal(mi(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}}));let bn=!0,Kt=!0,Sa=!1,jo=!0,Wt=!1,ds=!0,gt=!1,Aa=!1,Ta=!1,qt=!1,us=!1,ps=!1,Go=!0,Qo=!1;const kp="user-content-";let _a=!0,wn=!1,Ht={},Ne=null;const xa=W({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]);let Yo=null;const Jo=W({},["audio","video","img","source","image","track"]);let Ca=null;const Xo=W({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),hs="http://www.w3.org/1998/Math/MathML",fs="http://www.w3.org/2000/svg",He="http://www.w3.org/1999/xhtml";let Vt=He,Ea=!1,La=null;const $p=W({},[hs,fs,He],Oa);let gs=W({},["mi","mo","mn","ms","mtext"]),ms=W({},["annotation-xml"]);const Sp=W({},["title","style","font","a","script"]);let kn=null;const Ap=["application/xhtml+xml","text/html"],Tp="text/html";let te=null,jt=null;const _p=n.createElement("form"),Zo=function($){return $ instanceof RegExp||$ instanceof Function},Ra=function(){let $=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(jt&&jt===$)){if((!$||typeof $!="object")&&($={}),$=Ue($),kn=Ap.indexOf($.PARSER_MEDIA_TYPE)===-1?Tp:$.PARSER_MEDIA_TYPE,te=kn==="application/xhtml+xml"?Oa:Cs,F=Le($,"ALLOWED_TAGS")?W({},$.ALLOWED_TAGS,te):vn,X=Le($,"ALLOWED_ATTR")?W({},$.ALLOWED_ATTR,te):yn,La=Le($,"ALLOWED_NAMESPACES")?W({},$.ALLOWED_NAMESPACES,Oa):$p,Ca=Le($,"ADD_URI_SAFE_ATTR")?W(Ue(Xo),$.ADD_URI_SAFE_ATTR,te):Xo,Yo=Le($,"ADD_DATA_URI_TAGS")?W(Ue(Jo),$.ADD_DATA_URI_TAGS,te):Jo,Ne=Le($,"FORBID_CONTENTS")?W({},$.FORBID_CONTENTS,te):xa,st=Le($,"FORBID_TAGS")?W({},$.FORBID_TAGS,te):Ue({}),ft=Le($,"FORBID_ATTR")?W({},$.FORBID_ATTR,te):Ue({}),Ht=Le($,"USE_PROFILES")?$.USE_PROFILES:!1,bn=$.ALLOW_ARIA_ATTR!==!1,Kt=$.ALLOW_DATA_ATTR!==!1,Sa=$.ALLOW_UNKNOWN_PROTOCOLS||!1,jo=$.ALLOW_SELF_CLOSE_IN_ATTR!==!1,Wt=$.SAFE_FOR_TEMPLATES||!1,ds=$.SAFE_FOR_XML!==!1,gt=$.WHOLE_DOCUMENT||!1,qt=$.RETURN_DOM||!1,us=$.RETURN_DOM_FRAGMENT||!1,ps=$.RETURN_TRUSTED_TYPE||!1,Ta=$.FORCE_BODY||!1,Go=$.SANITIZE_DOM!==!1,Qo=$.SANITIZE_NAMED_PROPS||!1,_a=$.KEEP_CONTENT!==!1,wn=$.IN_PLACE||!1,Se=$.ALLOWED_URI_REGEXP||Uc,Vt=$.NAMESPACE||He,gs=$.MATHML_TEXT_INTEGRATION_POINTS||gs,ms=$.HTML_INTEGRATION_POINTS||ms,Q=$.CUSTOM_ELEMENT_HANDLING||{},$.CUSTOM_ELEMENT_HANDLING&&Zo($.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(Q.tagNameCheck=$.CUSTOM_ELEMENT_HANDLING.tagNameCheck),$.CUSTOM_ELEMENT_HANDLING&&Zo($.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(Q.attributeNameCheck=$.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),$.CUSTOM_ELEMENT_HANDLING&&typeof $.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(Q.allowCustomizedBuiltInElements=$.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),Wt&&(Kt=!1),us&&(qt=!0),Ht&&(F=W({},Mr),X=[],Ht.html===!0&&(W(F,Ir),W(X,Dr)),Ht.svg===!0&&(W(F,Fa),W(X,za),W(X,ws)),Ht.svgFilters===!0&&(W(F,Ba),W(X,za),W(X,ws)),Ht.mathMl===!0&&(W(F,Ua),W(X,Or),W(X,ws))),$.ADD_TAGS&&(typeof $.ADD_TAGS=="function"?at.tagCheck=$.ADD_TAGS:(F===vn&&(F=Ue(F)),W(F,$.ADD_TAGS,te))),$.ADD_ATTR&&(typeof $.ADD_ATTR=="function"?at.attributeCheck=$.ADD_ATTR:(X===yn&&(X=Ue(X)),W(X,$.ADD_ATTR,te))),$.ADD_URI_SAFE_ATTR&&W(Ca,$.ADD_URI_SAFE_ATTR,te),$.FORBID_CONTENTS&&(Ne===xa&&(Ne=Ue(Ne)),W(Ne,$.FORBID_CONTENTS,te)),$.ADD_FORBID_CONTENTS&&(Ne===xa&&(Ne=Ue(Ne)),W(Ne,$.ADD_FORBID_CONTENTS,te)),_a&&(F["#text"]=!0),gt&&W(F,["html","head","body"]),F.table&&(W(F,["tbody"]),delete st.tbody),$.TRUSTED_TYPES_POLICY){if(typeof $.TRUSTED_TYPES_POLICY.createHTML!="function")throw Tn('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof $.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Tn('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');A=$.TRUSTED_TYPES_POLICY,_=A.createHTML("")}else A===void 0&&(A=df(g,a)),A!==null&&typeof _=="string"&&(_=A.createHTML(""));me&&me($),jt=$}},er=W({},[...Fa,...Ba,...Xh]),tr=W({},[...Ua,...Zh]),xp=function($){let C=k($);(!C||!C.tagName)&&(C={namespaceURI:Vt,tagName:"template"});const I=Cs($.tagName),Y=Cs(C.tagName);return La[$.namespaceURI]?$.namespaceURI===fs?C.namespaceURI===He?I==="svg":C.namespaceURI===hs?I==="svg"&&(Y==="annotation-xml"||gs[Y]):!!er[I]:$.namespaceURI===hs?C.namespaceURI===He?I==="math":C.namespaceURI===fs?I==="math"&&ms[Y]:!!tr[I]:$.namespaceURI===He?C.namespaceURI===fs&&!ms[Y]||C.namespaceURI===hs&&!gs[Y]?!1:!tr[I]&&(Sp[I]||!er[I]):!!(kn==="application/xhtml+xml"&&La[$.namespaceURI]):!1},Fe=function($){Sn(t.removed,{element:$});try{k($).removeChild($)}catch{T($)}},mt=function($,C){try{Sn(t.removed,{attribute:C.getAttributeNode($),from:C})}catch{Sn(t.removed,{attribute:null,from:C})}if(C.removeAttribute($),$==="is")if(qt||us)try{Fe(C)}catch{}else try{C.setAttribute($,"")}catch{}},nr=function($){let C=null,I=null;if(Ta)$="<remove></remove>"+$;else{const Z=Na($,/^[\r\n\t ]+/);I=Z&&Z[0]}kn==="application/xhtml+xml"&&Vt===He&&($='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+$+"</body></html>");const Y=A?A.createHTML($):$;if(Vt===He)try{C=new m().parseFromString(Y,kn)}catch{}if(!C||!C.documentElement){C=L.createDocument(Vt,"template",null);try{C.documentElement.innerHTML=Ea?_:Y}catch{}}const ue=C.body||C.documentElement;return $&&I&&ue.insertBefore(n.createTextNode(I),ue.childNodes[0]||null),Vt===He?j.call(C,gt?"html":"body")[0]:gt?C.documentElement:ue},sr=function($){return R.call($.ownerDocument||$,$,u.SHOW_ELEMENT|u.SHOW_COMMENT|u.SHOW_TEXT|u.SHOW_PROCESSING_INSTRUCTION|u.SHOW_CDATA_SECTION,null)},Pa=function($){return $ instanceof f&&(typeof $.nodeName!="string"||typeof $.textContent!="string"||typeof $.removeChild!="function"||!($.attributes instanceof p)||typeof $.removeAttribute!="function"||typeof $.setAttribute!="function"||typeof $.namespaceURI!="string"||typeof $.insertBefore!="function"||typeof $.hasChildNodes!="function")},ar=function($){return typeof l=="function"&&$ instanceof l};function Ve(O,$,C){bs(O,I=>{I.call(t,$,C,jt)})}const ir=function($){let C=null;if(Ve(K.beforeSanitizeElements,$,null),Pa($))return Fe($),!0;const I=te($.nodeName);if(Ve(K.uponSanitizeElement,$,{tagName:I,allowedTags:F}),ds&&$.hasChildNodes()&&!ar($.firstElementChild)&&he(/<[/\w!]/g,$.innerHTML)&&he(/<[/\w!]/g,$.textContent)||$.nodeType===xn.progressingInstruction||ds&&$.nodeType===xn.comment&&he(/<[/\w]/g,$.data))return Fe($),!0;if(!(at.tagCheck instanceof Function&&at.tagCheck(I))&&(!F[I]||st[I])){if(!st[I]&&rr(I)&&(Q.tagNameCheck instanceof RegExp&&he(Q.tagNameCheck,I)||Q.tagNameCheck instanceof Function&&Q.tagNameCheck(I)))return!1;if(_a&&!Ne[I]){const Y=k($)||$.parentNode,ue=d($)||$.childNodes;if(ue&&Y){const Z=ue.length;for(let ye=Z-1;ye>=0;--ye){const je=S(ue[ye],!0);je.__removalCount=($.__removalCount||0)+1,Y.insertBefore(je,x($))}}}return Fe($),!0}return $ instanceof c&&!xp($)||(I==="noscript"||I==="noembed"||I==="noframes")&&he(/<\/no(script|embed|frames)/i,$.innerHTML)?(Fe($),!0):(Wt&&$.nodeType===xn.text&&(C=$.textContent,bs([ie,de,D],Y=>{C=An(C,Y," ")}),$.textContent!==C&&(Sn(t.removed,{element:$.cloneNode()}),$.textContent=C)),Ve(K.afterSanitizeElements,$,null),!1)},or=function($,C,I){if(Go&&(C==="id"||C==="name")&&(I in n||I in _p))return!1;if(!(Kt&&!ft[C]&&he(B,C))){if(!(bn&&he(U,C))){if(!(at.attributeCheck instanceof Function&&at.attributeCheck(C,$))){if(!X[C]||ft[C]){if(!(rr($)&&(Q.tagNameCheck instanceof RegExp&&he(Q.tagNameCheck,$)||Q.tagNameCheck instanceof Function&&Q.tagNameCheck($))&&(Q.attributeNameCheck instanceof RegExp&&he(Q.attributeNameCheck,C)||Q.attributeNameCheck instanceof Function&&Q.attributeNameCheck(C,$))||C==="is"&&Q.allowCustomizedBuiltInElements&&(Q.tagNameCheck instanceof RegExp&&he(Q.tagNameCheck,I)||Q.tagNameCheck instanceof Function&&Q.tagNameCheck(I))))return!1}else if(!Ca[C]){if(!he(Se,An(I,N,""))){if(!((C==="src"||C==="xlink:href"||C==="href")&&$!=="script"&&Gh(I,"data:")===0&&Yo[$])){if(!(Sa&&!he(M,An(I,N,"")))){if(I)return!1}}}}}}}return!0},rr=function($){return $!=="annotation-xml"&&Na($,Oe)},lr=function($){Ve(K.beforeSanitizeAttributes,$,null);const{attributes:C}=$;if(!C||Pa($))return;const I={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:X,forceKeepAttr:void 0};let Y=C.length;for(;Y--;){const ue=C[Y],{name:Z,namespaceURI:ye,value:je}=ue,Gt=te(Z),Ia=je;let oe=Z==="value"?Ia:Qh(Ia);if(I.attrName=Gt,I.attrValue=oe,I.keepAttr=!0,I.forceKeepAttr=void 0,Ve(K.uponSanitizeAttribute,$,I),oe=I.attrValue,Qo&&(Gt==="id"||Gt==="name")&&(mt(Z,$),oe=kp+oe),ds&&he(/((--!?|])>)|<\/(style|title|textarea)/i,oe)){mt(Z,$);continue}if(Gt==="attributename"&&Na(oe,"href")){mt(Z,$);continue}if(I.forceKeepAttr)continue;if(!I.keepAttr){mt(Z,$);continue}if(!jo&&he(/\/>/i,oe)){mt(Z,$);continue}Wt&&bs([ie,de,D],dr=>{oe=An(oe,dr," ")});const cr=te($.nodeName);if(!or(cr,Gt,oe)){mt(Z,$);continue}if(A&&typeof g=="object"&&typeof g.getAttributeType=="function"&&!ye)switch(g.getAttributeType(cr,Gt)){case"TrustedHTML":{oe=A.createHTML(oe);break}case"TrustedScriptURL":{oe=A.createScriptURL(oe);break}}if(oe!==Ia)try{ye?$.setAttributeNS(ye,Z,oe):$.setAttribute(Z,oe),Pa($)?Fe($):Pr(t.removed)}catch{mt(Z,$)}}Ve(K.afterSanitizeAttributes,$,null)},Cp=function O($){let C=null;const I=sr($);for(Ve(K.beforeSanitizeShadowDOM,$,null);C=I.nextNode();)Ve(K.uponSanitizeShadowNode,C,null),ir(C),lr(C),C.content instanceof i&&O(C.content);Ve(K.afterSanitizeShadowDOM,$,null)};return t.sanitize=function(O){let $=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},C=null,I=null,Y=null,ue=null;if(Ea=!O,Ea&&(O="<!-->"),typeof O!="string"&&!ar(O))if(typeof O.toString=="function"){if(O=O.toString(),typeof O!="string")throw Tn("dirty is not a string, aborting")}else throw Tn("toString is not a function");if(!t.isSupported)return O;if(Aa||Ra($),t.removed=[],typeof O=="string"&&(wn=!1),wn){if(O.nodeName){const je=te(O.nodeName);if(!F[je]||st[je])throw Tn("root node is forbidden and cannot be sanitized in-place")}}else if(O instanceof l)C=nr("<!---->"),I=C.ownerDocument.importNode(O,!0),I.nodeType===xn.element&&I.nodeName==="BODY"||I.nodeName==="HTML"?C=I:C.appendChild(I);else{if(!qt&&!Wt&&!gt&&O.indexOf("<")===-1)return A&&ps?A.createHTML(O):O;if(C=nr(O),!C)return qt?null:ps?_:""}C&&Ta&&Fe(C.firstChild);const Z=sr(wn?O:C);for(;Y=Z.nextNode();)ir(Y),lr(Y),Y.content instanceof i&&Cp(Y.content);if(wn)return O;if(qt){if(us)for(ue=z.call(C.ownerDocument);C.firstChild;)ue.appendChild(C.firstChild);else ue=C;return(X.shadowroot||X.shadowrootmode)&&(ue=J.call(s,ue,!0)),ue}let ye=gt?C.outerHTML:C.innerHTML;return gt&&F["!doctype"]&&C.ownerDocument&&C.ownerDocument.doctype&&C.ownerDocument.doctype.name&&he(zc,C.ownerDocument.doctype.name)&&(ye="<!DOCTYPE "+C.ownerDocument.doctype.name+`>
`+ye),Wt&&bs([ie,de,D],je=>{ye=An(ye,je," ")}),A&&ps?A.createHTML(ye):ye},t.setConfig=function(){let O=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Ra(O),Aa=!0},t.clearConfig=function(){jt=null,Aa=!1},t.isValidAttribute=function(O,$,C){jt||Ra({});const I=te(O),Y=te($);return or(I,Y,C)},t.addHook=function(O,$){typeof $=="function"&&Sn(K[O],$)},t.removeHook=function(O,$){if($!==void 0){const C=Vh(K[O],$);return C===-1?void 0:jh(K[O],C,1)[0]}return Pr(K[O])},t.removeHooks=function(O){K[O]=[]},t.removeAllHooks=function(){K=Fr()},t}var cn=Kc();function Xi(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Bt=Xi();function Wc(e){Bt=e}var xt={exec:()=>null};function H(e,t=""){let n=typeof e=="string"?e:e.source,s={replace:(a,i)=>{let o=typeof i=="string"?i:i.source;return o=o.replace(ge.caret,"$1"),n=n.replace(a,o),s},getRegex:()=>new RegExp(n,t)};return s}var uf=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),ge={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:e=>new RegExp(`^ {0,${Math.min(3,e-1)}}>`)},pf=/^(?:[ \t]*(?:\n|$))+/,hf=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,ff=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,ns=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,gf=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Zi=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,qc=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Hc=H(qc).replace(/bull/g,Zi).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),mf=H(qc).replace(/bull/g,Zi).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),eo=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,vf=/^[^\n]+/,to=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,yf=H(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",to).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),bf=H(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Zi).getRegex(),ia="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",no=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,wf=H("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",no).replace("tag",ia).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Vc=H(eo).replace("hr",ns).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ia).getRegex(),kf=H(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Vc).getRegex(),so={blockquote:kf,code:hf,def:yf,fences:ff,heading:gf,hr:ns,html:wf,lheading:Hc,list:bf,newline:pf,paragraph:Vc,table:xt,text:vf},Br=H("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",ns).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ia).getRegex(),$f={...so,lheading:mf,table:Br,paragraph:H(eo).replace("hr",ns).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Br).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ia).getRegex()},Sf={...so,html:H(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",no).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:xt,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:H(eo).replace("hr",ns).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Hc).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Af=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Tf=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,jc=/^( {2,}|\\)\n(?!\s*$)/,_f=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,oa=/[\p{P}\p{S}]/u,ao=/[\s\p{P}\p{S}]/u,Gc=/[^\s\p{P}\p{S}]/u,xf=H(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,ao).getRegex(),Qc=/(?!~)[\p{P}\p{S}]/u,Cf=/(?!~)[\s\p{P}\p{S}]/u,Ef=/(?:[^\s\p{P}\p{S}]|~)/u,Yc=/(?![*_])[\p{P}\p{S}]/u,Lf=/(?![*_])[\s\p{P}\p{S}]/u,Rf=/(?:[^\s\p{P}\p{S}]|[*_])/u,Pf=H(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",uf?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Jc=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,If=H(Jc,"u").replace(/punct/g,oa).getRegex(),Mf=H(Jc,"u").replace(/punct/g,Qc).getRegex(),Xc="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Df=H(Xc,"gu").replace(/notPunctSpace/g,Gc).replace(/punctSpace/g,ao).replace(/punct/g,oa).getRegex(),Of=H(Xc,"gu").replace(/notPunctSpace/g,Ef).replace(/punctSpace/g,Cf).replace(/punct/g,Qc).getRegex(),Nf=H("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Gc).replace(/punctSpace/g,ao).replace(/punct/g,oa).getRegex(),Ff=H(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,Yc).getRegex(),Bf="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",Uf=H(Bf,"gu").replace(/notPunctSpace/g,Rf).replace(/punctSpace/g,Lf).replace(/punct/g,Yc).getRegex(),zf=H(/\\(punct)/,"gu").replace(/punct/g,oa).getRegex(),Kf=H(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Wf=H(no).replace("(?:-->|$)","-->").getRegex(),qf=H("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Wf).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),zs=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,Hf=H(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",zs).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Zc=H(/^!?\[(label)\]\[(ref)\]/).replace("label",zs).replace("ref",to).getRegex(),ed=H(/^!?\[(ref)\](?:\[\])?/).replace("ref",to).getRegex(),Vf=H("reflink|nolink(?!\\()","g").replace("reflink",Zc).replace("nolink",ed).getRegex(),Ur=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,io={_backpedal:xt,anyPunctuation:zf,autolink:Kf,blockSkip:Pf,br:jc,code:Tf,del:xt,delLDelim:xt,delRDelim:xt,emStrongLDelim:If,emStrongRDelimAst:Df,emStrongRDelimUnd:Nf,escape:Af,link:Hf,nolink:ed,punctuation:xf,reflink:Zc,reflinkSearch:Vf,tag:qf,text:_f,url:xt},jf={...io,link:H(/^!?\[(label)\]\((.*?)\)/).replace("label",zs).getRegex(),reflink:H(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",zs).getRegex()},bi={...io,emStrongRDelimAst:Of,emStrongLDelim:Mf,delLDelim:Ff,delRDelim:Uf,url:H(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Ur).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:H(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Ur).getRegex()},Gf={...bi,br:H(jc).replace("{2,}","*").getRegex(),text:H(bi.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},ks={normal:so,gfm:$f,pedantic:Sf},Cn={normal:io,gfm:bi,breaks:Gf,pedantic:jf},Qf={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},zr=e=>Qf[e];function ze(e,t){if(t){if(ge.escapeTest.test(e))return e.replace(ge.escapeReplace,zr)}else if(ge.escapeTestNoEncode.test(e))return e.replace(ge.escapeReplaceNoEncode,zr);return e}function Kr(e){try{e=encodeURI(e).replace(ge.percentDecode,"%")}catch{return null}return e}function Wr(e,t){let n=e.replace(ge.findPipe,(i,o,l)=>{let c=!1,u=o;for(;--u>=0&&l[u]==="\\";)c=!c;return c?"|":" |"}),s=n.split(ge.splitPipe),a=0;if(s[0].trim()||s.shift(),s.length>0&&!s.at(-1)?.trim()&&s.pop(),t)if(s.length>t)s.splice(t);else for(;s.length<t;)s.push("");for(;a<s.length;a++)s[a]=s[a].trim().replace(ge.slashPipe,"|");return s}function En(e,t,n){let s=e.length;if(s===0)return"";let a=0;for(;a<s&&e.charAt(s-a-1)===t;)a++;return e.slice(0,s-a)}function Yf(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let s=0;s<e.length;s++)if(e[s]==="\\")s++;else if(e[s]===t[0])n++;else if(e[s]===t[1]&&(n--,n<0))return s;return n>0?-2:-1}function Jf(e,t=0){let n=t,s="";for(let a of e)if(a==="	"){let i=4-n%4;s+=" ".repeat(i),n+=i}else s+=a,n++;return s}function qr(e,t,n,s,a){let i=t.href,o=t.title||null,l=e[1].replace(a.other.outputLinkReplace,"$1");s.state.inLink=!0;let c={type:e[0].charAt(0)==="!"?"image":"link",raw:n,href:i,title:o,text:l,tokens:s.inlineTokens(l)};return s.state.inLink=!1,c}function Xf(e,t,n){let s=e.match(n.other.indentCodeCompensation);if(s===null)return t;let a=s[1];return t.split(`
...
`,e=e.substring(m.length+1),c=!0),!c){let S=this.rules.other.nextBulletRegex(w),T=this.rules.other.hrRegex(w),x=this.rules.other.fencesBeginRegex(w),d=this.rules.other.headingBeginRegex(w),k=this.rules.other.htmlBeginRegex(w),A=this.rules.other.blockquoteBeginRegex(w);for(;e;){let _=e.split(`
`,1)[0],L;if(m=_,this.options.pedantic?(m=m.replace(this.rules.other.listReplaceNesting,"  "),L=m):L=m.replace(this.rules.other.tabCharGlobal,"    "),x.test(m)||d.test(m)||k.test(m)||A.test(m)||S.test(m)||T.test(m))break;if(L.search(this.rules.other.nonSpaceChar)>=w||!m.trim())p+=`
`+L.slice(w);else{if(g||f.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||x.test(f)||d.test(f)||T.test(f))break;p+=`
`+m}g=!m.trim(),u+=_+`
...
`)?"":`
`)+a.raw,o.text+=`
`+a.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=o.text):n.push(a);continue}if(t){let o="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(o);break}else throw new Error(o)}}return this.state.top=!0,n}inline(t,n=[]){return this.inlineQueue.push({src:t,tokens:n}),n}inlineTokens(t,n=[]){let s=t,a=null;if(this.tokens.links){let c=Object.keys(this.tokens.links);if(c.length>0)for(;(a=this.tokenizer.rules.inline.reflinkSearch.exec(s))!=null;)c.includes(a[0].slice(a[0].lastIndexOf("[")+1,-1))&&(s=s.slice(0,a.index)+"["+"a".repeat(a[0].length-2)+"]"+s.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(a=this.tokenizer.rules.inline.anyPunctuation.exec(s))!=null;)s=s.slice(0,a.index)+"++"+s.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let i;for(;(a=this.tokenizer.rules.inline.blockSkip.exec(s))!=null;)i=a[2]?a[2].length:0,s=s.slice(0,a.index+i)+"["+"a".repeat(a[0].length-i-2)+"]"+s.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);s=this.options.hooks?.emStrongMask?.call({lexer:this},s)??s;let o=!1,l="";for(;t;){o||(l=""),o=!1;let c;if(this.options.extensions?.inline?.some(p=>(c=p.call({lexer:this},t,n))?(t=t.substring(c.raw.length),n.push(c),!0):!1))continue;if(c=this.tokenizer.escape(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.tag(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.link(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.reflink(t,this.tokens.links)){t=t.substring(c.raw.length);let p=n.at(-1);c.type==="text"&&p?.type==="text"?(p.raw+=c.raw,p.text+=c.text):n.push(c);continue}if(c=this.tokenizer.emStrong(t,s,l)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.codespan(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.br(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.del(t,s,l)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.autolink(t)){t=t.substring(c.raw.length),n.push(c);continue}if(!this.state.inLink&&(c=this.tokenizer.url(t))){t=t.substring(c.raw.length),n.push(c);continue}let u=t;if(this.options.extensions?.startInline){let p=1/0,f=t.slice(1),m;this.options.extensions.startInline.forEach(g=>{m=g.call({lexer:this},f),typeof m=="number"&&m>=0&&(p=Math.min(p,m))}),p<1/0&&p>=0&&(u=t.substring(0,p+1))}if(c=this.tokenizer.inlineText(u)){t=t.substring(c.raw.length),c.raw.slice(-1)!=="_"&&(l=c.raw.slice(-1)),o=!0;let p=n.at(-1);p?.type==="text"?(p.raw+=c.raw,p.text+=c.text):n.push(c);continue}if(t){let p="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(p);break}else throw new Error(p)}}return n}},Ws=class{options;parser;constructor(e){this.options=e||Bt}space(e){return""}code({text:e,lang:t,escaped:n}){let s=(t||"").match(ge.notSpaceStart)?.[0],a=e.replace(ge.endingNewline,"")+`
...
`);return s.length>Yr?s.slice(0,Yr)+"…":n.length<t.length?s+"…":s}function Jg(e){const t=e,n=tm(t.content),s=[];for(const a of n){const i=(typeof a.type=="string"?a.type:"").toLowerCase();(["toolcall","tool_call","tooluse","tool_use"].includes(i)||typeof a.name=="string"&&a.arguments!=null)&&s.push({kind:"call",name:a.name??"tool",args:nm(a.arguments??a.args)})}for(const a of n){const i=(typeof a.type=="string"?a.type:"").toLowerCase();if(i!=="toolresult"&&i!=="tool_result")continue;const o=sm(a);if(Xr(o))continue;const l=typeof a.name=="string"?a.name:"tool";s.push({kind:"result",name:l,text:o})}if(cd(e)&&!s.some(a=>a.kind==="result")){const a=typeof t.toolName=="string"&&t.toolName||typeof t.tool_name=="string"&&t.tool_name||"tool",i=ro(e)??void 0;Xr(i)||s.push({kind:"result",name:a,text:i})}return s}const Xg=new Set(["write","read","edit","attach"]);function Zg(e){if(!e||typeof e!="object")return null;const t=e,n=t.path??t.file_path??t.filePath;return typeof n=="string"&&n.trim()?n.trim():null}function em(e){if(!e)return null;const t=e.match(/(?:\/(?:Users|home|tmp|var)\/\S+|~\/\S+)/);return t?t[0].replace(/[.,;:!?)'"]+$/,""):null}function Jr(e,t,n){const s=Wg({name:e.name,args:e.args}),a=qg(s),i=!!e.text?.trim(),o=Xg.has(e.name.toLowerCase())?Zg(e.args)??em(e.text):null,l=!!t||!!(n&&o),c=l?S=>{if(S.stopPropagation(),n&&o){n(o);return}if(t&&i){t(Qg(e.text));return}if(t){const T=`## ${s.label}

${a?`**Command:** \`${a}\`

`:""}*No output — tool completed successfully.*`;t(T)}}:void 0,u=e.text?e.text.split(`
`).length:0,p=i&&(e.text?.length??0)<=Vg,f=i&&!p&&u>Gg,m=i&&!f,g=!i,w=e.kind==="call"?"chat-tool-card--call":"chat-tool-card--result";return r`
    <div
      class="chat-tool-card ${w} ${l?"chat-tool-card--clickable":""}"
      @click=${c}
      role=${l?"button":h}
      tabindex=${l?"0":h}
      @keydown=${l?S=>{S.key!=="Enter"&&S.key!==" "||(S.preventDefault(),S.stopPropagation(),c?.(S))}:h}
    >
      <div class="chat-tool-card__header">
        <div class="chat-tool-card__title">
          <span class="chat-tool-card__icon">${G[s.icon]}</span>
          <span>${s.label}</span>
        </div>
        ${l?r`<span class="chat-tool-card__action">${i?"View":""} ${G.check}</span>`:h}
        ${g&&!l?r`<span class="chat-tool-card__status">${G.check}</span>`:h}
      </div>
      ${a?r`<div class="chat-tool-card__detail">${a}</div>`:h}
      ${g?r`
              <div class="chat-tool-card__status-text muted">Completed</div>
            `:h}
      ${f?r`<details class="chat-tool-card__expandable" @click=${S=>S.stopPropagation()}>
  ...
  `}function tm(e){return Array.isArray(e)?e.filter(Boolean):[]}function nm(e){if(typeof e!="string")return e;const t=e.trim();if(!t||!t.startsWith("{")&&!t.startsWith("["))return e;try{return JSON.parse(t)}catch{return e}}function sm(e){if(typeof e.text=="string")return e.text;if(typeof e.content=="string")return e.content}function Xr(e){if(!e)return!1;const t=e.toLowerCase();return t.includes("process exited")?!1:t.includes("(no new output)")&&t.includes("still running")}const Zr={exec:["Executing","Running","Conjuring","Manifesting","Brewing"],read:["Reading","Perusing","Absorbing","Scanning","Devouring"],write:["Writing","Scribbling","Crafting","Inscribing","Authoring"],edit:["Editing","Refining","Polishing","Tweaking","Sculpting"],browser:["Browsing","Surfing","Exploring","Navigating","Spelunking"],web_search:["Searching","Hunting","Investigating","Sleuthing","Scouring"],web_fetch:["Fetching","Grabbing","Retrieving","Summoning","Acquiring"],memory_search:["Remembering","Recalling","Pondering","Reflecting"],image:["Analyzing","Examining","Scrutinizing","Inspecting","Beholding"],default:["Working on","Processing","Handling","Tinkering with","Wrangling"]};function pd(e){const t=e.toLowerCase().replace(/[^a-z_]/g,""),n=Zr[t]??Zr.default,s=Math.floor(Date.now()/2e3)%n.length;return n[s]}const el={pdf:"📕",doc:"📘",docx:"📘",txt:"📄",rtf:"📄",xls:"📗",xlsx:"📗",csv:"📊",ppt:"📙",pptx:"📙",jpg:"🖼️",jpeg:"🖼️",png:"🖼️",gif:"🖼️",webp:"🖼️",svg:"🖼️",mp3:"🎵",wav:"🎵",m4a:"🎵",mp4:"🎬",mov:"🎬",avi:"🎬",zip:"📦",rar:"📦","7z":"📦",tar:"📦",gz:"📦",js:"📜",ts:"📜",py:"📜",json:"📜",html:"📜",css:"📜",md:"📜",default:"📎"};function am(e){const t=e.split(".").pop()?.toLowerCase()||"";return el[t]??el.default}function im(e,t){const n=t.split(".").pop()?.toLowerCase()||"";return{pdf:"PDF Document",doc:"Word Document",docx:"Word Document",xls:"Excel Spreadsheet",xlsx:"Excel Spreadsheet",csv:"CSV File",ppt:"PowerPoint",pptx:"PowerPoint",txt:"Text File",md:"Markdown",json:"JSON File",zip:"ZIP Archive",png:"PNG Image",jpg:"JPEG Image",jpeg:"JPEG Image",gif:"GIF Image",mp3:"Audio File",mp4:"Video File"}[n]||e.split("/")[1]?.toUpperCase()||"File"}function om(e){const t=e.match(/\[Files uploaded:\s*([^\]]+)\]/);if(!t)return null;const n=t[1],s=[],a=/([^(,]+?)\s*\(fileId:\s*([^,]+),\s*size:\s*([^,]+),\s*type:\s*([^)]+)\)/g;let i;for(;(i=a.exec(n))!==null;)s.push({fileName:i[1].trim(),fileId:i[2].trim(),size:i[3].trim(),mimeType:i[4].trim()});return s.length>0?s:null}function rm(e){return r`
    <div class="chat-file-uploads">
      ${e.map(t=>r`
        <div class="chat-file-upload-card">
          <span class="chat-file-upload-card__icon">${am(t.fileName)}</span>
          <div class="chat-file-upload-card__info">
            <span class="chat-file-upload-card__name" title="${t.fileName}">${t.fileName}</span>
            <span class="chat-file-upload-card__meta">${t.size} • ${im(t.mimeType,t.fileName)}</span>
          </div>
        </div>
      `)}
    </div>
  `}function lm(e){return e.replace(/\[Files uploaded:[^\]]+\]\s*/g,"").trim()}function cm(e){if(!e)return e;if(e.startsWith("System:")||e.startsWith("GatewayRestart:")){const i=e.indexOf(`
...
`);)a=a.slice(1);return a.trim()}function dm(e){return typeof e!="number"||!Number.isFinite(e)||e<=0?null:e>=1024*1024?`${(e/(1024*1024)).toFixed(1)} MB`:e>=1024?`${Math.round(e/1024)} KB`:`${Math.round(e)} B`}function Si(e){const t=e,n=t.content,s=[];if(Array.isArray(n))for(const i of n){if(typeof i!="object"||i===null)continue;const o=i;if(o.type==="image"){const l=o.source;if(l?.type==="base64"&&typeof l.data=="string"){const c=l.data,u=l.media_type||"image/png",p=c.startsWith("data:")?c:`data:${u};base64,${c}`;s.push({url:p})}else if(typeof o.data=="string"&&typeof o.mimeType=="string"){const c=o.data.startsWith("data:")?o.data:`data:${o.mimeType};base64,${o.data}`;s.push({url:c})}else typeof o.url=="string"?s.push({url:o.url}):o.omitted===!0&&s.push({omitted:!0,bytes:typeof o.bytes=="number"?o.bytes:void 0,mimeType:typeof o.mimeType=="string"?o.mimeType:void 0,alt:typeof o.fileName=="string"?o.fileName:void 0})}else if(o.type==="image_url"){const l=o.image_url;typeof l?.url=="string"&&s.push({url:l.url})}else o.type==="attachment"&&typeof o.content=="string"&&(o.mimeType||"").startsWith("image/")&&s.push({url:o.content,alt:o.fileName||void 0});if(o.type==="text"&&typeof o.text=="string"){const l=/data:image\/[^;]+;base64,[A-Za-z0-9+/=]+/g,c=o.text.match(l);if(c)for(const u of c)s.push({url:u})}if(Array.isArray(o.content))for(const l of o.content){if(typeof l!="object"||l===null)continue;const c=l;if(c.type==="image"){const u=c.source;if(u?.type==="base64"&&typeof u.data=="string"){const p=u.media_type||"image/png",f=u.data.startsWith("data:")?u.data:`data:${p};base64,${u.data}`;s.push({url:f})}else if(typeof c.data=="string"&&typeof c.mimeType=="string"){const p=c.data.startsWith("data:")?c.data:`data:${c.mimeType};base64,${c.data}`;s.push({url:p})}else c.omitted===!0&&s.push({omitted:!0,bytes:typeof c.bytes=="number"?c.bytes:void 0,mimeType:typeof c.mimeType=="string"?c.mimeType:void 0,alt:typeof c.fileName=="string"?c.fileName:void 0})}}}const a=t.attachments;if(Array.isArray(a))for(const i of a){if(typeof i!="object"||i===null)continue;const o=i;if(o.type==="image"&&typeof o.content=="string"){const l=o.mimeType||"image/png",c=o.content.startsWith("data:")?o.content:`data:${l};base64,${o.content}`;s.push({url:c,alt:o.fileName||void 0})}else o.type==="image"&&o.omitted===!0&&s.push({omitted:!0,bytes:typeof o.bytes=="number"?o.bytes:void 0,mimeType:typeof o.mimeType=="string"?o.mimeType:void 0,alt:typeof o.fileName=="string"?o.fileName:void 0})}return s}function um(e){const t=e,n=t.content,s=[];if(Array.isArray(n))for(const i of n){if(typeof i!="object"||i===null)continue;const o=i;if(o.type==="attachment"&&typeof o.content=="string"){const l=o.mimeType||"application/octet-stream";l.startsWith("image/")||s.push({fileName:o.fileName||"file",mimeType:l,content:o.content})}}const a=t.attachments;if(Array.isArray(a))for(const i of a){if(typeof i!="object"||i===null)continue;const o=i;o.type==="file"&&typeof o.content=="string"&&s.push({fileName:o.fileName||"file",mimeType:o.mimeType||"application/octet-stream",content:o.content})}return s}function pm(e,t){return r`
  ...
  `}function hm(e,t,n,s,a){const i=new Date(t).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"}),o=s?.name??"Assistant";return r`
    <div class="chat-group assistant">
  ...
  `}function fm(e,t){const n=lo(e.role),s=t.assistantName??"Assistant",a=t.userName??"You",i=n==="user"?a:n==="assistant"?s:n,o=n==="user"?"user":n==="assistant"?"assistant":"other",l=new Date(e.timestamp).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"});return r`
    <div class="chat-group ${o}">
      ${co(e.role,{assistantName:s,assistantAvatar:t.assistantAvatar??null,userName:a,userAvatar:t.userAvatar??null})}
      <div class="chat-group-messages">
        ${e.messages.map((c,u)=>hd(c.message,{isStreaming:e.isStreaming&&u===e.messages.length-1,showReasoning:t.showReasoning},t.onOpenSidebar,t.onOpenFile,t.onImageClick,t.resolveImageUrl))}
        <div class="chat-group-footer">
  ...
  `}function co(e,t){const n=lo(e),s=t?.assistantName?.trim()||"Assistant",a=typeof t?.assistantAvatar=="string"?t.assistantAvatar.trim():"",i=t?.userName?.trim()||"You",o=typeof t?.userAvatar=="string"?t.userAvatar.trim():"",l=n==="user"?"user":n==="assistant"?"assistant":n==="tool"?"tool":"other";return n==="user"?o&&tl(o)?r`<img
    ...
    <div class="chat-message-images">
      ${s.map(i=>{const o=i.resolvedUrl||i.url;if(!o){const c=dm(i.bytes),p=[i.mimeType?i.mimeType.replace("image/","").toUpperCase():null,c,"preview omitted"].filter(Boolean).join(" - ");return r`
            <div
  ...
  `}function gm(e){return e.length===0?h:r`
  ...
  `}function hd(e,t,n,s,a,i){try{return mm(e,t,n,s,a,i)}catch(o){return console.error("[chat] message render error:",o),r`
      <div class="chat-bubble">
        <div class="chat-text"><em>Message failed to render</em></div>
      </div>
    `}}function mm(e,t,n,s,a,i){const o=e,l=typeof o.role=="string"?o.role:"unknown",c=cd(e)||l.toLowerCase()==="toolresult"||l.toLowerCase()==="tool_result"||typeof o.toolCallId=="string"||typeof o.tool_call_id=="string",u=Jg(e),p=u.length>0,f=Si(e),m=f.length>0,g=typeof o._chatIdx=="number"?o._chatIdx:-1,w=i&&g>=0?K=>i(g,K):void 0,S=um(e),T=S.length>0,x=ro(e),d=t.showReasoning&&l==="assistant"?id(e):null,k=l==="user"&&x?om(x):null,A=k&&k.length>0;let _=x;if(l==="user"&&_&&(_=cm(_)),_&&(_=_.replace(/<system-context\b[^>]*>[\s\S]*?<\/system-context>/gi,"").trim()||null),_){const K=ad(_);K&&(_=K)}A&&_&&(_=lm(_));const L=_?.trim()?_:null,R=d?rd(d):null,z=L,j=l==="assistant"&&!!z?.trim(),J=["chat-bubble",j?"has-copy":"",t.isStreaming?"streaming":"","fade-in"].filter(Boolean).join(" ");if(p&&c)return r`
      ${m?nl(f,a,w):h}
      ${u.map(K=>Jr(K,n,s))}
    `;if(!z&&!p&&!m&&!T&&!A&&!R){const K=typeof o.errorMessage=="string"?o.errorMessage:null;if(o.stopReason==="error"&&K){let ie=K;const de=K.match(/(\d+)\s*tokens?\s*>\s*(\d+)/);if(de){const D=parseInt(de[1]).toLocaleString(),B=parseInt(de[2]).toLocaleString();ie=`Context overflow: ${D} tokens exceeded the ${B} token limit. The conversation needs to be compacted.`}else K.includes("prompt is too long")&&(ie="Context overflow: The conversation is too long for the model.");return r`
        <div class="chat-bubble chat-bubble--error fade-in">
          <div class="chat-text">${ie}</div>
        </div>
      `}return h}return r`
    <div class="${J}">
      ${j?Ag(z):h}
      ...
      ${nl(f,a,w)}
      ${gm(S)}
      ${R?r`<details class="chat-thinking-details">
              <summary class="chat-thinking-summary">Thinking...</summary>
              <div class="chat-thinking">${Ce(we(R))}</div>
            </details>`:h}
      ${z?r`<div class="chat-text">${Ce(t.isStreaming?nd(z):we(z))}</div>`:h}
      ${u.map(K=>Jr(K,n,s))}
    </div>
  `}function vm(e){const t=e,n=typeof t.content=="string"?t.content:"",s=typeof t.keptMessages=="number"?t.keptMessages:null,a=typeof t.timestamp=="number"?new Date(t.timestamp).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"}):"";return r`
...
No details available.`,title:t.task,mimeType:"text/markdown"}}const Yt=Object.freeze(Object.defineProperty({__proto__:null,AGENT_ROLE_NAMES:su,approveCodingTask:dy,approveQueueItem:cy,cancelCodingTask:ly,formatDuration:au,loadAgentDetail:py,loadMissionControl:fn,retryQueueItem:uy},Symbol.toStringTag,{value:"Module"}));function So(e){e.nodesPollInterval==null&&(e.nodesPollInterval=window.setInterval(()=>{ua(e,{quiet:!0})},5e3))}function Ao(e){e.nodesPollInterval!=null&&(clearInterval(e.nodesPollInterval),e.nodesPollInterval=null)}function To(e){e.logsPollInterval==null&&(e.logsPollInterval=window.setInterval(()=>{e.tab==="logs"&&$o(e,{quiet:!0})},2e3))}function _o(e){e.logsPollInterval!=null&&(clearInterval(e.logsPollInterval),e.logsPollInterval=null)}function xo(e){e.debugPollInterval==null&&(e.debugPollInterval=window.setInterval(()=>{e.tab==="debug"&&pa(e)},3e3))}function Co(e){e.debugPollInterval!=null&&(clearInterval(e.debugPollInterval),e.debugPollInterval=null)}function iu(e){e.missionControlPollInterval==null&&(e.missionControlPollInterval=window.setInterval(()=>{e.tab==="mission-control"&&fn(e,{quiet:!0})},5e3))}function ou(e){e.missionControlPollInterval!=null&&(clearInterval(e.missionControlPollInterval),e.missionControlPollInterval=null)}async function ss(e){if(!(!e.client||!e.connected))try{const t=await e.client.request("cron.status",{});e.cronStatus=t}catch(t){e.cronError=String(t)}}async function ha(e){if(!(!e.client||!e.connected)&&!e.cronLoading){e.cronLoading=!0,e.cronError=null;try{const t=await e.client.request("cron.list",{includeDisabled:!0});e.cronJobs=Array.isArray(t.jobs)?t.jobs:[]}catch(t){e.cronError=String(t)}finally{e.cronLoading=!1}}}function hy(e){if(e.scheduleKind==="at"){const n=Date.parse(e.scheduleAt);if(!Number.isFinite(n))throw new Error("Invalid run time.");return{kind:"at",atMs:n}}if(e.scheduleKind==="every"){const n=Us(e.everyAmount,0);if(n<=0)throw new Error("Invalid interval amount.");const s=e.everyUnit;return{kind:"every",everyMs:n*(s==="minutes"?6e4:s==="hours"?36e5:864e5)}}const t=e.cronExpr.trim();if(!t)throw new Error("Cron expression required.");return{kind:"cron",expr:t,tz:e.cronTz.trim()||void 0}}function fy(e){if(e.payloadKind==="systemEvent"){const a=e.payloadText.trim();if(!a)throw new Error("System event text required.");return{kind:"systemEvent",text:a}}const t=e.payloadText.trim();if(!t)throw new Error("Agent message required.");const n={kind:"agentTurn",message:t};e.deliver&&(n.deliver=!0),e.channel&&(n.channel=e.channel),e.to.trim()&&(n.to=e.to.trim());const s=Us(e.timeoutSeconds,0);return s>0&&(n.timeoutSeconds=s),n}async function gy(e){if(!(!e.client||!e.connected||e.cronBusy)){e.cronBusy=!0,e.cronError=null;try{const t=hy(e.cronForm),n=fy(e.cronForm),s=e.cronForm.agentId.trim(),a={name:e.cronForm.name.trim(),description:e.cronForm.description.trim()||void 0,agentId:s||void 0,enabled:e.cronForm.enabled,schedule:t,sessionTarget:e.cronForm.sessionTarget,wakeMode:e.cronForm.wakeMode,payload:n,isolation:e.cronForm.postToMainPrefix.trim()&&e.cronForm.sessionTarget==="isolated"?{postToMainPrefix:e.cronForm.postToMainPrefix.trim()}:void 0};if(!a.name)throw new Error("Name required.");await e.client.request("cron.add",a),e.cronForm={...e.cronForm,name:"",description:"",payloadText:""},await ha(e),await ss(e)}catch(t){e.cronError=String(t)}finally{e.cronBusy=!1}}}async function my(e,t,n){if(!(!e.client||!e.connected||e.cronBusy)){e.cronBusy=!0,e.cronError=null;try{await e.client.request("cron.update",{id:t.id,patch:{enabled:n}}),await ha(e),await ss(e)}catch(s){e.cronError=String(s)}finally{e.cronBusy=!1}}}async function vy(e,t){if(!(!e.client||!e.connected||e.cronBusy)){e.cronBusy=!0,e.cronError=null;try{await e.client.request("cron.run",{id:t.id,mode:"force"}),await ru(e,t.id)}catch(n){e.cronError=String(n)}finally{e.cronBusy=!1}}}async function yy(e,t){if(!(!e.client||!e.connected||e.cronBusy)){e.cronBusy=!0,e.cronError=null;try{await e.client.request("cron.remove",{id:t.id}),e.cronRunsJobId===t.id&&(e.cronRunsJobId=null,e.cronRuns=[]),await ha(e),await ss(e)}catch(n){e.cronError=String(n)}finally{e.cronBusy=!1}}}async function ru(e,t){if(!(!e.client||!e.connected))try{const n=await e.client.request("cron.runs",{id:t,limit:50});e.cronRunsJobId=t,e.cronRuns=Array.isArray(n.entries)?n.entries:[]}catch(n){e.cronError=String(n)}}async function Ut(e){if(!(!e.client||!e.connected)){e.guardrailsLoading=!0;try{const[t,n]=await Promise.all([e.client.request("guardrails.list",{}),e.client.request("guardrails.history",{limit:50})]);e.guardrailsData={gates:t.gates,activity:n.activity,custom:t.custom??[]}}catch(t){console.error("[Guardrails] load error:",t),e.guardrailsData=null}finally{e.guardrailsLoading=!1}}}async function by(e,t,n){if(!(!e.client||!e.connected))try{await e.client.request("guardrails.set",{gateId:t,enabled:n});const a=e.guardrailsData?.gates.find(i=>i.id===t)?.name??t;e.showToast(`${a} ${n?"enabled":"disabled"}`,"success",2e3),await Ut(e)}catch(s){e.showToast("Failed to update guardrail","error"),console.error("[Guardrails] toggle error:",s)}}async function wy(e,t,n,s){if(!(!e.client||!e.connected))try{await e.client.request("guardrails.set",{gateId:t,thresholds:{[n]:s}}),e.showToast("Threshold updated","success",2e3),await Ut(e)}catch(a){e.showToast("Failed to update threshold","error"),console.error("[Guardrails] threshold error:",a)}}async function ky(e,t,n){if(!(!e.client||!e.connected))try{await e.client.request("guardrails.setCustom",{id:t,enabled:n}),e.showToast(`Custom rule ${n?"enabled":"disabled"}`,"success",2e3),await Ut(e)}catch(s){e.showToast("Failed to update custom rule","error"),console.error("[Guardrails] toggleCustom error:",s)}}async function $y(e,t){if(!(!e.client||!e.connected))try{await e.client.request("guardrails.removeCustom",{id:t}),e.showToast("Custom rule removed","success",2e3),await Ut(e)}catch(n){e.showToast("Failed to remove custom rule","error"),console.error("[Guardrails] deleteCustom error:",n)}}async function Sy(e,t){if(!(!e.client||!e.connected))try{await e.client.request("guardrails.addCustom",{guardrail:{name:t.name,description:"",enabled:!0,trigger:{tool:t.tool,patterns:t.patterns},action:t.action,message:t.message,...t.redirectTo?{redirectTo:t.redirectTo}:{}}}),e.showToast("Custom rule created","success",2e3),await Ut(e)}catch(n){e.showToast("Failed to create custom rule","error"),console.error("[Guardrails] addCustom error:",n)}}const Jt=Object.freeze(Object.defineProperty({__proto__:null,addCustomGuardrailFromUI:Sy,deleteCustomGuardrail:$y,loadGuardrails:Ut,toggleCustomGuardrail:ky,toggleGuardrail:by,updateGuardrailThreshold:wy},Symbol.toStringTag,{value:"Module"}));function Ay(e){if(!e||e.kind==="gateway")return{method:"exec.approvals.get",params:{}};const t=e.nodeId.trim();return t?{method:"exec.approvals.node.get",params:{nodeId:t}}:null}function Ty(e,t){if(!e||e.kind==="gateway")return{method:"exec.approvals.set",params:t};const n=e.nodeId.trim();return n?{method:"exec.approvals.node.set",params:{...t,nodeId:n}}:null}async function Eo(e,t){if(!(!e.client||!e.connected)&&!e.execApprovalsLoading){e.execApprovalsLoading=!0,e.lastError=null;try{const n=Ay(t);if(!n){e.lastError="Select a node before loading exec approvals.";return}const s=await e.client.request(n.method,n.params);_y(e,s)}catch(n){e.lastError=String(n)}finally{e.execApprovalsLoading=!1}}}function _y(e,t){e.execApprovalsSnapshot=t,e.execApprovalsDirty||(e.execApprovalsForm=Pt(t.file??{}))}async function xy(e,t){if(!(!e.client||!e.connected)){e.execApprovalsSaving=!0,e.lastError=null;try{const n=e.execApprovalsSnapshot?.hash;if(!n){e.lastError="Exec approvals hash missing; reload and retry.";return}const s=e.execApprovalsForm??e.execApprovalsSnapshot?.file??{},a=Ty(t,{file:s,baseHash:n});if(!a){e.lastError="Select a node before saving exec approvals.";return}await e.client.request(a.method,a.params),e.execApprovalsDirty=!1,await Eo(e,t)}catch(n){e.lastError=String(n)}finally{e.execApprovalsSaving=!1}}}function Cy(e,t,n){const s=Pt(e.execApprovalsForm??e.execApprovalsSnapshot?.file??{});Lc(s,t,n),e.execApprovalsForm=s,e.execApprovalsDirty=!0}function Ey(e,t){const n=Pt(e.execApprovalsForm??e.execApprovalsSnapshot?.file??{});Rc(n,t),e.execApprovalsForm=n,e.execApprovalsDirty=!0}async function lu(e){if(!(!e.client||!e.connected))try{const t=await e.client.request("lifetracks.config.get",{});t&&(e.lifetracksConfig=t)}catch(t){console.error("Failed to load lifetracks config:",t)}}async function Qs(e){if(!e.client||!e.connected){e.lifetracksError="Not connected to gateway";return}e.lifetracksLoading=!0,e.lifetracksError=null;try{await lu(e);const t=await e.client.request("lifetracks.list",{});if(t?.lifetracks)if(e.lifetracksData=t.lifetracks,t.lifetracks.length>0){const n=ne(),s=t.lifetracks.find(a=>a.date===n);e.lifetracksCurrentTrack=s||t.lifetracks[0]}else e.lifetracksCurrentTrack=null;else e.lifetracksData=[],e.lifetracksCurrentTrack=null}catch(t){e.lifetracksError=t instanceof Error?t.message:"Failed to load lifetracks"}finally{e.lifetracksLoading=!1}}function Ly(e,t){e.lifetracksCurrentTrack=t}async function Ry(e){if(!e.client||!e.connected)return e.lifetracksError="Not connected to gateway",!1;try{const t=await e.client.request("lifetracks.config.update",{enabled:!0});return t?.updated?(e.lifetracksConfig=t.config,await Qs(e),!0):!1}catch(t){return e.lifetracksError=t instanceof Error?t.message:"Failed to enable lifetracks",!1}}async function Py(e,t){if(!e.client||!e.connected)return e.lifetracksGenerationError="Not connected to gateway",!1;e.lifetracksGenerating=!0,e.lifetracksGenerationError=null;try{const n=await e.client.request("lifetracks.generate",t||{});return n?.generated&&n.track?(e.lifetracksData=[n.track,...e.lifetracksData||[]],e.lifetracksCurrentTrack=n.track,await lu(e),!0):n?.alreadyExists&&n.track?(e.lifetracksCurrentTrack=n.track,!0):(e.lifetracksGenerationError=n?.error||"Generation failed",!1)}catch(n){return e.lifetracksGenerationError=n instanceof Error?n.message:"Failed to generate lifetrack",!1}finally{e.lifetracksGenerating=!1}}const Iy=["~/godmode/memory/AGENT-DAY.md","~/godmode/AGENT-DAY.md"];function My(e){return[...[`~/godmode/memory/agent-day/${e}.md`,`~/godmode/memory/agent-log/${e}.md`,`~/godmode/memory/daily/${e}-agent-log.md`],...Iy]}function Dy(e){return["Needs Review","Active Sub-Agents","Completed Today","Queue","Feedback Log","AGENT-DAY"].filter(s=>e.includes(s)).length>=2}async function cu(e,t){try{const n=t?{date:t}:{},s=await e.request("dailyBrief.get",n);return!s||!s.content||!s.date?null:s}catch(n){return console.error("[MyDay] Failed to load daily brief:",n),null}}async function du(e,t,n){const s=t||ne(),a="agentLog.get";try{const i=await e.request(a,{date:s});if(i?.content?.trim()&&i?.sourcePath)return{date:i.date||s,content:i.content,updatedAt:i.updatedAt||new Date().toISOString(),sourcePath:i.sourcePath}}catch(i){console.warn(`[MyDay] ${a} unavailable, falling back to files.read:`,i)}return Oy(e,s)}async function Oy(e,t){const n=My(t),s=a=>a.includes("AGENT-DAY.md");for(const a of n)try{const i=await e.request("files.read",{path:a,maxSize:1e6});if(!i?.content?.trim()||!Dy(i.content)||s(a)&&typeof i.modifiedAt=="number"&&ne(new Date(i.modifiedAt))!==t)continue;return{date:t,content:i.content,updatedAt:typeof i.modifiedAt=="number"?new Date(i.modifiedAt).toISOString():new Date().toISOString(),sourcePath:a}}catch{}return null}function As(e,t,n){return new Promise((s,a)=>{const i=setTimeout(()=>a(new Error(`${n} timed out after ${t}ms`)),t);e.then(o=>{clearTimeout(i),s(o)},o=>{clearTimeout(i),a(o)})})}const Ny={coding:"Builder",research:"Researcher",analysis:"Analyst",creative:"Creative",review:"Reviewer",ops:"Ops",task:"Agent",url:"Reader",idea:"Explorer"};async function uu(e){if(!e.client||!e.connected)return[];e.todayTasksLoading=!0;try{const t=e.todaySelectedDate??ne(),[n,s]=await Promise.all([e.client.request("tasks.today",{date:t,includeCompleted:!0}),e.client.request("queue.list",{limit:100}).catch(()=>({items:[]}))]),a=new Map;for(const o of s.items)o.sourceTaskId&&(o.status==="processing"||o.status==="review"||o.status==="failed")&&a.set(o.sourceTaskId,{status:o.status,type:o.type,roleName:Ny[o.type]??o.type,queueItemId:o.id});const i=(n.tasks??[]).map(o=>({id:o.id,title:o.title,status:o.status,project:o.project,dueDate:o.dueDate,priority:o.priority,createdAt:o.createdAt,completedAt:o.completedAt,queueStatus:a.get(o.id)??null}));return e.todayTasks=i,i}catch(t){return console.error("[MyDay] Failed to load today tasks:",t),e.todayTasks??[]}finally{e.todayTasksLoading=!1}}async function Fy(e){if(!e.client||!e.connected)return[];try{const n=(await e.client.request("queue.list",{limit:50}))?.items??[],s=Date.now()-1440*60*1e3;return n.filter(a=>!(a.status!=="review"&&a.status!=="done"||a.status==="done"&&(a.completedAt??0)<s)).map(a=>({id:a.id,title:a.title,summary:a.result?.summary??a.description??"",status:a.status,completedAt:a.completedAt,outputPath:a.result?.outputPath,prUrl:a.result?.prUrl}))}catch(t){return console.error("[MyDay] Failed to load queue results for decision cards:",t),[]}}function By(e,t){e.request("dailyBrief.syncTasks",t?{date:t}:{}).catch(n=>{console.warn("[MyDay] dailyBrief.syncTasks failed (non-blocking):",n)})}async function Is(e){if(!(!e.client||!e.connected)){e.dailyBriefLoading=!0,e.dailyBriefError=null;try{e.dailyBrief=await cu(e.client,e.todaySelectedDate),e.loadBriefNotes&&await e.loadBriefNotes()}catch(t){e.dailyBriefError=t instanceof Error?t.message:"Failed to load daily brief",console.error("[MyDay] Brief load error:",t)}finally{e.dailyBriefLoading=!1}}}async function Tt(e,t){if(!(!e.client||!e.connected)){e.agentLogLoading=!0,e.agentLogError=null;try{e.agentLog=await du(e.client,e.todaySelectedDate,t)}catch(n){e.agentLogError=n instanceof Error?n.message:"Failed to load agent log",console.error("[MyDay] Agent log load error:",n)}finally{e.agentLogLoading=!1}}}function pu(e){const t=e||ne(),n="VAULT",s=`01-Daily/${t}`,a=`obsidian://open?vault=${encodeURIComponent(n)}&file=${encodeURIComponent(s)}`;window.open(a,"_blank")}async function Ys(e){if(!e.client||!e.connected)return;e.myDayLoading=!0,e.myDayError=null,e.dailyBriefLoading=!0,e.agentLogLoading=!0,e.todayTasksLoading=!0;const t=e.todaySelectedDate,n=e.loadBriefNotes?As(e.loadBriefNotes(),5e3,"Brief Notes"):Promise.resolve(),s=await Promise.allSettled([As(cu(e.client,t),1e4,"Daily Brief"),n,As(du(e.client,t),1e4,"Agent Log"),As(uu(e),8e3,"Today Tasks")]);e.dailyBrief=s[0].status==="fulfilled"?s[0].value:null,e.agentLog=s[2].status==="fulfilled"?s[2].value:null;const a=["Brief","Brief Notes","Agent Log","Today Tasks"],i=s.map((o,l)=>o.status==="rejected"?{section:a[l],reason:o.reason}:null).filter(Boolean);if(i.length>0){for(const o of i)console.warn(`[MyDay] ${o.section} failed:`,o.reason);i.length===s.length&&(e.myDayError="Failed to load daily brief")}e.myDayLoading=!1,e.dailyBriefLoading=!1,e.agentLogLoading=!1,e.todayTasksLoading=!1}function Uy(e,t){const n=s=>{t(s)};return e.on("daily-brief:update",n),()=>{e.off("daily-brief:update",n)}}function hu(e,t){const n=()=>{t()};return e.on("agent-log:update",n),()=>{e.off("agent-log:update",n)}}const Dn=Object.freeze(Object.defineProperty({__proto__:null,loadAgentLogOnly:Tt,loadBriefOnly:Is,loadMyDay:Ys,loadTodayQueueResults:Fy,loadTodayTasksWithQueueStatus:uu,openBriefInObsidian:pu,subscribeToAgentLogUpdates:hu,subscribeToBriefUpdates:Uy,syncTodayTasks:By},Symbol.toStringTag,{value:"Module"}));async function fu(e){if(!(!e.client||!e.connected)){e.peopleLoading=!0,e.peopleError=null;try{const t=await e.client.request("people.list",{});e.peopleList=t.people??[]}catch(t){console.error("[People] Failed to load contacts:",t),e.peopleError=t instanceof Error?t.message:"Failed to load contacts"}finally{e.peopleLoading=!1}}}async function Lo(e){if(!(!e.client||!e.connected)&&!e.presenceLoading){e.presenceLoading=!0,e.presenceError=null,e.presenceStatus=null;try{const t=await e.client.request("system-presence",{});Array.isArray(t)?(e.presenceEntries=t,e.presenceStatus=t.length===0?"No instances yet.":null):(e.presenceEntries=[],e.presenceStatus="No presence payload.")}catch(t){e.presenceError=String(t)}finally{e.presenceLoading=!1}}}function un(e,t,n){if(!t.trim())return;const s={...e.skillMessages};n?s[t]=n:delete s[t],e.skillMessages=s}function fa(e){return e instanceof Error?e.message:String(e)}async function as(e,t){if(t?.clearMessages&&Object.keys(e.skillMessages).length>0&&(e.skillMessages={}),!(!e.client||!e.connected)&&!e.skillsLoading){e.skillsLoading=!0,e.skillsError=null;try{const n=await e.client.request("skills.status",{});n&&(e.skillsReport=n)}catch(n){e.skillsError=fa(n)}finally{e.skillsLoading=!1}}}function zy(e,t,n){e.skillEdits={...e.skillEdits,[t]:n}}async function Ky(e,t,n){if(!(!e.client||!e.connected)){e.skillsBusyKey=t,e.skillsError=null;try{await e.client.request("skills.update",{skillKey:t,enabled:n}),await as(e),un(e,t,{kind:"success",message:n?"Skill enabled":"Skill disabled"})}catch(s){const a=fa(s);e.skillsError=a,un(e,t,{kind:"error",message:a})}finally{e.skillsBusyKey=null}}}async function Wy(e,t){if(!(!e.client||!e.connected)){e.skillsBusyKey=t,e.skillsError=null;try{const n=e.skillEdits[t]??"";await e.client.request("skills.update",{skillKey:t,apiKey:n}),await as(e),un(e,t,{kind:"success",message:"API key saved"})}catch(n){const s=fa(n);e.skillsError=s,un(e,t,{kind:"error",message:s})}finally{e.skillsBusyKey=null}}}async function qy(e,t,n,s){if(!(!e.client||!e.connected)){e.skillsBusyKey=t,e.skillsError=null;try{const a=await e.client.request("skills.install",{name:n,installId:s,timeoutMs:12e4});await as(e),un(e,t,{kind:"success",message:a?.message??"Installed"})}catch(a){const i=fa(a);e.skillsError=i,un(e,t,{kind:"error",message:i})}finally{e.skillsBusyKey=null}}}async function Ii(e){if(!e.client||!e.connected){e.visionBoardError="Not connected to gateway";return}e.visionBoardLoading=!0,e.visionBoardError=null;try{const[t,n]=await Promise.all([e.client.request("visionBoard.get",{}),e.client.request("visionBoard.identityToday",{})]);t?e.visionBoardData=t:e.visionBoardError="No data returned",n&&(e.visionBoardIdentityToday=n.identity)}catch(t){e.visionBoardError=t instanceof Error?t.message:"Failed to load vision board"}finally{e.visionBoardLoading=!1}}async function Js(e){if(!e.client||!e.connected){e.wheelOfLifeError="Not connected to gateway";return}e.wheelOfLifeLoading=!0,e.wheelOfLifeError=null;try{const t=await e.client.request("wheelOfLife.get",{});t?e.wheelOfLifeData=t:e.wheelOfLifeError="No data returned"}catch(t){e.wheelOfLifeError=t instanceof Error?t.message:"Failed to load wheel data"}finally{e.wheelOfLifeLoading=!1}}async function Hy(e,t){if(!e.client||!e.connected)return e.wheelOfLifeError="Not connected to gateway",!1;try{return(await e.client.request("wheelOfLife.update",{updates:t}))?.updated?(await Js(e),!0):!1}catch(n){return e.wheelOfLifeError=n instanceof Error?n.message:"Failed to update wheel",!1}}function Vy(e){e.wheelOfLifeEditMode=!0}function yl(e){e.wheelOfLifeEditMode=!1}async function gu(e){if(!(!e.client||!e.connected)){e.workLoading=!0,e.workError=null;try{const t=await e.client.request("projects.list",{});e.workProjects=t.projects??[]}catch(t){console.error("[Work] Failed to load:",t),e.workError=t instanceof Error?t.message:"Failed to load"}finally{e.workLoading=!1}}}async function jy(e,t){if(!e.client||!e.connected)return;const n=new Set(e.workDetailLoading??[]);n.add(t),e.workDetailLoading=n;try{const s=await e.client.request("projects.get",{id:t,includeFiles:!0,depth:2});if(s){const a=s.files??[];e.workProjectFiles={...e.workProjectFiles,[t]:a}}}catch(s){console.warn("[Work] Failed to load project details:",s)}finally{const s=new Set(e.workDetailLoading??[]);s.delete(t),e.workDetailLoading=s}}function ga(e,t=Date.now()){if(typeof e=="number"&&Number.isFinite(e))return new Date(e);if(typeof e=="string"){const n=Date.parse(e);if(Number.isFinite(n))return new Date(n)}return new Date(t)}function Ro(e){return{id:e.id,name:e.name,emoji:e.emoji||"📁",type:e.type,path:e.path,artifactCount:e.artifactCount??0,sessionCount:e.sessionCount??0,lastUpdated:ga(e.lastUpdated,e.lastScanned)}}function ei(e){return{path:e.path,name:e.name,type:e.type,size:e.size,modified:ga(e.modified),isDirectory:e.isDirectory,searchText:e.searchText}}function bl(e){return{id:e.id,key:e.key,title:e.title,created:ga(e.created),status:e.status,workspaceSubfolder:e.workspaceSubfolder}}function zt(e){return{id:e.id,title:e.title,status:e.status,project:e.project,dueDate:e.dueDate,priority:e.priority,createdAt:e.createdAt,completedAt:e.completedAt}}function mu(e){return e.map(t=>({name:t.name,path:t.path,type:t.type,fileType:t.fileType,size:t.size,modified:t.modified?ga(t.modified):void 0,children:t.children?mu(t.children):void 0}))}function Gy(e,t){return{...t,id:e.id,name:e.name,emoji:e.emoji,type:e.type,path:e.path,artifactCount:e.artifactCount,sessionCount:e.sessionCount,lastUpdated:e.lastUpdated}}async function ma(e){if(!e.client||!e.connected){e.workspaces=[],e.workspacesLoading=!1,e.workspacesError="Connect to gateway to see workspaces";return}e.workspacesLoading=!0,e.workspacesError=null;try{const t=await e.client.request("workspaces.list",{});if(e.workspaces=(t.workspaces??[]).map(Ro),e.selectedWorkspace){const n=e.workspaces.find(s=>s.id===e.selectedWorkspace?.id);n&&(e.selectedWorkspace=Gy(n,e.selectedWorkspace))}}catch(t){console.error("[Workspaces] load failed:",t),e.workspacesError=t instanceof Error?t.message:"Failed to load workspaces",e.workspaces=[]}finally{e.workspacesLoading=!1}}async function va(e,t){if(!e.client||!e.connected)return null;try{const n=await e.client.request("workspaces.get",{id:t});return n.workspace?{...Ro(n.workspace),pinned:(n.pinned??[]).map(ei),pinnedSessions:(n.pinnedSessions??[]).map(bl),outputs:(n.outputs??[]).map(ei),folderTree:n.folderTree?mu(n.folderTree):void 0,sessions:(n.sessions??[]).map(bl),tasks:(n.tasks??[]).map(zt),memory:(n.memory??[]).map(ei)}:null}catch(n){return console.error("[Workspaces] get failed:",n),null}}async function Qy(e,t,n){if(!e.client||!e.connected)return null;try{const s=await e.client.request("workspaces.readFile",n?{workspaceId:n,filePath:t}:{path:t});return s.content?{content:s.content,mime:s.contentType??s.mime??"text/plain"}:(s.error&&console.warn("[Workspaces] readFile failed:",s.error),null)}catch(s){return console.error("[Workspaces] readFile error:",s),null}}async function Yy(e){if(!(!e.client||!e.connected))try{e.workspacesLoading=!0,e.workspacesError=null,await e.client.request("workspaces.scan",{}),await ma(e)}catch(t){e.workspacesError=t instanceof Error?t.message:"Failed to scan workspaces"}finally{e.workspacesLoading=!1}}async function Jy(e,t){if(!t){e.selectedWorkspace=null;return}const n=await va(e,t.id);e.selectedWorkspace=n||{...t,pinned:[],pinnedSessions:[],outputs:[],sessions:[],tasks:[]}}async function Xy(e,t,n,s){if(!e.client||!e.connected)return!1;try{if(await e.client.request(s?"workspaces.unpin":"workspaces.pin",{workspaceId:t,filePath:n}),e.selectedWorkspace?.id===t){const a=await va(e,t);a&&(e.selectedWorkspace=a)}return!0}catch(a){return console.error("[Workspaces] pin toggle failed:",a),!1}}async function Zy(e,t,n,s){if(!e.client||!e.connected)return!1;try{if(await e.client.request(s?"workspaces.unpinSession":"workspaces.pinSession",{workspaceId:t,sessionKey:n}),e.selectedWorkspace?.id===t){const a=await va(e,t);a&&(e.selectedWorkspace=a)}return!0}catch(a){return console.error("[Workspaces] session pin toggle failed:",a),!1}}async function eb(e,t){if(!e.client||!e.connected)return null;const n=String(t.name??"").trim();if(!n)return e.workspacesError="Workspace name is required",null;const s=t.type??"project",a=String(t.path??"").trim();try{const i=await e.client.request("workspaces.create",{name:n,type:s,...a?{path:a}:{}});if(!i.workspace)return e.workspacesError="Workspace creation returned no workspace",null;const o=Ro(i.workspace),l=e.workspaces??[],c=new Map(l.map(u=>[u.id,u]));return c.set(o.id,o),e.workspaces=Array.from(c.values()).toSorted((u,p)=>p.lastUpdated.getTime()-u.lastUpdated.getTime()),e.workspacesError=null,o}catch(i){return console.error("[Workspaces] create failed:",i),e.workspacesError=i instanceof Error?i.message:"Failed to create workspace",null}}async function tb(e,t){if(!e.client||!e.connected)return!1;try{return await e.client.request("workspaces.delete",{id:t}),e.workspaces=(e.workspaces??[]).filter(n=>n.id!==t),e.selectedWorkspace?.id===t&&(e.selectedWorkspace=null),e.workspacesError=null,!0}catch(n){return console.error("[Workspaces] delete failed:",n),e.workspacesError=n instanceof Error?n.message:"Failed to delete workspace",!1}}function nb(e,t){e.workspacesSearchQuery=t}function sb(e){e.selectedWorkspace=null}async function ab(e){if(!(!e.client||!e.connected))try{const t=await e.client.request("workspaces.teamSetupPrompt",{});t?.prompt&&(e.chatMessage=t.prompt,e.setTab?.("chat"))}catch{e.chatMessage="I want to set up a Team Workspace so my team can collaborate. Please walk me through it step by step, keeping it simple.",e.setTab?.("chat")}}function ib(e,t){const n=new Set(e);return n.has(t)?n.delete(t):n.add(t),n}async function ob(e,t){if(!e.client||!e.connected)return[];try{return((await e.client.request("tasks.byProject",{project:t})).tasks??[]).map(zt)}catch(n){return console.error("[Workspaces] loadWorkspaceTasks failed:",n),[]}}async function rb(e){if(!e.client||!e.connected)return[];try{return((await e.client.request("tasks.list",{})).tasks??[]).map(zt)}catch(t){return console.error("[Workspaces] loadAllTasks failed:",t),[]}}const lb={coding:"Builder",research:"Researcher",analysis:"Analyst",creative:"Creative",review:"Reviewer",ops:"Ops",task:"Agent",url:"Reader",idea:"Explorer"};async function cb(e){if(!e.client||!e.connected)return[];try{const[t,n]=await Promise.all([e.client.request("tasks.list",{}),e.client.request("queue.list",{limit:100}).catch(()=>({items:[]}))]),s=new Map;for(const a of n.items)a.sourceTaskId&&(a.status==="processing"||a.status==="review"||a.status==="failed")&&s.set(a.sourceTaskId,{status:a.status,type:a.type,roleName:lb[a.type]??a.type,queueItemId:a.id});return(t.tasks??[]).map(a=>({...zt(a),queueStatus:s.get(a.id)??null}))}catch(t){return console.error("[Workspaces] loadAllTasksWithQueueStatus failed:",t),[]}}async function db(e,t,n){if(!e.client||!e.connected)return null;const s=n==="complete"?"pending":"complete";try{const a=await e.client.request("tasks.update",{id:t,status:s});return zt(a)}catch(a){return console.error("[Workspaces] toggleTaskComplete failed:",a),null}}async function ub(e,t,n){if(!e.client||!e.connected)return null;try{const s=await e.client.request("tasks.update",{id:t,...n});return zt(s)}catch(s){return console.error("[Workspaces] updateTask failed:",s),null}}async function pb(e,t){if(!e.client||!e.connected)return null;try{return await e.client.request("tasks.openSession",{taskId:t})}catch(n){return console.error("[Workspaces] startTask failed:",n),null}}async function hb(e,t,n){if(!e.client||!e.connected)return null;try{const s=await e.client.request("tasks.create",{title:t,project:n,source:"chat"});return zt(s)}catch(s){return console.error("[Workspaces] createTask failed:",s),null}}async function fb(e,t,n){if(!e.client||!e.connected)return null;try{return await e.client.request("workspaces.browseFolder",{workspaceId:t,folderPath:n})}catch(s){return console.error("[Workspaces] browseFolder failed:",s),null}}async function gb(e,t,n,s=50){if(!e.client||!e.connected)return[];try{return(await e.client.request("workspaces.search",{workspaceId:t,query:n,limit:s})).results??[]}catch(a){return console.error("[Workspaces] search failed:",a),[]}}async function mb(e,t,n){if(!e.client||!e.connected)return!1;try{return await e.client.request("workspaces.createFolder",{workspaceId:t,folderPath:n}),!0}catch(s){return console.error("[Workspaces] createFolder failed:",s),!1}}async function vb(e,t,n,s){if(!e.client||!e.connected)return!1;try{return await e.client.request("workspaces.moveFile",{workspaceId:t,sourcePath:n,destPath:s}),!0}catch(a){return console.error("[Workspaces] moveFile failed:",a),!1}}async function yb(e,t,n,s){if(!e.client||!e.connected)return!1;try{return await e.client.request("workspaces.renameFile",{workspaceId:t,filePath:n,newName:s}),!0}catch(a){return console.error("[Workspaces] renameFile failed:",a),!1}}const fe=Object.freeze(Object.defineProperty({__proto__:null,browseWorkspaceFolder:fb,clearWorkspaceSelection:sb,createTask:hb,createWorkspace:eb,createWorkspaceFolder:mb,deleteWorkspace:tb,getWorkspace:va,loadAllTasks:rb,loadAllTasksWithQueueStatus:cb,loadWorkspaceTasks:ob,loadWorkspaces:ma,moveWorkspaceFile:vb,readWorkspaceFile:Qy,renameWorkspaceFile:yb,scanWorkspaces:Yy,searchWorkspaceFiles:gb,selectWorkspace:Jy,setWorkspacesSearchQuery:nb,startTask:pb,startTeamSetup:ab,toggleTaskComplete:db,toggleWorkspaceFolder:ib,toggleWorkspacePin:Xy,toggleWorkspaceSessionPin:Zy,updateTask:ub},Symbol.toStringTag,{value:"Module"})),vu="godmode.ui.settings.v1";function bb(){const e=new URLSearchParams(location.search),t=(()=>{const a=e.get("gatewayUrl");return a||(typeof window.__GODMODE_DEV__<"u"?"/ws":`${location.protocol==="https:"?"wss:":"ws:"}//${location.host}`)})(),n=e.get("token")||"",s={gatewayUrl:t,token:n,sessionKey:"main",lastActiveSessionKey:"main",theme:"system",chatFocusMode:!1,chatShowThinking:!0,splitRatio:.6,navCollapsed:!1,navGroupsCollapsed:{System:!0},openTabs:["agent:main:main"],tabLastViewed:{},userName:"",userAvatar:"",chatParallelView:!1,parallelLanes:[null,null,null,null]};try{const a=localStorage.getItem(vu);if(!a)return s;const i=JSON.parse(a);return{gatewayUrl:e.get("gatewayUrl")||(typeof window.__GODMODE_DEV__<"u"?"/ws":typeof i.gatewayUrl=="string"&&i.gatewayUrl.trim()?i.gatewayUrl.trim():s.gatewayUrl),token:n||(typeof i.token=="string"?i.token:""),sessionKey:typeof i.sessionKey=="string"&&i.sessionKey.trim()?i.sessionKey.trim():s.sessionKey,lastActiveSessionKey:typeof i.lastActiveSessionKey=="string"&&i.lastActiveSessionKey.trim()?i.lastActiveSessionKey.trim():typeof i.sessionKey=="string"&&i.sessionKey.trim()||s.lastActiveSessionKey,theme:i.theme==="light"||i.theme==="dark"||i.theme==="system"||i.theme==="lifetrack"?i.theme:s.theme,chatFocusMode:typeof i.chatFocusMode=="boolean"?i.chatFocusMode:s.chatFocusMode,chatShowThinking:typeof i.chatShowThinking=="boolean"?i.chatShowThinking:s.chatShowThinking,splitRatio:typeof i.splitRatio=="number"&&i.splitRatio>=.4&&i.splitRatio<=.7?i.splitRatio:s.splitRatio,navCollapsed:typeof i.navCollapsed=="boolean"?i.navCollapsed:s.navCollapsed,navGroupsCollapsed:typeof i.navGroupsCollapsed=="object"&&i.navGroupsCollapsed!==null?i.navGroupsCollapsed:s.navGroupsCollapsed,openTabs:Array.isArray(i.openTabs)&&i.openTabs.every(o=>typeof o=="string")?i.openTabs:s.openTabs,tabLastViewed:typeof i.tabLastViewed=="object"&&i.tabLastViewed!==null?i.tabLastViewed:s.tabLastViewed,userName:typeof i.userName=="string"?i.userName.trim().slice(0,50):s.userName,userAvatar:typeof i.userAvatar=="string"?i.userAvatar.trim():s.userAvatar,chatParallelView:typeof i.chatParallelView=="boolean"?i.chatParallelView:s.chatParallelView,parallelLanes:Array.isArray(i.parallelLanes)&&i.parallelLanes.length===4?i.parallelLanes.map(o=>typeof o=="string"?o:null):s.parallelLanes}}catch{return s}}function wb(e){localStorage.setItem(vu,JSON.stringify(e))}const kb=56,$b="quantum-particles",Sb="quantum-particle";let ct=null,Bn=null;function Ae(e,t){return Math.random()*(t-e)+e}function yu(){if(bu(),typeof document>"u")return;const e=document.querySelector(".shell");if(!e){Bn=requestAnimationFrame(()=>{Bn=null,yu()});return}ct=document.createElement("div"),ct.className=$b,Object.assign(ct.style,{position:"fixed",inset:"0",pointerEvents:"none",zIndex:"1",overflow:"hidden"});for(let t=0;t<kb;t++){const n=document.createElement("div");n.className=Sb;const s=Ae(2,5),a=Ae(.3,.65),i=Ae(15,35),o=Ae(0,12),l=Ae(5,95),c=Ae(5,95),u=Ae(-150,150),p=Ae(-200,200),f=Ae(-250,250),m=Ae(-350,350),g=Ae(.8,1.5);Object.assign(n.style,{position:"absolute",left:`${l}%`,top:`${c}%`,width:`${s}px`,height:`${s}px`,borderRadius:"50%",background:`rgba(235, 158, 15, ${Ae(.7,1)})`,boxShadow:`0 0 ${s*3}px rgba(235, 158, 15, ${a*.7})`,opacity:"0",willChange:"transform, opacity",animation:`quantum-float ${i}s ${o}s ease-in-out infinite`}),n.style.setProperty("--particle-opacity",String(a)),n.style.setProperty("--drift-x",`${u}px`),n.style.setProperty("--drift-y",`${p}px`),n.style.setProperty("--drift-end-x",`${f}px`),n.style.setProperty("--drift-end-y",`${m}px`),n.style.setProperty("--particle-scale-mid",String(g)),ct.appendChild(n)}e.prepend(ct)}function bu(){Bn!==null&&(cancelAnimationFrame(Bn),Bn=null),ct&&(ct.remove(),ct=null)}function Ab(){return typeof window>"u"||typeof window.matchMedia!="function"||window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"lifetrack"}function Po(e){return e==="system"?Ab():e==="light"?"lifetrack":e}const Ts=e=>Number.isNaN(e)?.5:e<=0?0:e>=1?1:e,Tb=()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches??!1,Ln=e=>{e.classList.remove("theme-transition"),e.style.removeProperty("--theme-switch-x"),e.style.removeProperty("--theme-switch-y")},_b=({nextTheme:e,applyTheme:t,context:n,currentTheme:s})=>{if(s===e)return;const a=globalThis.document??null;if(!a){t();return}const i=a.documentElement,o=a,l=Tb();if(!!o.startViewTransition&&!l){let u=.5,p=.5;if(n?.pointerClientX!==void 0&&n?.pointerClientY!==void 0&&typeof window<"u")u=Ts(n.pointerClientX/window.innerWidth),p=Ts(n.pointerClientY/window.innerHeight);else if(n?.element){const m=n.element.getBoundingClientRect();m.width>0&&m.height>0&&typeof window<"u"&&(u=Ts((m.left+m.width/2)/window.innerWidth),p=Ts((m.top+m.height/2)/window.innerHeight))}i.style.setProperty("--theme-switch-x",`${u*100}%`),i.style.setProperty("--theme-switch-y",`${p*100}%`),i.classList.add("theme-transition");const f=setTimeout(()=>{Ln(i)},1e3);try{const m=o.startViewTransition?.(()=>{t()});m?.finished?m.finished.finally(()=>{clearTimeout(f),Ln(i)}):(clearTimeout(f),Ln(i))}catch{clearTimeout(f),Ln(i),t()}return}t(),Ln(i)};function xb(e,t){const n=Array.isArray(e)?[...new Set(e.map(s=>s.trim()).filter(s=>s.length>0))]:[];return n.length===0&&n.push(t),n}function Cb(e){const t={};if(!e||typeof e!="object")return t;for(const[n,s]of Object.entries(e)){const a=n.trim();!a||typeof s!="number"||!Number.isFinite(s)||(t[a]=Math.max(t[a]??0,s))}return t}function Xe(e,t){const n=t.sessionKey.trim()||"main",s=xb(t.openTabs,n),a=Cb(t.tabLastViewed),i={...t,sessionKey:n,openTabs:s,tabLastViewed:a,lastActiveSessionKey:t.lastActiveSessionKey?.trim()||n};e.settings=i,wb(i),i.theme!==e.theme&&(e.theme=i.theme,os(e,Po(i.theme))),e.applySessionKey=e.settings.lastActiveSessionKey}function Io(e,t){const n=t.trim();n&&e.settings.lastActiveSessionKey!==n&&Xe(e,{...e.settings,lastActiveSessionKey:n})}function wu(e){if(!window.location.search)return;const t=new URLSearchParams(window.location.search),n=t.get("token"),s=t.get("password"),a=t.get("session"),i=t.get("gatewayUrl");let o=!1;if(n!=null){const c=n.trim();c&&c!==e.settings.token&&Xe(e,{...e.settings,token:c}),t.delete("token"),o=!0}if(s!=null){const c=s.trim();c&&(e.password=c),t.delete("password"),o=!0}if(a!=null){const c=a.trim();if(c){e.sessionKey=c;const u=e.settings.openTabs.includes(c)?e.settings.openTabs:[...e.settings.openTabs,c];Xe(e,{...e.settings,sessionKey:c,lastActiveSessionKey:c,openTabs:u})}}if(i!=null){const c=i.trim();c&&c!==e.settings.gatewayUrl&&(e.pendingGatewayUrl=c),t.delete("gatewayUrl"),o=!0}if(!o)return;const l=new URL(window.location.href);l.search=t.toString(),window.history.replaceState({},"",l.toString())}function Mo(e,t){const n=e.tab;if(n!==t&&(e.tab=t),n==="dashboards"&&t!=="dashboards"){const s=e;if(s.dashboardPreviousSessionKey&&s.activeDashboardId){const a=s.dashboardPreviousSessionKey;s.dashboardPreviousSessionKey=null,s.activeDashboardId=null,s.activeDashboardManifest=null,s.activeDashboardHtml=null,s.dashboardChatOpen=!1,e.sessionKey=a}}t==="chat"&&(e.chatHasAutoScrolled=!1),t==="nodes"?So(e):Ao(e),t==="logs"?To(e):_o(e),t==="debug"?xo(e):Co(e),t==="mission-control"?iu(e):ou(e),is(e),Oo(e,t,!1)}function ku(e,t,n){_b({nextTheme:t,applyTheme:()=>{e.theme=t,Xe(e,{...e.settings,theme:t}),os(e,Po(t))},context:n,currentTheme:e.theme})}async function is(e){if(e.tab==="overview"&&await No(e),(e.tab==="today"||e.tab==="my-day")&&(await Ys(e),E(()=>Promise.resolve().then(()=>Dn),void 0,import.meta.url).then(async({loadTodayQueueResults:t})=>{e.todayQueueResults=await t(e)}).catch(()=>{})),e.tab==="work"&&await gu(e),e.tab==="people"&&await fu(e),e.tab==="workspaces"&&(await ma(e),E(()=>Promise.resolve().then(()=>fe),void 0,import.meta.url).then(async({loadAllTasksWithQueueStatus:t})=>{e.allTasks=await t(e)})),e.tab==="wheel-of-life"&&await Js(e),e.tab==="vision-board"&&await Ii(e),e.tab==="lifetracks"&&await Qs(e),e.tab==="life"&&await Promise.all([Js(e),Ii(e),Qs(e)]),e.tab==="data"&&e.handleDataRefresh(),e.tab==="channels"&&await Cu(e),e.tab==="instances"&&await Lo(e),e.tab==="sessions"&&(await ee(e),await Ot(e)),e.tab==="cron"&&await ya(e),e.tab==="skills"&&await as(e),e.tab==="nodes"&&(await ua(e),await ht(e),await Je(e),await Eo(e)),e.tab==="chat"&&(await Uo(e),ln(e,!e.chatHasAutoScrolled)),e.tab==="options"){const t=e;typeof t.handleOptionsLoad=="function"&&await t.handleOptionsLoad()}if(e.tab==="trust"){const t=e,n=[];typeof t.handleTrustLoad=="function"&&n.push(t.handleTrustLoad()),n.push(Ut(t)),n.push(ee(t)),await Promise.all(n)}if(e.tab==="guardrails"){const t=e;typeof t.handleGuardrailsLoad=="function"&&await t.handleGuardrailsLoad()}if(e.tab==="mission-control"){const t=e;typeof t.handleMissionControlRefresh=="function"&&await t.handleMissionControlRefresh()}if(e.tab==="setup"){const t=e;typeof t.handleLoadSetupChecklist=="function"&&t.handleLoadSetupChecklist()}if(e.tab==="dashboards"){const t=e;typeof t.handleDashboardsRefresh=="function"&&await t.handleDashboardsRefresh()}if(e.tab==="second-brain"){const t=e,n=t.secondBrainSubtab;n==="intel"?typeof t.handleIntelLoad=="function"&&await t.handleIntelLoad():n==="files"?typeof t.handleSecondBrainFileTreeRefresh=="function"&&await t.handleSecondBrainFileTreeRefresh():typeof t.handleSecondBrainRefresh=="function"&&await t.handleSecondBrainRefresh()}e.tab==="config"&&(await Pc(e),await Je(e)),e.tab==="debug"&&(await pa(e),e.eventLog=Dv()),e.tab==="logs"&&(e.logsAtBottom=!0,await $o(e,{reset:!0}),Oc(e,!0))}function $u(){if(typeof window>"u")return"";const e=window.__OPENCLAW_CONTROL_UI_BASE_PATH__;return typeof e=="string"&&e.trim()?la(e):wm(window.location.pathname)}function Su(e){e.theme=e.settings.theme??"system",os(e,Po(e.theme))}function os(e,t){if(e.themeResolved=t,typeof document>"u")return;const n=document.documentElement;n.dataset.theme=t,n.style.colorScheme=t==="dark"?"dark":"light",t==="lifetrack"?yu():bu()}function Au(e){if(typeof window>"u"||typeof window.matchMedia!="function")return;if(e.themeMedia=window.matchMedia("(prefers-color-scheme: dark)"),e.themeMediaHandler=n=>{e.theme==="system"&&os(e,n.matches?"dark":"lifetrack")},typeof e.themeMedia.addEventListener=="function"){e.themeMedia.addEventListener("change",e.themeMediaHandler);return}e.themeMedia.addListener(e.themeMediaHandler)}function Tu(e){if(!e.themeMedia||!e.themeMediaHandler)return;if(typeof e.themeMedia.removeEventListener=="function"){e.themeMedia.removeEventListener("change",e.themeMediaHandler);return}e.themeMedia.removeListener(e.themeMediaHandler),e.themeMedia=null,e.themeMediaHandler=null}function _u(e,t){if(typeof window>"u")return;const n=gd(window.location.pathname,e.basePath)??"chat";Do(e,n),Oo(e,n,t)}function xu(e){if(typeof window>"u")return;const t=gd(window.location.pathname,e.basePath);if(!t)return;const s=new URL(window.location.href).searchParams.get("session")?.trim();if(s){e.sessionKey=s;const a=e.settings.openTabs.includes(s)?e.settings.openTabs:[...e.settings.openTabs,s];Xe(e,{...e.settings,sessionKey:s,lastActiveSessionKey:s,openTabs:a})}Do(e,t)}function Do(e,t){e.tab!==t&&(e.tab=t),t==="chat"&&(e.chatHasAutoScrolled=!1),t==="nodes"?So(e):Ao(e),t==="logs"?To(e):_o(e),t==="debug"?xo(e):Co(e),t==="mission-control"?iu(e):ou(e),e.connected&&is(e)}function Oo(e,t,n){if(typeof window>"u")return;const s=Jn(uo(t,e.basePath)),a=Jn(window.location.pathname),i=new URL(window.location.href);t==="chat"&&e.sessionKey?i.searchParams.set("session",e.sessionKey):i.searchParams.delete("session"),a!==s&&(i.pathname=s),n?window.history.replaceState({},"",i.toString()):window.history.pushState({},"",i.toString())}function be(e,t,n){if(typeof window>"u")return;const s=new URL(window.location.href);s.searchParams.set("session",t),n?window.history.replaceState({},"",s.toString()):window.history.pushState({},"",s.toString())}async function No(e){await Promise.all([De(e,!1),Lo(e),ee(e),ss(e),pa(e)])}async function Cu(e){await Promise.all([De(e,!0),Pc(e),Je(e)])}async function ya(e){await Promise.all([De(e,!1),ss(e),ha(e)])}const Eb=Object.freeze(Object.defineProperty({__proto__:null,applyResolvedTheme:os,applySettings:Xe,applySettingsFromUrl:wu,attachThemeListener:Au,detachThemeListener:Tu,inferBasePath:$u,loadChannelsTab:Cu,loadCron:ya,loadOverview:No,onPopState:xu,refreshActiveTab:is,setLastActiveSessionKey:Io,setTab:Mo,setTabFromRoute:Do,setTheme:ku,syncTabWithLocation:_u,syncThemeWithSettings:Su,syncUrlWithSessionKey:be,syncUrlWithTab:Oo},Symbol.toStringTag,{value:"Module"}));function Xs(e){return e.chatSending||!!e.chatRunId}function $e(e,t){const n=t??e.sessionKey,s=e.chatMessage.trim();if(s)e.chatDrafts={...e.chatDrafts,[n]:s};else{const{[n]:a,...i}=e.chatDrafts;e.chatDrafts=i}}function Re(e,t){const n=t??e.sessionKey;e.chatMessage=e.chatDrafts[n]??""}function Eu(e,t){const n=t??e.sessionKey,{[n]:s,...a}=e.chatDrafts;e.chatDrafts=a,n===e.sessionKey&&(e.chatMessage="")}function Lu(e){const t=e.trim();if(!t)return!1;const n=t.toLowerCase();return n==="/stop"?!0:n==="stop"||n==="esc"||n==="abort"||n==="wait"||n==="exit"}function Lb(e){const t=e.trim();if(!t)return!1;const n=t.toLowerCase();return n==="/new"||n==="/reset"?!0:n.startsWith("/new ")||n.startsWith("/reset ")}async function Fo(e){e.connected&&(e.chatMessage="",await fo(e))}function Rb(e,t,n){const s=t.trim(),a=!!(n&&n.length>0);if(!s&&!a)return;const i=Date.now();e.chatQueue=[...e.chatQueue,{id:ca(),text:s,createdAt:i,attachments:a?n?.map(l=>({...l})):void 0}];const o=[];if(s&&o.push({type:"text",text:s}),a&&n)for(const l of n)o.push({type:"image",source:{type:"base64",media_type:l.mimeType,data:l.dataUrl}});e.chatMessages=[...e.chatMessages,{role:"user",content:o,timestamp:i}],ln(e,!0)}async function Mi(e,t,n){Gi(e);const s=e;s.sessionKey&&s.workingSessions&&(s.workingSessions=new Set([...s.workingSessions,s.sessionKey])),n?.skipOptimisticUpdate||queueMicrotask(()=>{ln(e,!0)});const a=await ho(e,t,n?.attachments,{skipOptimisticUpdate:n?.skipOptimisticUpdate});return!a&&n?.previousDraft!=null&&(e.chatMessage=n.previousDraft),!a&&n?.previousAttachments&&(e.chatAttachments=n.previousAttachments),a&&(Io(e,e.sessionKey),e.chatAttachments=[]),a&&n?.restoreDraft&&n.previousDraft?.trim()&&(e.chatMessage=n.previousDraft),a&&n?.restoreAttachments&&n.previousAttachments?.length&&(e.chatAttachments=n.previousAttachments),ln(e,!0),a&&!e.chatRunId&&Bo(e),a&&n?.refreshSessions&&(e.refreshSessionsAfterChat=!0),a}async function Bo(e){if(!e.connected||Xs(e))return;const[t,...n]=e.chatQueue;if(!t)return;e.chatQueue=n,await Mi(e,t.text,{attachments:t.attachments,skipOptimisticUpdate:!0})||(e.chatQueue=[t,...e.chatQueue])}function Ru(e,t){e.chatQueue=e.chatQueue.filter(n=>n.id!==t)}async function Pu(e,t,n){if(!e.connected)return;const s=e.chatMessage,a=(t??e.chatMessage).trim(),i=e.chatAttachments??[],o=t==null?i:[],l=o.length>0;if(!a&&!l)return;if(Lu(a)){await Fo(e);return}const c=Lb(a);if(t==null&&(e.chatMessage="",Eu(e)),n?.queue){Rb(e,a,o),Xs(e)||await Bo(e);return}if(Xs(e)){await fo(e),await new Promise(u=>setTimeout(u,50)),await Mi(e,a,{attachments:l?o:void 0,refreshSessions:c});return}await Mi(e,a,{previousDraft:t==null?s:void 0,restoreDraft:!!(t&&n?.restoreDraft),attachments:l?o:void 0,previousAttachments:t==null?i:void 0,restoreAttachments:!!(t&&n?.restoreDraft),refreshSessions:c})}async function Uo(e){await Promise.all([se(e),ee(e,{activeMinutes:0}),Zs(e)]),ln(e,!0)}const Iu=Bo;function Pb(e){const t=Dc(e.sessionKey);return t?.agentId?t.agentId:e.hello?.snapshot?.sessionDefaults?.defaultAgentId?.trim()||"main"}function Ib(e,t){const n=la(e),s=encodeURIComponent(t);return n?`${n}/avatar/${s}?meta=1`:`/avatar/${s}?meta=1`}async function Zs(e){if(!e.connected){e.chatAvatarUrl=null;return}const t=Pb(e);if(!t){e.chatAvatarUrl=null;return}e.chatAvatarUrl=null;const n=Ib(e.basePath,t);try{const s=await fetch(n,{method:"GET"});if(!s.ok){e.chatAvatarUrl=null;return}const a=await s.json(),i=typeof a.avatarUrl=="string"?a.avatarUrl.trim():"";e.chatAvatarUrl=i||null}catch{e.chatAvatarUrl=null}}const ti=Object.freeze(Object.defineProperty({__proto__:null,clearDraft:Eu,flushChatQueueForEvent:Iu,handleAbortChat:Fo,handleSendChat:Pu,isChatBusy:Xs,isChatStopCommand:Lu,refreshChat:Uo,refreshChatAvatar:Zs,removeQueuedMessage:Ru,restoreDraft:Re,saveDraft:$e},Symbol.toStringTag,{value:"Module"})),Mb={trace:!0,debug:!0,info:!0,warn:!0,error:!0,fatal:!0},Db={name:"",description:"",agentId:"",enabled:!0,scheduleKind:"every",scheduleAt:"",everyAmount:"30",everyUnit:"minutes",cronExpr:"0 7 * * *",cronTz:"",sessionTarget:"main",wakeMode:"next-heartbeat",payloadKind:"systemEvent",payloadText:"",deliver:!1,channel:"last",to:"",timeoutSeconds:"",postToMainPrefix:""};const{I:Ob}=Yp,wl=e=>e,Nb=e=>e.strings===void 0,kl=()=>document.createComment(""),Rn=(e,t,n)=>{const s=e._$AA.parentNode,a=t===void 0?e._$AB:t._$AA;if(n===void 0){const i=s.insertBefore(kl(),a),o=s.insertBefore(kl(),a);n=new Ob(i,o,e,e.options)}else{const i=n._$AB.nextSibling,o=n._$AM,l=o!==e;if(l){let c;n._$AQ?.(e),n._$AM=e,n._$AP!==void 0&&(c=e._$AU)!==o._$AU&&n._$AP(c)}if(i!==a||l){let c=n._$AA;for(;c!==i;){const u=wl(c).nextSibling;wl(s).insertBefore(c,a),c=u}}}return n},yt=(e,t,n=e)=>(e._$AI(t,n),e),Fb={},Bb=(e,t=Fb)=>e._$AH=t,Ub=e=>e._$AH,ni=e=>{e._$AR(),e._$AA.remove()};const $l=(e,t,n)=>{const s=new Map;for(let a=t;a<=n;a++)s.set(e[a],a);return s},ba=Yi(class extends Ji{constructor(e){if(super(e),e.type!==Qi.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,n){let s;n===void 0?n=t:t!==void 0&&(s=t);const a=[],i=[];let o=0;for(const l of e)a[o]=s?s(l,o):o,i[o]=n(l,o),o++;return{values:i,keys:a}}render(e,t,n){return this.dt(e,t,n).values}update(e,[t,n,s]){const a=Ub(e),{values:i,keys:o}=this.dt(t,n,s);if(!Array.isArray(a))return this.ut=o,i;const l=this.ut??=[],c=[];let u,p,f=0,m=a.length-1,g=0,w=i.length-1;for(;f<=m&&g<=w;)if(a[f]===null)f++;else if(a[m]===null)m--;else if(l[f]===o[g])c[g]=yt(a[f],i[g]),f++,g++;else if(l[m]===o[w])c[w]=yt(a[m],i[w]),m--,w--;else if(l[f]===o[w])c[w]=yt(a[f],i[w]),Rn(e,c[w+1],a[f]),f++,w--;else if(l[m]===o[g])c[g]=yt(a[m],i[g]),Rn(e,a[f],a[m]),m--,g++;else if(u===void 0&&(u=$l(o,g,w),p=$l(l,f,m)),u.has(l[f]))if(u.has(l[m])){const S=p.get(o[g]),T=S!==void 0?a[S]:null;if(T===null){const x=Rn(e,a[f]);yt(x,i[g]),c[g]=x}else c[g]=yt(T,i[g]),Rn(e,a[f],T),a[S]=null;g++}else ni(a[m]),m--;else ni(a[f]),f++;for(;g<=w;){const S=Rn(e,c[w+1]);yt(S,i[g]),c[g++]=S}for(;f<=m;){const S=a[f++];S!==null&&ni(S)}return this.ut=o,Bb(e,c),ut}});function wa(e){$e(e);const n=`agent:main:webchat-${ca().slice(0,8)}`;e.applySettings({...e.settings,openTabs:[...e.settings.openTabs,n],sessionKey:n,lastActiveSessionKey:n,tabLastViewed:{...e.settings.tabLastViewed,[n]:Date.now()}}),e.sessionKey=n,e.chatMessage="",e.chatMessages=[],e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.resetToolStream(),e.resetChatScroll(),e.loadAssistantIdentity(),be(e,n,!0),se(e)}function Mu(e,t){const n=uo(t,e.basePath);return r`
  ...
  `}function zb(e){const t=new Date,n=new Date(t.getFullYear(),t.getMonth(),t.getDate()),s=new Date(n.getTime()-864e5);return{today:e.filter(a=>a.updatedAt&&new Date(a.updatedAt)>=n),yesterday:e.filter(a=>a.updatedAt&&new Date(a.updatedAt)>=s&&new Date(a.updatedAt)<n),older:e.filter(a=>!a.updatedAt||new Date(a.updatedAt)<s)}}let si=null;function Kb(e){if(!e.client||!e.connected)return r`
      <div
...
Deletes the session entry and archives its transcript.`)&&(e.sessionsResult?.sessions&&(e.sessionsResult={...e.sessionsResult,sessions:e.sessionsResult.sessions.filter(S=>S.key!==g)}),e.client&&e.connected))try{await e.client.request("sessions.delete",{key:g,deleteTranscript:!0}),ee(e)}catch(S){console.error("Failed to delete session:",S),ee(e)}},u=m=>r`
  ...
  `}const qb=["system","light","dark","lifetrack"];function Ou(e){const t=Math.max(0,qb.indexOf(e.theme)),n=s=>a=>{const o={element:a.currentTarget};(a.clientX||a.clientY)&&(o.pointerClientX=a.clientX,o.pointerClientY=a.clientY),e.setTheme(s,o)};return r`
  ...
  `}function lw(e,t){if(e.isNotification)return r`
  ...
  `}function hw(e){const t=e.connected?`Message ${e.allyName}...`:"Reconnecting...",n=e.draft.trim()||e.attachments.length>0;return r`
    ${pw(e)}
    <div class="ally-panel__input">
      <textarea
        ...
        placeholder=${t}
        rows="1"
        @input=${s=>{const a=s.target;aw(a),e.onDraftChange(a.value)}}
        @paste=${s=>uw(s,e)}
  ...
  `};function Ze(e){const{schema:t,value:n,path:s,hints:a,unsupported:i,disabled:o,onPatch:l}=e,c=e.showLabel??!0,u=qe(t),p=xe(s,a),f=p?.label??t.title??tt(String(s.at(-1))),m=p?.help??t.description,g=$a(s);if(i.has(g))return r`<div class="cfg-field cfg-field--error">
      ...
      `}if(d&&x.length>5)return Pl({...e,options:x,value:n??t.default});const k=new Set(S.map(_=>qe(_)).filter(Boolean)),A=new Set([...k].map(_=>_==="integer"?"number":_));if([...A].every(_=>["string","number","boolean"].includes(_))){const _=A.has("string"),L=A.has("number");if(A.has("boolean")&&A.size===1)return Ze({...e,schema:{...t,type:"boolean",anyOf:void 0,oneOf:void 0}});if(_||L)return Rl({...e,inputType:L&&!_?"number":"text"})}}if(t.enum){const w=t.enum;if(w.length<=5){const S=n??t.default;return r`
        <div class="cfg-field">
          ${c?r`<label class="cfg-field__label">${f}</label>`:h}
          ${m?r`<div class="cfg-field__help">${m}</div>`:h}
          <div class="cfg-segmented">
      ...
      `}return Pl({...e,options:w,value:n??t.default})}if(u==="object")return $w(e);if(u==="array")return Sw(e);if(u==="boolean"){const w=typeof n=="boolean"?n:typeof t.default=="boolean"?t.default:!1;return r`
    ...
    `}return u==="number"||u==="integer"?kw(e):u==="string"?Rl({...e,inputType:"text"}):r`
    <div class="cfg-field cfg-field--error">
      <div class="cfg-field__label">${f}</div>
      <div class="cfg-field__error">Unsupported type: ${u}. Use Raw mode.</div>
    </div>
  `}function Rl(e){const{schema:t,value:n,path:s,hints:a,disabled:i,onPatch:o,inputType:l}=e,c=e.showLabel??!0,u=xe(s,a),p=u?.label??t.title??tt(String(s.at(-1))),f=u?.help??t.description,m=u?.sensitive??vw(s),g=u?.placeholder??(m?"••••":t.default!==void 0?`Default: ${an(t.default)}`:""),w=n??"";return r`
    <div class="cfg-field">
      ...
      <div class="cfg-input-wrap">
        <input
          ...
          .value=${an(w)}
          ?disabled=${i}
          @input=${S=>{const T=S.target.value;if(l==="number"){if(T.trim()===""){o(s,void 0);return}const x=Number(T);o(s,Number.isNaN(x)?T:x);return}o(s,T)}}
  ...
  `}function kw(e){const{schema:t,value:n,path:s,hints:a,disabled:i,onPatch:o}=e,l=e.showLabel??!0,c=xe(s,a),u=c?.label??t.title??tt(String(s.at(-1))),p=c?.help??t.description,f=n??t.default??"",m=typeof f=="number"?f:0;return r`
    <div class="cfg-field">
  ...
  `}function Pl(e){const{schema:t,value:n,path:s,hints:a,disabled:i,options:o,onPatch:l}=e,c=e.showLabel??!0,u=xe(s,a),p=u?.label??t.title??tt(String(s.at(-1))),f=u?.help??t.description,m=n??t.default,g=o.findIndex(S=>S===m||String(S)===String(m)),w="__unset__";return r`
    <div class="cfg-field">
      ${c?r`<label class="cfg-field__label">${p}</label>`:h}
      ${f?r`<div class="cfg-field__help">${f}</div>`:h}
      <select
  ...
  `}function $w(e){const{schema:t,value:n,path:s,hints:a,unsupported:i,disabled:o,onPatch:l}=e;e.showLabel;const c=xe(s,a),u=c?.label??t.title??tt(String(s.at(-1))),p=c?.help??t.description,f=n??t.default,m=f&&typeof f=="object"&&!Array.isArray(f)?f:{},g=t.properties??{},S=Object.entries(g).toSorted((k,A)=>{const _=xe([...s,k[0]],a)?.order??0,L=xe([...s,A[0]],a)?.order??0;return _!==L?_-L:k[0].localeCompare(A[0])}),T=new Set(Object.keys(g)),x=t.additionalProperties,d=!!x&&typeof x=="object";return s.length===1?r`
      <div class="cfg-fields">
        ${S.map(([k,A])=>Ze({schema:A,value:m[k],path:[...s,k],hints:a,unsupported:i,disabled:o,onPatch:l}))}
        ${d?Il({schema:x,value:m,path:s,hints:a,unsupported:i,disabled:o,reservedKeys:T,onPatch:l}):h}
      </div>
    `:r`
  ...
  `}function Sw(e){const{schema:t,value:n,path:s,hints:a,unsupported:i,disabled:o,onPatch:l}=e,c=e.showLabel??!0,u=xe(s,a),p=u?.label??t.title??tt(String(s.at(-1))),f=u?.help??t.description,m=Array.isArray(t.items)?t.items[0]:t.items;if(!m)return r`
      <div class="cfg-field cfg-field--error">
          ...
          ${g.map((w,S)=>r`
            <div class="cfg-array__item">
              ...
              <div class="cfg-array__item-content">
                ${Ze({schema:m,value:w,path:[...s,S],hints:a,unsupported:i,disabled:o,showLabel:!1,onPatch:l})}
              </div>
            </div>
          `)}
        </div>
  ...
  `}function Il(e){const{schema:t,value:n,path:s,hints:a,unsupported:i,disabled:o,reservedKeys:l,onPatch:c}=e,u=bw(t),p=Object.entries(n??{}).filter(([f])=>!l.has(f));return r`
    <div class="cfg-map">
      ...
      ${p.length===0?r`
        ...
        <div class="cfg-map__items">
          ${p.map(([f,m])=>{const g=[...s,f],w=ww(m);return r`
              <div class="cfg-map__item">
                <div class="cfg-map__item-key">
                  <input
                    ...
                    .value=${f}
                    ?disabled=${o}
                    @change=${S=>{const T=S.target.value.trim();if(!T||T===f)return;const x={...n};T in x||(x[T]=x[f],delete x[f],c(s,x))}}
                  />
                </div>
                <div class="cfg-map__item-value">
                  ${u?r`
                        <textarea
                          ...
                          .value=${w}
                          ?disabled=${o}
                          @change=${S=>{const T=S.target,x=T.value.trim();if(!x){c(g,void 0);return}try{c(g,JSON.parse(x))}catch{T.value=w}}}
                        ></textarea>
  ...
  `},zo={env:{label:"Environment Variables",description:"Environment variables passed to the gateway process"},update:{label:"Updates",description:"Auto-update settings and release channel"},agents:{label:"Agents",description:"Agent configurations, models, and identities"},auth:{label:"Authentication",description:"API keys and authentication profiles"},channels:{label:"Channels",description:"Messaging channels (Telegram, Discord, Slack, etc.)"},messages:{label:"Messages",description:"Message handling and routing settings"},commands:{label:"Commands",description:"Custom slash commands"},hooks:{label:"Hooks",description:"Webhooks and event hooks"},skills:{label:"Skills",description:"Skill packs and capabilities"},tools:{label:"Tools",description:"Tool configurations (browser, search, etc.)"},gateway:{label:"Gateway",description:"Gateway server settings (port, auth, binding)"},wizard:{label:"Setup Wizard",description:"Setup wizard state and history"},meta:{label:"Metadata",description:"Gateway metadata and version information"},logging:{label:"Logging",description:"Log levels and output configuration"},browser:{label:"Browser",description:"Browser automation settings"},ui:{label:"UI",description:"User interface preferences"},models:{label:"Models",description:"AI model configurations and providers"},bindings:{label:"Bindings",description:"Key bindings and shortcuts"},broadcast:{label:"Broadcast",description:"Broadcast and notification settings"},audio:{label:"Audio",description:"Audio input/output settings"},session:{label:"Session",description:"Session management and persistence"},cron:{label:"Cron",description:"Scheduled tasks and automation"},web:{label:"Web",description:"Web server and API settings"},discovery:{label:"Discovery",description:"Service discovery and networking"},canvasHost:{label:"Canvas Host",description:"Canvas rendering and display"},talk:{label:"Talk",description:"Voice and speech settings"},plugins:{label:"Plugins",description:"Plugin management and extensions"},user:{label:"User Profile",description:"Your display name and avatar"}};function Dl(e){return Ml[e]??Ml.default}function Aw(e,t,n){if(!n)return!0;const s=n.toLowerCase(),a=zo[e];return e.toLowerCase().includes(s)||a&&(a.label.toLowerCase().includes(s)||a.description.toLowerCase().includes(s))?!0:On(t,s)}function On(e,t){if(e.title?.toLowerCase().includes(t)||e.description?.toLowerCase().includes(t)||e.enum?.some(s=>String(s).toLowerCase().includes(t)))return!0;if(e.properties){for(const[s,a]of Object.entries(e.properties))if(s.toLowerCase().includes(t)||On(a,t))return!0}if(e.items){const s=Array.isArray(e.items)?e.items:[e.items];for(const a of s)if(a&&On(a,t))return!0}if(e.additionalProperties&&typeof e.additionalProperties=="object"&&On(e.additionalProperties,t))return!0;const n=e.anyOf??e.oneOf??e.allOf;if(n){for(const s of n)if(s&&On(s,t))return!0}return!1}function Tw(e){if(!e.schema)return r`
    ...
    <div class="config-form config-form--modern">
      ${p?(()=>{const{sectionKey:f,subsectionKey:m,schema:g}=p,w=xe([f,m],e.uiHints),S=w?.label??g.title??tt(m),T=w?.help??g.description??"",x=n[f],d=x&&typeof x=="object"?x[m]:void 0,k=`config-section-${f}-${m}`;return r`
  ...
  `}const _w=new Set(["title","description","default","nullable"]);function xw(e){return Object.keys(e??{}).filter(n=>!_w.has(n)).length===0}function Ku(e){const t=e.filter(a=>a!=null),n=t.length!==e.length,s=[];for(const a of t)s.some(i=>Object.is(i,a))||s.push(a);return{enumValues:s,nullable:n}}function Wu(e){return!e||typeof e!="object"?{schema:null,unsupportedPaths:["<root>"]}:Un(e,[])}function Un(e,t){const n=new Set,s={...e},a=$a(t)||"<root>";if(e.anyOf||e.oneOf||e.allOf){const l=Cw(e,t);return l||{schema:e,unsupportedPaths:[a]}}const i=Array.isArray(e.type)&&e.type.includes("null"),o=qe(e)??(e.properties||e.additionalProperties?"object":void 0);if(s.type=o??e.type,s.nullable=i||e.nullable,s.enum){const{enumValues:l,nullable:c}=Ku(s.enum);s.enum=l,c&&(s.nullable=!0),l.length===0&&n.add(a)}if(o==="object"){const l=e.properties??{},c={};for(const[u,p]of Object.entries(l)){const f=Un(p,[...t,u]);f.schema&&(c[u]=f.schema);for(const m of f.unsupportedPaths)n.add(m)}if(s.properties=c,e.additionalProperties===!0)n.add(a);else if(e.additionalProperties===!1)s.additionalProperties=!1;else if(e.additionalProperties&&typeof e.additionalProperties=="object"&&!xw(e.additionalProperties)){const u=Un(e.additionalProperties,[...t,"*"]);s.additionalProperties=u.schema??e.additionalProperties,u.unsupportedPaths.length>0&&n.add(a)}}else if(o==="array"){const l=Array.isArray(e.items)?e.items[0]:e.items;if(!l)n.add(a);else{const c=Un(l,[...t,"*"]);s.items=c.schema??l,c.unsupportedPaths.length>0&&n.add(a)}}else o!=="string"&&o!=="number"&&o!=="integer"&&o!=="boolean"&&!s.enum&&n.add(a);return{schema:s,unsupportedPaths:Array.from(n)}}function Cw(e,t){if(e.allOf)return null;const n=e.anyOf??e.oneOf;if(!n)return null;const s=[],a=[];let i=!1;for(const l of n){if(!l||typeof l!="object")return null;if(Array.isArray(l.enum)){const{enumValues:c,nullable:u}=Ku(l.enum);s.push(...c),u&&(i=!0);continue}if("const"in l){if(l.const==null){i=!0;continue}s.push(l.const);continue}if(qe(l)==="null"){i=!0;continue}a.push(l)}if(s.length>0&&a.length===0){const l=[];for(const c of s)l.some(u=>Object.is(u,c))||l.push(c);return{schema:{...e,enum:l,nullable:i,anyOf:void 0,oneOf:void 0,allOf:void 0},unsupportedPaths:[]}}if(a.length===1){const l=Un(a[0],t);return l.schema&&(l.schema.nullable=i||l.schema.nullable),l}const o=new Set(["string","number","integer","boolean"]);return a.length>0&&s.length===0&&a.every(l=>l.type&&o.has(String(l.type)))?{schema:{...e,nullable:i},unsupportedPaths:[]}:null}function Ew(e,t){let n=e;for(const s of t){if(!n)return null;const a=qe(n);if(a==="object"){const i=n.properties??{};if(typeof s=="string"&&i[s]){n=i[s];continue}const o=n.additionalProperties;if(typeof s=="string"&&o&&typeof o=="object"){n=o;continue}return null}if(a==="array"){if(typeof s!="number")return null;n=(Array.isArray(n.items)?n.items[0]:n.items)??null;continue}return null}return n}function Lw(e,t){const s=(e.channels??{})[t],a=e[t];return(s&&typeof s=="object"?s:null)??(a&&typeof a=="object"?a:null)??{}}function Rw(e){const t=Wu(e.schema),n=t.schema;if(!n)return r`
      <div class="callout danger">Schema unavailable. Use Raw.</div>
    `;const s=Ew(n,["channels",e.channelId]);if(!s)return r`
      <div class="callout danger">Channel config schema unavailable.</div>
    `;const a=e.configValue??{},i=Lw(a,e.channelId);return r`
  ...
  `}function nt(e){const{channelId:t,props:n}=e,s=n.configSaving||n.configSchemaLoading;return r`
    <div style="margin-top: 16px;">
      ${n.configSchemaLoading?r`
            ...
            `:Rw({channelId:t,configValue:n.configForm,schema:n.configSchema,uiHints:n.configUiHints,disabled:s,onPatch:n.onConfigPatch})}
  ...
  `}function Pw(e){const{props:t,discord:n,accountCountLabel:s}=e;return r`
    <div class="card">
  ...
  `}function Iw(e){const{props:t,googleChat:n,accountCountLabel:s}=e;return r`
    <div class="card">
  ...
  `}function Ol(e){return e?e.length<=20?e:`${e.slice(0,8)}...${e.slice(-8)}`:"n/a"}function Dw(e){const{props:t,nostr:n,nostrAccounts:s,accountCountLabel:a,profileFormState:i,profileFormCallbacks:o,onEditProfile:l}=e,c=s[0],u=n?.configured??c?.configured??!1,p=n?.running??c?.running??!1,f=n?.publicKey??c?.publicKey,m=n?.lastStartAt??c?.lastStartAt??null,g=n?.lastError??c?.lastError??null,w=s.length>1,S=i!=null,T=d=>{const k=d.publicKey,A=d.profile,_=A?.displayName??A?.name??d.name??d.accountId;return r`
      <div class="account-card">
        ...
        <div class="status-list account-card-status">
          ...
          <div>
            ...
            <span>${d.lastInboundAt?q(d.lastInboundAt):"n/a"}</span>
          </div>
          ${d.lastError?r`
    ...
    `},x=()=>{if(S&&o)return dh({state:i,callbacks:o,accountId:s[0]?.accountId??"default"});const d=c?.profile??n?.profile,{name:k,displayName:A,about:_,picture:L,nip05:R}=d??{},z=k||A||_||L||R;return r`
  ...
  `}function Ow(e){if(!e&&e!==0)return"n/a";const t=Math.round(e/1e3);if(t<60)return`${t}s`;const n=Math.round(t/60);return n<60?`${n}m`:`${Math.round(n/60)}h`}function Nw(e,t){const n=t.snapshot,s=n?.channels;if(!n||!s)return!1;const a=s[e],i=typeof a?.configured=="boolean"&&a.configured,o=typeof a?.running=="boolean"&&a.running,l=typeof a?.connected=="boolean"&&a.connected,u=(n.channelAccounts?.[e]??[]).some(p=>p.configured||p.running||p.connected);return i||o||l||u}function Fw(e,t){return t?.[e]?.length??0}function qu(e,t){const n=Fw(e,t);return n<2?h:r`<div class="account-count">Accounts (${n})</div>`}function Bw(e){const{props:t,signal:n,accountCountLabel:s}=e;return r`
    <div class="card">
  ...
  `}function Uw(e){const{props:t,slack:n,accountCountLabel:s}=e;return r`
    <div class="card">
  ...
  `}function zw(e){const{props:t,telegram:n,telegramAccounts:s,accountCountLabel:a}=e,i=s.length>1,o=l=>{const u=l.probe?.bot?.username,p=l.name||l.accountId;return r`
      <div class="account-card">
        <div class="account-card-header">
  ...
  `}function Kw(e){const{props:t,whatsapp:n,accountCountLabel:s}=e;return r`
    <div class="card">
      ...
      <div class="status-list" style="margin-top: 16px;">
        ...
        <div>
          ...
          <span>
            ${n?.authAgeMs!=null?Ow(n.authAgeMs):"n/a"}
          </span>
        </div>
      </div>
  ...
  `}function Ww(e){const t=e.snapshot?.channels,n=t?.whatsapp??void 0,s=t?.telegram??void 0,a=t?.discord??null;t?.googlechat;const i=t?.slack??null,o=t?.signal??null,l=t?.imessage??null,c=t?.nostr??null,p=qw(e.snapshot).map((f,m)=>({key:f,enabled:Nw(f,e),order:m})).toSorted((f,m)=>f.enabled!==m.enabled?f.enabled?-1:1:f.order-m.order);return r`
    <section class="grid grid-cols-2">
      ${p.map(f=>Hw(f.key,e,{whatsapp:n,telegram:s,discord:a,slack:i,signal:o,imessage:l,nostr:c,channelAccounts:e.snapshot?.channelAccounts??null}))}
    </section>
...
${e.snapshot?JSON.stringify(e.snapshot,null,2):"No snapshot yet."}
  ...
  `}function qw(e){return e?.channelMeta?.length?e.channelMeta.map(t=>t.id):e?.channelOrder?.length?e.channelOrder:["whatsapp","telegram","discord","googlechat","slack","signal","imessage","nostr"]}function Hw(e,t,n){const s=qu(e,n.channelAccounts);switch(e){case"whatsapp":return Kw({props:t,whatsapp:n.whatsapp,accountCountLabel:s});case"telegram":return zw({props:t,telegram:n.telegram,telegramAccounts:n.channelAccounts?.telegram??[],accountCountLabel:s});case"discord":return Pw({props:t,discord:n.discord,accountCountLabel:s});case"googlechat":return Iw({props:t,accountCountLabel:s});case"slack":return Uw({props:t,slack:n.slack,accountCountLabel:s});case"signal":return Bw({props:t,signal:n.signal,accountCountLabel:s});case"imessage":return Mw({props:t,imessage:n.imessage,accountCountLabel:s});case"nostr":{const a=n.channelAccounts?.nostr??[],i=a[0],o=i?.accountId??"default",l=i?.profile??null,c=t.nostrProfileAccountId===o?t.nostrProfileFormState:null,u=c?{onFieldChange:t.onNostrProfileFieldChange,onSave:t.onNostrProfileSave,onImport:t.onNostrProfileImport,onCancel:t.onNostrProfileCancel,onToggleAdvanced:t.onNostrProfileToggleAdvanced}:null;return Dw({props:t,nostr:n.nostr,nostrAccounts:a,accountCountLabel:s,profileFormState:c,profileFormCallbacks:u,onEditProfile:()=>t.onNostrProfileEdit(o,l)})}default:return Vw(e,t,n.channelAccounts??{})}}function Vw(e,t,n){const s=Gw(t.snapshot,e),a=t.snapshot?.channels?.[e],i=typeof a?.configured=="boolean"?a.configured:void 0,o=typeof a?.running=="boolean"?a.running:void 0,l=typeof a?.connected=="boolean"?a.connected:void 0,c=typeof a?.lastError=="string"?a.lastError:void 0,u=n[e]??[],p=qu(e,n);return r`
    <div class="card">
  ...
  `}function jw(e){return e?.channelMeta?.length?Object.fromEntries(e.channelMeta.map(t=>[t.id,t])):{}}function Gw(e,t){return jw(e)[t]?.label??e?.channelLabels?.[t]??t}const Qw=600*1e3;function Hu(e){return e.lastInboundAt?Date.now()-e.lastInboundAt<Qw:!1}function Yw(e){return e.running?"Yes":Hu(e)?"Active":"No"}function Jw(e){return e.connected===!0?"Yes":e.connected===!1?"No":Hu(e)?"Active":"n/a"}function Xw(e){const t=Yw(e),n=Jw(e);return r`
    <div class="account-card">
      <div class="account-card-header">
  ...
  `}const zn=(e,t)=>{const n=e._$AN;if(n===void 0)return!1;for(const s of n)s._$AO?.(t,!1),zn(s,t);return!0},ea=e=>{let t,n;do{if((t=e._$AM)===void 0)break;n=t._$AN,n.delete(e),e=t}while(n?.size===0)},Vu=e=>{for(let t;t=e._$AM;e=t){let n=t._$AN;if(n===void 0)t._$AN=n=new Set;else if(n.has(e))break;n.add(e),tk(t)}};function Zw(e){this._$AN!==void 0?(ea(this),this._$AM=e,Vu(this)):this._$AM=e}function ek(e,t=!1,n=0){const s=this._$AH,a=this._$AN;if(a!==void 0&&a.size!==0)if(t)if(Array.isArray(s))for(let i=n;i<s.length;i++)zn(s[i],!1),ea(s[i]);else s!=null&&(zn(s,!1),ea(s));else zn(this,e)}const tk=e=>{e.type==Qi.CHILD&&(e._$AP??=ek,e._$AQ??=Zw)};class nk extends Ji{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,n,s){super._$AT(t,n,s),Vu(this),this.isConnected=t._$AU}_$AO(t,n=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),n&&(zn(this,t),ea(this))}setValue(t){if(Nb(this._$Ct))this._$Ct._$AI(t,this);else{const n=[...this._$Ct._$AH];n[this._$Ci]=t,this._$Ct._$AI(n,this,0)}}disconnected(){}reconnected(){}}const ii=new WeakMap,sk=Yi(class extends nk{render(e){return h}update(e,[t]){const n=t!==this.G;return n&&this.G!==void 0&&this.rt(void 0),(n||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),h}rt(e){if(this.isConnected||(e=void 0),typeof this.G=="function"){const t=this.ht??globalThis;let n=ii.get(t);n===void 0&&(n=new WeakMap,ii.set(t,n)),n.get(this.G)!==void 0&&this.G.call(this.ht,void 0),n.set(this.G,e),e!==void 0&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return typeof this.G=="function"?ii.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Nl=25*1024*1024,Fl=50*1024*1024,Bl=20;function oi(e){return e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:e<1024*1024*1024?`${(e/(1024*1024)).toFixed(1)} MB`:`${(e/(1024*1024*1024)).toFixed(1)} GB`}function Ko(e,t=0){const n=[],s=[];let a=t;const i=Array.from(e);for(const o of i){if(n.length>=Bl){s.push(`Maximum ${Bl} files allowed per upload`);break}if(o.size>Nl){s.push(`"${o.name}" is too large (${oi(o.size)}). Max ${oi(Nl)}. For larger files, mention the file path instead.`);continue}if(a+o.size>Fl){s.push(`Total upload size exceeds ${oi(Fl)} limit`);break}a+=o.size,n.push(o)}return{validFiles:n,errors:s}}const ak=new Set(["md","markdown","mdx"]),ik=new Set(["htm","html"]),ok=new Set(["avif","bmp","gif","heic","heif","jpeg","jpg","png","svg","svgz","webp"]);function rk(e){const t=e.replaceAll("\\","/").trim();if(!t)return e;const n=t.split("/");return n[n.length-1]||t}function lk(e){if(!e)return null;const n=e.trim().toLowerCase().split(".").pop()??"";return n?ak.has(n)?"text/markdown":ik.has(n)?"text/html":ok.has(n)?n==="svg"||n==="svgz"?"image/svg+xml":n==="jpg"?"image/jpeg":`image/${n}`:n==="pdf"?"application/pdf":n==="json"||n==="json5"?"application/json":n==="txt"||n==="text"||n==="log"?"text/plain":null:null}function ju(e){const t=e.mimeType?.split(";")[0]?.trim().toLowerCase()??"";if(t)return t;const n=e.content?.trim()??"";if(n.startsWith("data:image/")){const s=/^data:(image\/[^;]+);/i.exec(n);return s?.[1]?s[1].toLowerCase():"image/*"}return lk(e.filePath??null)??"text/markdown"}function ck(e){if(!e.startsWith("file://"))return null;let t=e.slice(7);return t.startsWith("/~/")&&(t="~"+t.slice(2)),decodeURIComponent(t)}function dk(e,t){if(!t)return;const s=e.target.closest("a");if(!s)return;const a=s.getAttribute("href");if(!a)return;const i=ck(a);i&&(e.preventDefault(),e.stopPropagation(),t(i))}function uk(e){if(e.error)return r`
    ...
    `;const t=ju(e),n=e.content,s=n.trim();if(t.startsWith("image/"))return s.startsWith("data:image/")?r`
        <div class="sidebar-image">
          <img src=${s} alt=${rk(e.filePath??"Image preview")} />
        </div>
      `:r`
      <div class="callout">
    ...
    ></iframe>`}if(t==="text/markdown"||t==="text/x-markdown"){const a=ng(n);return r`<div
      ...
      @click=${i=>dk(i,e.onOpenFile)}
    >${Ce(we(a))}</div>`}return r`<pre class="sidebar-plain">${n}</pre>`}function pk(e){const t=ju(e);return t==="text/html"||t==="application/xhtml+xml"}function hk(e){const t=new Blob([e],{type:"text/html"}),n=URL.createObjectURL(t);window.open(n,"_blank","noopener,noreferrer")}function Di(e){const t=e.title?.trim()||"Tool Output",n=pk(e)&&e.content;return r`
  ...
  `;rs([ts({type:Number})],Ft.prototype,"splitRatio",2);rs([ts({type:Number})],Ft.prototype,"minRatio",2);rs([ts({type:Number})],Ft.prototype,"maxRatio",2);rs([ts({type:String})],Ft.prototype,"direction",2);Ft=rs([Ec("resizable-divider")],Ft);const mk=5e3;function vk(e){const t=(e??"").trim();if(!t||t==="/")return"/consciousness-icon.webp";const n=t.startsWith("/")?t:`/${t}`;return`${n.endsWith("/")?n.slice(0,-1):n}/consciousness-icon.webp`}function Ul(e){e.style.height="auto",e.style.height=`${e.scrollHeight}px`}function yk(e){const t=e.sessions?.sessions?.find(a=>a.key===e.sessionKey);if(!t)return null;const n=t.totalTokens??0,s=t.contextTokens??e.sessions?.defaults?.contextTokens??2e5;return s<=0?null:n/s}function bk(e){const t=yk(e);if(t===null)return h;const n=Math.round(t*100),s=n>=90?"danger":n>=70?"warn":"ok",a=e.sessions?.sessions?.find(l=>l.key===e.sessionKey),i=a?.totalTokens??0,o=a?.contextTokens??e.sessions?.defaults?.contextTokens??2e5;return r`
    <button
      type="button"
  ...
  `}function wk(e){return e?e.active?r`
  ...
  `}function Ck(e){return e.button===0&&!e.metaKey&&!e.ctrlKey&&!e.shiftKey&&!e.altKey}function Ek(e){const t=e.href;if(t){if(e.target==="_blank"){window.open(t,"_blank","noopener,noreferrer");return}window.location.assign(t)}}function Lk(e){const t=e.trim();return!t||t.includes(`
`)?null:t.startsWith("/")||t.startsWith("~/")||t.startsWith("./")||t.startsWith("../")||/^[a-z]:[\\/]/i.test(t)||/^[^:\s]+\/[^\s]+$/.test(t)&&/\.[a-z0-9]{1,12}$/i.test(t)||/^[^\s/\\:*?"<>|]+\.[a-z0-9]{1,12}$/i.test(t)&&t.length<=100?t:null}async function Rk(e,t){const n=e.target,s=n instanceof Element?n:n instanceof Node?n.parentElement:null;if(!s||!t.onMessageLinkClick||!Ck(e))return;const a=s.closest("a");if(a instanceof HTMLAnchorElement){if(a.hasAttribute("download"))return;const c=a.getAttribute("href");if(!c)return;try{const p=new URL(c,window.location.href);if(/^https?:$/.test(p.protocol)&&p.origin!==window.location.origin){e.preventDefault(),window.open(p.href,"_blank","noopener,noreferrer");return}}catch{}e.preventDefault(),await t.onMessageLinkClick(c)||Ek(a);return}const i=s.closest("code");if(!(i instanceof HTMLElement))return;const o=(i.textContent??"").trim();if(/^https?:\/\/\S+$/i.test(o)){e.preventDefault(),window.open(o,"_blank","noopener,noreferrer");return}const l=Lk(o);l&&(e.preventDefault(),await t.onMessageLinkClick(l))}function Pk(e){const t=e.connected,n=e.sending||e.stream!==null;e.canAbort&&e.onAbort;const a=e.sessions?.sessions?.find(g=>g.key===e.sessionKey)?.reasoningLevel??"off",i=e.showThinking&&a!=="off",o={name:e.assistantName,avatar:e.assistantAvatar??e.assistantAvatarUrl??null},l=(e.attachments?.length??0)>0,c=e.connected?l?"Add a message or paste more images...":"Message (↩ to send, ⌘↩ to queue, Shift+↩ for line breaks)":"Connect to the gateway to start chatting…",u=e.splitRatio??.6,p=!!(e.sidebarOpen&&e.onCloseSidebar),f=vk(e.basePath),m=r`
    <div
      class="chat-thread"
      role="log"
      aria-live="polite"
    ...
    >
      ${e.loading?r`
            ...
            `:h}
      ${ba(Dk(e),g=>g.key,g=>{try{if(g.kind==="reading-indicator")return pm(o,e.currentToolInfo);if(g.kind==="stream")return hm(g.text,g.startedAt,e.onOpenSidebar,o,e.currentToolInfo);if(g.kind==="compaction-summary")return vm(g.message);if(g.kind==="group"){const w=e.resolveImageUrl?(S,T)=>e.resolveImageUrl(S,T):void 0;return fm(g,{onOpenSidebar:e.onOpenSidebar,onOpenFile:e.onOpenFile,onImageClick:e.onImageClick,resolveImageUrl:w,showReasoning:i,assistantName:e.assistantName,assistantAvatar:o.avatar,userName:e.userName,userAvatar:e.userAvatar})}return h}catch(w){return console.error("[chat] item render error:",w,g.key),h}})}
    </div>
  `;return r`
    <section 
      class="card chat"
      @dragover=${kk}
      @dragenter=${g=>$k(g,g.currentTarget)}
      @dragleave=${g=>Sk(g,g.currentTarget)}
      @drop=${g=>Ak(g,e)}
    >
  ...
  `}const zl=200;function Ik(e){const t=[];let n=null;for(const s of e){if(s.kind!=="message"){n&&(t.push(n),n=null),t.push(s);continue}const a=ld(s.message),i=lo(a.role),o=a.timestamp||Date.now();!n||n.role!==i?(n&&t.push(n),n={kind:"group",key:`group:${i}:${s.key}`,role:i,messages:[{message:s.message,key:s.key}],timestamp:o,isStreaming:!1}):n.messages.push({message:s.message,key:s.key})}return n&&t.push(n),t}function Mk(e){const n=e.content;if(!Array.isArray(n))return!1;for(const s of n){if(typeof s!="object"||s===null)continue;const a=s;if(a.type==="image")return!0;if(Array.isArray(a.content)){for(const i of a.content)if(!(typeof i!="object"||i===null)&&i.type==="image")return!0}}return!1}function Dk(e){const t=[],n=Array.isArray(e.messages)?e.messages:[],s=Array.isArray(e.toolMessages)?e.toolMessages:[],a=Math.max(0,n.length-zl);a>0&&t.push({kind:"message",key:"chat:history:notice",message:{role:"system",content:`Showing last ${zl} messages (${a} hidden).`,timestamp:Date.now()}});for(let i=a;i<n.length;i++){const o=n[i];if(o._chatIdx=i,ym(o)){t.push({kind:"compaction-summary",key:`compaction:${i}`,message:o});continue}const l=ld(o);!e.showThinking&&l.role.toLowerCase()==="toolresult"&&!Mk(o)||t.push({kind:"message",key:Kl(o,i),message:o})}if(e.showThinking)for(let i=0;i<s.length;i++)t.push({kind:"message",key:Kl(s[i],i+n.length),message:s[i]});if(e.stream!==null){const i=`stream:${e.sessionKey}:${e.streamStartedAt??"live"}`;e.stream.trim().length>0?t.push({kind:"stream",key:i,text:e.stream,startedAt:e.streamStartedAt??Date.now()}):t.push({kind:"reading-indicator",key:i})}else if(e.isWorking){const i=`working:${e.sessionKey}`;t.push({kind:"reading-indicator",key:i})}else if(e.sending||e.canAbort){const i=`sending:${e.sessionKey}`;t.push({kind:"reading-indicator",key:i})}return Ik(t)}function Kl(e,t){const n=e,s=typeof n.toolCallId=="string"?n.toolCallId:"";if(s)return`tool:${s}`;const a=typeof n.id=="string"?n.id:"";if(a)return`msg:${a}`;const i=typeof n.messageId=="string"?n.messageId:"";if(i)return`msg:${i}`;const o=typeof n.timestamp=="number"?n.timestamp:null,l=typeof n.role=="string"?n.role:"unknown";return o!=null?`msg:${l}:${o}:${t}`:`msg:${l}:${t}`}function Ok(e,t=128){return new Promise((n,s)=>{const a=new Image;a.addEventListener("load",()=>{const i=document.createElement("canvas");i.width=t,i.height=t;const o=i.getContext("2d");if(!o){s(new Error("Could not get canvas context"));return}const l=Math.min(a.width,a.height),c=(a.width-l)/2,u=(a.height-l)/2;o.drawImage(a,c,u,l,l,0,0,t,t),n(i.toDataURL("image/png"))}),a.addEventListener("error",()=>s(new Error("Failed to load image"))),a.src=URL.createObjectURL(e)})}let Zt="",Nn=null,_t=null,Wl=!1,it=!1;function Nk(e){Wl||(Zt=e.userName||"",Nn=e.userAvatar||null,_t=e.userAvatar||null,Wl=!0,it=!1)}function Fk(e){Nk(e);const t=c=>{Zt=c.target.value,it=!0},n=async c=>{const p=c.target.files?.[0];if(p){if(!p.type.startsWith("image/")){alert("Please select an image file");return}if(p.size>5*1024*1024){alert("Image must be less than 5MB");return}try{const f=await Ok(p,128);Nn=f,_t=f,it=!0,document.dispatchEvent(new CustomEvent("user-settings-updated"))}catch(f){console.error("Failed to process image:",f),alert("Failed to process image")}}},s=()=>{Nn=null,_t=null,it=!0;const c=document.getElementById("user-avatar-input");c&&(c.value=""),document.dispatchEvent(new CustomEvent("user-settings-updated"))},a=()=>{e.onUpdate(Zt,Nn||""),it=!1;const c=document.querySelector(".user-settings__save");c&&(c.textContent="Saved!",setTimeout(()=>{c.textContent="Save"},1500))},i=()=>{Zt=e.userName||"",Nn=e.userAvatar||null,_t=e.userAvatar||null,it=!1,document.dispatchEvent(new CustomEvent("user-settings-updated"))},o=Zt||"You",l=_t?r`<img src="${_t}" alt="${o}" class="user-settings__avatar-img" />`:r`<span class="user-settings__avatar-initial">${o.charAt(0).toUpperCase()}</span>`;return r`
  ...
  `},ri=[{key:"model",label:"AI Model"},{key:"env",label:"Environment"},{key:"update",label:"Updates"},{key:"agents",label:"Agents"},{key:"auth",label:"Authentication"},{key:"channels",label:"Channels"},{key:"messages",label:"Messages"},{key:"commands",label:"Commands"},{key:"hooks",label:"Hooks"},{key:"skills",label:"Skills"},{key:"tools",label:"Tools"},{key:"gateway",label:"Gateway"},{key:"wizard",label:"Setup Wizard"},{key:"user",label:"User"}],ql=new Set(["user","model"]),Hl="__all__";function Vl(e){return Oi[e]??Oi.default}function Bk(e,t){const n=zo[e];return n||{label:t?.title??tt(e),description:t?.description??""}}function Uk(e){const{key:t,schema:n,uiHints:s}=e;if(!n||qe(n)!=="object"||!n.properties)return[];const a=Object.entries(n.properties).map(([i,o])=>{const l=xe([t,i],s),c=l?.label??o.title??tt(i),u=l?.help??o.description??"",p=l?.order??50;return{key:i,label:c,description:u,order:p}});return a.sort((i,o)=>i.order!==o.order?i.order-o.order:i.key.localeCompare(o.key)),a}function zk(e,t){if(!e||!t)return[];const n=[];function s(a,i,o){if(a===i)return;if(typeof a!=typeof i){n.push({path:o,from:a,to:i});return}if(typeof a!="object"||a===null||i===null){a!==i&&n.push({path:o,from:a,to:i});return}if(Array.isArray(a)&&Array.isArray(i)){JSON.stringify(a)!==JSON.stringify(i)&&n.push({path:o,from:a,to:i});return}const l=a,c=i,u=new Set([...Object.keys(l),...Object.keys(c)]);for(const p of u)s(l[p],c[p],o?`${o}.${p}`:p)}return s(e,t,""),n}function jl(e,t=40){let n;try{n=JSON.stringify(e)??String(e)}catch{n=String(e)}return n.length<=t?n:n.slice(0,t-3)+"..."}const Gl={anthropic:"#d97706",openai:"#10b981","openai-codex":"#10b981",xai:"#6366f1"};function Kk(e){const t=[],n=e.models,s=e.agents,a=n?.providers;if(a&&typeof a=="object")for(const[o,l]of Object.entries(a)){const c=l;for(const u of c.models??[])t.push({id:`${o}/${u.id}`,name:u.name??u.id,provider:o,providerLabel:o.charAt(0).toUpperCase()+o.slice(1),reasoning:u.reasoning??!1,contextWindow:u.contextWindow??0})}const i=s?.defaults?.models;if(i&&typeof i=="object")for(const o of Object.keys(i)){if(t.some(c=>c.id===o))continue;const l=o.split("/");t.push({id:o,name:l.slice(1).join("/"),provider:l[0]??"unknown",providerLabel:(l[0]??"unknown").replace(/-/g," ").replace(/\b\w/g,c=>c.toUpperCase()),reasoning:!1,contextWindow:0})}return t}function Wk(e){return e.startsWith("anthropic/")?["openai-codex/gpt-5.3-codex"]:["anthropic/claude-sonnet-4-6"]}function qk(e){const t=e.formValue;if(!t)return r`<div class="config-loading"><span>Loading config...</span></div>`;const n=t.agents,s=n?.defaults?.model?.primary??"",a=n?.defaults?.model?.fallbacks??[],i=Kk(t),o=new Map;for(const c of i){const u=o.get(c.provider)??[];u.push(c),o.set(c.provider,u)}const l=e.saving||e.applying;return r`
            ...
            <div class="model-picker__cards">
              ${u.map(p=>{const f=p.id===s,m=Gl[p.provider]??"var(--accent)";return r`
                  <button
                    ...
                    ?disabled=${l}
                    @click=${()=>{f||!e.onModelSwitch||e.onModelSwitch(p.id,Wk(p.id))}}
                  >
  ...
  `}function Hk(e){const t=e.valid==null?"unknown":e.valid?"valid":"invalid",n=Wu(e.schema),s=n.schema?n.unsupportedPaths.length>0:!1,a=n.schema?.properties??{},i=ri.filter(R=>R.key in a&&!ql.has(R.key)),o=new Set(ri.map(R=>R.key)),l=Object.keys(a).filter(R=>!o.has(R)).map(R=>({key:R,label:R.charAt(0).toUpperCase()+R.slice(1)})),c=ri.filter(R=>ql.has(R.key)),u=[...i,...l,...c],p=e.activeSection&&n.schema&&qe(n.schema)==="object"?n.schema.properties?.[e.activeSection]:void 0,f=e.activeSection?Bk(e.activeSection,p):null,m=e.activeSection?Uk({key:e.activeSection,schema:p,uiHints:e.uiHints}):[],g=e.formMode==="form"&&!!e.activeSection&&m.length>0,w=e.activeSubsection===Hl,S=e.searchQuery||w?null:e.activeSubsection??m[0]?.key??null,T=e.formMode==="form"?zk(e.originalValue,e.formValue):[],x=e.formMode==="raw"&&e.raw!==e.originalRaw,d=e.formMode==="form"?T.length>0:x,k=!!e.formValue&&!e.loading&&!!n.schema,A=e.connected&&!e.saving&&d&&(e.formMode==="raw"?!0:k),_=e.connected&&!e.applying&&!e.updating&&d&&(e.formMode==="raw"?!0:k),L=e.connected&&!e.applying&&!e.updating;return r`
    <div class="config-layout">
      ...
      <main class="config-main">
        ...
        <div class="config-content">
          ${e.activeSection==="model"?qk(e):e.activeSection==="user"?Fk({userName:e.userName,userAvatar:e.userAvatar,onUpdate:e.onUserProfileUpdate}):e.formMode==="form"?r`
                  ${e.schemaLoading?r`
                          <div class="config-loading">
                            <div class="config-loading__spinner"></div>
                            <span>Loading schema…</span>
                          </div>
                        `:Tw({schema:n.schema,uiHints:e.uiHints,value:e.formValue,disabled:e.loading||!e.formValue,unsupportedPaths:n.unsupportedPaths,onPatch:e.onFormPatch,searchQuery:e.searchQuery,activeSection:e.activeSection,activeSubsection:S})}
                  ${s?r`
  ...
  `}function Vk(e){const t=e.host??"unknown",n=e.ip?`(${e.ip})`:"",s=e.mode??"",a=e.version??"";return`${t} ${n} ${s} ${a}`.trim()}function jk(e){const t=e.ts??null;return t?q(t):"n/a"}function Gu(e){return e?`${jn(e)} (${q(e)})`:"n/a"}function Gk(e){if(e.totalTokens==null)return"n/a";const t=e.totalTokens??0,n=e.contextTokens??0;return n?`${t} / ${n}`:String(t)}function Qk(e){if(e==null)return"";try{return JSON.stringify(e,null,2)}catch{return String(e)}}function Yk(e){const t=e.state??{},n=t.nextRunAtMs?jn(t.nextRunAtMs):"n/a",s=t.lastRunAtMs?jn(t.lastRunAtMs):"n/a";return`${t.lastStatus??"n/a"} · next ${n} · last ${s}`}function Jk(e){const t=e.schedule;return t.kind==="at"?`At ${jn(t.atMs)}`:t.kind==="every"?`Every ${ji(t.everyMs)}`:`Cron ${t.expr}${t.tz?` (${t.tz})`:""}`}function Xk(e){const t=e.payload;return t.kind==="systemEvent"?`System: ${t.text}`:`Agent: ${t.message}`}function Zk(e){const t=["last",...e.channels.filter(Boolean)],n=e.form.channel?.trim();n&&!t.includes(n)&&t.push(n);const s=new Set;return t.filter(a=>s.has(a)?!1:(s.add(a),!0))}function e$(e,t){if(t==="last")return"last";const n=e.channelMeta?.find(s=>s.id===t);return n?.label?n.label:e.channelLabels?.[t]??t}function t$(e){const t=Zk(e);return r`
    <section class="grid grid-cols-2">
      <div class="card">
  ...
  `}function n$(e){const t=e.form;return t.scheduleKind==="at"?r`
      <label class="field" style="margin-top: 12px;">
        <span>Run at</span>
        <input
          type="datetime-local"
  ...
  `}function s$(e,t){const s=`list-item list-item-clickable${t.runsJobId===e.id?" list-item-selected":""}`;return r`
    <div class=${s} @click=${()=>t.onLoadRuns(e.id)}>
      <div class="list-main">
        <div class="list-title">${e.name}</div>
        <div class="list-sub">${Jk(e)}</div>
        <div class="muted">${Xk(e)}</div>
  ...
  `}function i$(e){const n=(e.status&&typeof e.status=="object"?e.status.securityAudit:null)?.summary??null,s=n?.critical??0,a=n?.warn??0,i=n?.info??0,o=s>0?"danger":a>0?"warn":"success",l=s>0?`${s} critical`:a>0?`${a} warnings`:"No critical issues";return r`
    <section class="grid grid-cols-2">
      <div class="card">
        <div class="row" style="justify-content: space-between;">
          <div>
            ...
            <div class="list" style="margin-top: 12px;">
              ${e.eventLog.map(c=>r`
                  <div class="list-item">
                    ...
                    <div class="list-meta">
                      <pre class="code-block">${Qk(c.payload)}</pre>
                    </div>
                  </div>
                `)}
            </div>
  ...
  `}function o$(e){const t=Math.max(0,e),n=Math.floor(t/1e3);if(n<60)return`${n}s`;const s=Math.floor(n/60);return s<60?`${s}m`:`${Math.floor(s/60)}h`}function wt(e,t){return t?r`<div class="exec-approval-meta-row"><span>${e}</span><span>${t}</span></div>`:h}function r$(e){const t=e.execApprovalQueue[0];if(!t)return h;const n=t.request,s=t.expiresAtMs-Date.now(),a=s>0?`expires in ${o$(s)}`:"expired",i=e.execApprovalQueue.length;return r`
  ...
  `}function l$(e){const{pendingGatewayUrl:t}=e;return t?r`
  ...
  `}function u$(e){return new Date(e).toLocaleDateString("en-US",{weekday:"short",month:"short",day:"numeric",year:"numeric"})}function p$(e){return new Date(e).toLocaleDateString("en-US",{month:"short",day:"numeric"})}function Qu(e){return e===ne()}function h$(e){const t=new Date,n=new Date(e),s=Math.floor((t.getTime()-n.getTime())/(1e3*60*60*24));return s===0?"Today":s===1?"Yesterday":s<7?`${s} days ago`:p$(e)}function f$(e){if(!e||e.length===0)return!1;const t=ne();return e.some(n=>n.date===t)}function g$(e){return r`
  ...
  `}function v$(e,t,n,s){return e?r`
    <div class="lifetracks-player">
      <div class="player-header">
        <div class="player-info">
          <span class="player-date">${u$(e.date)}</span>
          ${Qu(e.date)?r`
  ...
  `:r`
    ...
    `}function y$(e,t,n){return!e||e.length===0?r`
    ...
    <div class="lifetracks-list">
      ${e.map(s=>{const a=t?.date===s.date,i=Qu(s.date);return r`
          <button
            ...
            @click=${()=>n?.(s)}
          >
            <span class="list-item-date">${h$(s.date)}</span>
            ${i?r`
  ...
  `}function b$(e){if(!e?.stats)return h;const{totalGenerated:t,estimatedCost:n}=e.stats;return t===0?h:r`
  ...
  `}function w$(e){if(!e.config?.enabled&&!e.loading)return g$(e.onEnable);if(e.loading)return r`
      <div class="lifetracks-container">
    ...
    `;if(!e.data||e.data.length===0)return r`
      <div class="lifetracks-container">
        ...
        ${m$(e.generating??!1,e.generationError??null,e.onGenerate)}
      </div>
    `;const t=f$(e.data);return r`
    <div class="lifetracks-container">
      <!-- Header -->
      <div class="lifetracks-header">
        <div class="lifetracks-header-left">
  ...
  `}const Ql=["trace","debug","info","warn","error","fatal"];function k$(e){if(!e)return"";const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleTimeString()}function $$(e,t){return t?[e.message,e.subsystem,e.raw].filter(Boolean).join(" ").toLowerCase().includes(t):!0}function S$(e){const t=e.filterText.trim().toLowerCase(),n=Ql.some(i=>!e.levelFilters[i]),s=e.entries.filter(i=>i.level&&!e.levelFilters[i.level]?!1:$$(i,t)),a=t||n?"filtered":"visible";return r`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
      ...
      <div class="log-stream" style="margin-top: 12px;" @scroll=${e.onScroll}>
        ${s.length===0?r`
              ...
              `:s.map(i=>r`
                <div class="log-row">
                  <div class="log-time mono">${k$(i.time)}</div>
  ...
  `}const A$=/(^~\/|^\/|^\.\.?\/|[\\/])/;function Yl(e){const t=e.trim();if(!t)return null;const n=t.replace(/^["']|["']$/g,"").trim();return!n||/^[a-z][a-z0-9+.-]*:\/\//i.test(n)||/[*?<>|]/.test(n)||n.includes("\0")||n.includes(`
`)||n.includes("\r")||!A$.test(n)&&!/\.[a-z0-9]{1,12}$/i.test(n)?null:n}function Yu(e){const t=e instanceof Element?e:e instanceof Node?e.parentElement:null;if(!t)return null;const n=t.closest("a");if(n){const a=n.getAttribute("href")??"";let i=a;if(a.includes("%"))try{i=decodeURIComponent(a)}catch{i=a}return Yl(i)}const s=t.closest("code");return!s||s.closest("pre")?null:Yl(s.textContent??"")}function T$(e){const n=new DOMParser().parseFromString(`<div>${e}</div>`,"text/html").body.firstElementChild;if(!n)return"";const a=Ke(n,{listDepth:0,orderedIndex:[]});return x$(a)}function Ni(e,t){if(e.nodeType===Node.TEXT_NODE)return e.textContent??"";if(e.nodeType!==Node.ELEMENT_NODE)return"";const n=e;switch(n.tagName.toLowerCase()){case"h1":return`# ${Ye(n,t)}
...
`)}function E$(e){const t=new Date(e),s=new Date().getTime()-t.getTime(),a=Math.floor(s/(1e3*60));if(a<1)return"Just now";if(a<60)return`${a}m ago`;const i=Math.floor(a/60);return i<24?`${i}h ago`:t.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})}function L$(e){const t="VAULT",n=encodeURIComponent(`01-Daily/${e}`);return`obsidian://open?vault=${t}&file=${n}`}let Kn=null,pn=null;function Xl(e,t,n=1500){Kn&&clearTimeout(Kn),Kn=setTimeout(()=>{e!==pn&&(pn=e,t(e))},n)}function R$(e,t){Kn&&clearTimeout(Kn),e!==pn&&(pn=e,t(e))}function li(e){for(const t of e.querySelectorAll('input[type="checkbox"]')){const n=t;n.checked?n.setAttribute("checked",""):n.removeAttribute("checked")}return T$(e.innerHTML)}function P$(e){const{data:t,loading:n,error:s,onRefresh:a,onOpenInObsidian:i,onSaveBrief:o,onToggleCheckbox:l,onOpenFile:c}=e;if(n)return r`
    ...
    `;pn===null&&(pn=t.content);const u=g=>{const w=g.currentTarget;if(o){const S=li(w);Xl(S,o)}},p=g=>{if((g.ctrlKey||g.metaKey)&&g.key==="s"){g.preventDefault();const w=g.currentTarget;if(o){const S=li(w);R$(S,o)}}if((g.ctrlKey||g.metaKey)&&g.key==="l"){g.preventDefault();const w=window.getSelection();if(!w||w.rangeCount===0)return;const S=w.focusNode,T=S instanceof HTMLElement?S.closest("li"):S?.parentElement?.closest("li");if(T){const x=T.querySelector('input[type="checkbox"]');if(x)x.nextSibling?.nodeType===Node.TEXT_NODE&&x.nextSibling.textContent===" "&&x.nextSibling.remove(),x.remove();else{const k=document.createElement("input");k.type="checkbox",T.insertBefore(document.createTextNode(" "),T.firstChild),T.insertBefore(k,T.firstChild)}const d=g.currentTarget;if(o){const k=li(d);Xl(k,o)}}}if(g.key==="Enter"&&!g.shiftKey){const w=window.getSelection();if(!w||w.rangeCount===0)return;const S=w.focusNode,T=S instanceof HTMLElement?S.closest("li"):S?.parentElement?.closest("li");T&&T.querySelector('input[type="checkbox"]')&&setTimeout(()=>{const x=window.getSelection();if(!x||x.rangeCount===0)return;const d=x.focusNode,k=d instanceof HTMLElement?d.closest("li"):d?.parentElement?.closest("li");if(k&&k!==T&&!k.querySelector('input[type="checkbox"]')){const A=document.createElement("input");A.type="checkbox",k.insertBefore(A,k.firstChild),k.insertBefore(document.createTextNode(" "),A.nextSibling);const _=document.createRange();_.setStartAfter(A.nextSibling),_.collapse(!0),x.removeAllRanges(),x.addRange(_)}},0)}},f=g=>{const w=g.target;if(w.tagName==="INPUT"&&w.getAttribute("type")==="checkbox"){const T=w,x=g.currentTarget;if(l&&x){const k=Array.from(x.querySelectorAll('input[type="checkbox"]')).indexOf(T);k>=0&&l(k,T.checked)}return}const S=Yu(g.target);S&&c&&(g.preventDefault(),c(S))},m=rg(C$(t.content));return r`
    <div class="my-day-card brief-section brief-editor">
      <div class="my-day-card-header">
        ...
        <div class="brief-header-actions">
          <span class="brief-updated">${E$(t.updatedAt)}</span>
          ${i?r`
                <a
                  href="${L$(t.date)}"
  ...
  `}function I$(e,t){return e.trim()?t.toLowerCase().includes(e.trim().toLowerCase()):!0}function tc(e,t){if(!e.trim())return t;const n=e.trim().toLowerCase();return t.filter(s=>s.name.toLowerCase().includes(n)||s.path.toLowerCase().includes(n)||s.type.toLowerCase().includes(n)||(s.searchText??"").toLowerCase().includes(n))}function nc(e,t){if(!e.trim())return t;const n=e.trim().toLowerCase();return t.filter(s=>s.title.toLowerCase().includes(n)||s.key.toLowerCase().includes(n))}function sp(e,t){if(!e.trim())return t;const n=e.trim().toLowerCase();return t.reduce((s,a)=>{if(a.type==="file")(a.name.toLowerCase().includes(n)||a.path.toLowerCase().includes(n))&&s.push(a);else{const i=sp(e,a.children??[]);i.length>0&&s.push({...a,children:i})}return s},[])}function ap(e){let t=0;for(const n of e)n.type==="file"?t++:n.children&&(t+=ap(n.children));return t}const M$=10;function D$(e){if(!e.searchText)return null;const t=e.searchText.trim();if(!t)return null;const n=t.match(/#+ (.+?)(?:\s#|$)/);return n?n[1].trim().slice(0,120):(t.startsWith("---")?t.replace(/^---.*?---\s*/s,""):t).slice(0,120)||null}function O$(e,t=M$){return[...e].sort((n,s)=>s.modified.getTime()-n.modified.getTime()).slice(0,t)}function ip(e,t,n){if(e.type==="file"){const o=n.pinnedPaths.has(e.path);return r`
      <div class="ws-folder-file-row" style="padding-left: ${12+t*16}px">
        ...
        >
          ...
          ${e.modified?r`<span class="ws-list-meta">${q(e.modified.getTime())}</span>`:h}
        </button>
        <button
      ...
      >
        ...
        <div class="workspace-card-content">
          ...
          <div class="workspace-card-meta">
            ...
            <span class="workspace-card-separator">•</span>
            <span>${q(e.lastUpdated.getTime())}</span>
          </div>
        </div>
      </button>
      ${n?r`<button
  ...
  `}function ci(e){const{workspaceId:t,entry:n,pinned:s,onOpen:a,onPinToggle:i}=e;return r`
    <div class="ws-list-row">
      <button class="ws-list-main" @click=${()=>a?.(n)}>
        ...
        <span class="ws-list-meta">${q(n.modified.getTime())}</span>
      </button>
      <button
  ...
  `}function F$(e){const{workspaceId:t,entry:n,pinned:s,onOpen:a,onPinToggle:i}=e,o=D$(n);return r`
    <div class="ws-list-row">
      <button class="ws-list-main" @click=${()=>a?.(n)}>
        <span class="ws-list-icon">${qo(n.type)}</span>
        <span class="ws-list-title">${n.name}</span>
  ...
  `}function U$(e){const{browseEntries:t,breadcrumbs:n,browseSearchQuery:s,browseSearchResults:a,onBrowseFolder:i,onBrowseSearch:o,onBrowseBack:l,onCreateFolder:c,onItemClick:u}=e,p=a??t??[];return r`
  ...
  `}function z$(e){const{workspace:t,itemSearchQuery:n,expandedFolders:s=new Set,showCompletedTasks:a=!1,onItemSearch:i,onBack:o,onItemClick:l,onSessionClick:c,onPinToggle:u,onPinSessionToggle:p,onToggleFolder:f,onToggleTaskComplete:m,onCreateTask:g,onToggleCompletedTasks:w,onStartTask:S,editingTaskId:T,onEditTask:x,onUpdateTask:d}=e,k=tc(n,t.pinned).toSorted((M,N)=>N.modified.getTime()-M.modified.getTime()),A=nc(n,t.pinnedSessions),_=tc(n,t.outputs).filter(M=>!t.pinned.some(N=>N.path===M.path)),L=(t.folderTree?.length??0)>0,R=L?sp(n,t.folderTree):[],z=nc(n,t.sessions),j=new Set(t.pinnedSessions.map(M=>M.key)),J=new Set(t.pinned.map(M=>M.path)),K=n.trim().length>0,ie=k.length>0||A.length>0,de=z.length>0||t.sessions.length===0||K,D=O$(t.outputs),B=D.length>0&&!K,U={expandedFolders:s,pinnedPaths:J,workspaceId:t.id,onToggleFolder:f,onItemClick:l,onPinToggle:u};return r`
    <div class="workspaces-container">
      ...
      <div class="workspace-content">
                    ...
                    ${A.map(M=>r`
                        <div class="ws-list-row">
                          <button class="ws-list-main" @click=${()=>c?.(M)}>
                            ...
                            <span class="ws-list-meta">${q(M.created.getTime())}</span>
                          </button>
                          <button
        ...
        ${K$({tasks:t.tasks??[],workspaceName:t.name,showCompleted:a,onToggleTaskComplete:m,onCreateTask:g,onToggleCompletedTasks:w,onStartTask:S,editingTaskId:T,onEditTask:x,onUpdateTask:d})}
        ...
        ${B?r`
              <section class="ws-section">
                ...
                <div class="ws-list">
                  ${D.map(M=>F$({workspaceId:t.id,entry:M,pinned:J.has(M.path),onOpen:l,onPinToggle:u}))}
                </div>
              </section>
            `:h}
        ...
        <section class="ws-section">
          ...
          <div class="ws-list ws-list--scroll">
            ${L?R.length===0?r`<div class="ws-empty">No artifacts</div>`:R.map(M=>ip(M,0,U)):_.length===0?r`<div class="ws-empty">No artifacts</div>`:_.map(M=>ci({workspaceId:t.id,entry:M,pinned:!1,onOpen:l,onPinToggle:u}))}
          </div>
        </section>
                    ...
                    ${z.length===0?r`
                          ...
                          `:z.map(M=>r`
                              <div class="ws-list-row">
                                ...
                                <button
                                  class="ws-pin-btn ${j.has(M.key)?"active":""}"
                                  @click=${()=>p?.(t.id,M.key,j.has(M.key))}
                                  title=${j.has(M.key)?"Unpin":"Pin"}
                                >
                                  ${j.has(M.key)?"Unpin":"Pin"}
                                </button>
                              </div>
                            `)}
                  </div>
        ...
        ${(t.memory?.length??0)>0?r`
              <section class="ws-section">
                ...
                <div class="ws-list ws-list--scroll">
                  ${t.memory.map(M=>ci({workspaceId:t.id,entry:M,pinned:J.has(M.path),onOpen:l,onPinToggle:u}))}
                </div>
              </section>
            `:h}
      </div>
    </div>
  `}function K$(e){const{tasks:t,workspaceName:n,showCompleted:s,onToggleTaskComplete:a,onCreateTask:i,onToggleCompletedTasks:o,onStartTask:l,editingTaskId:c,onEditTask:u,onUpdateTask:p}=e,f=ta(t.filter(g=>g.status==="pending")),m=ta(t.filter(g=>g.status==="complete"));return r`
    <section class="ws-section">
      <div class="ws-section__header">
        <h3>Tasks</h3>
  ...
  `}function W$(e){const{connected:t,workspaces:n,selectedWorkspace:s,searchQuery:a,itemSearchQuery:i,expandedFolders:o,loading:l,createLoading:c,error:u,allTasks:p=[],taskFilter:f="outstanding",taskSort:m="due",showCompletedTasks:g=!1,editingTaskId:w,workspaceNames:S=[],onSearch:T,onItemSearch:x,onSelectWorkspace:d,onBack:k,onItemClick:A,onSessionClick:_,onPinToggle:L,onPinSessionToggle:R,onCreateWorkspace:z,onDeleteWorkspace:j,onToggleFolder:J,onTeamSetup:K,onToggleTaskComplete:ie,onCreateTask:de,onSetTaskFilter:D,onSetTaskSort:B,onToggleCompletedTasks:U,onStartTask:M,onEditTask:N,onUpdateTask:Oe}=e,Se=n.filter(F=>I$(a,`${F.name} ${F.path} ${F.type}`));return s?z$({workspace:s,itemSearchQuery:i??"",expandedFolders:o,showCompletedTasks:g,onItemSearch:x,onBack:k,onItemClick:A,onSessionClick:_,onPinToggle:L,onPinSessionToggle:R,onToggleFolder:J,onToggleTaskComplete:ie,onCreateTask:de,onToggleCompletedTasks:U,onStartTask:M,editingTaskId:w,onEditTask:N,onUpdateTask:Oe,browsePath:e.browsePath,browseEntries:e.browseEntries,breadcrumbs:e.breadcrumbs,browseSearchQuery:e.browseSearchQuery,browseSearchResults:e.browseSearchResults,onBrowseFolder:e.onBrowseFolder,onBrowseSearch:e.onBrowseSearch,onBrowseBack:e.onBrowseBack,onCreateFolder:e.onCreateFolder}):r`
    <div class="workspaces-container">
      <div class="workspaces-toolbar">
        <form
            class="workspaces-create-form"
            @submit=${async F=>{if(F.preventDefault(),c||!z)return;const vn=F.currentTarget,X=new FormData(vn),yn=X.get("name"),Q=(typeof yn=="string"?yn:"").trim();if(!Q)return;const st=X.get("type"),ft=(typeof st=="string"?st:"project").trim().toLowerCase(),at=ft==="team"||ft==="personal"?ft:"project",bn=X.get("path"),Kt=(typeof bn=="string"?bn:"").trim();await z({name:Q,type:at,...Kt?{path:Kt}:{}})!==!1&&vn.reset()}}
          >
            <input
              type="text"
              name="name"
          ...
          ${K?r`<button class="ws-team-setup-btn" @click=${()=>K()}>Team Setup</button>`:h}
      </div>
      ...
      ${l?r`
            ...
            `:r`
              <div class="workspaces-body">
                ...
                ${q$({tasks:p,taskFilter:f,taskSort:m,onToggleTaskComplete:ie,onSetTaskFilter:D,onSetTaskSort:B,onCreateTask:de,workspaceNames:S,onStartTask:M,editingTaskId:w,onEditTask:N,onUpdateTask:Oe})}
              </div>
            `}
    </div>
  `}function q$(e){const{tasks:t,taskFilter:n,taskSort:s="due",onToggleTaskComplete:a,onSetTaskFilter:i,onSetTaskSort:o,onCreateTask:l,workspaceNames:c=[],onStartTask:u,editingTaskId:p,onEditTask:f,onUpdateTask:m}=e;if(t.length===0&&!l)return r``;let g;if(n==="outstanding")g=t.filter(S=>S.status==="pending");else if(n==="today"){const S=ne();g=t.filter(T=>T.status==="pending"&&T.dueDate!=null&&T.dueDate<=S)}else n==="complete"?g=t.filter(S=>S.status==="complete"):g=t;const w=ta(g,s);return r`
    <div class="ws-all-tasks-section">
      <section class="ws-section">
        ...
        ${l?r`
              <form
                class="ws-task-create-form"
                @submit=${S=>{S.preventDefault();const T=S.currentTarget,x=T.querySelector(".ws-task-create-input"),d=T.querySelector(".ws-task-create-project"),k=x.value.trim();if(!k)return;const A=d?.value||c[0]||"";l(k,A),x.value=""}}
              >
                <input
                  type="text"
                  class="ws-task-create-input"
            ...
            `:h}
        <div class="ws-list ws-list--scroll">
          ${w.length===0?r`<div class="ws-empty">No tasks</div>`:w.map(S=>Fi(S,a,u,p,f,m))}
        </div>
      </section>
    </div>
  `}function H$(e){return e===ne()}function op(e){const t=new Date(e+"T12:00:00");return V$(t)}function V$(e){const t=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],n=["January","February","March","April","May","June","July","August","September","October","November","December"],s=t[e.getDay()],a=n[e.getMonth()],i=e.getDate();return`${s}, ${a} ${i}`}function j$(e){if(!e)return"";const t=new Date(e);if(Number.isNaN(t.getTime()))return"";const s=new Date().getTime()-t.getTime(),a=Math.floor(s/(1e3*60));if(a<1)return"Just now";if(a<60)return`${a}m ago`;const i=Math.floor(a/60);return i<24?`${i}h ago`:t.toLocaleString()}function G$(e){if(!e)return"";const t=e.split("/");return t[t.length-1]||e}function Q$(e,t,n){const s=a=>{if(!e.onOpenFile)return;const i=Yu(a.target);i&&(a.preventDefault(),e.onOpenFile(i))};return r`
    <div class="my-day-card agent-log-section brief-editor">
      <div class="my-day-card-header">
        ...
        <div class="agent-log-header-actions">
          ${t?.updatedAt?r`<span class="brief-updated">${j$(t.updatedAt)}</span>`:h}
  ...
  `}function J$(e){const t=ta(e.todayTasks??[],"due"),n=t.filter(a=>a.status==="pending"),s=t.filter(a=>a.status==="complete");return r`
    <div class="my-day-card today-tasks-panel">
      ...
      <div class="my-day-card-content">
        ${e.todayTasksLoading?r`<div class="brief-loading"><div class="spinner"></div><span>Loading tasks...</span></div>`:r`
              ${e.onCreateTask?Y$(e.onCreateTask):h}
  ...
  `}function X$(e,t){const n=e.status==="review";return r`
  ...
  `}function Z$(e){if(!e.items.length)return h;const t=e.items.length>3;return r`
  ...
  `}function e0(e){const t=ne(),n=e.selectedDate??t,s=H$(n),a=op(n),i=e.viewMode??"my-day";return r`
  ...
  `}function t0(e){const t=ne(),n=e.selectedDate??t,s=e.viewMode??"my-day",a=e.agentLog??null;if(e.loading)return r`
    ...
    <div class="my-day-container">
      ${e.decisionCards&&e.decisionCards.items.length>0?Z$(e.decisionCards):h}
      ...
      <div class="my-day-columns">
        ...
        <div class="my-day-brief-col">
          ${s==="my-day"?P$(i):Q$(e,a,op(n))}
        </div>
      </div>
    </div>
  `}function n0(e){const t=l0(e),n=f0(e);return r`
    ${m0(n)}
    ${g0(t)}
    ${s0(e)}
    <section class="card">
  ...
  `}function s0(e){const t=e.devicesList??{pending:[],paired:[]},n=Array.isArray(t.pending)?t.pending:[],s=Array.isArray(t.paired)?t.paired:[];return r`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
  ...
  `}function a0(e,t){const n=e.displayName?.trim()||e.deviceId,s=typeof e.ts=="number"?q(e.ts):"n/a",a=e.role?.trim()?`role: ${e.role}`:"role: -",i=e.isRepair?" · repair":"",o=e.remoteIp?` · ${e.remoteIp}`:"";return r`
    <div class="list-item">
      <div class="list-main">
  ...
  `}function i0(e,t){const n=e.displayName?.trim()||e.deviceId,s=e.remoteIp?` · ${e.remoteIp}`:"",a=`roles: ${hi(e.roles)}`,i=`scopes: ${hi(e.scopes)}`,o=Array.isArray(e.tokens)?e.tokens:[];return r`
    <div class="list-item">
      <div class="list-main">
        <div class="list-title">${n}</div>
        ...
        ${o.length===0?r`
              ...
              <div style="display: flex; flex-direction: column; gap: 8px; margin-top: 6px;">
                ${o.map(l=>o0(e.deviceId,l,t))}
              </div>
            `}
      </div>
    </div>
  `}function o0(e,t,n){const s=t.revokedAtMs?"revoked":"active",a=`scopes: ${hi(t.scopes)}`,i=q(t.rotatedAtMs??t.createdAtMs??t.lastUsedAtMs??null);return r`
  ...
  `}const dt="__defaults__",sc=[{value:"deny",label:"Deny"},{value:"allowlist",label:"Allowlist"},{value:"full",label:"Full"}],r0=[{value:"off",label:"Off"},{value:"on-miss",label:"On miss"},{value:"always",label:"Always"}];function l0(e){const t=e.configForm,n=S0(e.nodes),{defaultBinding:s,agents:a}=T0(t),i=!!t,o=e.configSaving||e.configFormMode==="raw";return{ready:i,disabled:o,configDirty:e.configDirty,configLoading:e.configLoading,configSaving:e.configSaving,defaultBinding:s,agents:a,nodes:n,onBindDefault:e.onBindDefault,onBindAgent:e.onBindAgent,onSave:e.onSaveBindings,onLoadConfig:e.onLoadConfig,formMode:e.configFormMode}}function ac(e){return e==="allowlist"||e==="full"||e==="deny"?e:"deny"}function c0(e){return e==="always"||e==="off"||e==="on-miss"?e:"on-miss"}function d0(e){const t=e?.defaults??{};return{security:ac(t.security),ask:c0(t.ask),askFallback:ac(t.askFallback??"deny"),autoAllowSkills:!!(t.autoAllowSkills??!1)}}function u0(e){const t=e?.agents??{},n=Array.isArray(t.list)?t.list:[],s=[];return n.forEach(a=>{if(!a||typeof a!="object")return;const i=a,o=typeof i.id=="string"?i.id.trim():"";if(!o)return;const l=typeof i.name=="string"?i.name.trim():void 0,c=i.default===!0;s.push({id:o,name:l||void 0,isDefault:c})}),s}function p0(e,t){const n=u0(e),s=Object.keys(t?.agents??{}),a=new Map;n.forEach(o=>a.set(o.id,o)),s.forEach(o=>{a.has(o)||a.set(o,{id:o})});const i=Array.from(a.values());return i.length===0&&i.push({id:"main",isDefault:!0}),i.sort((o,l)=>{if(o.isDefault&&!l.isDefault)return-1;if(!o.isDefault&&l.isDefault)return 1;const c=o.name?.trim()?o.name:o.id,u=l.name?.trim()?l.name:l.id;return c.localeCompare(u)}),i}function h0(e,t){return e===dt?dt:e&&t.some(n=>n.id===e)?e:dt}function f0(e){const t=e.execApprovalsForm??e.execApprovalsSnapshot?.file??null,n=!!t,s=d0(t),a=p0(e.configForm,t),i=A0(e.nodes),o=e.execApprovalsTarget;let l=o==="node"&&e.execApprovalsTargetNodeId?e.execApprovalsTargetNodeId:null;o==="node"&&l&&!i.some(f=>f.id===l)&&(l=null);const c=h0(e.execApprovalsSelectedAgent,a),u=c!==dt?(t?.agents??{})[c]??null:null,p=Array.isArray(u?.allowlist)?u.allowlist??[]:[];return{ready:n,disabled:e.execApprovalsSaving||e.execApprovalsLoading,dirty:e.execApprovalsDirty,loading:e.execApprovalsLoading,saving:e.execApprovalsSaving,form:t,defaults:s,selectedScope:c,selectedAgent:u,agents:a,allowlist:p,target:o,targetNodeId:l,targetNodes:i,onSelectScope:e.onExecApprovalsSelectAgent,onSelectTarget:e.onExecApprovalsTargetChange,onPatch:e.onExecApprovalsPatch,onRemove:e.onExecApprovalsRemove,onLoad:e.onLoadExecApprovals,onSave:e.onSaveExecApprovals}}function g0(e){const t=e.nodes.length>0,n=e.defaultBinding??"";return r`
    <section class="card">
  ...
  `}function m0(e){const t=e.ready,n=e.target!=="node"||!!e.targetNodeId;return r`
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        <div>
  ...
  `}function v0(e){const t=e.targetNodes.length>0,n=e.targetNodeId??"";return r`
    <div class="list" style="margin-top: 12px;">
      <div class="list-item">
        <div class="list-main">
  ...
  `}function w0(e){const t=["agents",e.selectedScope,"allowlist"],n=e.allowlist;return r`
  ...
  `}function k0(e,t,n){const s=t.lastUsedAt?q(t.lastUsedAt):"never",a=t.lastUsedCommand?Gn(t.lastUsedCommand,120):null,i=t.lastResolvedPath?Gn(t.lastResolvedPath,120):null;return r`
    <div class="list-item">
      <div class="list-main">
  ...
  `}function $0(e,t){const n=e.binding??"__default__",s=e.name?.trim()?`${e.name} (${e.id})`:e.id,a=t.nodes.length>0;return r`
    <div class="list-item">
      <div class="list-main">
      ...
      <div class="card">
        ...
        <div class="stat-grid" style="margin-top: 16px;">
          ...
          <div class="stat">
            ...
            <div class="stat-value">
              ${e.updateLastChecked?q(e.updateLastChecked):"Never"}
            </div>
          </div>
        </div>
        <div class="row" style="margin-top: 14px;">
  ...
  `}const C0=["","off","minimal","low","medium","high"],E0=["","off","on"],L0=[{value:"",label:"inherit"},{value:"off",label:"off (explicit)"},{value:"on",label:"on"}],R0=["","off","on","stream"];function P0(e){if(!e)return"";const t=e.trim().toLowerCase();return t==="z.ai"||t==="z-ai"?"zai":t}function rp(e){return P0(e)==="zai"}function I0(e){return rp(e)?E0:C0}function M0(e,t){return!t||!e||e==="off"?e:"on"}function D0(e,t){return e?t&&e==="on"?"low":e:null}function O0(e){switch(e){case"idle-7d":return"Idle > 7 days";case"task-complete":return"Task completed";case"manual":return"Manual";default:return e}}function N0(){return r`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  </svg>`}function B0(e){return r`<svg
    width="12" height="12" viewBox="0 0 24 24" fill="none"
    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
    style="transition: transform 150ms ease; transform: rotate(${e?"90deg":"0deg"});"
  >
    <polyline points="9 18 15 12 9 6"/>
  </svg>`}function U0(e){const t=e.result?.sessions??[],n=new Set(e.archivedSessions.map(i=>i.sessionKey)),s=t.filter(i=>!n.has(i.key)),a=e.archivedSessions.length;return r`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
    ...
    ${z0(e,a)}
  `}function z0(e,t){return t===0&&!e.archivedSessionsLoading?h:r`
    <section class="card archived-section">
      ...
      ${e.archivedSessionsExpanded?r`
              <div class="archived-table" style="margin-top: 12px;">
                ...
                ${e.archivedSessionsLoading?r`<div class="muted" style="padding: 12px;">Loading...</div>`:e.archivedSessions.length===0?r`<div class="muted" style="padding: 12px;">No archived sessions.</div>`:e.archivedSessions.map(n=>W0(n,e.onUnarchive,e.loading))}
              </div>
            `:h}
    </section>
  `}function K0(e,t,n,s,a,i){const o=e.updatedAt?q(e.updatedAt):"n/a",l=e.thinkingLevel??"",c=rp(e.modelProvider),u=M0(l,c),p=I0(e.modelProvider),f=e.verboseLevel??"",m=e.reasoningLevel??"",g=e.displayName??e.key,w=e.kind!=="global",S=w?`${uo("chat",t)}?session=${encodeURIComponent(e.key)}`:null;return r`
    <div class="table-row">
      ...
      <div>
        <input
          ...
          @change=${T=>{const x=T.target.value.trim();n(e.key,{label:x||null})}}
        />
      </div>
      <div>${e.kind}</div>
      <div>${o}</div>
      ...
      <div>
        <select
          .value=${u}
          ?disabled=${i}
          @change=${T=>{const x=T.target.value;n(e.key,{thinkingLevel:D0(x,c)})}}
        >
      ...
      <div>
        <select
          .value=${f}
          ?disabled=${i}
          @change=${T=>{const x=T.target.value;n(e.key,{verboseLevel:x||null})}}
        >
          ${L0.map(T=>r`<option value=${T.value}>${T.label}</option>`)}
        </select>
      </div>
      <div>
        <select
          .value=${m}
          ?disabled=${i}
          @change=${T=>{const x=T.target.value;n(e.key,{reasoningLevel:x||null})}}
        >
          ${R0.map(T=>r`<option value=${T}>${T||"inherit"}</option>`)}
        </select>
      </div>
  ...
  `}function W0(e,t,n){const s=q(Date.parse(e.archivedAt));return r`
  ...
  `}const q0=[{key:"trending",label:"Trending"},{key:"updated",label:"Newest"},{key:"stars",label:"Top Rated"},{key:"downloads",label:"Popular"}];function H0(e){return r`
  ...
  `}function j0(e){return e.results&&e.query.trim()?r`
      <div>
    ...
    <div>
      ...
      ${e.exploreItems&&e.exploreItems.length>0?r`<div class="list">
            ${e.exploreItems.map(t=>Q0(t,e))}
          </div>`:e.loading?h:r`<div class="muted">No skills found.</div>`}
    </div>
  `}function G0(e,t){const n=e.slug??"unknown",s=e.displayName??n,a=t.importing===n;return r`
    <div class="list-item">
      <div class="list-main">
        <div class="list-title">${s}</div>
  ...
  `}function Q0(e,t){const n=t.importing===e.slug,s=J0(e.updatedAt);return r`
    <div class="list-item">
      <div class="list-main">
  ...
  `}function Y0(e){const t=e.detail,n=e.detailSlug??"",s=e.importing===n;if(e.loading&&!t)return r`<div class="muted">Loading skill details...</div>`;if(!t||!t.skill)return r`
      <div>
  ...
  `}function di(e){return e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e)}function Ho(e){if(!e)return h;const t=[];return typeof e.stars=="number"&&e.stars>0&&t.push(r`<span class="chip" title="Stars">\u2605 ${di(e.stars)}</span>`),typeof e.downloads=="number"&&e.downloads>0&&t.push(r`<span class="chip" title="Downloads">\u2193 ${di(e.downloads)}</span>`),typeof e.installsCurrent=="number"&&e.installsCurrent>0&&t.push(r`<span class="chip" title="Active installs">\u2713 ${di(e.installsCurrent)}</span>`),t}function J0(e){const t=Date.now()-e,n=Math.floor(t/1e3),s=Math.floor(n/60),a=Math.floor(s/60),i=Math.floor(a/24);return i>30?`${Math.floor(i/30)}mo ago`:i>0?`${i}d ago`:a>0?`${a}h ago`:s>0?`${s}m ago`:"just now"}function X0(e){return r`
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
      ...
      ${e.subTab==="clawhub"?r`<div style="margin-top: 16px;">${H0(e.clawhub)}</div>`:h}
    </section>
  ...
  `}function lp(){return{open:!1,images:[],currentIndex:0}}function tS(e,t,n){return{open:!0,images:t,currentIndex:n}}function nS(){return lp()}function sS(e,t){const n=e.currentIndex+t;return n<0||n>=e.images.length?e:{...e,currentIndex:n}}const aS=r`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>`,iS=r`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>`,oS=r`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 6 15 12 9 18"/></svg>`;function rS(e,t){if(!e.open||e.images.length===0)return h;const n=e.images[e.currentIndex];if(!n)return h;const s=e.images.length>1,a=e.currentIndex>0,i=e.currentIndex<e.images.length-1;return r`
    <div
    ...
    >
      ...
      ${s&&a?r`<button class="lightbox-nav lightbox-nav--prev" @click=${()=>t.onNav(-1)} aria-label="Previous image">${iS}</button>`:h}
      ...
      ${s&&i?r`<button class="lightbox-nav lightbox-nav--next" @click=${()=>t.onNav(1)} aria-label="Next image">${oS}</button>`:h}

      ${s?r`<div class="lightbox-counter">${e.currentIndex+1} / ${e.images.length}</div>`:h}
    </div>
  `}const lS=e=>{switch(e){case"success":return r`
        <svg
          width="16"
          height="16"
          viewBox="0 0 16 16"
      ...
      `}};function cS({toasts:e,onDismiss:t}){return e.length===0?null:r`
    <div class="toast-container">
      ${ba(e,n=>n.id,n=>r`
          <div class="toast toast--${n.type}">
            <div class="toast__icon">${lS(n.type)}</div>
  ...
  `}const ic={launch:"🚀",milestone:"🎉",health:"💪",systems:"⚙️",default:"🎯"},dS={health:"Health",wealth:"Wealth",career:"Career",relationships:"Relationships",fun:"Fun",environment:"Environment",growth:"Growth",contribution:"Contribution"};function uS(e){const t=new Date(e),n=new Date,s=t.getFullYear()-n.getFullYear();return s<=0?"This year":s===1?"Next year":`${s} years`}function cp(e){return`${Math.round(e*100)}%`}function pS(e){return ic[e]||ic.default}function hS(e){const t=e.progress*100;return r`
    <div class="vision-cda-section">
      ...
      <div class="vision-cda-meta">
        <div class="vision-cda-deadline">
          ...
          <span class="meta-label">(${uS(e.deadline)})</span>
        </div>
  ...
  `:null}function gS(e){return!e||e.length===0?r`
        ...
        ${e.map(t=>{const n=t.progress*100;return r`
            <div class="vision-theme-card">
              <div class="theme-card-header">
                <span class="theme-icon">${pS(t.id)}</span>
              ...
              ${t.wheelSpokes&&t.wheelSpokes.length>0?r`
                    <div class="theme-spokes">
                      ${t.wheelSpokes.map(s=>r`
                          <span class="theme-spoke-badge">${dS[s]||s}</span>
                        `)}
                    </div>
                  `:null}
  ...
  `}function mS(e){return!e||e.length===0?null:r`
  ...
  `}function vS(e){return!e||e.length===0?null:r`
  ...
  `}function yS(e){if(e.loading)return r`
    ...
    <div class="vision-container">
      ...
      <div class="vision-bottom-grid">
        ${mS(t.values)} ${vS(t.antiGoals)}
      </div>
    </div>
  `}const ot=["health","wealth","career","relationships","fun","environment","growth","contribution"],Ms={health:"Health",wealth:"Wealth",career:"Career",relationships:"Relationships",fun:"Fun",environment:"Environment",growth:"Growth",contribution:"Contribution"},dp={health:"💪",wealth:"💰",career:"🚀",relationships:"❤️",fun:"🎉",environment:"🏠",growth:"📚",contribution:"🤝"};function bS(e){return new Date(e).toLocaleDateString("en-US",{weekday:"long",year:"numeric",month:"long",day:"numeric"})}function wS(e){switch(e){case"up":return"↑";case"down":return"↓";case"stable":return"→"}}function kS(e){switch(e){case"up":return"trend-up";case"down":return"trend-down";case"stable":return"trend-stable"}}function $S(e){return e<=4?"score-low":e<=6?"score-medium":"score-high"}function SS(e){const a=2*Math.PI/ot.length,i=ot.map((l,c)=>{const u=c*a-Math.PI/2,p=(e[l]?.current??5)/10,f=150+Math.cos(u)*120*p,m=150+Math.sin(u)*120*p;return`${f},${m}`}).join(" "),o=ot.map((l,c)=>{const u=c*a-Math.PI/2,p=(e[l]?.target??8)/10,f=150+Math.cos(u)*120*p,m=150+Math.sin(u)*120*p;return`${f},${m}`}).join(" ");return r`
  ...
  `}function TS(e){if(e.loading)return r`
    ...
    <div class="wheel-container">
      ...
      <!-- Date badge -->
      <div class="wheel-date-badge">As of ${bS(t.asOf)}</div>
      ...
      <div class="wheel-content">
        <!-- Radar chart -->
        <div class="wheel-chart-section">${SS(t.scores)}</div>
  ...
  `}const oc=[{key:"focusPulse.enabled",icon:"☀️",name:"Focus Pulse",description:"Morning priority ritual + persistent focus widget in the topbar. Silent 30-min pulse checks compare your activity against your plan.",default:!0}];function _S(e,t){return r`
    <button
  ...
  `}function RS(e){if(e>=lc.length)return r`${h}`;const t=lc[e];return r`
    <div class="wizard-step-header">
      <h2 class="wizard-question">${t.question}</h2>
    </div>
  `}function PS(e,t,n,s){return r`
  ...
  `}function MS(e,t){const n=Intl.DateTimeFormat().resolvedOptions().timeZone;return r`
    <div class="wizard-field">
  ...
  `}function DS(e,t){function n(a){t.onAnswerChange("focus",a.target.value)}function s(a){a.key==="Enter"&&(a.preventDefault(),t.onStepChange(3))}return r`
    <div class="wizard-field">
      <input
        type="text"
        class="wizard-input"
  ...
  `}function FS(e,t){const n=e.hardRules.length>0?e.hardRules:[];function s(o){n.includes(o)?t.onAnswerChange("hardRules",n.filter(l=>l!==o)):t.onAnswerChange("hardRules",[...n,o])}function a(){const o=document.querySelector(".wizard-rule-input");if(!o)return;const l=o.value.trim();l&&(t.onAnswerChange("hardRules",[...n,l]),o.value="",o.focus())}function i(o){o.key==="Enter"&&(o.preventDefault(),o.target.value.trim()&&a())}return r`
    <div class="wizard-field">
  ...
  `}function zS(e,t){const{answers:n,preview:s,generating:a}=e;return r`
  ...
  `:r`${h}`}function pp(){return{name:"",timezone:Intl.DateTimeFormat().resolvedOptions().timeZone,focus:"",projects:[],commStyle:"Direct and concise -- no fluff, just answers",hardRules:[],keyPeople:[],defaultModel:"sonnet"}}function WS(){return{step:0,answers:pp(),preview:null,generating:!1,result:null,error:null}}function hp(e,t){const{step:n,answers:s}=e;if(n===9)return r`
  ...
  `}const qS=Object.freeze(Object.defineProperty({__proto__:null,emptyWizardAnswers:pp,emptyWizardState:WS,renderOnboardingWizard:hp},Symbol.toStringTag,{value:"Module"}));function gn(e){return e===null?"none":e>=8?"high":e>=5?"medium":"low"}function ls(e){return{high:"trust-score--high",medium:"trust-score--medium",low:"trust-score--low",none:"trust-score--none"}[e]}function HS(e){return{improving:"Improving",declining:"Declining",stable:"Stable",new:"New"}[e]??"New"}function VS(e){return{improving:"trust-trend--up",declining:"trust-trend--down",stable:"trust-trend--stable",new:"trust-trend--new"}[e]??"trust-trend--new"}function jS(e){return{improving:"↑",declining:"↓",stable:"→",new:"•"}[e]??"•"}function GS(e){const t=Date.now()-Date.parse(e),n=Math.floor(t/6e4);if(n<1)return"just now";if(n<60)return`${n}m ago`;const s=Math.floor(n/60);if(s<24)return`${s}h ago`;const a=Math.floor(s/24);return a<7?`${a}d ago`:new Date(e).toLocaleDateString()}function QS(e){const t=e.overallScore,n=gn(t);return r`
  ...
  `}function YS(e,t){const s=Math.min(100,Math.max(0,(e??t)/10*100)),a=gn(e??(t>0?t:null));return r`
  ...
  `}function JS(e,t){const s=e.trustScore!==null?e.trustScore.toFixed(1):e.avgRating>0?e.avgRating.toFixed(1):"--",a=gn(e.trustScore??(e.avgRating>0?e.avgRating:null)),i=e.count<10?10-e.count:0;return r`
  ...
  `}function a1(e){return e<=4?"trust-daily-button--low":e<=7?"trust-daily-button--med":"trust-daily-button--high"}function dc(e){const t=[];for(let n=0;n<7;n++)t.push(e[n]??null);return r`
  ...
  `}function i1(e){const t=e.data,n=t?.todayRating??null,s=t?.recentDaily??[],a=t?.dailyStreak??0,i=t?.dailyAverage??null;if(!e.onDailyRate)return h;if(n){const o=gn(n.rating),l=n.rating<7&&!n.note;return r`
  ...
  `}function p1(e){const t=Date.now()-Date.parse(e),n=Math.floor(t/6e4);if(n<1)return"just now";if(n<60)return`${n}m ago`;const s=Math.floor(n/60);if(s<24)return`${s}h ago`;const a=Math.floor(s/24);return a<7?`${a}d ago`:new Date(e).toLocaleDateString()}function h1(e){return{fired:"guardrails-badge--fired",blocked:"guardrails-badge--blocked",cleaned:"guardrails-badge--cleaned"}[e]??""}function fp(e,t){return r`
    <button
      class="options-toggle ${e?"options-toggle--on":""}"
      role="switch"
      aria-checked="${e}"
  ...
  `}function y1(e){const{connected:t,loading:n,data:s,onToggle:a,onThresholdChange:i,onCustomToggle:o,onCustomDelete:l,onToggleAddForm:c,onOpenAllyChat:u}=e;if(!t)return r`
    ...
    `;const p=s?.gates??[],f=s?.activity??[],m=s?.custom??[],g=p.filter(T=>T.enabled).length,w=m.filter(T=>T.enabled).length,S=[`${g}/${p.length} gates active`];return m.length>0&&S.push(`${w} custom rule${m.length===1?"":"s"}`),r`
    <section class="tab-body guardrails-section">
  ...
  `}const b1={coding:"Builder",research:"Researcher",analysis:"Analyst",creative:"Creative",review:"Reviewer",ops:"Ops",task:"Agent",url:"Reader",idea:"Explorer"};function w1(e){const t=Date.now()-e,n=Math.floor(t/6e4);if(n<1)return"just now";if(n<60)return`${n}m ago`;const s=Math.floor(n/60);return s<24?`${s}h ago`:`${Math.floor(s/24)}d ago`}function k1(e){switch(e){case"started":return"▶️";case"completed":return"✅";case"failed":return"❌";case"queued":return"⏳";case"stage":return"🔄";default:return"📋"}}function $1(e){switch(e){case"coding":return"mc-type-badge mc-type-badge--coding";case"subagent":return"mc-type-badge mc-type-badge--subagent";case"swarm":return"mc-type-badge mc-type-badge--swarm";case"queue":return"mc-type-badge mc-type-badge--queue";default:return"mc-type-badge"}}function S1(e){return`mc-agent-card mc-agent-card--${e}`}function A1(e){return r`
  ...
  `}function T1(e){return e.swarmStages?r`
  ...
  `}function _1(e,t){const n=e.filter(s=>s.status==="active"||s.status==="queued");return n.length===0?r`
      <div class="mc-empty">
        No active agents
  ...
  `}function x1(e,t,n,s){const a=e.filter(i=>i.isReview===!0);return a.length===0?h:r`
  ...
  `}function C1(e,t){const n=e.filter(s=>s.status==="pending");return n.length===0?h:r`
    <div style="margin-bottom: 1.5rem">
  ...
  `}function E1(e,t){const n=(e.type==="failed"||e.type==="completed")&&e.agentRef;return r`
    <div class="mc-feed-item ${n?"mc-feed-item--clickable":""}"
         @click=${n?()=>t?.(e.agentRef):h}>
      <span class="mc-feed-time">${w1(e.timestamp)}</span>
      <span class="mc-feed-icon">${k1(e.type)}</span>
      <span class="mc-feed-text">${e.summary}</span>
      ${e.prUrl&&!n?r`<a class="mc-feed-link" href="${e.prUrl}" target="_blank">View PR</a>`:h}
    </div>
  `}function L1(e,t,n){if(e.length===0)return h;const s=e.slice(0,20),a=e.length>20;return r`
    <div class="mc-feed">
  ...
  `}function R1(e,t){const s=e.filter(i=>i.status==="done"||i.status==="failed").filter(i=>!i.isReview);if(s.length===0)return h;const a=s.slice(0,10);return r`
    <div style="margin-bottom: 1.5rem">
  ...
  `}function P1(e){if(!e.connected)return r`<div class="mc-section"><div class="mc-empty">Not connected to gateway.</div></div>`;if(e.loading&&!e.data)return r`<div class="mc-section"><div class="mc-loading">Loading agent data...</div></div>`;if(e.error&&!e.data)return r`
    ...
    <div class="mc-section">
      ...
      <div class="mc-two-col">
        <div class="mc-col-main">
          ...
          ${x1(t.agents,e.onApproveItem,e.onViewDetail,e.onOpenTaskSession)}

          ${C1(t.queueItems,e.onStartQueueItem)}
  ...
  `}function I1(e,t){if(e?.label)return e.label;if(e?.displayName)return e.displayName;const n=_e.get(t);if(n)return n;if(t.includes("webchat")){const a=t.match(/webchat[:-](\d+)/);return a?`Chat ${a[1]}`:"Chat"}if(t.includes("main"))return"MAIN";const s=t.split(/[:-]/);return s[s.length-1]||t}function M1(e){return e?e>=1e3?`${(e/1e3).toFixed(1)}k`:String(e):"0"}function D1(e){const t=e,n=String(t.role??"");if(n!=="user"&&n!=="assistant")return h;const s=typeof t.content=="string"?t.content:Array.isArray(t.content)?t.content.filter(i=>i.type==="text").map(i=>String(i.text??"")).join(" "):"";if(!s.trim())return h;const a=s.slice(0,300);return r`
  ...
  `}function N1(e,t,n){const{state:s,onAssignLane:a,onSendInLane:i}=n,o=s.sessionsResult?.sessions??[],l=Me(o,t),c=l?.key??t,u=s.workingSessions.has(t)||s.workingSessions.has(c),p=I1(l,t),f=Hs.get(t)??Hs.get(c),m=l?.model??"",g=l?.totalTokens??0,w=s.settings.tabLastViewed[c]??s.settings.tabLastViewed[t]??0,S=l?.updatedAt??0,T=!u&&S>w,d=t===s.sessionKey?s.chatMessages:We.get(t)??We.get(c)??[],k=A=>{A instanceof HTMLElement&&A.dispatchEvent(new CustomEvent("lane-viewed",{detail:{sessionKey:c},bubbles:!0,composed:!0}))};return r`
    <div
      ...
      @drop=${A=>{A.preventDefault(),A.currentTarget.classList.remove("parallel-col--dragover");const _=A.dataTransfer?.getData("text/lane-index");if(_!=null&&_!==""){const R=Number.parseInt(_,10);if(!Number.isNaN(R)){A.currentTarget.dispatchEvent(new CustomEvent("lane-reorder",{detail:{fromIndex:R,toIndex:e},bubbles:!0,composed:!0}));return}}const L=A.dataTransfer?.getData("text/session-key");L&&A.currentTarget.dispatchEvent(new CustomEvent("lane-drop",{detail:{laneIndex:e,sessionKey:L},bubbles:!0,composed:!0}))}}
      data-lane-index="${e}"
    >
      <!-- Header -->
      <div
      ...
      >
        ...
        <div class="parallel-col__meta">
          ...
          <span class="parallel-col__tokens">${M1(g)} tokens</span>
        </div>
      </div>

      <!-- Messages -->
      <div class="parallel-col__messages">
        ${d.length>0?d.slice(-120).map(D1):r`<div class="parallel-col__empty">No messages yet</div>`}
      </div>
      ...
      <div class="parallel-col__compose">
        <input
          ...
          draggable="false"
          placeholder="Message..."
          @keydown=${A=>{if(A.key==="Enter"&&!A.shiftKey){A.preventDefault();const _=A.target,L=_.value.trim();L&&(i(t,L),_.value="")}}}
        />
      </div>
    </div>
  `}function F1(e){const t=e.state.settings.parallelLanes;return r`
    <div
    ...
    >
      ${t.map((n,s)=>n?N1(s,n,e):O1(s))}
    </div>
  `}const B1=20;function mp(e){switch(e.split(".").pop()?.toLowerCase()){case"md":return"📝";case"html":return"🌐";case"json":case"yaml":case"yml":case"toml":return"⚙️";case"ts":case"js":case"py":case"sh":case"rs":case"go":return"💻";case"css":return"🎨";default:return"📄"}}function vp(e,t=B1){const n=[];function s(a){for(const i of a){if(n.length>=t)return;const o=i;o.type==="file"?n.push(o):o.type==="directory"&&o.children&&s(o.children)}}return s(e),n}const U1=8;function z1(e){return vp(e,500).filter(n=>n.modifiedAt!=null).sort((n,s)=>(s.modifiedAt??0)-(n.modifiedAt??0)).slice(0,U1)}function K1(e){const n=Date.now()-e,s=Math.floor(n/6e4);if(s<1)return"just now";if(s<60)return`${s}m ago`;const a=Math.floor(s/60);if(a<24)return`${a}h ago`;const i=Math.floor(a/24);return i<30?`${i}d ago`:`${Math.floor(i/30)}mo ago`}function W1(e,t){if(!e||e.length===0)return h;const n=z1(e);return n.length===0?h:r`
      ...
      <div class="work-file-list">
        ${n.map(s=>r`
          ...
          >
            ...
            <span class="work-file-meta">${s.modifiedAt?K1(s.modifiedAt):""}</span>
          </button>
        `)}
      </div>
    </div>
  `}function q1(e,t){if(!e||e.length===0)return h;const n=vp(e);return n.length===0?h:r`
    <div class="work-file-list">
      ${n.map(s=>r`
        <button
          class="work-file-item"
  ...
  `}function V1(e){const t=e.reduce((s,a)=>{const i=a.type||"other";return s[i]||(s[i]=[]),s[i].push(a),s},{}),n={document:"📄",template:"📋",report:"📊",presentation:"📽️",spreadsheet:"📈",code:"💻",image:"🖼️",video:"🎬",audio:"🎵",archive:"📦",pdf:"📕",markdown:"📝"};return r`
  ...
  `}function j1(e){const{projects:t,loading:n,error:s,expandedProjects:a=new Set,projectFiles:i={},detailLoading:o=new Set,onRefresh:l,onToggleProject:c,onPersonClick:u,onFileClick:p,onSkillClick:f}=e;if(n)return r`
      <div class="my-day-container">
        <div class="my-day-loading">
          <div class="spinner"></div>
      ...
      <div class="work-workspaces-section">
        ...
        <div class="my-day-grid" style="grid-template-columns: 1fr;">
          ${m.length===0&&g.length===0?r`
                ...
                `:h}
          ${m.map(w=>H1(w,a.has(w.id),i[w.id]??[],o.has(w.id),()=>c?.(w.id),u,p,f))}
          ${g.length>0?r`
  ...
  `}const G1={urgent:"badge-danger",high:"badge-warning",medium:"badge-info",low:"badge-muted"},Q1={"new-feature":"New Feature","skill-recommendation":"Skill","config-optimization":"Config","workflow-suggestion":"Workflow","trend-alert":"Trend","goal-nudge":"Goal","health-warning":"Health"};function Wn(e){const t=Date.now()-e;return t<6e4?"just now":t<36e5?`${Math.floor(t/6e4)}m ago`:t<864e5?`${Math.floor(t/36e5)}h ago`:`${Math.floor(t/864e5)}d ago`}function Y1(e){return r`
    <div style="display: flex; flex-direction: column; gap: 16px;">
      ${J1(e)}
  ...
  `}function X1(e){const t=e.insights.filter(n=>!n.dismissed&&!n.actedOn);return t.length===0?r`
      ...
      ${t.map(n=>r`
          <div class="card" style="padding: 12px;">
            <div style="display: flex; align-items: start; gap: 8px;">
              <span class="badge ${G1[n.priority]??"badge-muted"}" style="flex-shrink: 0; font-size: 0.75em;">
                ${Q1[n.category]??n.category}
              </span>
  ...
  `}function Z1(e){if(!e.patterns)return h;const t=e.patterns,n=[{label:"Completion Rate (7d)",value:`${Math.round(t.taskPatterns.completionRate7d*100)}%`},{label:"Tasks/Day",value:t.taskPatterns.avgTasksPerDay.toFixed(1)},{label:"Stuck Tasks",value:String(t.taskPatterns.stuckTasks.length)},{label:"Active Days (7d)",value:String(t.activityPatterns.activeDaysLast7d)},{label:"Coding Sessions (7d)",value:String(t.codingPatterns.totalSessionsLast7d)},{label:"Stalled Goals",value:String(t.goalStatus.stalledGoals.length)}];return r`
    <div>
  ...
  `}function e2(e){if(e.discoveries.length===0)return h;const t=e.discoveries.slice(0,10);return r`
    <div>
  ...
  `}function t2(e){if(!e.status)return h;const t=e.status;return r`
  ...
  `}function et(e){if(!e)return"";try{return q(new Date(e).getTime())}catch{return""}}function hn(e){return r`<div class="second-brain-md-body">${Ce(we(e))}</div>`}function n2(e){const{identity:t}=e;return!t||t.files.length===0?cs("No identity files found","Start building your Second Brain by creating USER.md in ~/godmode/."):r`
  ...
  `}function s2(e){const{memoryBank:t,selectedEntry:n,searchQuery:s,browsingFolder:a,folderEntries:i,folderName:o}=e;if(n)return r`
      <div class="second-brain-panel">
  ...
  `}function a2(e){const{aiPacket:t,syncing:n}=e;return r`
    <div class="second-brain-panel">
  ...
  `}const uc={connected:{dot:"●",label:"Connected",cls:"second-brain-source--connected"},available:{dot:"○",label:"Available",cls:"second-brain-source--available"}};function i2(e){const{sourcesData:t}=e;if(!t||t.sources.length===0)return cs("No sources detected","Connect data sources to build your context universe.");const n=t.sources.filter(a=>a.status==="connected"),s=t.sources.filter(a=>a.status==="available");return r`
    <div class="second-brain-panel">
  ...
  `}function o2(e){const{researchData:t,selectedEntry:n,searchQuery:s,browsingFolder:a,folderEntries:i,folderName:o}=e;if(n)return r`
      <div class="second-brain-panel">
        <button class="second-brain-back-btn" @click=${()=>e.onBack()}>
          \u{2190} Back
        </button>
  ...
  `}function r2(e){return e<1024?`${e}B`:e<1024*1024?`${(e/1024).toFixed(1)}K`:`${(e/(1024*1024)).toFixed(1)}M`}function l2(e){return r`
    <div class="sb-files-container">
      ...
      ${e.fileSearchResults?c2(e):e.fileTreeLoading?r`<div class="sb-files-loading">Loading file tree...</div>`:e.fileTree?yp(e.fileTree,e):r`<div class="sb-files-empty">No files found</div>`}
    </div>
  `}function c2(e){const t=e.fileSearchResults??[];return t.length===0?r`<div class="sb-files-empty">No results found</div>`:r`
    ...
    <div class="sb-file-tree" style="padding-left: ${n*16}px">
      ${e.map(s=>s.type==="folder"?r`
          ...
          >
            ...
            ${s.size!=null?r`<span class="sb-tree-size">${r2(s.size)}</span>`:h}
          </button>
        `)}
    </div>
  ...
  `}function d2(e){if(!e)return h;if(!e.available)return r`
  ...
  `}function u2(e){const{subtab:t,loading:n,vaultHealth:s}=e;return r`
    <section class="second-brain-container">
      ...
      ${t==="intel"?e.intelProps?Y1(e.intelProps):r`<div class="second-brain-loading"><div class="second-brain-loading-spinner"></div>Loading...</div>`:n?r`<div class="second-brain-loading"><div class="second-brain-loading-spinner"></div>Loading...</div>`:t==="identity"?n2(e):t==="memory-bank"?s2(e):t==="ai-packet"?a2(e):t==="sources"?i2(e):t==="resources"?p2(e):t==="files"?l2(e):o2(e)}
    </section>
  ...
  `}function g2(e){return e==="global"?r`<span class="dashboard-card-scope">Global</span>`:r`<span class="dashboard-card-scope">${e}</span>`}function m2(e,t,n){return r`
    <div class="dashboard-card">
      ...
      >
        ...
        <div class="dashboard-card-meta">
          ${g2(e.scope)}
          <span>${q(new Date(e.updatedAt).getTime())}</span>
        </div>
      </button>
      <button
  ...
  `}function v2(e){const{activeDashboardHtml:t,activeDashboardManifest:n,isWorking:s}=e;return!t||!n?h:r`
  ...
  `}function y2(e){const{loading:t,dashboards:n}=e;return r`
    <section class="dashboards-container">
      ...
      ${t?r`<div class="dashboards-loading">Loading...</div>`:!n||n.length===0?r`
            ...
            `:r`
              <div class="dashboards-grid">
                ${n.map(s=>m2(s,e.onSelectDashboard,e.onDeleteDashboard))}
              </div>
            `}
    </section>
  `}function b2(e){return e.error?r`
      <section class="dashboards-container">
			...
			<div class="onboarding-progress-bar">
				${[2,3,4,5].map(n=>r`
						...
						>
							...
							<span class="onboarding-progress-label">${w2[n]}</span>
						</div>
					`)}
			</div>
			<div class="onboarding-progress-fill" style="width: ${(e-2)/4*100}%"></div>
		</div>
	`}function S2(e,t){return r`
		<div class="onboarding-tools-overlay">
			...
			<div class="onboarding-tools-grid">
				${k2.map(n=>{const a=e.find(i=>i.id===n.id)?.status??"pending";return r`
	...
	`}function A2(e){return e.length?r`
	...
	`:r`${h}`}function T2(e){const t=e>=70?"#38a169":e>=40?"#d69e2e":"#e53e3e",n=e>=70?"Good":e>=40?"Needs Work":"Getting Started";return r`
	...
	`}function C2(e){let t="",n="",s="";const a=["rocket","lightning","fire","star","brain","crown","diamond","target","compass","mountain"],i={rocket:"🚀",lightning:"⚡",fire:"🔥",star:"⭐",brain:"🧠",crown:"👑",diamond:"💎",target:"🎯",compass:"🧭",mountain:"⛰️"};function o(l){l.preventDefault();const c=l.target,u=new FormData(c);t=u.get("name")?.trim()??"",n=u.get("mission")?.trim()??"",s=u.get("emoji")?.trim()||"🚀",t&&e({name:t,mission:n,emoji:s})}return r`
		<div class="onboarding-fullscreen">
	...
	`}function E2(e){const{phase:t,tools:n,auditFindings:s,onSkipPhase:a}=e;return r`
		${$2(t)}
		${t===3?S2(n,a):h}
		${t===4&&s.length>0?A2(s):h}
  ...
  `}function I2(e){const t=e.steps.filter(a=>a.completed).length,n=e.steps.length,s=t===n;return r`
  ...
  `}function M2(e){const{checklist:t,checklistLoading:n,onHideSetup:s,onOpenWizard:a}=e;if(n&&!t)return r`<div class="setup-loading">Loading setup progress...</div>`;if(!t)return r`<div class="setup-loading">Couldn't load setup progress. Is the gateway running?</div>`;const{milestones:i,percentComplete:o}=t;return r`
  ...
  `}function D2(e){return e.connected?r`
    <section class="tab-body setup-section">
      ${e.quickSetupDone?h:P2(e)}
      ${M2(e)}
    </section>
  `:r`
      <section class="tab-body setup-section">
              ...
              ${m?r`
                  ...
                  `:r`
                    ${!s||s.integrationId!==e.id?r`
                        ...
                        `:r`
                          <div class="integration-guide">
                            <div class="guide-steps">${O2(s.steps)}</div>
                                  ...
                                  <div class="guide-inputs">
                                    ${s.envVars.map(g=>r`
                                        <label class="input-group">
                                          ...
                                          <input
                                            ...
                                            placeholder="${g.label}"
                                            .value=${l[g.key]??""}
                                            @input=${w=>{const S=w.target.value;t.onUpdateConfigValue(g.key,S)}}
                                          />
                                        </label>
                                      `)}
                                    <div class="guide-actions">
                                      <button
                                        ...
                                        @click=${()=>{const g={};for(const w of s.envVars){const S=l[w.key];S&&(g[w.key]=S)}t.onConfigureIntegration(e.id,g)}}
                                      >
                                        Save & Test
                                      </button>
  ...
  `}function O2(e){const t=e.split(`
`),n=[];for(const s of t)s.startsWith("```")||(s.match(/^\d+\./)?n.push(r`<p class="guide-step">${mc(s)}</p>`):s.trim()&&n.push(r`<p>${mc(s)}</p>`));return r`${n}`}function mc(e){const t=/`([^`]+)`/g,n=/\[([^\]]+)\]\(([^)]+)\)/g;let s=e;return s=s.replace(n,'<a href="$2" target="_blank" rel="noopener">$1</a>'),s=s.replace(t,"<code>$1</code>"),s=s.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),r`<span .innerHTML=${s}></span>`}const N2=/^data:/i,F2=/^https?:\/\//i;function B2(e){const t=e.agentsList?.agents??[],s=Dc(e.sessionKey)?.agentId??e.agentsList?.defaultId??"main",i=t.find(l=>l.id===s)?.identity,o=i?.avatarUrl??i?.avatar;if(o)return N2.test(o)||F2.test(o)?o:i?.avatarUrl}function Pn(e,t){const n=e.dynamicSlots[t];return n?r`
  ...
  `:h}function vc(e){return e.trim().toLowerCase().replace(/[^a-z0-9+\s]/g," ").replace(/\s+/g," ")}function Bi(e){const t=e.trim();if(!t)return t;const n=t.split(/\s+/);if(n.length>=2&&n.length%2===0){const l=n.length/2,c=n.slice(0,l).join(" "),u=n.slice(l).join(" ");if(c.toLowerCase()===u.toLowerCase())return c}const s=t.replace(/\s+/g," ").toLowerCase(),a=Math.floor(s.length/2),i=s.slice(0,a).trim(),o=s.slice(a).trim();return i&&i===o?t.slice(0,Math.ceil(t.length/2)).trim():t}function Ui(e,t){const n=t?.sessionId?.trim();if(n)return`session:${n}`;const s=t?.label??t?.displayName??_e.get(t?.key??e)??_e.get(e)??"",a=vc(Bi(s));if(a){const i=String(t?.surface??"").trim().toLowerCase(),o=vc(String(t?.subject??"")).slice(0,20),l=a.split(" ").filter(Boolean).slice(0,3).join(" ");return`name:${i}|${o}|${l||a.slice(0,24)}`}return`key:${e.trim().toLowerCase()}`}function U2(e){const t=e.sessionsResult?.sessions,n=[...new Set(e.settings.openTabs.map(l=>l.trim()).filter(Boolean))].filter(l=>l!==ce),s=Me(t,e.sessionKey),a=Ui(e.sessionKey,s),i=new Map;for(const l of n){const c=Me(t,l),u=Ui(l,c);if(!i.has(u)){i.set(u,l);continue}l===e.sessionKey&&i.set(u,l)}const o=[...i.values()];return o.length===0&&o.push(e.sessionKey.trim()||"main"),{tabKeys:o,activeIdentity:a}}function z2(e){const t=e.onboardingActive&&e.onboarding,n=e.onboardingPhase??0,s=e.onboardingData;if(t&&n===0)return x2(()=>{e.handleOnboardingStart?.()},s?.assessment);if(t&&n===1)return C2(d=>{e.handleOnboardingIdentitySubmit?.(d)});if(t&&n===6)return L2(s?.summary??null,s?.identity??null,()=>{e.handleOnboardingComplete?.()});if(e.wizardActive&&e.wizardState)return hp(e.wizardState,{onStepChange:d=>{e.handleWizardStepChange?.(d)},onAnswerChange:(d,k)=>{e.handleWizardAnswerChange?.(d,k)},onPreview:()=>{e.handleWizardPreview?.()},onGenerate:()=>{e.handleWizardGenerate?.()},onClose:()=>{e.handleWizardClose?.()}});const a=e.presenceEntries.length,i=e.sessionsResult?.count??null,o=e.cronStatus?.nextWakeAtMs??null,l=e.connected?null:"Disconnected from gateway.",c=e.tab==="chat",u=c&&(e.settings.chatFocusMode||e.onboarding||t&&n>=2),p=e.onboarding?!1:e.settings.chatShowThinking,f=B2(e),m=e.chatAvatarUrl??f??null,g=!!(e.godmodeOptions?.["focusPulse.enabled"]??!0),w=!!e.focusPulseData?.active,S=g&&w&&!!e.focusPulseData?.currentFocus,{tabKeys:T,activeIdentity:x}=U2(e);return r`
    <div class="shell ${c?"shell--chat":""} ${u?"shell--chat-focus":""} ${e.settings.navCollapsed?"shell--nav-collapsed":""} ${e.onboarding?"shell--onboarding":""}">
      ...
      <aside class="nav ${e.settings.navCollapsed?"nav--collapsed":""}">
        ${bm.map(d=>{const k=e.settings.navGroupsCollapsed[d.label]??!1,A=d.tabs.some(L=>L===e.tab),_=!d.label||d.tabs.length===1&&Xn(d.tabs[0])===d.label;return r`
      ...
      <main class="content ${c?"content--chat":""}">
        <section class="content-header">
          <div>
            ${e.tab!=="chat"&&e.tab!=="setup"&&e.tab!=="wheel-of-life"&&e.tab!=="vision-board"&&e.tab!=="lifetracks"?r`
              ...
              <div class="page-sub">${$m(e.tab)}</div>
            `:e.tab==="chat"?r`
              <div class="session-tabs">
                ...
                ${ba(T,d=>d,(d,k)=>{const A=Me(e.sessionsResult?.sessions,d),_=Ui(d,A)===x,R=(()=>{if(A?.label||A?.displayName)return Bi(A.label??A.displayName);const D=_e.get(d);if(D)return Bi(D);if(d==="agent:main:support")return"Support";if(d.includes("webchat")){const U=d.match(/webchat[:-](\d+)/);return U?`Chat ${U[1]}`:"Chat"}if(d.includes("main"))return"MAIN";const B=d.split(/[:-]/);return B[B.length-1]||d})(),z=T.length>1,j=e.workingSessions.has(d),J=e.settings.tabLastViewed[d]??0,K=A?.updatedAt??0,ie=!_&&!j&&K>J,de=e.editingTabKey===d;return r`
                      <div
                        class="session-tab ${_?"session-tab--active":""} ${j?"session-tab--working":""} ${ie?"session-tab--ready":""} ${de?"session-tab--editing":""}"
                        draggable="true"
                        ...
                        @click=${()=>{if(!de){if(_){e.applySettings({...e.settings,tabLastViewed:{...e.settings.tabLastViewed,[d]:Date.now()}});return}$e(e),e.sessionKey=d,Re(e,d),e.chatLoading=!0,e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.resetToolStream(),e.resetChatScroll(),e.applySettings({...e.settings,sessionKey:d,lastActiveSessionKey:d,tabLastViewed:{...e.settings.tabLastViewed,[d]:Date.now()}}),e.loadAssistantIdentity(),be(e,d,!0),se(e),ee(e)}}}
                        @dragend=${D=>{D.target.classList.remove("dragging")}}
                        @dragover=${D=>{D.preventDefault(),D.dataTransfer.dropEffect="move";const B=D.currentTarget,U=B.getBoundingClientRect(),M=U.left+U.width/2;D.clientX<M?(B.classList.add("drop-left"),B.classList.remove("drop-right")):(B.classList.add("drop-right"),B.classList.remove("drop-left"))}}
                        @dragleave=${D=>{D.currentTarget.classList.remove("drop-left","drop-right")}}
                        @drop=${D=>{D.preventDefault();const B=parseInt(D.dataTransfer.getData("text/plain")),U=k;if(B===U)return;const M=e.settings.openTabs.slice(),[N]=M.splice(B,1);M.splice(U,0,N),e.applySettings({...e.settings,openTabs:M}),D.currentTarget.classList.remove("drop-left","drop-right")}}
                        title=${R}
                      >
                        ${de?r`
                          <input
                            ...
                            @blur=${async D=>{const B=D.target;if(B._committedByEnter)return;const U=B.value.trim();e.editingTabKey=null;const M=A?.label??A?.displayName??"";if(U!==M){U?_e.set(d,U):_e.delete(d),e.sessionsResult?.sessions&&(e.sessionsResult={...e.sessionsResult,sessions:e.sessionsResult.sessions.map(F=>F.key===d?{...F,label:U||void 0,displayName:U||void 0}:F)});const N=await Ps(e,d,{label:U||null,displayName:U||null});ee(e);const Oe=N.ok&&N.canonicalKey!==d?N.canonicalKey:d,Se=d===e.sessionKey;e.applySettings({...e.settings,...N.ok&&N.canonicalKey!==d&&e.settings.openTabs.includes(d)?{openTabs:e.settings.openTabs.map(F=>F===d?N.canonicalKey:F)}:{},tabLastViewed:{...e.settings.tabLastViewed,[Oe]:Date.now()},...Se&&N.ok&&N.canonicalKey!==d?{sessionKey:N.canonicalKey,lastActiveSessionKey:N.canonicalKey}:{}}),Se&&N.ok&&N.canonicalKey!==d&&(e.sessionKey=N.canonicalKey,be(e,N.canonicalKey,!0))}else e.applySettings({...e.settings,tabLastViewed:{...e.settings.tabLastViewed,[d]:Date.now()}})}}
                            @keydown=${async D=>{if(D.key==="Enter"){D.preventDefault();const B=D.target;B._committedByEnter=!0;const U=B.value.trim();e.editingTabKey=null;const M=A?.label??A?.displayName??"";if(U!==M){U?_e.set(d,U):_e.delete(d),e.sessionsResult?.sessions&&(e.sessionsResult={...e.sessionsResult,sessions:e.sessionsResult.sessions.map(F=>F.key===d?{...F,label:U||void 0,displayName:U||void 0}:F)});const N=await Ps(e,d,{label:U||null,displayName:U||null});ee(e);const Oe=N.ok&&N.canonicalKey!==d?N.canonicalKey:d,Se=d===e.sessionKey;e.applySettings({...e.settings,...N.ok&&N.canonicalKey!==d&&e.settings.openTabs.includes(d)?{openTabs:e.settings.openTabs.map(F=>F===d?N.canonicalKey:F)}:{},tabLastViewed:{...e.settings.tabLastViewed,[Oe]:Date.now()},...Se&&N.ok&&N.canonicalKey!==d?{sessionKey:N.canonicalKey,lastActiveSessionKey:N.canonicalKey}:{}}),Se&&N.ok&&N.canonicalKey!==d&&(e.sessionKey=N.canonicalKey,be(e,N.canonicalKey,!0))}else e.applySettings({...e.settings,tabLastViewed:{...e.settings.tabLastViewed,[d]:Date.now()}})}else D.key==="Escape"&&(D.preventDefault(),e.editingTabKey=null)}}
                          />
                        `:(()=>{let D=null;return r`
                          <span
                            class="session-tab__name"
                            draggable="false"
                            @click=${B=>{B.stopPropagation(),D&&clearTimeout(D),D=setTimeout(()=>{D=null,e.editingTabKey!==d&&(d===e.sessionKey?e.applySettings({...e.settings,tabLastViewed:{...e.settings.tabLastViewed,[d]:Date.now()}}):($e(e),e.sessionKey=d,e.chatPrivateMode=!!e.privateSessions?.has(d),Re(e,d),e.chatLoading=!0,e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.resetToolStream(),e.resetChatScroll(),e.applySettings({...e.settings,sessionKey:d,lastActiveSessionKey:d,tabLastViewed:{...e.settings.tabLastViewed,[d]:Date.now()}}),e.loadAssistantIdentity(),be(e,d,!0),se(e),ee(e)))},250)}}
                            @dblclick=${B=>{B.preventDefault(),B.stopPropagation(),D&&(clearTimeout(D),D=null),e.editingTabKey=d;const U=B.target.closest(".session-tab"),M=N=>{const Oe=N.target;U&&!U.contains(Oe)&&(e.editingTabKey=null,document.removeEventListener("mousedown",M,!0))};document.addEventListener("mousedown",M,!0),requestAnimationFrame(()=>{requestAnimationFrame(()=>{const N=U?.querySelector(".session-tab__name-input");N&&(N.focus(),N.select())})})}}
                          >${R}</span>
                        `})()}
                        ${e.privateSessions?.has(d)?(()=>{const D=e.privateSessions.get(d),B=Math.max(0,D-Date.now()),U=Math.floor(B/36e5),M=Math.floor(B%36e5/6e4),N=U>0?`${U}h ${M}m`:`${M}m`;return r`
                        ...
                        ${z?r`
                          <button
                            ...
                            @click=${D=>{if(D.stopPropagation(),e.privateSessions?.has(d)){e._destroyPrivateSession(d);return}const B=e.settings.openTabs.filter(M=>M!==d),U=d===e.sessionKey;e.applySettings({...e.settings,openTabs:B,...U?{sessionKey:B[0],lastActiveSessionKey:B[0]}:{}}),U&&(e.sessionKey=B[0],be(e,B[0],!0),se(e))}}
          ...
          <div class="page-meta">
            ...
            ${c?Du(e):h}
            ${(e.tab==="today"||e.tab==="my-day")&&!e.dynamicSlots.today?e0({connected:e.connected,onRefresh:()=>e.handleMyDayRefresh(),selectedDate:e.todaySelectedDate,onDatePrev:()=>e.handleDatePrev(),onDateNext:()=>e.handleDateNext(),onDateToday:()=>e.handleDateToday(),viewMode:e.todayViewMode??"my-day",onViewModeChange:d=>e.handleTodayViewModeChange(d),focusPulseActive:w,onStartMorningSet:g?()=>e.handleFocusPulseStartMorning():void 0}):h}
          </div>
        </section>
        ...
        ${e.tab==="setup"?r`
                ${D2({connected:e.connected,quickSetupDone:e.setupQuickDone??!1,checklist:e.setupChecklist??null,checklistLoading:e.setupChecklistLoading??!1,onQuickSetup:(d,k,A)=>e.handleQuickSetup?.(d,k,A),onHideSetup:()=>e.handleHideSetup?.(),onOpenWizard:()=>e.handleWizardOpen?.(),onNavigate:d=>e.setTab(d),onRunAssessment:()=>e.handleRunAssessment?.(),onOpenSupportChat:()=>e.handleOpenSupportChat()})}
        ...
        ${e.tab==="overview"?x0({connected:e.connected,hello:e.hello,settings:e.settings,password:e.password,lastError:e.lastError,presenceCount:a,sessionsCount:i,cronEnabled:e.cronStatus?.enabled??null,cronNext:o,lastChannelsRefresh:e.channelsLastSuccess,updateStatus:e.updateStatus,updateLoading:e.updateLoading,updateError:e.updateError,updateLastChecked:e.updateLastChecked,updateRunning:e.updateRunning,onSettingsChange:d=>e.applySettings(d),onPasswordChange:d=>e.password=d,onSessionKeyChange:d=>{$e(e),e.sessionKey=d,Re(e,d),e.resetToolStream(),e.applySettings({...e.settings,sessionKey:d,lastActiveSessionKey:d}),e.loadAssistantIdentity()},onConnect:()=>e.connect(),onRefresh:()=>e.loadOverview(),onCheckUpdates:()=>fv(e),onUpdateNow:()=>{Sr(e)}}):h}

        ${e.tab==="workspaces"?W$({connected:e.connected,workspaces:e.workspaces??[],selectedWorkspace:e.selectedWorkspace??null,searchQuery:e.workspacesSearchQuery??"",itemSearchQuery:e.workspaceItemSearchQuery??"",expandedFolders:e.workspaceExpandedFolders??new Set,loading:e.workspacesLoading??!1,createLoading:e.workspacesCreateLoading??!1,error:e.workspacesError??null,onSearch:d=>e.workspacesSearchQuery=d,onItemSearch:d=>e.workspaceItemSearchQuery=d,onCreateWorkspace:async d=>{e.workspacesCreateLoading=!0;try{const{createWorkspace:k,selectWorkspace:A}=await E(async()=>{const{createWorkspace:L,selectWorkspace:R}=await Promise.resolve().then(()=>fe);return{createWorkspace:L,selectWorkspace:R}},void 0,import.meta.url),_=await k(e,d);return _?(e.workspaceItemSearchQuery="",await A(e,_),e.showToast(`Created workspace: ${_.name}`,"success"),!0):(e.showToast("Failed to create workspace","error"),!1)}finally{e.workspacesCreateLoading=!1}},onDeleteWorkspace:async d=>{const{deleteWorkspace:k,loadAllTasksWithQueueStatus:A}=await E(async()=>{const{deleteWorkspace:L,loadAllTasksWithQueueStatus:R}=await Promise.resolve().then(()=>fe);return{deleteWorkspace:L,loadAllTasksWithQueueStatus:R}},void 0,import.meta.url);if(!await k(e,d.id)){e.showToast(`Failed to delete ${d.name}`,"error");return}e.showToast(`Deleted workspace: ${d.name}`,"success"),e.allTasks=await A(e)},onSelectWorkspace:async d=>{e.workspaceItemSearchQuery="";const{selectWorkspace:k}=await E(async()=>{const{selectWorkspace:A}=await Promise.resolve().then(()=>fe);return{selectWorkspace:A}},void 0,import.meta.url);await k(e,d)},onBack:()=>{e.selectedWorkspace=null,e.workspaceItemSearchQuery=""},onItemClick:async d=>{const{readWorkspaceFile:k}=await E(async()=>{const{readWorkspaceFile:L}=await Promise.resolve().then(()=>fe);return{readWorkspaceFile:L}},void 0,import.meta.url),A=e.selectedWorkspace?.id,_=await k(e,d.path,A);if(!_){e.showToast(`Failed to open ${d.name}`,"error");return}e.handleOpenSidebar(_.content,{mimeType:_.mime,filePath:d.path,title:d.name})},onSessionClick:async d=>{if(!d.key)return;const k=d.key;$e(e),e.sessionKey=k,Re(e,k),e.chatLoading=!0,e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.resetToolStream(),e.resetChatScroll();const A=e.settings.openTabs.includes(k)?e.settings.openTabs:[...e.settings.openTabs,k];e.applySettings({...e.settings,openTabs:A,sessionKey:k,lastActiveSessionKey:k,tabLastViewed:{...e.settings.tabLastViewed,[k]:Date.now()}}),e.setTab("chat"),e.loadAssistantIdentity(),be(e,k,!0),se(e)},onPinToggle:async(d,k,A)=>{const{toggleWorkspacePin:_}=await E(async()=>{const{toggleWorkspacePin:R}=await Promise.resolve().then(()=>fe);return{toggleWorkspacePin:R}},void 0,import.meta.url);await _(e,d,k,A)||e.showToast("Failed to update pin","error")},onPinSessionToggle:async(d,k,A)=>{const{toggleWorkspaceSessionPin:_}=await E(async()=>{const{toggleWorkspaceSessionPin:R}=await Promise.resolve().then(()=>fe);return{toggleWorkspaceSessionPin:R}},void 0,import.meta.url);await _(e,d,k,A)||e.showToast("Failed to update session pin","error")},onToggleFolder:d=>{E(async()=>{const{toggleWorkspaceFolder:k}=await Promise.resolve().then(()=>fe);return{toggleWorkspaceFolder:k}},void 0,import.meta.url).then(({toggleWorkspaceFolder:k})=>{e.workspaceExpandedFolders=k(e.workspaceExpandedFolders??new Set,d),e.requestUpdate()})},onTeamSetup:async()=>{let d="I want to set up a Team Workspace so my team can collaborate. Please walk me through it step by step, keeping it simple.";try{const k=await e.client?.request("workspaces.teamSetupPrompt",{});k?.prompt&&(d=k.prompt)}catch{}e.handleStartChatWithPrompt(d)},allTasks:e.allTasks??[],taskFilter:e.taskFilter??"outstanding",taskSort:e.taskSort??"due",showCompletedTasks:e.showCompletedTasks??!1,onToggleTaskComplete:async(d,k)=>{const{toggleTaskComplete:A,loadAllTasksWithQueueStatus:_,getWorkspace:L}=await E(async()=>{const{toggleTaskComplete:z,loadAllTasksWithQueueStatus:j,getWorkspace:J}=await Promise.resolve().then(()=>fe);return{toggleTaskComplete:z,loadAllTasksWithQueueStatus:j,getWorkspace:J}},void 0,import.meta.url);if(!await A(e,d,k)){e.showToast("Failed to update task","error");return}if(e.allTasks=await _(e),e.selectedWorkspace){const z=await L(e,e.selectedWorkspace.id);z&&(e.selectedWorkspace=z)}},onCreateTask:async(d,k)=>{const{createTask:A,loadAllTasksWithQueueStatus:_,getWorkspace:L}=await E(async()=>{const{createTask:z,loadAllTasksWithQueueStatus:j,getWorkspace:J}=await Promise.resolve().then(()=>fe);return{createTask:z,loadAllTasksWithQueueStatus:j,getWorkspace:J}},void 0,import.meta.url),R=await A(e,d,k);if(!R){e.showToast("Failed to create task","error");return}if(e.showToast(`Task created: ${R.title}`,"success"),e.allTasks=await _(e),e.selectedWorkspace){const z=await L(e,e.selectedWorkspace.id);z&&(e.selectedWorkspace=z)}},onSetTaskFilter:d=>{e.taskFilter=d},onSetTaskSort:d=>{e.taskSort=d},onToggleCompletedTasks:()=>{e.showCompletedTasks=!(e.showCompletedTasks??!1)},editingTaskId:e.editingTaskId??null,workspaceNames:(e.workspaces??[]).map(d=>d.name),onStartTask:async d=>{const{startTask:k,loadAllTasksWithQueueStatus:A}=await E(async()=>{const{startTask:z,loadAllTasksWithQueueStatus:j}=await Promise.resolve().then(()=>fe);return{startTask:z,loadAllTasksWithQueueStatus:j}},void 0,import.meta.url),_=await k(e,d);if(!_?.sessionId){e.showToast("Failed to open session for task","error");return}$e(e);const L=_.sessionId;_.task?.title&&_e.set(L,_.task.title);const R=e.settings.openTabs.includes(L)?e.settings.openTabs:[...e.settings.openTabs,L];if(e.applySettings({...e.settings,openTabs:R,sessionKey:L,lastActiveSessionKey:L,tabLastViewed:{...e.settings.tabLastViewed,[L]:Date.now()}}),e.sessionKey=L,e.setTab("chat"),_.created&&!_.queueOutput){const z=e.allTasks??[],j=e.selectedWorkspace?.tasks??[],J=[...z,...j].find(ie=>ie.id===d),K=J?.project?` (project: ${J.project})`:"";e.chatMessage=`Let's work on: ${J?.title??"this task"}${K}`}else e.chatMessage="";e.chatMessages=[],e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.resetToolStream(),e.resetChatScroll(),e.loadAssistantIdentity(),be(e,L,!0),await se(e),_.queueOutput&&e.chatMessages.length===0&&e.seedSessionWithAgentOutput(_.task?.title??"this task",_.queueOutput,_.agentPrompt??void 0),e.allTasks=await A(e),e.requestUpdate()},onEditTask:d=>{e.editingTaskId=d},onUpdateTask:async(d,k)=>{const{updateTask:A,loadAllTasksWithQueueStatus:_,getWorkspace:L}=await E(async()=>{const{updateTask:z,loadAllTasksWithQueueStatus:j,getWorkspace:J}=await Promise.resolve().then(()=>fe);return{updateTask:z,loadAllTasksWithQueueStatus:j,getWorkspace:J}},void 0,import.meta.url);if(!await A(e,d,k)){e.showToast("Failed to update task","error");return}if(e.editingTaskId=null,e.allTasks=await _(e),e.selectedWorkspace){const z=await L(e,e.selectedWorkspace.id);z&&(e.selectedWorkspace=z)}},browsePath:e.workspaceBrowsePath??null,browseEntries:e.workspaceBrowseEntries??null,breadcrumbs:e.workspaceBreadcrumbs??null,browseSearchQuery:e.workspaceBrowseSearchQuery??"",browseSearchResults:e.workspaceBrowseSearchResults??null,onBrowseFolder:d=>e.handleWorkspaceBrowse(d),onBrowseSearch:d=>e.handleWorkspaceBrowseSearch(d),onBrowseBack:()=>e.handleWorkspaceBrowseBack(),onCreateFolder:d=>e.handleWorkspaceCreateFolder(d)}):h}

        ${e.tab==="today"||e.tab==="my-day"?e.dynamicSlots.today?Pn(e,"today"):t0({connected:e.connected,loading:e.myDayLoading??!1,error:e.myDayError??null,onRefresh:()=>e.handleMyDayRefresh(),dailyBrief:e.dailyBrief??null,dailyBriefLoading:e.dailyBriefLoading??!1,dailyBriefError:e.dailyBriefError??null,onBriefRefresh:()=>e.handleDailyBriefRefresh(),onBriefOpenInObsidian:()=>e.handleDailyBriefOpenInObsidian(),onBriefSave:d=>e.handleBriefSave(d),onBriefToggleCheckbox:(d,k)=>e.handleBriefToggleCheckbox(d,k),onOpenFile:d=>{e.handleOpenFile(d)},selectedDate:e.todaySelectedDate,onDatePrev:()=>e.handleDatePrev(),onDateNext:()=>e.handleDateNext(),onDateToday:()=>e.handleDateToday(),viewMode:e.todayViewMode??"my-day",onViewModeChange:d=>e.handleTodayViewModeChange(d),agentLog:e.agentLog??null,agentLogLoading:e.agentLogLoading??!1,agentLogError:e.agentLogError??null,onAgentLogRefresh:()=>e.handleMyDayRefresh(),focusPulseActive:w,onStartMorningSet:g?()=>e.handleFocusPulseStartMorning():void 0,todayTasks:e.todayTasks??[],todayTasksLoading:e.todayTasksLoading??!1,onToggleTaskComplete:(d,k)=>e.handleMyDayTaskStatusChange(d,k==="complete"?"pending":"complete"),onStartTask:d=>e.handleTodayStartTask(d),onCreateTask:d=>e.handleTodayCreateTask(d),onEditTask:d=>e.handleTodayEditTask(d),onUpdateTask:(d,k)=>e.handleTodayUpdateTask(d,k),editingTaskId:e.todayEditingTaskId,showCompletedTasks:e.todayShowCompleted,onToggleCompletedTasks:()=>e.handleTodayToggleCompleted(),decisionCards:(e.todayQueueResults??[]).length>0?{items:e.todayQueueResults,onApprove:d=>e.handleDecisionApprove(d),onReject:d=>e.handleDecisionReject(d),onViewOutput:(d,k)=>e.handleDecisionViewOutput(d,k),onOpenChat:d=>e.handleDecisionOpenChat(d)}:void 0}):h}

        ${e.tab==="work"?e.dynamicSlots.work?Pn(e,"work"):j1({connected:e.connected,projects:e.workProjects??[],loading:e.workLoading??!1,error:e.workError??null,expandedProjects:e.workExpandedProjects,projectFiles:e.workProjectFiles??{},detailLoading:e.workDetailLoading??new Set,onRefresh:()=>e.handleWorkRefresh(),onToggleProject:d=>e.handleWorkToggleProject(d),onPersonClick:d=>e.handleWorkPersonClick(d),onFileClick:d=>e.handleWorkFileClick(d),onSkillClick:(d,k)=>e.handleWorkSkillClick(d,k)}):h}

        ${e.tab==="wheel-of-life"?e.dynamicSlots["wheel-of-life"]?Pn(e,"wheel-of-life"):TS({connected:e.connected,data:e.wheelOfLifeData??null,loading:e.wheelOfLifeLoading??!1,error:e.wheelOfLifeError??null,editMode:e.wheelOfLifeEditMode??!1,onRefresh:()=>e.handleWheelOfLifeRefresh(),onEdit:()=>e.handleWheelOfLifeEdit(),onSave:d=>e.handleWheelOfLifeSave(d),onCancel:()=>e.handleWheelOfLifeCancel()}):h}

        ${e.tab==="vision-board"?e.dynamicSlots["vision-board"]?Pn(e,"vision-board"):yS({connected:e.connected,data:e.visionBoardData??null,identityToday:e.visionBoardIdentityToday??null,loading:e.visionBoardLoading??!1,error:e.visionBoardError??null,onRefresh:()=>e.handleVisionBoardRefresh()}):h}

        ${e.tab==="lifetracks"?e.dynamicSlots.lifetracks?Pn(e,"lifetracks"):w$({connected:e.connected,data:e.lifetracksData??null,currentTrack:e.lifetracksCurrentTrack??null,loading:e.lifetracksLoading??!1,error:e.lifetracksError??null,config:e.lifetracksConfig??null,generating:e.lifetracksGenerating??!1,generationError:e.lifetracksGenerationError??null,onRefresh:()=>e.handleLifetracksRefresh(),onSelectTrack:d=>e.handleLifetracksSelectTrack(d),onEnable:()=>e.handleLifetracksEnable(),onGenerate:()=>e.handleLifetracksGenerate()}):h}

        ${e.tab==="channels"?Ww({connected:e.connected,loading:e.channelsLoading,snapshot:e.channelsSnapshot,lastError:e.channelsError,lastSuccessAt:e.channelsLastSuccess,whatsappMessage:e.whatsappLoginMessage,whatsappQrDataUrl:e.whatsappLoginQrDataUrl,whatsappConnected:e.whatsappLoginConnected,whatsappBusy:e.whatsappBusy,configSchema:e.configSchema,configSchemaLoading:e.configSchemaLoading,configForm:e.configForm,configUiHints:e.configUiHints,configSaving:e.configSaving,configFormDirty:e.configFormDirty,nostrProfileFormState:e.nostrProfileFormState,nostrProfileAccountId:e.nostrProfileAccountId,onRefresh:d=>De(e,d),onWhatsAppStart:d=>e.handleWhatsAppStart(d),onWhatsAppWait:()=>e.handleWhatsAppWait(),onWhatsAppLogout:()=>e.handleWhatsAppLogout(),onConfigPatch:(d,k)=>en(e,d,k),onConfigSave:()=>e.handleChannelConfigSave(),onConfigReload:()=>e.handleChannelConfigReload(),onNostrProfileEdit:(d,k)=>e.handleNostrProfileEdit(d,k),onNostrProfileCancel:()=>e.handleNostrProfileCancel(),onNostrProfileFieldChange:(d,k)=>e.handleNostrProfileFieldChange(d,k),onNostrProfileSave:()=>e.handleNostrProfileSave(),onNostrProfileImport:()=>e.handleNostrProfileImport(),onNostrProfileToggleAdvanced:()=>e.handleNostrProfileToggleAdvanced()}):h}

        ${e.tab==="instances"?c$({loading:e.presenceLoading,entries:e.presenceEntries,lastError:e.presenceError,statusMessage:e.presenceStatus,onRefresh:()=>Lo(e)}):h}

        ${e.tab==="sessions"?U0({loading:e.sessionsLoading,result:e.sessionsResult,error:e.sessionsError,activeMinutes:e.sessionsFilterActive,limit:e.sessionsFilterLimit,includeGlobal:e.sessionsIncludeGlobal,includeUnknown:e.sessionsIncludeUnknown,basePath:e.basePath,archivedSessions:e.archivedSessions,archivedSessionsLoading:e.archivedSessionsLoading,archivedSessionsExpanded:e.archivedSessionsExpanded,onFiltersChange:d=>{e.sessionsFilterActive=d.activeMinutes,e.sessionsFilterLimit=d.limit,e.sessionsIncludeGlobal=d.includeGlobal,e.sessionsIncludeUnknown=d.includeUnknown},onRefresh:()=>{ee(e),Ot(e)},onPatch:async(d,k)=>{const A=await Ps(e,d,k);if(A.ok&&A.canonicalKey!==d&&e.settings.openTabs.includes(d)){const _=e.settings.openTabs.map(R=>R===d?A.canonicalKey:R),L=d===e.sessionKey;e.applySettings({...e.settings,openTabs:_,tabLastViewed:{...e.settings.tabLastViewed,[A.canonicalKey]:e.settings.tabLastViewed[d]??Date.now()},...L?{sessionKey:A.canonicalKey,lastActiveSessionKey:A.canonicalKey}:{}}),L&&(e.sessionKey=A.canonicalKey,be(e,A.canonicalKey,!0))}},onDelete:d=>Kd(e,d),onArchive:d=>Wd(e,d),onUnarchive:d=>qd(e,d),onToggleArchived:()=>{e.archivedSessionsExpanded=!e.archivedSessionsExpanded,e.archivedSessionsExpanded&&e.archivedSessions.length===0&&Ot(e)},onAutoArchive:()=>Hd(e)}):h}

        ${e.tab==="cron"?t$({loading:e.cronLoading,status:e.cronStatus,jobs:e.cronJobs,error:e.cronError,busy:e.cronBusy,form:e.cronForm,channels:e.channelsSnapshot?.channelMeta?.length?e.channelsSnapshot.channelMeta.map(d=>d.id):e.channelsSnapshot?.channelOrder??[],channelLabels:e.channelsSnapshot?.channelLabels??{},channelMeta:e.channelsSnapshot?.channelMeta??[],runsJobId:e.cronRunsJobId,runs:e.cronRuns,onFormChange:d=>e.cronForm={...e.cronForm,...d},onRefresh:()=>e.loadCron(),onAdd:()=>gy(e),onToggle:(d,k)=>my(e,d,k),onRun:d=>vy(e,d),onRemove:d=>yy(e,d),onLoadRuns:d=>ru(e,d)}):h}

        ${e.tab==="skills"?X0({loading:e.skillsLoading,report:e.skillsReport,error:e.skillsError,filter:e.skillsFilter,edits:e.skillEdits,messages:e.skillMessages,busyKey:e.skillsBusyKey,subTab:e.skillsSubTab,onFilterChange:d=>e.skillsFilter=d,onRefresh:()=>as(e,{clearMessages:!0}),onToggle:(d,k)=>Ky(e,d,k),onEdit:(d,k)=>zy(e,d,k),onSaveKey:d=>Wy(e,d),onInstall:(d,k,A)=>qy(e,d,k,A),onSubTabChange:d=>{e.skillsSubTab=d,d==="clawhub"&&!e.clawhubExploreItems&&Al(e)},clawhub:{loading:e.clawhubLoading,error:e.clawhubError,query:e.clawhubQuery,results:e.clawhubResults,exploreItems:e.clawhubExploreItems,exploreSort:e.clawhubExploreSort,detailSlug:e.clawhubDetailSlug,detail:e.clawhubDetail,importing:e.clawhubImporting,message:e.clawhubMessage,onSearch:d=>{e.clawhubQuery=d,ew(e,d)},onExplore:d=>Al(e,d),onDetail:d=>tw(e,d),onCloseDetail:()=>sw(e),onImport:d=>Tl(e,d),onImportAndPersonalize:async d=>{if(!await Tl(e,d))return;const A=await nw(e,d);A&&(Mo(e,"chat"),wa(e),e.chatMessage=A)}}}):h}

        ${e.tab==="nodes"?n0({loading:e.nodesLoading,nodes:e.nodes,devicesLoading:e.devicesLoading,devicesError:e.devicesError,devicesList:e.devicesList,configForm:e.configForm??e.configSnapshot?.config,configLoading:e.configLoading,configSaving:e.configSaving,configDirty:e.configFormDirty,configFormMode:e.configFormMode,execApprovalsLoading:e.execApprovalsLoading,execApprovalsSaving:e.execApprovalsSaving,execApprovalsDirty:e.execApprovalsDirty,execApprovalsSnapshot:e.execApprovalsSnapshot,execApprovalsForm:e.execApprovalsForm,execApprovalsSelectedAgent:e.execApprovalsSelectedAgent,execApprovalsTarget:e.execApprovalsTarget,execApprovalsTargetNodeId:e.execApprovalsTargetNodeId,onRefresh:()=>ua(e),onDevicesRefresh:()=>ht(e),onDeviceApprove:d=>ov(e,d),onDeviceReject:d=>rv(e,d),onDeviceRotate:(d,k,A)=>lv(e,{deviceId:d,role:k,scopes:A}),onDeviceRevoke:(d,k)=>cv(e,{deviceId:d,role:k}),onLoadConfig:()=>Je(e),onLoadExecApprovals:()=>{const d=e.execApprovalsTarget==="node"&&e.execApprovalsTargetNodeId?{kind:"node",nodeId:e.execApprovalsTargetNodeId}:{kind:"gateway"};return Eo(e,d)},onBindDefault:d=>{d?en(e,["tools","exec","node"],d):Ar(e,["tools","exec","node"])},onBindAgent:(d,k)=>{const A=["agents","list",d,"tools","exec","node"];k?en(e,A,k):Ar(e,A)},onSaveBindings:()=>Bs(e),onExecApprovalsTargetChange:(d,k)=>{e.execApprovalsTarget=d,e.execApprovalsTargetNodeId=k,e.execApprovalsSnapshot=null,e.execApprovalsForm=null,e.execApprovalsDirty=!1,e.execApprovalsSelectedAgent=null},onExecApprovalsSelectAgent:d=>{e.execApprovalsSelectedAgent=d},onExecApprovalsPatch:(d,k)=>Cy(e,d,k),onExecApprovalsRemove:d=>Ey(e,d),onSaveExecApprovals:()=>{const d=e.execApprovalsTarget==="node"&&e.execApprovalsTargetNodeId?{kind:"node",nodeId:e.execApprovalsTargetNodeId}:{kind:"gateway"};return xy(e,d)}}):h}

        ${t&&n>=2&&n<=5&&e.tab==="chat"?E2({phase:n,identity:s?.identity??null,tools:s?.tools??[],auditFindings:s?.audit?.findings??[],summary:s?.summary??null,onSkipPhase:()=>e.handleOnboardingSkipPhase?.()}):e.tab==="chat"&&e.workspaceNeedsSetup&&!e.chatMessages?.length&&!t?r`
