      ...
      ${l?r`
            ...
            `:r`
              <div class="workspaces-body">
                ...
                ${_k({tasks:p,taskFilter:f,taskSort:m,onToggleTaskComplete:D,onSetTaskFilter:F,onSetTaskSort:ue,onCreateTask:W,workspaceNames:d,onStartTask:X,editingTaskId:$,onEditTask:B,onUpdateTask:Me})}
              </div>
            `}
    </div>
              ...
              <div class="nav-group__items">
                ${!d.label&&e.godmodeOptions!=null&&e.showSetupTab&&!e.godmodeOptions?.["onboarding.hidden"]?r`
                        ...
                        >
                          ...
                          ${e.onboardingProgress!=null?r`<span class="nav-item__badge">${e.onboardingProgress}%</span>`:e.setupCapabilities&&e.setupCapabilities.percentComplete!=null?r`<span class="nav-item__badge">${e.setupCapabilities.percentComplete}%</span>`:h}
                        </a>
                      `:h}
                ${d.tabs.map(_=>Ci(e,_))}
              </div>
            ...
            `:e.tab==="chat"?r`
              <div class="session-tabs">
                <div class="session-tab session-tab--pinned ${e.sessionKey===ee?"session-tab--active":""}"
                     @click=${()=>{e.sessionKey!==ee&&(ke(e),e.sessionKey=ee,e.allyUnread=0,Ee(e,ee),e.chatLoading=!0,e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.resetToolStream(),e.resetChatScroll(),e.applySettings({...e.settings,sessionKey:ee,lastActiveSessionKey:ee,tabLastViewed:{...e.settings.tabLastViewed,[ee]:Date.now()}}),e.loadAssistantIdentity(),se(e),te(e))}}
                      ...
                      >
                        ...
                        ${r`
                          <button
                            ...
                            @click=${M=>{if(M.stopPropagation(),e.privateSessions?.has(d)){e._destroyPrivateSession(d);return}const O=e.settings.openTabs.filter(F=>F!==d),D=d===e.sessionKey,W=O[0]||ee;e.applySettings({...e.settings,openTabs:O,...D?{sessionKey:W,lastActiveSessionKey:W}:{}}),D&&(e.sessionKey=W,ye(e,W,!0),se(e))}}
