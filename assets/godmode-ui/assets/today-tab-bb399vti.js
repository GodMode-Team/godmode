import{b as n,A as u,d as k,g as w,r as l,t as T}from"./lit-core-CTInmNPB.js";import{a as p,p as S,q as D,v as _,w as C,x as y,o as I}from"./index-CMubI-u1.js";import{A as h}from"./ctrl-settings-C2Q1A5fK.js";import{A as $}from"./views-settings-DK3deM1Q.js";import{s as L,a as g}from"./workspaces-D9PGyktE.js";import"./markdown-i_gIkIP3.js";function f(t){const e=Date.now()-new Date(t).getTime(),a=Math.floor(e/6e4);if(a<1)return"just now";if(a<60)return`${a}m ago`;const i=Math.floor(a/60);return i<24?`${i}h ago`:`${Math.floor(i/24)}d ago`}function B(t){return t.source.persona?t.source.persona.replace(/-/g," ").replace(/\b\w/g,e=>e.toUpperCase()):t.source.skill?t.source.skill:t.type==="agent-execution"?"Agent":"Skill"}function O(t){return t<=2?"Poor":t<=4?"Below expectations":t<=6?"Okay":t<=8?"Good":"Excellent"}function m(t,e){if(t.scoringId!==e.id)return u;const a=t.scoringValue??7,i=t.feedbackText??"",o=a<=4,s=a<=4||a>=9;return n`
  ...
  `}function F(t){return t===h()}function M(t){const e=new Date(t+"T12:00:00");return V(e)}function V(t){const e=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],a=["January","February","March","April","May","June","July","August","September","October","November","December"],i=e[t.getDay()],o=a[t.getMonth()],s=t.getDate();return`${i}, ${o} ${s}`}function A(t){return n`
  ...
  `}function P(t){const e=L(t.todayTasks??[],"due"),a=e.filter(o=>o.status==="pending"),i=e.filter(o=>o.status==="complete");return n`
    <div class="my-day-card today-tasks-panel">
      ...
      <div class="my-day-card-content">
        ${t.todayTasksLoading?n`<div class="brief-loading"><div class="spinner"></div><span>Loading tasks...</span></div>`:n`
              ${t.onCreateTask?A(t.onCreateTask):u}
  ...
  `}function N(t){const e=h(),a=t.selectedDate??e,i=F(a),o=M(a),s=t.viewMode??"brief";return n`
  ...
  `}function Q(t){const e=h();t.selectedDate;const a=t.viewMode??"brief";if(t.loading)return n`
