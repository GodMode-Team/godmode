import{A as d,b as a,o as $a}from"./lit-core-CTInmNPB.js";import{t as wa,f as L,a as Be,b as jn,c as Et,d as Fe}from"./ctrl-settings-CN1lXpxD.js";import{g as Pt}from"./markdown-i_gIkIP3.js";function xa(e){const{values:t,original:n}=e;return t.name!==n.name||t.displayName!==n.displayName||t.about!==n.about||t.picture!==n.picture||t.banner!==n.banner||t.website!==n.website||t.nip05!==n.nip05||t.lud16!==n.lud16}function ka(e){const{state:t,callbacks:n,accountId:s}=e,i=xa(t),l=(r,u,v={})=>{const{type:p="text",placeholder:g,maxLength:h,help:$}=v,b=t.values[r]??"",y=t.fieldErrors[r],f=`nostr-profile-${r}`;return p==="textarea"?a`
