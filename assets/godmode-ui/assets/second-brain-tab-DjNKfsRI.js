import{d as x,b as a,A as r,o as E,g as C,r as u,t as _}from"./lit-core-CTInmNPB.js";import{a as m,o as A}from"./index-CpSkSSRc.js";import{a as T}from"./views-settings-Bq31gF_6.js";import{f as D}from"./ctrl-settings-WnDhxjfx.js";import"./markdown-i_gIkIP3.js";async function L(e){if(!e.client||!e.connected)return;const n=e.secondBrainSubtab??"identity";e.secondBrainLoading=!0,e.secondBrainError=null;try{if(n==="identity"){const s=await e.client.request("secondBrain.identity",{});e.secondBrainIdentity=s}else if(n==="knowledge"){const[s,i,d]=await Promise.all([e.client.request("secondBrain.memoryBank",{}),e.client.request("secondBrain.research",{}),e.client.request("secondBrain.fileTree",{depth:4})]);e.secondBrainMemoryBank=s,e.secondBrainResearchData=i,e.secondBrainFileTree=d.tree??[],e.secondBrainBrowsingFolder=null,e.secondBrainFolderEntries=null,e.secondBrainFolderName=null}else if(n==="context"){const[s,i,d]=await Promise.all([e.client.request("secondBrain.aiPacket",{}),e.client.request("secondBrain.sources",{}),e.client.request("secondBrain.vaultHealth",{})]);e.secondBrainAiPacket=s,e.secondBrainSourcesData=i,e.secondBrainVaultHealth=d}}catch(s){console.error("[SecondBrain] Failed to load:",s),e.secondBrainError=s instanceof Error?s.message:"Failed to load Second Brain data"}finally{e.secondBrainLoading=!1}}async function P(e,n){if(!(!e.client||!e.connected)){e.secondBrainLoading=!0;try{const s=await e.client.request("secondBrain.memoryBank",{folder:n});e.secondBrainBrowsingFolder=s.folder,e.secondBrainFolderName=s.folderName,e.secondBrainFolderEntries=s.entries}catch(s){console.error("[SecondBrain] Failed to browse folder:",s),e.secondBrainError=s instanceof Error?s.message:"Failed to browse folder"}finally{e.secondBrainLoading=!1}}}async function R(e,n){if(!(!e.client||!e.connected)){e.secondBrainLoading=!0;try{const s=await e.client.request("secondBrain.memoryBankEntry",{path:n});e.secondBrainSelectedEntry=s}catch(s){console.error("[SecondBrain] Failed to load entry:",s),e.secondBrainError=s instanceof Error?s.message:"Failed to load entry"}finally{e.secondBrainLoading=!1}}}async function N(e){if(!(!e.client||!e.connected)){e.secondBrainSyncing=!0;try{const n=await e.client.request("secondBrain.sync",{});e.secondBrainAiPacket={snapshot:n.snapshot??null}}catch(n){console.error("[SecondBrain] Sync failed:",n),e.secondBrainError=n instanceof Error?n.message:"Sync failed"}finally{e.secondBrainSyncing=!1}}}var H=Object.defineProperty,q=Object.getOwnPropertyDescriptor,l=(e,n,s,i)=>{for(var d=i>1?void 0:i?q(n,s):n,h=e.length-1,c;h>=0;h--)(c=e[h])&&(d=(i?c(n,s,d):c(d))||d);return i&&d&&H(n,s,d),d};function y(e){if(!e)return"";try{return D(new Date(e).getTime())}catch{return""}}function B(e){return a`<div class="second-brain-md-body">${E(T(e))}</div>`}function I(e){const{identity:n}=e;return!n||n.files.length===0?a`
  ...
  `}function Q(e,n){const s=e.isDirectory,i=s?"📁":"📑",d=()=>{s?n.onBrowseFolder(e.path):n.onSelectEntry(e.path)},h=e.frontmatter?.title||e.name;return a`
  ...
  `}function V(e){return e<1024?`${e}B`:e<1024*1024?`${(e/1024).toFixed(1)}K`:`${(e/(1024*1024)).toFixed(1)}M`}function S(e,n,s=0){return a`
    <div class="sb-file-tree" style="padding-left: ${s*16}px">
      ${e.map(i=>i.type==="folder"?a`
          ...
          >
            ...
            ${i.size!=null?a`<span class="sb-tree-size">${V(i.size)}</span>`:r}
          </button>
        `)}
    </div>
  `}function M(e){const{memoryBank:n,researchData:s,selectedEntry:i,searchQuery:d,browsingFolder:h,folderEntries:c,folderName:F}=e;if(i)return a`
      <div class="second-brain-panel">
    ...
    `;if(!(n&&n.totalEntries>0||s&&s.totalEntries>0||e.fileTree&&e.fileTree.length>0))return U("No knowledge found","Start building your second brain by telling your ally about the people, companies, and projects in your life.");const v=(d??"").toLowerCase().trim(),w=t=>v?t.filter(b=>b.name.toLowerCase().includes(v)||b.excerpt.toLowerCase().includes(v)):t,p=e.fileSearchResults;return a`
    <div class="second-brain-panel">
  ...
  `}function z(e){const{aiPacket:n,sourcesData:s,vaultHealth:i,syncing:d}=e,h=n?.snapshot??null;return a`
    <div class="second-brain-panel">
