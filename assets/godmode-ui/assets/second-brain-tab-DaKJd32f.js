import{b as s,A as c,o as x,f as C,k as E,j as l,g as _}from"./lit-core-CthTC9XT.js";import{B as A,C as T,o as D}from"./index-xEE89f2N.js";import{a as B}from"./event-bus-4tWT8iFZ.js";import{loadSecondBrain as R,loadSecondBrainEntry as L,browseFolder as N,syncSecondBrain as P}from"./second-brain-cP3vM8ym.js";import"./markdown-i_gIkIP3.js";function p(e){if(!e)return"";try{return A(new Date(e).getTime())}catch{return""}}function m(e){return s`<div class="second-brain-md-body">${x(T(e))}</div>`}function H(e){const{identity:n}=e;return!n||n.files.length===0?s`
  ...
  `}function $(e,n){const a=e.isDirectory;return s`
      ...
      <div class="second-brain-panel">
        ...
        <div class="second-brain-section">
          ...
          <div class="second-brain-entry-list">
            ${r.length>0?r.map(i=>$(i,e)):s`<div class="second-brain-empty-inline">Empty folder</div>`}
          </div>
        </div>
      </div>
      ...
      ${!v&&n?s`
        ${n.sections.map(i=>{const b=w(i.entries);return i.entries.length===0?c:s`
            <div class="second-brain-section">
              ...
              <div class="second-brain-entry-list">
                ${b.length>0?b.map(k=>$(k,e)):v?s`<div class="second-brain-empty-inline">No matches</div>`:c}
              </div>
            </div>
          `})}
