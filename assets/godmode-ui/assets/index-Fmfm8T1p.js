...
`).length:0,y=c&&(e.text?.length??0)<=Qg,b=c&&!y&&h>Jg,$=c&&!b,k=!c,S=e.kind==="call"?"chat-tool-card--call":"chat-tool-card--result";return l`
    <div
...
Deletes the session entry and archives its transcript.`)&&(e.sessionsResult?.sessions&&(e.sessionsResult={...e.sessionsResult,sessions:e.sessionsResult.sessions.filter($=>$.key!==y)}),e.client&&e.connected))try{await e.client.request("sessions.delete",{key:y,deleteTranscript:!0}),Z(e)}catch($){console.error("Failed to delete session:",$),Z(e)}},p=h=>l`
  ...
  `};function Ze(e){const{schema:t,value:n,path:s,hints:i,unsupported:a,disabled:o,onPatch:c}=e,d=e.showLabel??!0,p=ze(t),r=xe(s,i),u=r?.label??t.title??et(String(s.at(-1))),h=r?.help??t.description,y=fi(s);if(a.has(y))return l`<div class="cfg-field cfg-field--error">
  ...
  `}function $l(e){const{schema:t,value:n,path:s,hints:i,disabled:a,onPatch:o,inputType:c}=e,d=e.showLabel??!0,p=xe(s,i),r=p?.label??t.title??et(String(s.at(-1))),u=p?.help??t.description,h=p?.sensitive??Tw(s),y=p?.placeholder??(h?"••••":t.default!==void 0?`Default: ${ln(t.default)}`:""),b=n??"";return l`
    <div class="cfg-field">
  ...
  `}function Sl(e){const{schema:t,value:n,path:s,hints:i,disabled:a,options:o,onPatch:c}=e,d=e.showLabel??!0,p=xe(s,i),r=p?.label??t.title??et(String(s.at(-1))),u=p?.help??t.description,h=n??t.default,y=o.findIndex($=>$===h||String($)===String(h)),b="__unset__";return l`
    <div class="cfg-field">
      ${d?l`<label class="cfg-field__label">${r}</label>`:f}
      ${u?l`<div class="cfg-field__help">${u}</div>`:f}
      <select
    ...
    <div class="cfg-map">
      <div class="cfg-map__header">
        ...
        <button
          ...
          class="cfg-map__add"
          ?disabled=${o}
          @click=${()=>{const u={...n};let h=1,y=`custom-${h}`;for(;y in u;)h+=1,y=`custom-${h}`;u[y]=p?{}:Lu(t),d(s,u)}}
        >
      ...
      ${r.length===0?l`
        ...
        <div class="cfg-map__items">
          ${r.map(([u,h])=>{const y=[...s,u],b=Ew(h);return l`
  ...
  `},No={env:{label:"Environment Variables",description:"Environment variables passed to the gateway process"},update:{label:"Updates",description:"Auto-update settings and release channel"},agents:{label:"Agents",description:"Agent configurations, models, and identities"},auth:{label:"Authentication",description:"API keys and authentication profiles"},channels:{label:"Channels",description:"Messaging channels (Telegram, Discord, Slack, etc.)"},messages:{label:"Messages",description:"Message handling and routing settings"},commands:{label:"Commands",description:"Custom slash commands"},hooks:{label:"Hooks",description:"Webhooks and event hooks"},skills:{label:"Skills",description:"Skill packs and capabilities"},tools:{label:"Tools",description:"Tool configurations (browser, search, etc.)"},gateway:{label:"Gateway",description:"Gateway server settings (port, auth, binding)"},wizard:{label:"Setup Wizard",description:"Setup wizard state and history"},meta:{label:"Metadata",description:"Gateway metadata and version information"},logging:{label:"Logging",description:"Log levels and output configuration"},browser:{label:"Browser",description:"Browser automation settings"},ui:{label:"UI",description:"User interface preferences"},models:{label:"Models",description:"AI model configurations and providers"},bindings:{label:"Bindings",description:"Key bindings and shortcuts"},broadcast:{label:"Broadcast",description:"Broadcast and notification settings"},audio:{label:"Audio",description:"Audio input/output settings"},session:{label:"Session",description:"Session management and persistence"},cron:{label:"Cron",description:"Scheduled tasks and automation"},web:{label:"Web",description:"Web server and API settings"},discovery:{label:"Discovery",description:"Service discovery and networking"},canvasHost:{label:"Canvas Host",description:"Canvas rendering and display"},talk:{label:"Talk",description:"Voice and speech settings"},plugins:{label:"Plugins",description:"Plugin management and extensions"},user:{label:"User Profile",description:"Your display name and avatar"}};function Tl(e){return Al[e]??Al.default}function Iw(e,t,n){if(!n)return!0;const s=n.toLowerCase(),i=No[e];return e.toLowerCase().includes(s)||i&&(i.label.toLowerCase().includes(s)||i.description.toLowerCase().includes(s))?!0:On(t,s)}function On(e,t){if(e.title?.toLowerCase().includes(t)||e.description?.toLowerCase().includes(t)||e.enum?.some(s=>String(s).toLowerCase().includes(t)))return!0;if(e.properties){for(const[s,i]of Object.entries(e.properties))if(s.toLowerCase().includes(t)||On(i,t))return!0}if(e.items){const s=Array.isArray(e.items)?e.items:[e.items];for(const i of s)if(i&&On(i,t))return!0}if(e.additionalProperties&&typeof e.additionalProperties=="object"&&On(e.additionalProperties,t))return!0;const n=e.anyOf??e.oneOf??e.allOf;if(n){for(const s of n)if(s&&On(s,t))return!0}return!1}function Dw(e){if(!e.schema)return l`
    ...
    `;const s=new Set(e.unsupportedPaths??[]),i=t.properties,a=e.searchQuery??"",o=e.activeSection,c=e.activeSubsection??null,p=Object.entries(i).toSorted((u,h)=>{const y=xe([u[0]],e.uiHints)?.order??50,b=xe([h[0]],e.uiHints)?.order??50;return y!==b?y-b:u[0].localeCompare(h[0])}).filter(([u,h])=>!(o&&u!==o||a&&!Iw(u,h,a)));let r=null;if(o&&c&&p.length===1){const u=p[0]?.[1];u&&ze(u)==="object"&&u.properties&&u.properties[c]&&(r={sectionKey:o,subsectionKey:c,schema:u.properties[c]})}return p.length===0?l`
    ...
    <div class="config-form config-form--modern">
      ${r?(()=>{const{sectionKey:u,subsectionKey:h,schema:y}=r,b=xe([u,h],e.uiHints),$=b?.label??y.title??et(h),k=b?.help??y.description??"",S=n[u],A=S&&typeof S=="object"?S[h]:void 0,P=`config-section-${u}-${h}`;return l`
            ...
            `})():p.map(([u,h])=>{const y=No[u]??{label:u.charAt(0).toUpperCase()+u.slice(1),description:h.description??""};return l`
  ...
  `}function jk(e){const t=e.connected,n=e.sending||e.stream!==null;e.canAbort&&e.onAbort;const i=e.sessions?.sessions?.find(h=>h.key===e.sessionKey)?.reasoningLevel??"off",a=e.showThinking&&i!=="off",o={name:e.assistantName,avatar:e.assistantAvatar??e.assistantAvatarUrl??null},c=(e.attachments?.length??0)>0,d=e.connected?c?"Add a message or paste more images...":"Message (↩ to send, ⌘↩ to queue, Shift+↩ for line breaks)":"Connect to the gateway to start chatting…",p=e.splitRatio??.6,r=!!(e.sidebarOpen&&e.onCloseSidebar),u=l`
    ...
    >
      ${e.loading?l`
            ...
            `:f}
      ${pi(Qk(e),h=>h.key,h=>{try{if(h.kind==="reading-indicator")return vm(o,e.currentToolInfo);if(h.kind==="stream")return ym(h.text,h.startedAt,e.onOpenSidebar,o,e.currentToolInfo);if(h.kind==="compaction-summary")return $m(h.message);if(h.kind==="group"){const y=e.resolveImageUrl?(b,$)=>e.resolveImageUrl(b,$):void 0;return bm(h,{onOpenSidebar:e.onOpenSidebar,onOpenFile:e.onOpenFile,onOpenProof:e.onOpenProof,onPushToDrive:e.onPushToDrive,onImageClick:e.onImageClick,resolveImageUrl:y,showReasoning:a,assistantName:e.assistantName,assistantAvatar:o.avatar,userName:e.userName,userAvatar:e.userAvatar})}return f}catch(y){return console.error("[chat] item render error:",y,h.key),f}})}
    </div>
  `;return l`
    <section 
      class="card chat"
      @dragover=${Lk}
      @dragenter=${h=>Ik(h,h.currentTarget)}
      @dragleave=${h=>Dk(h,h.currentTarget)}
      @drop=${h=>Mk(h,e)}
    >
...
`)}function O0(e){const t=new Date(e),s=new Date().getTime()-t.getTime(),i=Math.floor(s/(1e3*60));if(i<1)return"Just now";if(i<60)return`${i}m ago`;const a=Math.floor(i/60);return a<24?`${a}h ago`:t.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})}function N0(e){const t="VAULT",n=encodeURIComponent(`01-Daily/${e}`);return`obsidian://open?vault=${t}&file=${n}`}let Kn=null,hn=null;function Wl(e,t,n=1500){Kn&&clearTimeout(Kn),Kn=setTimeout(()=>{e!==hn&&(hn=e,t(e))},n)}function F0(e,t){Kn&&clearTimeout(Kn),e!==hn&&(hn=e,t(e))}function ea(e){for(const t of e.querySelectorAll('input[type="checkbox"]')){const n=t;n.checked?n.setAttribute("checked",""):n.removeAttribute("checked")}return L0(e.innerHTML)}function B0(e){const{data:t,loading:n,error:s,onRefresh:i,onGenerate:a,onOpenInObsidian:o,onSaveBrief:c,onToggleCheckbox:d,onOpenFile:p}=e;if(n)return l`
  ...
  `}function Z0(e){const{workspace:t,itemSearchQuery:n,expandedFolders:s=new Set,showCompletedTasks:i=!1,onItemSearch:a,onBack:o,onItemClick:c,onSessionClick:d,onPinToggle:p,onPinSessionToggle:r,onToggleFolder:u,onToggleTaskComplete:h,onCreateTask:y,onToggleCompletedTasks:b,onStartTask:$,editingTaskId:k,onEditTask:S,onUpdateTask:A,onBatchPushToDrive:P}=e,R=Hl(n,t.pinned).toSorted((O,ke)=>ke.modified.getTime()-O.modified.getTime()),x=Vl(n,t.pinnedSessions),_=Hl(n,t.outputs).filter(O=>!t.pinned.some(ke=>ke.path===O.path)),T=(t.folderTree?.length??0)>0,F=T?Gu(n,t.folderTree):[],D=Vl(n,t.sessions),z=new Set(t.pinnedSessions.map(O=>O.key)),W=new Set(t.pinned.map(O=>O.path)),j=n.trim().length>0,de=R.length>0||x.length>0,Te=D.length>0||t.sessions.length===0||j,Ke=G0(t.outputs),Y=Ke.length>0&&!j,te={expandedFolders:s,pinnedPaths:W,workspaceId:t.id,onToggleFolder:u,onItemClick:c,onPinToggle:p};return l`
    <div class="workspaces-container">
      ...
      <div class="workspace-content">
        ...
        ${e$({tasks:t.tasks??[],workspaceName:t.name,showCompleted:i,onToggleTaskComplete:h,onCreateTask:y,onToggleCompletedTasks:b,onStartTask:$,editingTaskId:k,onEditTask:S,onUpdateTask:A})}
  ...
  `}function e$(e){const{tasks:t,workspaceName:n,showCompleted:s,onToggleTaskComplete:i,onCreateTask:a,onToggleCompletedTasks:o,onStartTask:c,editingTaskId:d,onEditTask:p,onUpdateTask:r}=e,u=js(t.filter(y=>y.status==="pending")),h=js(t.filter(y=>y.status==="complete"));return l`
    <section class="ws-section">
      <div class="ws-section__header">
        <h3>Tasks</h3>
      ...
      ${c?l`
            ...
            `:l`
              <div class="workspaces-body">
                ...
                ${n$({tasks:r,taskFilter:u,taskSort:h,taskSearch:y,onToggleTaskComplete:de,onSetTaskFilter:Ke,onSetTaskSort:Y,onSetTaskSearch:te,onCreateTask:Te,workspaceNames:k,onStartTask:ke,editingTaskId:$,onEditTask:vt,onUpdateTask:J})}
              </div>
            `}
    </div>
  `}function n$(e){const{tasks:t,taskFilter:n,taskSort:s="due",taskSearch:i="",onToggleTaskComplete:a,onSetTaskFilter:o,onSetTaskSort:c,onSetTaskSearch:d,onCreateTask:p,workspaceNames:r=[],onStartTask:u,editingTaskId:h,onEditTask:y,onUpdateTask:b}=e;if(t.length===0&&!p)return l``;let $;if(n==="outstanding")$=t.filter(S=>S.status==="pending");else if(n==="today"){const S=re();$=t.filter(A=>A.status==="pending"&&A.dueDate!=null&&A.dueDate<=S)}else n==="complete"?$=t.filter(S=>S.status==="complete"):$=t;if(i){const S=i.toLowerCase();$=$.filter(A=>A.title.toLowerCase().includes(S)||A.project?.toLowerCase().includes(S))}const k=js($,s);return l`
  ...
  `}function J$(e,t,n,s,i,a){const o=e.updatedAt?B(e.updatedAt):"n/a",c=e.thinkingLevel??"",d=Ju(e.modelProvider),p=W$(c,d),r=K$(e.modelProvider),u=e.verboseLevel??"",h=e.reasoningLevel??"",y=e.displayName??e.key,b=e.kind!=="global",$=b?`${Ka("chat",t)}?session=${encodeURIComponent(e.key)}`:null;return l`
    <div class="table-row">
    ...
    <div class="second-brain-panel">
      <div class="second-brain-search knowledge-search">
        <input
          ...
          .value=${i??""}
          @input=${h=>{const y=h.target.value;e.onSearch(y),e.onFileSearch?.(y)}}
        />
      </div>
      ...
      ${!p&&t?l`
        ${t.sections.map(h=>{const y=r(h.entries);return h.entries.length===0?f:l`
            <div class="second-brain-section">
              <div class="second-brain-section-header">
              ...
              <div class="second-brain-entry-list">
                ${y.length>0?y.map(b=>ia(b,e)):p?l`<div class="second-brain-empty-inline">No matches</div>`:f}
              </div>
            </div>
          `})}
  ...
  `:f}function ic(e){const t=e.trim();if(!t)return t;const n=t.split(/\s+/);if(n.length>=2&&n.length%2===0){const c=n.length/2,d=n.slice(0,c).join(" "),p=n.slice(c).join(" ");if(d.toLowerCase()===p.toLowerCase())return d}const s=t.replace(/\s+/g," ").toLowerCase(),i=Math.floor(s.length/2),a=s.slice(0,i).trim(),o=s.slice(i).trim();return a&&a===o?t.slice(0,Math.ceil(t.length/2)).trim():t}function Ma(e,t){const n=t?.sessionId?.trim();return n?`session:${n}`:`key:${e.trim().toLowerCase()}`}function ac(e){if(e===Q)return!0;const t=e.toLowerCase();return!!(t==="agent:main:main"||t.endsWith(":main"))}function C1(e){const t=e.sessionsResult?.sessions,n=[...new Set(e.settings.openTabs.map(c=>c.trim()).filter(Boolean))].filter(c=>!ac(c)),s=Lt(t,e.sessionKey),i=Ma(e.sessionKey,s),a=new Map;for(const c of n){const d=Lt(t,c),p=Ma(c,d);if(!a.has(p)){a.set(p,c);continue}c===e.sessionKey&&a.set(p,c)}const o=[...a.values()];if(o.length===0){const c=e.sessionKey.trim()||"main";ac(c)||o.push(c)}return{tabKeys:o,activeIdentity:i}}function E1(e){if(e.wizardActive&&e.wizardState)return np(e.wizardState,{onStepChange:r=>{e.handleWizardStepChange?.(r)},onAnswerChange:(r,u)=>{e.handleWizardAnswerChange?.(r,u)},onPreview:()=>{e.handleWizardPreview?.()},onGenerate:()=>{e.handleWizardGenerate?.()},onClose:()=>{e.handleWizardClose?.()},onFileToggle:(r,u)=>{e.handleWizardFileToggle?.(r,u)},onConfigToggle:(r,u)=>{e.handleWizardConfigToggle?.(r,u)}});e.presenceEntries.length;const t=e.sessionsResult?.count??null;e.cronStatus?.nextWakeAtMs;const n=e.connected?null:"Disconnected from gateway.",s=e.tab==="chat",i=s&&(e.settings.chatFocusMode||e.onboarding),a=e.onboarding?!1:e.settings.chatShowThinking,o=T1(e),c=e.chatAvatarUrl??o??null,{tabKeys:d,activeIdentity:p}=C1(e);return l`
    <div class="shell ${s?"shell--chat":""} ${i?"shell--chat-focus":""} ${e.settings.navCollapsed?"shell--nav-collapsed":""} ${e.onboarding?"shell--onboarding":""}">
      ...
      <aside class="nav ${e.settings.navCollapsed?"nav--collapsed":""}">
        ...
        ${bh.map(r=>{const u=e.settings.navGroupsCollapsed[r.label]??!1,h=r.tabs.some(b=>b===e.tab),y=!r.label||r.tabs.length===1&&Vn(r.tabs[0])===r.label;return l`
          ...
          `})}
        ${wh.map(r=>{const u=e.settings.navGroupsCollapsed[r.label]??!0,h=r.tabs.some(y=>y===e.tab);return l`
          ...
          <div>
            ...
            `:e.tab==="chat"?l`
              <div class="session-tabs">
                ...
                ${pi(d,r=>r,(r,u)=>{const h=Lt(e.sessionsResult?.sessions,r),y=Ma(r,h)===p,$=(()=>{if(h?.label||h?.displayName)return ic(h.label??h.displayName);const x=Pe.get(r);if(x)return ic(x);if(r==="agent:main:support")return"Support";if(r.includes("webchat")){const T=r.match(/webchat[:-](\d+)/);return T?`Chat ${T[1]}`:"Chat"}if(r.includes("main"))return"MAIN";const _=r.split(/[:-]/);return _[_.length-1]||r})(),k=e.workingSessions.has(r),S=e.settings.tabLastViewed[r]??0,A=h?.updatedAt??0,P=!y&&!k&&A>S,R=e.editingTabKey===r;return l`
                      <div
