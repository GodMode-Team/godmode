...
`}function Dc(e,t,n){if(t.length===0)return;let s=e;for(let i=0;i<t.length-1;i+=1){const o=t[i],l=t[i+1];if(typeof o=="number"){if(!Array.isArray(s))return;s[o]==null&&(s[o]=typeof l=="number"?[]:{}),s=s[o]}else{if(typeof s!="object"||s==null)return;const c=s;c[o]==null&&(c[o]=typeof l=="number"?[]:{}),s=c[o]}}const a=t[t.length-1];if(typeof a=="number"){Array.isArray(s)&&(s[a]=n);return}typeof s=="object"&&s!=null&&(s[a]=n)}function Mc(e,t){if(t.length===0)return;let n=e;for(let a=0;a<t.length-1;a+=1){const i=t[a];if(typeof i=="number"){if(!Array.isArray(n))return;n=n[i]}else{if(typeof n!="object"||n==null)return;n=n[i]}if(n==null)return}const s=t[t.length-1];if(typeof s=="number"){Array.isArray(n)&&n.splice(s,1);return}typeof n=="object"&&n!=null&&delete n[s]}async function Ze(e){if(!(!e.client||!e.connected)){e.configLoading=!0,e.lastError=null;try{const t=await e.client.request("config.get",{});mh(e,t)}catch(t){e.lastError=String(t)}finally{e.configLoading=!1}}}async function Oc(e){if(!(!e.client||!e.connected)&&!e.configSchemaLoading){e.configSchemaLoading=!0;try{const t=await e.client.request("config.schema",{});gh(e,t)}catch(t){e.lastError=String(t)}finally{e.configSchemaLoading=!1}}}function gh(e,t){e.configSchema=t.schema??null,e.configUiHints=t.uiHints??{},e.configSchemaVersion=t.version??null}function mh(e,t){e.configSnapshot=t;const n=typeof t.raw=="string"?t.raw:t.config&&typeof t.config=="object"?cn(t.config):e.configRaw;!e.configFormDirty||e.configFormMode==="raw"?e.configRaw=n:e.configForm?e.configRaw=cn(e.configForm):e.configRaw=n,e.configValid=typeof t.valid=="boolean"?t.valid:null,e.configIssues=Array.isArray(t.issues)?t.issues:[],e.configFormDirty||(e.configForm=It(t.config??{}),e.configFormOriginal=It(t.config??{}),e.configRawOriginal=n)}async function Ms(e){if(!(!e.client||!e.connected)){e.configSaving=!0,e.lastError=null;try{const t=e.configFormMode==="form"&&e.configForm?cn(e.configForm):e.configRaw,n=e.configSnapshot?.hash;if(!n){e.lastError="Config hash missing; reload and retry.";return}await e.client.request("config.set",{raw:t,baseHash:n}),e.configFormDirty=!1,await Ze(e)}catch(t){e.lastError=String(t)}finally{e.configSaving=!1}}}async function vh(e){if(!(!e.client||!e.connected)){e.configApplying=!0,e.lastError=null;try{const t=e.configFormMode==="form"&&e.configForm?cn(e.configForm):e.configRaw,n=e.configSnapshot?.hash;if(!n){e.lastError="Config hash missing; reload and retry.";return}await e.client.request("config.apply",{raw:t,baseHash:n,sessionKey:e.applySessionKey}),e.configFormDirty=!1,await Ze(e)}catch(t){e.lastError=String(t)}finally{e.configApplying=!1}}}async function Ar(e){if(!(!e.client||!e.connected)){e.updateRunning=!0,e.lastError=null;try{await e.client.request("godmode.update.run",{})}catch(t){e.lastError=String(t)}finally{e.updateRunning=!1}}}async function yh(e){if(!(!e.client||!e.connected)){e.pluginUpdateRunning=!0,e.lastError=null;try{await e.client.request("godmode.update.pluginRun",{})}catch(t){e.lastError=String(t)}finally{e.pluginUpdateRunning=!1}}}function nn(e,t,n){const s=It(e.configForm??e.configSnapshot?.config??{});Dc(s,t,n),e.configForm=s,e.configFormDirty=!0,e.configFormMode==="form"&&(e.configRaw=cn(s))}function xr(e,t){const n=It(e.configForm??e.configSnapshot?.config??{});Mc(n,t),e.configForm=n,e.configFormDirty=!0,e.configFormMode==="form"&&(e.configRaw=cn(n))}async function bh(e,t,n){nn(e,["agents","defaults","model","primary"],t),nn(e,["agents","defaults","model","fallbacks"],n),await Ms(e)}function wh(e){const{values:t,original:n}=e;return t.name!==n.name||t.displayName!==n.displayName||t.about!==n.about||t.picture!==n.picture||t.banner!==n.banner||t.website!==n.website||t.nip05!==n.nip05||t.lud16!==n.lud16}function $h(e){const{state:t,callbacks:n,accountId:s}=e,a=wh(t),i=(l,c,u={})=>{const{type:h="text",placeholder:f,maxLength:m,help:w}=u,$=t.values[l]??"",d=t.fieldErrors[l],g=`nostr-profile-${l}`;return h==="textarea"?r`
        <div class="form-field" style="margin-bottom: 12px;">
          ...
          ${d?r`<div style="font-size: 12px; color: var(--danger-color); margin-top: 2px;">${d}</div>`:p}
        </div>
      `:r`
      <div class="form-field" style="margin-bottom: 12px;">
        <label for="${g}" style="display: block; margin-bottom: 4px; font-weight: 500;">
...
`+n.join(`
`),d=this.blockquote($);i[i.length-1]=d,s=s.substring(0,s.length-w.raw.length)+d.raw,a=a.substring(0,a.length-w.text.length)+d.text;break}else if(m?.type==="list"){let w=m,$=w.raw+`
`+n.join(`
`),d=this.list($);i[i.length-1]=d,s=s.substring(0,s.length-m.raw.length)+d.raw,a=a.substring(0,a.length-w.raw.length)+d.raw,n=$.substring(i.at(-1).raw.length).split(`
...
`,e=e.substring(m.length+1),c=!0),!c){let d=this.rules.other.nextBulletRegex($),g=this.rules.other.hrRegex($),k=this.rules.other.fencesBeginRegex($),A=this.rules.other.headingBeginRegex($),T=this.rules.other.htmlBeginRegex($),x=this.rules.other.blockquoteBeginRegex($);for(;e;){let _=e.split(`
`,1)[0],P;if(m=_,this.options.pedantic?(m=m.replace(this.rules.other.listReplaceNesting,"  "),P=m):P=m.replace(this.rules.other.tabCharGlobal,"    "),k.test(m)||A.test(m)||T.test(m)||x.test(m)||d.test(m)||g.test(m))break;if(P.search(this.rules.other.nonSpaceChar)>=$||!m.trim())h+=`
...
`)?"":`
`)+a.raw,o.text+=`
`+a.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=o.text):n.push(a);continue}if(t){let o="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(o);break}else throw new Error(o)}}return this.state.top=!0,n}inline(t,n=[]){return this.inlineQueue.push({src:t,tokens:n}),n}inlineTokens(t,n=[]){let s=t,a=null;if(this.tokens.links){let c=Object.keys(this.tokens.links);if(c.length>0)for(;(a=this.tokenizer.rules.inline.reflinkSearch.exec(s))!=null;)c.includes(a[0].slice(a[0].lastIndexOf("[")+1,-1))&&(s=s.slice(0,a.index)+"["+"a".repeat(a[0].length-2)+"]"+s.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(a=this.tokenizer.rules.inline.anyPunctuation.exec(s))!=null;)s=s.slice(0,a.index)+"++"+s.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let i;for(;(a=this.tokenizer.rules.inline.blockSkip.exec(s))!=null;)i=a[2]?a[2].length:0,s=s.slice(0,a.index+i)+"["+"a".repeat(a[0].length-i-2)+"]"+s.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);s=this.options.hooks?.emStrongMask?.call({lexer:this},s)??s;let o=!1,l="";for(;t;){o||(l=""),o=!1;let c;if(this.options.extensions?.inline?.some(h=>(c=h.call({lexer:this},t,n))?(t=t.substring(c.raw.length),n.push(c),!0):!1))continue;if(c=this.tokenizer.escape(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.tag(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.link(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.reflink(t,this.tokens.links)){t=t.substring(c.raw.length);let h=n.at(-1);c.type==="text"&&h?.type==="text"?(h.raw+=c.raw,h.text+=c.text):n.push(c);continue}if(c=this.tokenizer.emStrong(t,s,l)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.codespan(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.br(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.del(t,s,l)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.autolink(t)){t=t.substring(c.raw.length),n.push(c);continue}if(!this.state.inLink&&(c=this.tokenizer.url(t))){t=t.substring(c.raw.length),n.push(c);continue}let u=t;if(this.options.extensions?.startInline){let h=1/0,f=t.slice(1),m;this.options.extensions.startInline.forEach(w=>{m=w.call({lexer:this},f),typeof m=="number"&&m>=0&&(h=Math.min(h,m))}),h<1/0&&h>=0&&(u=t.substring(0,h+1))}if(c=this.tokenizer.inlineText(u)){t=t.substring(c.raw.length),c.raw.slice(-1)!=="_"&&(l=c.raw.slice(-1)),o=!0;let h=n.at(-1);h?.type==="text"?(h.raw+=c.raw,h.text+=c.text):n.push(c);continue}if(t){let h="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(h);break}else throw new Error(h)}}return n}},Bs=class{options;parser;constructor(e){this.options=e||zt}space(e){return""}code({text:e,lang:t,escaped:n}){let s=(t||"").match(fe.notSpaceStart)?.[0],a=e.replace(fe.endingNewline,"")+`
...
`),o=n==="assistant"?Ea(i):_s(i);return za(o)?null:o}}if(typeof t.text=="string"){const a=Na(t.text);if(!a)return null;const i=n==="assistant"?Ea(a):_s(a);return za(i)?null:i}return null}function co(e){if(!e||typeof e!="object")return un(e);const t=e;if(Ba.has(t))return Ba.get(t)??null;const n=un(e);return Ba.set(t,n),n}function wi(e){const n=e.content,s=[];if(Array.isArray(n))for(const l of n){const c=l;if(c.type==="thinking"&&typeof c.thinking=="string"){const u=c.thinking.trim();u&&s.push(u)}}if(s.length>0)return s.join(`
...
`);return s.length>Jr?s.slice(0,Jr)+"…":n.length<t.length?s+"…":s}function ym(e){const t=e,n=km(t.content),s=[];for(const a of n){const i=(typeof a.type=="string"?a.type:"").toLowerCase();(["toolcall","tool_call","tooluse","tool_use"].includes(i)||typeof a.name=="string"&&a.arguments!=null)&&s.push({kind:"call",name:a.name??"tool",args:Sm(a.arguments??a.args)})}for(const a of n){const i=(typeof a.type=="string"?a.type:"").toLowerCase();if(i!=="toolresult"&&i!=="tool_result")continue;const o=Am(a);if(el(o))continue;const l=typeof a.name=="string"?a.name:"tool";s.push({kind:"result",name:l,text:o})}if(fd(e)&&!s.some(a=>a.kind==="result")){const a=typeof t.toolName=="string"&&t.toolName||typeof t.tool_name=="string"&&t.tool_name||"tool",i=co(e)??void 0;el(i)||s.push({kind:"result",name:a,text:i})}return s}const bm=new Set(["write","read","edit","attach"]);function wm(e){if(!e||typeof e!="object")return null;const t=e,n=t.path??t.file_path??t.filePath;return typeof n=="string"&&n.trim()?n.trim():null}function $m(e){if(!e)return null;const t=e.match(/(?:\/(?:Users|home|tmp|var)\/\S+|~\/\S+)/);return t?t[0].replace(/[.,;:!?)'"]+$/,""):null}function Zr(e,t,n,s,a){const i=um({name:e.name,args:e.args}),o=pm(i),l=!!e.text?.trim(),c=xm(e.text);if(c?.type==="proof"&&c.slug)return r`
      <div class="chat-artifact-card">
        ...
        <div class="chat-artifact-card__actions">
          ${s?r`<button class="chat-artifact-card__btn" @click=${A=>{A.stopPropagation(),s(c.slug)}}>Open</button>`:p}
          ${c.filePath&&a?r`<button class="chat-artifact-card__btn chat-artifact-card__btn--drive" @click=${A=>{A.stopPropagation(),a(c.filePath)}}>Drive</button>`:p}
        </div>
      </div>
...
`).length:0,w=l&&(e.text?.length??0)<=fm,$=l&&!w&&m>mm,d=l&&!$,g=!l,k=e.kind==="call"?"chat-tool-card--call":"chat-tool-card--result";return r`
    <div
    ...
    >
      ...
      ${d?r`<div class="chat-tool-card__inline mono">${e.text}</div>`:p}
    </div>
...
`);)a=a.slice(1);return a.trim()}function Em(e){return typeof e!="number"||!Number.isFinite(e)||e<=0?null:e>=1024*1024?`${(e/(1024*1024)).toFixed(1)} MB`:e>=1024?`${Math.round(e/1024)} KB`:`${Math.round(e)} B`}function $i(e){const t=e,n=t.content,s=[];if(Array.isArray(n))for(const i of n){if(typeof i!="object"||i===null)continue;const o=i;if(o.type==="image"){const l=o.source;if(l?.type==="base64"&&typeof l.data=="string"){const c=l.data,u=l.media_type||"image/png",h=c.startsWith("data:")?c:`data:${u};base64,${c}`;s.push({url:h})}else if(typeof o.data=="string"&&typeof o.mimeType=="string"){const c=o.data.startsWith("data:")?o.data:`data:${o.mimeType};base64,${o.data}`;s.push({url:c})}else typeof o.url=="string"?s.push({url:o.url}):o.omitted===!0&&s.push({omitted:!0,bytes:typeof o.bytes=="number"?o.bytes:void 0,mimeType:typeof o.mimeType=="string"?o.mimeType:void 0,alt:typeof o.fileName=="string"?o.fileName:void 0})}else if(o.type==="image_url"){const l=o.image_url;typeof l?.url=="string"&&s.push({url:l.url})}else o.type==="attachment"&&typeof o.content=="string"&&(o.mimeType||"").startsWith("image/")&&s.push({url:o.content,alt:o.fileName||void 0});if(o.type==="text"&&typeof o.text=="string"){const l=/data:image\/[^;]+;base64,[A-Za-z0-9+/=]+/g,c=o.text.match(l);if(c)for(const u of c)s.push({url:u})}if(Array.isArray(o.content))for(const l of o.content){if(typeof l!="object"||l===null)continue;const c=l;if(c.type==="image"){const u=c.source;if(u?.type==="base64"&&typeof u.data=="string"){const h=u.media_type||"image/png",f=u.data.startsWith("data:")?u.data:`data:${h};base64,${u.data}`;s.push({url:f})}else if(typeof c.data=="string"&&typeof c.mimeType=="string"){const h=c.data.startsWith("data:")?c.data:`data:${c.mimeType};base64,${c.data}`;s.push({url:h})}else c.omitted===!0&&s.push({omitted:!0,bytes:typeof c.bytes=="number"?c.bytes:void 0,mimeType:typeof c.mimeType=="string"?c.mimeType:void 0,alt:typeof c.fileName=="string"?c.fileName:void 0})}}}const a=t.attachments;if(Array.isArray(a))for(const i of a){if(typeof i!="object"||i===null)continue;const o=i;if(o.type==="image"&&typeof o.content=="string"){const l=o.mimeType||"image/png",c=o.content.startsWith("data:")?o.content:`data:${l};base64,${o.content}`;s.push({url:c,alt:o.fileName||void 0})}else o.type==="image"&&o.omitted===!0&&s.push({omitted:!0,bytes:typeof o.bytes=="number"?o.bytes:void 0,mimeType:typeof o.mimeType=="string"?o.mimeType:void 0,alt:typeof o.fileName=="string"?o.fileName:void 0})}return s}function Pm(e){const t=e,n=t.content,s=[];if(Array.isArray(n))for(const i of n){if(typeof i!="object"||i===null)continue;const o=i;if(o.type==="attachment"&&typeof o.content=="string"){const l=o.mimeType||"application/octet-stream";l.startsWith("image/")||s.push({fileName:o.fileName||"file",mimeType:l,content:o.content})}}const a=t.attachments;if(Array.isArray(a))for(const i of a){if(typeof i!="object"||i===null)continue;const o=i;o.type==="file"&&typeof o.content=="string"&&s.push({fileName:o.fileName||"file",mimeType:o.mimeType||"application/octet-stream",content:o.content})}return s}function Lm(e,t){return r`
  ...
  `}function Dm(e,t){const n=uo(e.role),s=t.assistantName??"Assistant",a=t.userName??"You",i=n==="user"?a:n==="assistant"?s:n,o=n==="user"?"user":n==="assistant"?"assistant":"other",l=new Date(e.timestamp).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"});return r`
    <div class="chat-group ${o}">
      ...
      <div class="chat-group-messages">
        ${e.messages.map((c,u)=>wd(c.message,{isStreaming:e.isStreaming&&u===e.messages.length-1,showReasoning:t.showReasoning},t.onOpenSidebar,t.onOpenFile,t.onOpenProof,t.onImageClick,t.resolveImageUrl,t.onPushToDrive))}
        <div class="chat-group-footer">
  ...
  `}function po(e,t){const n=uo(e),s=t?.assistantName?.trim()||"Assistant",a=typeof t?.assistantAvatar=="string"?t.assistantAvatar.trim():"",i=t?.userName?.trim()||"You",o=typeof t?.userAvatar=="string"?t.userAvatar.trim():"",l=n==="user"?"user":n==="assistant"?"assistant":n==="tool"?"tool":"other";return n==="user"?o&&nl(o)?r`<img
    ...
    <div class="chat-message-images">
      ${s.map(i=>{const o=i.resolvedUrl||i.url;if(!o){const c=Em(i.bytes),h=[i.mimeType?i.mimeType.replace("image/","").toUpperCase():null,c].filter(Boolean).join(" · ");return r`
            <div
  ...
  `;return r`
    <div class="chat-toolbar">
      ...
      <button
        ...
        @click=${()=>{if(e.sidebarOpen)e.handleCloseSidebar();else if(e.sidebarContent||e.sidebarProofSlug)e.sidebarOpen=!0;else{const u=e.chatMessages;if(u?.length)for(const h of u.slice(-10).reverse()){const f=Array.isArray(h.content)?h.content:[];for(const m of f){const w=typeof m.text=="string"?m.text:typeof m.content=="string"?m.content:null;if(w)try{const $=JSON.parse(w);if($._sidebarAction?.type==="proof"&&$._sidebarAction.slug){e.handleOpenProofDoc($._sidebarAction.slug);return}}catch{}}}}}}
...
Deletes the session entry and archives its transcript.`)&&(e.sessionsResult?.sessions&&(e.sessionsResult={...e.sessionsResult,sessions:e.sessionsResult.sessions.filter(d=>d.key!==w)}),e.client&&e.connected))try{await e.client.request("sessions.delete",{key:w,deleteTranscript:!0}),te(e)}catch(d){console.error("Failed to delete session:",d),te(e)}},u=m=>r`
  ...
  `};function tt(e){const{schema:t,value:n,path:s,hints:a,unsupported:i,disabled:o,onPatch:l}=e,c=e.showLabel??!0,u=je(t),h=_e(s,a),f=h?.label??t.title??st(String(s.at(-1))),m=h?.help??t.description,w=va(s);if(i.has(w))return r`<div class="cfg-field cfg-field--error">
      <div class="cfg-field__label">${f}</div>
      <div class="cfg-field__error">Unsupported schema node. Use Raw mode.</div>
    </div>`;if(t.anyOf||t.oneOf){const d=(t.anyOf??t.oneOf??[]).filter(_=>!(_.type==="null"||Array.isArray(_.type)&&_.type.includes("null")));if(d.length===1)return tt({...e,schema:d[0]});const g=_=>{if(_.const!==void 0)return _.const;if(_.enum&&_.enum.length===1)return _.enum[0]},k=d.map(g),A=k.every(_=>_!==void 0);if(A&&k.length>0&&k.length<=5){const _=n??t.default;return r`
        <div class="cfg-field">
      ...
      `}if(A&&k.length>5)return El({...e,options:k,value:n??t.default});const T=new Set(d.map(_=>je(_)).filter(Boolean)),x=new Set([...T].map(_=>_==="integer"?"number":_));if([...x].every(_=>["string","number","boolean"].includes(_))){const _=x.has("string"),P=x.has("number");if(x.has("boolean")&&x.size===1)return tt({...e,schema:{...t,type:"boolean",anyOf:void 0,oneOf:void 0}});if(_||P)return Rl({...e,inputType:P&&!_?"number":"text"})}}if(t.enum){const $=t.enum;if($.length<=5){const d=n??t.default;return r`
        <div class="cfg-field">
          ${c?r`<label class="cfg-field__label">${f}</label>`:p}
          ${m?r`<div class="cfg-field__help">${m}</div>`:p}
          <div class="cfg-segmented">
  ...
  `}function Rl(e){const{schema:t,value:n,path:s,hints:a,disabled:i,onPatch:o,inputType:l}=e,c=e.showLabel??!0,u=_e(s,a),h=u?.label??t.title??st(String(s.at(-1))),f=u?.help??t.description,m=u?.sensitive??Pw(s),w=u?.placeholder??(m?"••••":t.default!==void 0?`Default: ${rn(t.default)}`:""),$=n??"";return r`
    <div class="cfg-field">
      ...
      <div class="cfg-input-wrap">
        <input
          ...
          .value=${rn($)}
          ?disabled=${i}
          @input=${d=>{const g=d.target.value;if(l==="number"){if(g.trim()===""){o(s,void 0);return}const k=Number(g);o(s,Number.isNaN(k)?g:k);return}o(s,g)}}
  ...
  `}function Mw(e){const{schema:t,value:n,path:s,hints:a,disabled:i,onPatch:o}=e,l=e.showLabel??!0,c=_e(s,a),u=c?.label??t.title??st(String(s.at(-1))),h=c?.help??t.description,f=n??t.default??"",m=typeof f=="number"?f:0;return r`
    <div class="cfg-field">
      ...
      <div class="cfg-number">
        ...
        <input
          ...
          .value=${rn(f)}
          ?disabled=${i}
          @input=${w=>{const $=w.target.value,d=$===""?void 0:Number($);o(s,d)}}
        />
        <button
          type="button"
          class="cfg-number__btn"
  ...
  `}function El(e){const{schema:t,value:n,path:s,hints:a,disabled:i,options:o,onPatch:l}=e,c=e.showLabel??!0,u=_e(s,a),h=u?.label??t.title??st(String(s.at(-1))),f=u?.help??t.description,m=n??t.default,w=o.findIndex(d=>d===m||String(d)===String(m)),$="__unset__";return r`
    <div class="cfg-field">
      ${c?r`<label class="cfg-field__label">${h}</label>`:p}
      ${f?r`<div class="cfg-field__help">${f}</div>`:p}
      <select
  ...
  `}function Fw(e){const{schema:t,value:n,path:s,hints:a,unsupported:i,disabled:o,onPatch:l}=e,c=e.showLabel??!0,u=_e(s,a),h=u?.label??t.title??st(String(s.at(-1))),f=u?.help??t.description,m=Array.isArray(t.items)?t.items[0]:t.items;if(!m)return r`
      <div class="cfg-field cfg-field--error">
          ...
          ${w.map(($,d)=>r`
            <div class="cfg-array__item">
              ...
              <div class="cfg-array__item-content">
                ${tt({schema:m,value:$,path:[...s,d],hints:a,unsupported:i,disabled:o,showLabel:!1,onPatch:l})}
              </div>
            </div>
          `)}
        </div>
  ...
  `}function Pl(e){const{schema:t,value:n,path:s,hints:a,unsupported:i,disabled:o,reservedKeys:l,onPatch:c}=e,u=Iw(t),h=Object.entries(n??{}).filter(([f])=>!l.has(f));return r`
    <div class="cfg-map">
      <div class="cfg-map__header">
        ...
        <button
          ...
          class="cfg-map__add"
          ?disabled=${o}
          @click=${()=>{const f={...n};let m=1,w=`custom-${m}`;for(;w in f;)m+=1,w=`custom-${m}`;f[w]=u?{}:Vu(t),c(s,f)}}
        >
              ...
              <div class="cfg-map__item">
                <div class="cfg-map__item-key">
                  <input
                    ...
                    .value=${f}
                    ?disabled=${o}
                    @change=${d=>{const g=d.target.value.trim();if(!g||g===f)return;const k={...n};g in k||(k[g]=k[f],delete k[f],c(s,k))}}
                  />
                </div>
                <div class="cfg-map__item-value">
                  ${u?r`
                        <textarea
                          ...
                          .value=${$}
                          ?disabled=${o}
                          @change=${d=>{const g=d.target,k=g.value.trim();if(!k){c(w,void 0);return}try{c(w,JSON.parse(k))}catch{g.value=$}}}
                        ></textarea>
                      `:tt({schema:t,value:m,path:w,hints:a,unsupported:i,disabled:o,showLabel:!1,onPatch:c})}
                </div>
                <button
                  type="button"
  ...
  `},qo={env:{label:"Environment Variables",description:"Environment variables passed to the gateway process"},update:{label:"Updates",description:"Auto-update settings and release channel"},agents:{label:"Agents",description:"Agent configurations, models, and identities"},auth:{label:"Authentication",description:"API keys and authentication profiles"},channels:{label:"Channels",description:"Messaging channels (Telegram, Discord, Slack, etc.)"},messages:{label:"Messages",description:"Message handling and routing settings"},commands:{label:"Commands",description:"Custom slash commands"},hooks:{label:"Hooks",description:"Webhooks and event hooks"},skills:{label:"Skills",description:"Skill packs and capabilities"},tools:{label:"Tools",description:"Tool configurations (browser, search, etc.)"},gateway:{label:"Gateway",description:"Gateway server settings (port, auth, binding)"},wizard:{label:"Setup Wizard",description:"Setup wizard state and history"},meta:{label:"Metadata",description:"Gateway metadata and version information"},logging:{label:"Logging",description:"Log levels and output configuration"},browser:{label:"Browser",description:"Browser automation settings"},ui:{label:"UI",description:"User interface preferences"},models:{label:"Models",description:"AI model configurations and providers"},bindings:{label:"Bindings",description:"Key bindings and shortcuts"},broadcast:{label:"Broadcast",description:"Broadcast and notification settings"},audio:{label:"Audio",description:"Audio input/output settings"},session:{label:"Session",description:"Session management and persistence"},cron:{label:"Cron",description:"Scheduled tasks and automation"},web:{label:"Web",description:"Web server and API settings"},discovery:{label:"Discovery",description:"Service discovery and networking"},canvasHost:{label:"Canvas Host",description:"Canvas rendering and display"},talk:{label:"Talk",description:"Voice and speech settings"},plugins:{label:"Plugins",description:"Plugin management and extensions"},user:{label:"User Profile",description:"Your display name and avatar"}};function Il(e){return Ll[e]??Ll.default}function Nw(e,t,n){if(!n)return!0;const s=n.toLowerCase(),a=qo[e];return e.toLowerCase().includes(s)||a&&(a.label.toLowerCase().includes(s)||a.description.toLowerCase().includes(s))?!0:Bn(t,s)}function Bn(e,t){if(e.title?.toLowerCase().includes(t)||e.description?.toLowerCase().includes(t)||e.enum?.some(s=>String(s).toLowerCase().includes(t)))return!0;if(e.properties){for(const[s,a]of Object.entries(e.properties))if(s.toLowerCase().includes(t)||Bn(a,t))return!0}if(e.items){const s=Array.isArray(e.items)?e.items:[e.items];for(const a of s)if(a&&Bn(a,t))return!0}if(e.additionalProperties&&typeof e.additionalProperties=="object"&&Bn(e.additionalProperties,t))return!0;const n=e.anyOf??e.oneOf??e.allOf;if(n){for(const s of n)if(s&&Bn(s,t))return!0}return!1}function Bw(e){if(!e.schema)return r`
    ...
    <div class="config-form config-form--modern">
      ${h?(()=>{const{sectionKey:f,subsectionKey:m,schema:w}=h,$=_e([f,m],e.uiHints),d=$?.label??w.title??st(m),g=$?.help??w.description??"",k=n[f],A=k&&typeof k=="object"?k[m]:void 0,T=`config-section-${f}-${m}`;return r`
  ...
  `}const Uw=new Set(["title","description","default","nullable"]);function zw(e){return Object.keys(e??{}).filter(n=>!Uw.has(n)).length===0}function Hu(e){const t=e.filter(a=>a!=null),n=t.length!==e.length,s=[];for(const a of t)s.some(i=>Object.is(i,a))||s.push(a);return{enumValues:s,nullable:n}}function Gu(e){return!e||typeof e!="object"?{schema:null,unsupportedPaths:["<root>"]}:Wn(e,[])}function Wn(e,t){const n=new Set,s={...e},a=va(t)||"<root>";if(e.anyOf||e.oneOf||e.allOf){const l=Kw(e,t);return l||{schema:e,unsupportedPaths:[a]}}const i=Array.isArray(e.type)&&e.type.includes("null"),o=je(e)??(e.properties||e.additionalProperties?"object":void 0);if(s.type=o??e.type,s.nullable=i||e.nullable,s.enum){const{enumValues:l,nullable:c}=Hu(s.enum);s.enum=l,c&&(s.nullable=!0),l.length===0&&n.add(a)}if(o==="object"){const l=e.properties??{},c={};for(const[u,h]of Object.entries(l)){const f=Wn(h,[...t,u]);f.schema&&(c[u]=f.schema);for(const m of f.unsupportedPaths)n.add(m)}if(s.properties=c,e.additionalProperties===!0)n.add(a);else if(e.additionalProperties===!1)s.additionalProperties=!1;else if(e.additionalProperties&&typeof e.additionalProperties=="object"&&!zw(e.additionalProperties)){const u=Wn(e.additionalProperties,[...t,"*"]);s.additionalProperties=u.schema??e.additionalProperties,u.unsupportedPaths.length>0&&n.add(a)}}else if(o==="array"){const l=Array.isArray(e.items)?e.items[0]:e.items;if(!l)n.add(a);else{const c=Wn(l,[...t,"*"]);s.items=c.schema??l,c.unsupportedPaths.length>0&&n.add(a)}}else o!=="string"&&o!=="number"&&o!=="integer"&&o!=="boolean"&&!s.enum&&n.add(a);return{schema:s,unsupportedPaths:Array.from(n)}}function Kw(e,t){if(e.allOf)return null;const n=e.anyOf??e.oneOf;if(!n)return null;const s=[],a=[];let i=!1;for(const l of n){if(!l||typeof l!="object")return null;if(Array.isArray(l.enum)){const{enumValues:c,nullable:u}=Hu(l.enum);s.push(...c),u&&(i=!0);continue}if("const"in l){if(l.const==null){i=!0;continue}s.push(l.const);continue}if(je(l)==="null"){i=!0;continue}a.push(l)}if(s.length>0&&a.length===0){const l=[];for(const c of s)l.some(u=>Object.is(u,c))||l.push(c);return{schema:{...e,enum:l,nullable:i,anyOf:void 0,oneOf:void 0,allOf:void 0},unsupportedPaths:[]}}if(a.length===1){const l=Wn(a[0],t);return l.schema&&(l.schema.nullable=i||l.schema.nullable),l}const o=new Set(["string","number","integer","boolean"]);return a.length>0&&s.length===0&&a.every(l=>l.type&&o.has(String(l.type)))?{schema:{...e,nullable:i},unsupportedPaths:[]}:null}function Ww(e,t){let n=e;for(const s of t){if(!n)return null;const a=je(n);if(a==="object"){const i=n.properties??{};if(typeof s=="string"&&i[s]){n=i[s];continue}const o=n.additionalProperties;if(typeof s=="string"&&o&&typeof o=="object"){n=o;continue}return null}if(a==="array"){if(typeof s!="number")return null;n=(Array.isArray(n.items)?n.items[0]:n.items)??null;continue}return null}return n}function qw(e,t){const s=(e.channels??{})[t],a=e[t];return(s&&typeof s=="object"?s:null)??(a&&typeof a=="object"?a:null)??{}}function jw(e){const t=Gu(e.schema),n=t.schema;if(!n)return r`
  ...
  `}function Dl(e){return e?e.length<=20?e:`${e.slice(0,8)}...${e.slice(-8)}`:"n/a"}function Qw(e){const{props:t,nostr:n,nostrAccounts:s,accountCountLabel:a,profileFormState:i,profileFormCallbacks:o,onEditProfile:l}=e,c=s[0],u=n?.configured??c?.configured??!1,h=n?.running??c?.running??!1,f=n?.publicKey??c?.publicKey,m=n?.lastStartAt??c?.lastStartAt??null,w=n?.lastError??c?.lastError??null,$=s.length>1,d=i!=null,g=A=>{const T=A.publicKey,x=A.profile,_=x?.displayName??x?.name??A.name??A.accountId;return r`
    ...
    `},k=()=>{if(d&&o)return $h({state:i,callbacks:o,accountId:s[0]?.accountId??"default"});const A=c?.profile??n?.profile,{name:T,displayName:x,about:_,picture:P,nip05:E}=A??{},Z=T||x||_||P||E;return r`
...
`)?null:t.startsWith("/")||t.startsWith("~/")||t.startsWith("./")||t.startsWith("../")||/^[a-z]:[\\/]/i.test(t)||/^[^:\s]+\/[^\s]+$/.test(t)&&/\.[a-z0-9]{1,12}$/i.test(t)||/^[^\s/\\:*?"<>|]+\.[a-z0-9]{1,12}$/i.test(t)&&t.length<=100?t:null}async function G$(e,t){const n=e.target,s=n instanceof Element?n:n instanceof Node?n.parentElement:null;if(!s||!t.onMessageLinkClick||!j$(e))return;const a=s.closest("a");if(a instanceof HTMLAnchorElement){if(a.hasAttribute("download"))return;const c=a.getAttribute("href");if(!c)return;if(t.onOpenProof)try{const h=c.match(/(?:proofeditor\.ai|127\.0\.0\.1:\d+|localhost:\d+)\/d\/([a-zA-Z0-9_-]+)/);if(h){e.preventDefault(),t.onOpenProof(h[1]);return}}catch{}try{const h=new URL(c,window.location.href);if(/^https?:$/.test(h.protocol)&&h.origin!==window.location.origin){e.preventDefault(),window.open(h.href,"_blank","noopener,noreferrer");return}}catch{}e.preventDefault(),await t.onMessageLinkClick(c)||V$(a);return}const i=s.closest("code");if(!(i instanceof HTMLElement))return;const o=(i.textContent??"").trim();if(/^https?:\/\/\S+$/i.test(o)){e.preventDefault(),window.open(o,"_blank","noopener,noreferrer");return}if(/^[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)+\.[a-z]{2,}(\/\S*)?$/i.test(o)){e.preventDefault(),window.open(`https://${o}`,"_blank","noopener,noreferrer");return}const l=H$(o);l&&(e.preventDefault(),await t.onMessageLinkClick(l))}const Q$={html_report:"📊",plan:"📋",analysis:"🔍",code:"💻",doc:"📝",data:"📦",image:"🖼️",script:"⚙️"};function Y$(e){const t=e.sessionResources;if(!t||t.length===0)return p;if(e.sessionResourcesCollapsed)return r`
      ...
      ${Array.from(o.entries()).map(([c,u])=>r`
          <div class="model-picker__group">
            <div class="model-picker__group-label">
              <span class="model-picker__group-dot" style="background: ${Vl[c]??"var(--accent)"}"></span>
              ${u[0]?.providerLabel??c}
            </div>
  ...
  `}function uk(e){const t=e.valid==null?"unknown":e.valid?"valid":"invalid",n=Gu(e.schema),s=n.schema?n.unsupportedPaths.length>0:!1,a=n.schema?.properties??{},i=ni.filter(E=>E.key in a&&!Kl.has(E.key)),o=new Set(ni.map(E=>E.key)),l=Object.keys(a).filter(E=>!o.has(E)).map(E=>({key:E,label:E.charAt(0).toUpperCase()+E.slice(1)})),c=ni.filter(E=>Kl.has(E.key)),u=[...i,...l,...c],h=e.activeSection&&n.schema&&je(n.schema)==="object"?n.schema.properties?.[e.activeSection]:void 0,f=e.activeSection?ik(e.activeSection,h):null,m=e.activeSection?ok({key:e.activeSection,schema:h,uiHints:e.uiHints}):[],w=e.formMode==="form"&&!!e.activeSection&&m.length>0,$=e.activeSubsection===Wl,d=e.searchQuery||$?null:e.activeSubsection??m[0]?.key??null,g=e.formMode==="form"?rk(e.originalValue,e.formValue):[],k=e.formMode==="raw"&&e.raw!==e.originalRaw,A=e.formMode==="form"?g.length>0:k,T=!!e.formValue&&!e.loading&&!!n.schema,x=e.connected&&!e.saving&&A&&(e.formMode==="raw"?!0:T),_=e.connected&&!e.applying&&!e.updating&&A&&(e.formMode==="raw"?!0:T),P=e.connected&&!e.applying&&!e.updating;return r`
        ...
        <div class="config-content">
          ${e.activeSection==="model"?dk(e):e.activeSection==="user"?ak({userName:e.userName,userAvatar:e.userAvatar,onUpdate:e.onUserProfileUpdate}):e.formMode==="form"?r`
                  ${e.schemaLoading?r`
                        ...
                        `:Bw({schema:n.schema,uiHints:e.uiHints,value:e.formValue,disabled:e.loading||!e.formValue,unsupportedPaths:n.unsupportedPaths,onPatch:e.onFormPatch,searchQuery:e.searchQuery,activeSection:e.activeSection,activeSubsection:d})}
                  ${s?r`
...
`)}function zk(e){const t=new Date(e),s=new Date().getTime()-t.getTime(),a=Math.floor(s/(1e3*60));if(a<1)return"Just now";if(a<60)return`${a}m ago`;const i=Math.floor(a/60);return i<24?`${i}h ago`:t.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})}function Kk(e){const t="VAULT",n=encodeURIComponent(`01-Daily/${e}`);return`obsidian://open?vault=${t}&file=${n}`}let jn=null,hn=null;function Yl(e,t,n=1500){jn&&clearTimeout(jn),jn=setTimeout(()=>{e!==hn&&(hn=e,t(e))},n)}function Wk(e,t){jn&&clearTimeout(jn),e!==hn&&(hn=e,t(e))}function si(e){for(const t of e.querySelectorAll('input[type="checkbox"]')){const n=t;n.checked?n.setAttribute("checked",""):n.removeAttribute("checked")}return Fk(e.innerHTML)}function qk(e){const{data:t,loading:n,error:s,onRefresh:a,onGenerate:i,onOpenInObsidian:o,onSaveBrief:l,onToggleCheckbox:c,onOpenFile:u}=e;if(n)return r`
  ...
  `}function s0(e){const{browseEntries:t,breadcrumbs:n,browseSearchQuery:s,browseSearchResults:a,onBrowseFolder:i,onBrowseSearch:o,onBrowseBack:l,onCreateFolder:c,onItemClick:u}=e,h=a??t??[];return r`
  ...
  `}function a0(e){const{workspace:t,itemSearchQuery:n,expandedFolders:s=new Set,showCompletedTasks:a=!1,onItemSearch:i,onBack:o,onItemClick:l,onSessionClick:c,onPinToggle:u,onPinSessionToggle:h,onToggleFolder:f,onToggleTaskComplete:m,onCreateTask:w,onToggleCompletedTasks:$,onStartTask:d,editingTaskId:g,onEditTask:k,onUpdateTask:A,onBatchPushToDrive:T}=e,x=Zl(n,t.pinned).toSorted((B,Fe)=>Fe.modified.getTime()-B.modified.getTime()),_=ec(n,t.pinnedSessions),P=Zl(n,t.outputs).filter(B=>!t.pinned.some(Fe=>Fe.path===B.path)),E=(t.folderTree?.length??0)>0,Z=E?cp(n,t.folderTree):[],Y=ec(n,t.sessions),I=new Set(t.pinnedSessions.map(B=>B.key)),M=new Set(t.pinned.map(B=>B.path)),N=n.trim().length>0,U=x.length>0||_.length>0,O=Y.length>0||t.sessions.length===0||N,ie=Zk(t.outputs),ke=ie.length>0&&!N,J={expandedFolders:s,pinnedPaths:M,workspaceId:t.id,onToggleFolder:f,onItemClick:l,onPinToggle:u};return r`
    <div class="workspaces-container">
      ...
      <div class="workspace-content">
        ...
        ${i0({tasks:t.tasks??[],workspaceName:t.name,showCompleted:a,onToggleTaskComplete:m,onCreateTask:w,onToggleCompletedTasks:$,onStartTask:d,editingTaskId:g,onEditTask:k,onUpdateTask:A})}
  ...
  `}function i0(e){const{tasks:t,workspaceName:n,showCompleted:s,onToggleTaskComplete:a,onCreateTask:i,onToggleCompletedTasks:o,onStartTask:l,editingTaskId:c,onEditTask:u,onUpdateTask:h}=e,f=Ys(t.filter(w=>w.status==="pending")),m=Ys(t.filter(w=>w.status==="complete"));return r`
    <section class="ws-section">
      <div class="ws-section__header">
        <h3>Tasks</h3>
      ...
      ${l?r`
            ...
            `:r`
              <div class="workspaces-body">
                ...
                ${r0({tasks:h,taskFilter:f,taskSort:m,taskSearch:w,onToggleTaskComplete:U,onSetTaskFilter:ie,onSetTaskSort:ke,onSetTaskSearch:J,onCreateTask:O,workspaceNames:g,onStartTask:Fe,editingTaskId:d,onEditTask:mn,onUpdateTask:X})}
              </div>
            `}
    </div>
  `}function r0(e){const{tasks:t,taskFilter:n,taskSort:s="due",taskSearch:a="",onToggleTaskComplete:i,onSetTaskFilter:o,onSetTaskSort:l,onSetTaskSearch:c,onCreateTask:u,workspaceNames:h=[],onStartTask:f,editingTaskId:m,onEditTask:w,onUpdateTask:$}=e;if(t.length===0&&!u)return r``;let d;if(n==="outstanding")d=t.filter(k=>k.status==="pending");else if(n==="today"){const k=ce();d=t.filter(A=>A.status==="pending"&&A.dueDate!=null&&A.dueDate<=k)}else n==="complete"?d=t.filter(k=>k.status==="complete"):d=t;if(a){const k=a.toLowerCase();d=d.filter(A=>A.title.toLowerCase().includes(k)||A.project?.toLowerCase().includes(k))}const g=Ys(d,s);return r`
  ...
  `}const ht="__defaults__",tc=[{value:"deny",label:"Deny"},{value:"allowlist",label:"Allowlist"},{value:"full",label:"Full"}],$0=[{value:"off",label:"Off"},{value:"on-miss",label:"On miss"},{value:"always",label:"Always"}];function k0(e){const t=e.configForm,n=F0(e.nodes),{defaultBinding:s,agents:a}=B0(t),i=!!t,o=e.configSaving||e.configFormMode==="raw";return{ready:i,disabled:o,configDirty:e.configDirty,configLoading:e.configLoading,configSaving:e.configSaving,defaultBinding:s,agents:a,nodes:n,onBindDefault:e.onBindDefault,onBindAgent:e.onBindAgent,onSave:e.onSaveBindings,onLoadConfig:e.onLoadConfig,formMode:e.configFormMode}}function nc(e){return e==="allowlist"||e==="full"||e==="deny"?e:"deny"}function S0(e){return e==="always"||e==="off"||e==="on-miss"?e:"on-miss"}function A0(e){const t=e?.defaults??{};return{security:nc(t.security),ask:S0(t.ask),askFallback:nc(t.askFallback??"deny"),autoAllowSkills:!!(t.autoAllowSkills??!1)}}function x0(e){const t=e?.agents??{},n=Array.isArray(t.list)?t.list:[],s=[];return n.forEach(a=>{if(!a||typeof a!="object")return;const i=a,o=typeof i.id=="string"?i.id.trim():"";if(!o)return;const l=typeof i.name=="string"?i.name.trim():void 0,c=i.default===!0;s.push({id:o,name:l||void 0,isDefault:c})}),s}function T0(e,t){const n=x0(e),s=Object.keys(t?.agents??{}),a=new Map;n.forEach(o=>a.set(o.id,o)),s.forEach(o=>{a.has(o)||a.set(o,{id:o})});const i=Array.from(a.values());return i.length===0&&i.push({id:"main",isDefault:!0}),i.sort((o,l)=>{if(o.isDefault&&!l.isDefault)return-1;if(!o.isDefault&&l.isDefault)return 1;const c=o.name?.trim()?o.name:o.id,u=l.name?.trim()?l.name:l.id;return c.localeCompare(u)}),i}function _0(e,t){return e===ht?ht:e&&t.some(n=>n.id===e)?e:ht}function C0(e){const t=e.execApprovalsForm??e.execApprovalsSnapshot?.file??null,n=!!t,s=A0(t),a=T0(e.configForm,t),i=N0(e.nodes),o=e.execApprovalsTarget;let l=o==="node"&&e.execApprovalsTargetNodeId?e.execApprovalsTargetNodeId:null;o==="node"&&l&&!i.some(f=>f.id===l)&&(l=null);const c=_0(e.execApprovalsSelectedAgent,a),u=c!==ht?(t?.agents??{})[c]??null:null,h=Array.isArray(u?.allowlist)?u.allowlist??[]:[];return{ready:n,disabled:e.execApprovalsSaving||e.execApprovalsLoading,dirty:e.execApprovalsDirty,loading:e.execApprovalsLoading,saving:e.execApprovalsSaving,form:t,defaults:s,selectedScope:c,selectedAgent:u,agents:a,allowlist:h,target:o,targetNodeId:l,targetNodes:i,onSelectScope:e.onExecApprovalsSelectAgent,onSelectTarget:e.onExecApprovalsTargetChange,onPatch:e.onExecApprovalsPatch,onRemove:e.onExecApprovalsRemove,onLoad:e.onLoadExecApprovals,onSave:e.onSaveExecApprovals}}function R0(e){const t=e.nodes.length>0,n=e.defaultBinding??"";return r`
    <section class="card">
  ...
  `}function nS(e,t,n,s,a,i){const o=e.updatedAt?K(e.updatedAt):"n/a",l=e.thinkingLevel??"",c=pp(e.modelProvider),u=G0(l,c),h=H0(e.modelProvider),f=e.verboseLevel??"",m=e.reasoningLevel??"",w=e.displayName??e.key,$=e.kind!=="global",d=$?`${Hi("chat",t)}?session=${encodeURIComponent(e.key)}`:null;return r`
    <div class="table-row">
      <div class="mono">${$?r`<a href=${d} class="session-link">${w}</a>`:w}</div>
      <div>
        <input
          .value=${e.label??""}
          ?disabled=${i}
      ...
      <div>
        <select
          .value=${u}
          ?disabled=${i}
          @change=${g=>{const k=g.target.value;n(e.key,{thinkingLevel:Q0(k,c)})}}
        >
...
`).find(i=>i.trim().length>0)??"",a=!!e.schedule;return r`
    ...
    <section class="card">
      ...
      ${a.map(i=>{const o=s.get(i),l=i==="_default"?"General":hp(i);return r`
          <div style="margin-top: 20px;">
            ...
            <div class="list">
              ${o.map(c=>hS(c,e.expandedAgents.has(c.slug),e.onToggleExpand))}
            </div>
          </div>
        `})}
    </section>
    ...
    <div class="wizard-review">
      ...
      ${s&&s.length>0?r`
            <div class="wizard-review-section wizard-review-files">
              ...
              ${c?r`<p class="wizard-hint">Some files already exist. Uncheck to keep your existing version.</p>`:p}
  ...
  `}function l1(e){const{connected:t,loading:n,data:s,onRemoveWorkflow:a,onRefresh:i}=e;if(!t)return r`
    ...
    `;const l=!(s?.summaries??[]).some(f=>f.count>0),c=l?YS():s,u=c.summaries,h=l?[]:s?.ratings??[];return r`
    <section class="tab-body trust-section">
      ${e1(e)}
  ...
  `}function g1(e){const{connected:t,loading:n,data:s,onToggle:a,onThresholdChange:i,onCustomToggle:o,onCustomDelete:l,onToggleAddForm:c,onOpenAllyChat:u}=e;if(!t)return r`
    ...
    `;const h=s?.gates??[],f=s?.activity??[],m=s?.custom??[],w=h.filter(g=>g.enabled).length,$=m.filter(g=>g.enabled).length,d=[`${w}/${h.length} gates active`];return m.length>0&&d.push(`${$} custom rule${m.length===1?"":"s"}`),r`
    <section class="tab-body guardrails-section">
  ...
  `}function q1(e,t,n){const{state:s,onAssignLane:a,onSendInLane:i}=n,o=s.sessionsResult?.sessions??[],l=Me(o,t),c=l?.key??t,u=s.workingSessions.has(t)||s.workingSessions.has(c),h=U1(l,t),f=zs.get(t)??zs.get(c),m=l?.model??"",w=l?.totalTokens??0,$=s.settings.tabLastViewed[c]??s.settings.tabLastViewed[t]??0,d=l?.updatedAt??0,g=!u&&d>$,A=t===s.sessionKey?s.chatMessages:qe.get(t)??qe.get(c)??[],T=x=>{x instanceof HTMLElement&&x.dispatchEvent(new CustomEvent("lane-viewed",{detail:{sessionKey:c},bubbles:!0,composed:!0}))};return r`
    <div
  ...
  `}function s2(e){const{resources:t=[],resourcesLoading:n,resourceFilter:s="all",onResourceFilterChange:a,onResourceClick:i,onResourcePin:o,onResourceDelete:l}=e,c=t2(t,s);return c.sort((u,h)=>u.pinned!==h.pinned?u.pinned?-1:1:h.createdAt.localeCompare(u.createdAt)),r`
  ...
  `}function a2(e){const{projects:t,loading:n,error:s,expandedProjects:a=new Set,projectFiles:i={},detailLoading:o=new Set,onRefresh:l,onToggleProject:c,onPersonClick:u,onFileClick:h,onSkillClick:f}=e;if(n)return r`
      <div class="my-day-container">
        <div class="my-day-loading">
          <div class="spinner"></div>
      ...
      <div class="work-workspaces-section">
        ...
        <div class="my-day-grid" style="grid-template-columns: 1fr;">
          ${m.length===0&&w.length===0?r`
                ...
                `:p}
          ${m.map($=>J1($,a.has($.id),i[$.id]??[],o.has($.id),()=>c?.($.id),u,h,f))}
          ${w.length>0?r`
  ...
  `}function o2(e){const{memoryBank:t,selectedEntry:n,searchQuery:s,browsingFolder:a,folderEntries:i,folderName:o}=e;if(n)return r`
    ...
    `;if(!t)return ya("No memory bank files found","Start building your memory bank by telling your ally about the people, companies, and projects in your life.");const l=(s??"").toLowerCase().trim(),c=u=>l?u.filter(h=>h.name.toLowerCase().includes(l)||h.excerpt.toLowerCase().includes(l)):u;return r`
    <div class="second-brain-panel">
  ...
  `}function x2(e){const{loading:t,dashboards:n}=e,s=e.categoryFilter??"all",a=e.templates??w2,o=[...s==="all"?n??[]:(n??[]).filter(u=>_p(u)===s)].sort((u,h)=>u.pinned&&!h.pinned?-1:!u.pinned&&h.pinned?1:new Date(h.updatedAt).getTime()-new Date(u.updatedAt).getTime()),l=s==="all"?a:a.filter(u=>u.category===s),c=(n??[]).length>0;return r`
    <section class="dashboards-container">
      ...
      ${c&&e.onCategoryFilter?A2(s,n??[],e.onCategoryFilter):p}
  ...
  `}function T2(e){return e.error?r`
	...
	`}function M2(e){let t="",n="",s="";const a=["rocket","lightning","fire","star","brain","crown","diamond","target","compass","mountain"],i={rocket:"🚀",lightning:"⚡",fire:"🔥",star:"⭐",brain:"🧠",crown:"👑",diamond:"💎",target:"🎯",compass:"🧭",mountain:"⛰️"};function o(l){l.preventDefault();const c=l.target,u=new FormData(c);t=u.get("name")?.trim()??"",n=u.get("mission")?.trim()??"",s=u.get("emoji")?.trim()||"🚀",t&&e({name:t,mission:n,emoji:s})}return r`
		<div class="onboarding-fullscreen">
  ...
  `:r`
    ...
    `}function vc(e){const{connected:t,integrations:n,coreProgress:s,expandedCard:a,activeGuide:i,loadingGuide:o,testingId:l,testResult:c,configValues:u}=e;if(!t)return r`
  ...
  `}function yc(e,t){const{expandedCard:n,activeGuide:s,loadingGuide:a,testingId:i,testResult:o,configValues:l}=t,c=n===e.id,u=e.status.working||e.status.configured,h=i===e.id,f=o?.id===e.id,m=e.id==="messaging-channel";return r`
                                  ...
                                  <div class="guide-inputs">
                                    ${s.envVars.map(w=>r`
                                        <label class="input-group">
                                          ...
                                          <input
                                            ...
                                            placeholder="${w.label}"
                                            .value=${l[w.key]??""}
                                            @input=${$=>{const d=$.target.value;t.onUpdateConfigValue(w.key,d)}}
                                          />
                                        </label>
                                      `)}
                                    <div class="guide-actions">
                                      <button
                                        ...
                                        @click=${()=>{const w={};for(const $ of s.envVars){const d=l[$.key];d&&(w[$.key]=d)}t.onConfigureIntegration(e.id,w)}}
                                      >
                                        Save & Test
                                      </button>
  ...
  `:p}function $c(e){const t=e.trim();if(!t)return t;const n=t.split(/\s+/);if(n.length>=2&&n.length%2===0){const l=n.length/2,c=n.slice(0,l).join(" "),u=n.slice(l).join(" ");if(c.toLowerCase()===u.toLowerCase())return c}const s=t.replace(/\s+/g," ").toLowerCase(),a=Math.floor(s.length/2),i=s.slice(0,a).trim(),o=s.slice(a).trim();return i&&i===o?t.slice(0,Math.ceil(t.length/2)).trim():t}function Ui(e,t){const n=t?.sessionId?.trim();return n?`session:${n}`:`key:${e.trim().toLowerCase()}`}function kc(e){if(e===Q)return!0;const t=e.toLowerCase();return!!(t==="agent:main:main"||t.endsWith(":main"))}function Q2(e){const t=e.sessionsResult?.sessions,n=[...new Set(e.settings.openTabs.map(l=>l.trim()).filter(Boolean))].filter(l=>!kc(l)),s=Me(t,e.sessionKey),a=Ui(e.sessionKey,s),i=new Map;for(const l of n){const c=Me(t,l),u=Ui(l,c);if(!i.has(u)){i.set(u,l);continue}l===e.sessionKey&&i.set(u,l)}const o=[...i.values()];if(o.length===0){const l=e.sessionKey.trim()||"main";kc(l)||o.push(l)}return{tabKeys:o,activeIdentity:a}}function Y2(e){const t=e.onboardingActive&&e.onboarding,n=e.onboardingPhase??0,s=e.onboardingData;if(t&&n===0)return D2(()=>{e.handleOnboardingStart?.()},s?.assessment);if(t&&n===1)return M2(d=>{e.handleOnboardingIdentitySubmit?.(d)});if(t&&n===6)return F2(s?.summary??null,s?.identity??null,()=>{e.handleOnboardingComplete?.()});if(e.wizardActive&&e.wizardState)return vp(e.wizardState,{onStepChange:d=>{e.handleWizardStepChange?.(d)},onAnswerChange:(d,g)=>{e.handleWizardAnswerChange?.(d,g)},onPreview:()=>{e.handleWizardPreview?.()},onGenerate:()=>{e.handleWizardGenerate?.()},onClose:()=>{e.handleWizardClose?.()},onFileToggle:(d,g)=>{e.handleWizardFileToggle?.(d,g)},onConfigToggle:(d,g)=>{e.handleWizardConfigToggle?.(d,g)}});const a=e.presenceEntries.length,i=e.sessionsResult?.count??null,o=e.cronStatus?.nextWakeAtMs??null,l=e.connected?null:"Disconnected from gateway.",c=e.tab==="chat",u=c&&(e.settings.chatFocusMode||e.onboarding||t&&n>=2),h=e.onboarding?!1:e.settings.chatShowThinking,f=G2(e),m=e.chatAvatarUrl??f??null,{tabKeys:w,activeIdentity:$}=Q2(e);return r`
    <div class="shell ${c?"shell--chat":""} ${u?"shell--chat-focus":""} ${e.settings.navCollapsed?"shell--nav-collapsed":""} ${e.onboarding?"shell--onboarding":""}">
      ...
      <aside class="nav ${e.settings.navCollapsed?"nav--collapsed":""}">
        ${Uh.map(d=>{const g=e.settings.navGroupsCollapsed[d.label]??!1,k=d.tabs.some(T=>T===e.tab),A=!d.label||d.tabs.length===1&&Yn(d.tabs[0])===d.label;return r`
          ...
          `})}
        ${zh.map(d=>{const g=e.settings.navGroupsCollapsed[d.label]??!0,k=d.tabs.some(A=>A===e.tab);return r`
          ...
          <div>
            ...
            `:e.tab==="chat"?r`
              <div class="session-tabs">
                ...
                ${ga(w,d=>d,(d,g)=>{const k=Me(e.sessionsResult?.sessions,d),A=Ui(d,k)===$,x=(()=>{if(k?.label||k?.displayName)return $c(k.label??k.displayName);const I=De.get(d);if(I)return $c(I);if(d==="agent:main:support")return"Support";if(d.includes("webchat")){const N=d.match(/webchat[:-](\d+)/);return N?`Chat ${N[1]}`:"Chat"}if(d.includes("main"))return"MAIN";const M=d.split(/[:-]/);return M[M.length-1]||d})(),_=e.workingSessions.has(d),P=e.settings.tabLastViewed[d]??0,E=k?.updatedAt??0,Z=!A&&!_&&E>P,Y=e.editingTabKey===d;return r`
                      <div
                        ...
                        @click=${()=>{if(!Y){if(A){e.applySettings({...e.settings,tabLastViewed:{...e.settings.tabLastViewed,[d]:Date.now()}});return}Se(e),e.sessionKey=d,Pe(e,d),e.chatLoading=!0,e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.resetToolStream(),e.resetChatScroll(),e.applySettings({...e.settings,sessionKey:d,lastActiveSessionKey:d,tabLastViewed:{...e.settings.tabLastViewed,[d]:Date.now()}}),e.loadAssistantIdentity(),ye(e,d,!0),se(e).then(()=>{e.resetChatScroll(),we(e,!0)}),e.loadSessionResources(),te(e),Wo()}}}
                      ...
                      >
                        ...
                        `:(()=>{let I=null;return r`
                          <span
                            ...
                            draggable="false"
                            @click=${M=>{M.stopPropagation(),I&&clearTimeout(I),I=setTimeout(()=>{I=null,e.editingTabKey!==d&&(d===e.sessionKey?e.applySettings({...e.settings,tabLastViewed:{...e.settings.tabLastViewed,[d]:Date.now()}}):(Se(e),e.sessionKey=d,e.chatPrivateMode=!!e.privateSessions?.has(d),Pe(e,d),e.chatLoading=!0,e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.resetToolStream(),e.resetChatScroll(),e.applySettings({...e.settings,sessionKey:d,lastActiveSessionKey:d,tabLastViewed:{...e.settings.tabLastViewed,[d]:Date.now()}}),e.loadAssistantIdentity(),ye(e,d,!0),se(e).then(()=>{e.resetChatScroll(),we(e,!0)}),e.loadSessionResources(),te(e)))},250)}}
...
4. Ask me for an overall GodMode score (1-10) for today and any feedback. Submit it with the daily rating tool.`)}}):p}
        ...
        ${e.tab==="sessions"?eS({loading:e.sessionsLoading,result:e.sessionsResult,error:e.sessionsError,activeMinutes:e.sessionsFilterActive,limit:e.sessionsFilterLimit,includeGlobal:e.sessionsIncludeGlobal,includeUnknown:e.sessionsIncludeUnknown,basePath:e.basePath,archivedSessions:e.archivedSessions,archivedSessionsLoading:e.archivedSessionsLoading,archivedSessionsExpanded:e.archivedSessionsExpanded,onFiltersChange:d=>{e.sessionsFilterActive=d.activeMinutes,e.sessionsFilterLimit=d.limit,e.sessionsIncludeGlobal=d.includeGlobal,e.sessionsIncludeUnknown=d.includeUnknown},onRefresh:()=>{te(e),Nt(e)},onPatch:async(d,g)=>{const k=await Es(e,d,g);if(k.ok&&k.canonicalKey!==d&&e.settings.openTabs.includes(d)){const A=e.settings.openTabs.map(x=>x===d?k.canonicalKey:x),T=d===e.sessionKey;e.applySettings({...e.settings,openTabs:A,tabLastViewed:{...e.settings.tabLastViewed,[k.canonicalKey]:e.settings.tabLastViewed[d]??Date.now()},...T?{sessionKey:k.canonicalKey,lastActiveSessionKey:k.canonicalKey}:{}}),T&&(e.sessionKey=k.canonicalKey,ye(e,k.canonicalKey,!0))}},onDelete:d=>Qd(e,d),onArchive:d=>Yd(e,d),onUnarchive:d=>Jd(e,d),onToggleArchived:()=>{e.archivedSessionsExpanded=!e.archivedSessionsExpanded,e.archivedSessionsExpanded&&e.archivedSessions.length===0&&Nt(e)},onAutoArchive:()=>Xd(e)}):p}

        ${e.tab==="cron"?$k({loading:e.cronLoading,status:e.cronStatus,jobs:e.cronJobs,error:e.cronError,busy:e.cronBusy,form:e.cronForm,channels:e.channelsSnapshot?.channelMeta?.length?e.channelsSnapshot.channelMeta.map(d=>d.id):e.channelsSnapshot?.channelOrder??[],channelLabels:e.channelsSnapshot?.channelLabels??{},channelMeta:e.channelsSnapshot?.channelMeta??[],runsJobId:e.cronRunsJobId,runs:e.cronRuns,onFormChange:d=>e.cronForm={...e.cronForm,...d},onRefresh:()=>e.loadCron(),onAdd:()=>Iy(e),onToggle:(d,g)=>Dy(e,d,g),onRun:d=>My(e,d),onRemove:d=>Oy(e,d),onLoadRuns:d=>fu(e,d)}):p}

        ${e.tab==="skills"?iS({loading:e.skillsLoading,report:e.skillsReport,error:e.skillsError,filter:e.skillsFilter,edits:e.skillEdits,messages:e.skillMessages,busyKey:e.skillsBusyKey,subTab:e.skillsSubTab,godmodeSkills:e.godmodeSkills??null,godmodeSkillsLoading:e.godmodeSkillsLoading??!1,expandedSkills:e.expandedSkills??new Set,onFilterChange:d=>e.skillsFilter=d,onRefresh:()=>{os(e,{clearMessages:!0}),Pi(e)},onToggle:(d,g)=>sb(e,d,g),onEdit:(d,g)=>nb(e,d,g),onSaveKey:d=>ab(e,d),onInstall:(d,g,k)=>ib(e,d,g,k),onSubTabChange:d=>{e.skillsSubTab=d,d==="godmode"&&!e.godmodeSkills&&Pi(e),d==="clawhub"&&e.clawhubExploreItems},onToggleExpand:d=>{const g=new Set(e.expandedSkills);g.has(d)?g.delete(d):g.add(d),e.expandedSkills=g},clawhub:{loading:e.clawhubLoading,error:e.clawhubError,query:e.clawhubQuery,results:e.clawhubResults,exploreItems:e.clawhubExploreItems,exploreSort:e.clawhubExploreSort,detailSlug:e.clawhubDetailSlug,detail:e.clawhubDetail,importing:e.clawhubImporting,message:e.clawhubMessage,onSearch:d=>{e.clawhubQuery=d},onExplore:d=>void 0,onDetail:d=>void 0,onCloseDetail:()=>void 0,onImport:d=>Al(),onImportAndPersonalize:async d=>{if(!await Al())return;const k=await mw();k&&(Oo(e,"chat"),ma(e),e.chatMessage=k)}}}):p}

        ${e.tab==="agents"?pS({loading:e.rosterLoading,error:e.rosterError,roster:e.rosterData??[],filter:e.rosterFilter??"",expandedAgents:e.expandedAgents??new Set,onFilterChange:d=>e.rosterFilter=d,onRefresh:()=>kd(e),onToggleExpand:d=>{const g=new Set(e.expandedAgents);g.has(d)?g.delete(d):g.add(d),e.expandedAgents=g}}):p}

        ${e.tab==="nodes"?m0({loading:e.nodesLoading,nodes:e.nodes,devicesLoading:e.devicesLoading,devicesError:e.devicesError,devicesList:e.devicesList,configForm:e.configForm??e.configSnapshot?.config,configLoading:e.configLoading,configSaving:e.configSaving,configDirty:e.configFormDirty,configFormMode:e.configFormMode,execApprovalsLoading:e.execApprovalsLoading,execApprovalsSaving:e.execApprovalsSaving,execApprovalsDirty:e.execApprovalsDirty,execApprovalsSnapshot:e.execApprovalsSnapshot,execApprovalsForm:e.execApprovalsForm,execApprovalsSelectedAgent:e.execApprovalsSelectedAgent,execApprovalsTarget:e.execApprovalsTarget,execApprovalsTargetNodeId:e.execApprovalsTargetNodeId,onRefresh:()=>ra(e),onDevicesRefresh:()=>mt(e),onDeviceApprove:d=>$v(e,d),onDeviceReject:d=>kv(e,d),onDeviceRotate:(d,g,k)=>Sv(e,{deviceId:d,role:g,scopes:k}),onDeviceRevoke:(d,g)=>Av(e,{deviceId:d,role:g}),onLoadConfig:()=>Ze(e),onLoadExecApprovals:()=>{const d=e.execApprovalsTarget==="node"&&e.execApprovalsTargetNodeId?{kind:"node",nodeId:e.execApprovalsTargetNodeId}:{kind:"gateway"};return Po(e,d)},onBindDefault:d=>{d?nn(e,["tools","exec","node"],d):xr(e,["tools","exec","node"])},onBindAgent:(d,g)=>{const k=["agents","list",d,"tools","exec","node"];g?nn(e,k,g):xr(e,k)},onSaveBindings:()=>Ms(e),onExecApprovalsTargetChange:(d,g)=>{e.execApprovalsTarget=d,e.execApprovalsTargetNodeId=g,e.execApprovalsSnapshot=null,e.execApprovalsForm=null,e.execApprovalsDirty=!1,e.execApprovalsSelectedAgent=null},onExecApprovalsSelectAgent:d=>{e.execApprovalsSelectedAgent=d},onExecApprovalsPatch:(d,g)=>Vy(e,d,g),onExecApprovalsRemove:d=>Hy(e,d),onSaveExecApprovals:()=>{const d=e.execApprovalsTarget==="node"&&e.execApprovalsTargetNodeId?{kind:"node",nodeId:e.execApprovalsTargetNodeId}:{kind:"gateway"};return jy(e,d)}}):p}
        ...
        ${e.tab==="chat"&&e.settings.chatParallelView?j1({state:e,onAssignLane:(d,g)=>{const k=g?Me(e.sessionsResult?.sessions,g)?.key??g:null,A=[...e.settings.parallelLanes];A[d]=k,e.applySettings({...e.settings,parallelLanes:A}),k&&e.client&&ho(e.client,k).then(()=>{e.applySettings({...e.settings})})},onReorderLanes:(d,g)=>{if(d===g||d<0||g<0||d>=e.settings.parallelLanes.length||g>=e.settings.parallelLanes.length)return;const k=[...e.settings.parallelLanes],[A]=k.splice(d,1);k.splice(g,0,A),e.applySettings({...e.settings,parallelLanes:k})},onLaneViewed:d=>{const g=Me(e.sessionsResult?.sessions,d)?.key??d,k=Date.now(),T=Me(e.sessionsResult?.sessions,g)?.updatedAt??0,x=Math.max(e.settings.tabLastViewed[d]??0,e.settings.tabLastViewed[g]??0);T>0&&x>=T||e.applySettings({...e.settings,tabLastViewed:{...e.settings.tabLastViewed,[d]:k,[g]:k}})},onSendInLane:(d,g)=>{d!==e.sessionKey?(Se(e),e.sessionKey=d,Pe(e,d),e.chatLoading=!0,e.chatMessages=[],e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.resetToolStream(),e.applySettings({...e.settings,sessionKey:d,lastActiveSessionKey:d}),e.loadAssistantIdentity(),ye(e,d,!0),se(e).then(()=>{e.loadSessionResources(),e.chatMessage=g,e.handleSendChat(g)})):(e.chatMessage=g,e.handleSendChat(g))}}):p}

        ${e.tab==="chat"&&!e.settings.chatParallelView?J$({basePath:e.basePath,sessionKey:e.sessionKey,onSessionKeyChange:d=>{Se(e),e.sessionKey=d,Pe(e,d),e.chatLoading=!0,e.chatMessages=[],e.chatAttachments=[],e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.chatQueue=[],e.resetToolStream(),e.resetChatScroll(),e.applySettings({...e.settings,sessionKey:d,lastActiveSessionKey:d}),e.loadAssistantIdentity(),se(e).then(()=>{e.resetChatScroll(),we(e,!0)}),Gs(e),e.loadSessionResources(),js(e)},thinkingLevel:e.chatThinkingLevel,showThinking:h,loading:e.chatLoading,sending:e.chatSending,sendingSessionKey:e.chatSendingSessionKey,compactionStatus:e.compactionStatus,assistantAvatarUrl:m,messages:e.chatMessages,toolMessages:e.chatToolMessages,stream:e.chatStream,streamStartedAt:e.chatStreamStartedAt,draft:e.chatMessage,queue:e.chatQueue,connected:e.connected,canSend:e.connected,disabledReason:l,error:e.lastError,sessions:e.sessionsResult,focusMode:u,onRefresh:()=>(e.resetToolStream(),e.loadSessionResources(),js(e),Promise.all([se(e),Gs(e)])),onToggleFocusMode:()=>{e.onboarding||e.applySettings({...e.settings,chatFocusMode:!e.settings.chatFocusMode})},onChatScroll:d=>e.handleChatScroll(d),onDraftChange:d=>e.chatMessage=d,attachments:e.chatAttachments,onAttachmentsChange:d=>e.chatAttachments=d,showToast:(d,g)=>e.showToast(d,g),onSend:d=>e.handleSendChat(void 0,{queue:d}),canAbort:!!e.chatRunId,onAbort:()=>{e.handleAbortChat()},onCompact:()=>{e.handleCompactChat()},pendingRetry:e.pendingRetry,onRetry:()=>{e.handleRetryMessage()},onClearRetry:()=>e.handleClearRetry(),onQueueRemove:d=>e.removeQueuedMessage(d),onNewSession:()=>e.handleSendChat("/new",{restoreDraft:!0}),onConsciousnessFlush:()=>{e.handleConsciousnessFlush()},consciousnessStatus:e.consciousnessStatus,sidebarOpen:e.sidebarOpen,sidebarContent:e.sidebarContent,sidebarError:e.sidebarError,sidebarMimeType:e.sidebarMimeType,sidebarFilePath:e.sidebarFilePath,sidebarTitle:e.sidebarTitle,sidebarMode:e.sidebarMode,sidebarProofSlug:e.sidebarProofSlug,sidebarProofUrl:e.sidebarProofUrl,sidebarProofHtml:e.sidebarProofHtml,splitRatio:e.splitRatio,onOpenSidebar:(d,g)=>e.handleOpenSidebar(d,g),onMessageLinkClick:d=>e.handleOpenMessageFileLink(d),onCloseSidebar:()=>e.handleCloseSidebar(),onOpenProof:d=>{e.handleOpenProofDoc(d)},onOpenFile:d=>e.handleOpenFile(d),onSplitRatioChange:d=>e.handleSplitRatioChange(d),onPushToDrive:(d,g)=>e.handlePushToDrive(d,g),driveAccounts:e.driveAccounts,showDrivePicker:e.showDrivePicker,driveUploading:e.driveUploading,onToggleDrivePicker:()=>e.handleToggleDrivePicker(),onImageClick:(d,g,k)=>e.handleImageClick(d,g,k),resolveImageUrl:(d,g)=>Qv(e.sessionKey,d,g),assistantName:e.assistantName,assistantAvatar:e.assistantAvatar,userName:e.userName,userAvatar:e.userAvatar,currentToolName:e.currentToolName,currentToolInfo:e.currentToolInfo,privateMode:e.chatPrivateMode,onTogglePrivateMode:()=>e.handlePrivateModeToggle(),isWorking:e.workingSessions.has(e.sessionKey),showScrollButton:!e.chatUserNearBottom,showNewMessages:e.chatNewMessagesBelow,onScrollToBottom:()=>{const d=document.querySelector(".chat-thread");d&&(d.scrollTo({top:d.scrollHeight,behavior:"smooth"}),e.chatUserNearBottom=!0,e.chatNewMessagesBelow=!1)},allyPanelOpen:e.allyPanelOpen??!1,allyProps:e.allyPanelOpen?{allyName:e.assistantName,allyAvatar:e.assistantAvatar??null,open:!0,messages:e.allyMessages??[],stream:e.allyStream??null,draft:e.allyDraft??"",sending:e.allySending??!1,isWorking:e.allyWorking??!1,unreadCount:0,connected:e.connected,compact:!0,attachments:e.allyAttachments??[],onToggle:()=>e.handleAllyToggle(),onDraftChange:d=>e.handleAllyDraftChange(d),onSend:()=>e.handleAllySend(),onOpenFullChat:()=>e.handleAllyOpenFull(),onAttachmentsChange:d=>e.handleAllyAttachmentsChange(d),onAction:(d,g,k,A)=>e.handleAllyAction(d,g,k,A)}:null,sessionResources:e.sessionResources,sessionResourcesCollapsed:e.sessionResourcesCollapsed,onToggleSessionResources:()=>e.handleToggleSessionResources(),onSessionResourceClick:d=>e.handleSessionResourceClick(d),onViewAllResources:()=>e.handleViewAllResources()}):p}

        ${e.tab==="options"?xS({connected:e.connected,loading:e.godmodeOptionsLoading,options:e.godmodeOptions,onToggle:(d,g)=>e.handleOptionToggle(d,g),onOpenWizard:e.handleWizardOpen?()=>e.handleWizardOpen?.():void 0}):p}

        ${e.tab==="guardrails"?g1({connected:e.connected,loading:e.guardrailsLoading,data:e.guardrailsData,showAddForm:e.guardrailsShowAddForm,onToggle:(d,g)=>e.handleGuardrailToggle(d,g),onThresholdChange:(d,g,k)=>e.handleGuardrailThresholdChange(d,g,k),onCustomToggle:(d,g)=>e.handleCustomGuardrailToggle(d,g),onCustomDelete:d=>e.handleCustomGuardrailDelete(d),onToggleAddForm:()=>e.handleToggleGuardrailAddForm(),onOpenAllyChat:d=>{e.handleAllyToggle(),d&&e.handleAllyDraftChange(d)}}):p}

        ${e.tab==="mission-control"?B1({connected:e.connected,loading:e.missionControlLoading,error:e.missionControlError,data:e.missionControlData??null,fullControl:e.missionControlFullControl,onToggleFullControl:()=>e.handleMissionControlToggleFullControl(),onRefresh:()=>e.handleMissionControlRefresh(),onCancelTask:d=>e.handleMissionControlCancelTask(d),onApproveItem:d=>e.handleMissionControlApproveItem(d),onRetryItem:d=>e.handleMissionControlRetryItem(d),onViewDetail:d=>e.handleMissionControlViewDetail(d),onOpenSession:d=>e.handleMissionControlOpenSession(d),onOpenTaskSession:d=>e.handleMissionControlOpenTaskSession(d),onStartQueueItem:d=>e.handleMissionControlStartQueueItem(d),onViewTaskFiles:d=>e.handleMissionControlViewTaskFiles(d),onSelectSwarmProject:d=>e.handleSwarmSelectProject(d),onSteerSwarmAgent:(d,g,k)=>e.handleSwarmSteer(d,g,k),onViewProofDoc:d=>e.handleSwarmViewProofDoc(d),onViewRunLog:d=>e.handleSwarmViewRunLog(d),onAskAlly:()=>{e.handleAllyToggle(),e.handleAllyDraftChange("What should I focus on next?")},allyName:e.assistantName}):p}
