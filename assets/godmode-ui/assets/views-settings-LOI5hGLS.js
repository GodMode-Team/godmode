<<<<<<<< HEAD:assets/godmode-ui/assets/views-settings-DjuQCK7K.js
import{A as d,b as a,o as $a}from"./lit-core-CTInmNPB.js";import{t as wa,f as L,a as Be,b as jn,c as Et,d as Fe}from"./ctrl-settings-9Mbvofam.js";import{g as Pt}from"./markdown-i_gIkIP3.js";function xa(e){const{values:t,original:n}=e;return t.name!==n.name||t.displayName!==n.displayName||t.about!==n.about||t.picture!==n.picture||t.banner!==n.banner||t.website!==n.website||t.nip05!==n.nip05||t.lud16!==n.lud16}function ka(e){const{state:t,callbacks:n,accountId:s}=e,i=xa(t),l=(r,u,v={})=>{const{type:p="text",placeholder:g,maxLength:h,help:$}=v,b=t.values[r]??"",y=t.fieldErrors[r],f=`nostr-profile-${r}`;return p==="textarea"?a`
========
import{A as u,b as a,o as _a}from"./lit-core-CTInmNPB.js";import{t as Aa,f as L,a as He,b as Yn,c as Rt,d as je}from"./ctrl-settings-CXQpHQPk.js";import{g as We}from"./markdown-i_gIkIP3.js";function Sa(e){const{values:t,original:n}=e;return t.name!==n.name||t.displayName!==n.displayName||t.about!==n.about||t.picture!==n.picture||t.banner!==n.banner||t.website!==n.website||t.nip05!==n.nip05||t.lud16!==n.lud16}function Ca(e){const{state:t,callbacks:n,accountId:s}=e,i=Sa(t),l=(r,d,v={})=>{const{type:p="text",placeholder:g,maxLength:h,help:$}=v,b=t.values[r]??"",y=t.fieldErrors[r],f=`nostr-profile-${r}`;return p==="textarea"?a`
>>>>>>>> origin/main:assets/godmode-ui/assets/views-settings-LOI5hGLS.js
...
<<<<<<<< HEAD:assets/godmode-ui/assets/views-settings-DjuQCK7K.js
  `};function se(e){const{schema:t,value:n,path:s,hints:i,unsupported:l,disabled:o,onPatch:r}=e,u=e.showLabel??!0,v=Z(t),p=V(s,i),g=p?.label??t.title??ie(String(s.at(-1))),h=p?.help??t.description,$=tt(s);if(l.has($))return a`<div class="cfg-field cfg-field--error">
...
========
  `};function ae(e){const{schema:t,value:n,path:s,hints:i,unsupported:l,disabled:o,onPatch:r}=e,d=e.showLabel??!0,v=Z(t),p=V(s,i),g=p?.label??t.title??se(String(s.at(-1))),h=p?.help??t.description,$=at(s);if(l.has($))return a`<div class="cfg-field cfg-field--error">
      <div class="cfg-field__label">${g}</div>
      <div class="cfg-field__error">Unsupported schema node. Use Raw mode.</div>
    </div>`;if(t.anyOf||t.oneOf){const y=(t.anyOf??t.oneOf??[]).filter(A=>!(A.type==="null"||Array.isArray(A.type)&&A.type.includes("null")));if(y.length===1)return ae({...e,schema:y[0]});const f=A=>{if(A.const!==void 0)return A.const;if(A.enum&&A.enum.length===1)return A.enum[0]},w=y.map(f),S=w.every(A=>A!==void 0);if(S&&w.length>0&&w.length<=5){const A=n??t.default;return a`
>>>>>>>> origin/main:assets/godmode-ui/assets/views-settings-LOI5hGLS.js
        <div class="cfg-field">
...
<<<<<<<< HEAD:assets/godmode-ui/assets/views-settings-DjuQCK7K.js
  `}function wn(e){const{schema:t,value:n,path:s,hints:i,disabled:l,onPatch:o,inputType:r}=e,u=e.showLabel??!0,v=V(s,i),p=v?.label??t.title??ie(String(s.at(-1))),g=v?.help??t.description,h=v?.sensitive??rs(s),$=v?.placeholder??(h?"••••":t.default!==void 0?`Default: ${ke(t.default)}`:""),b=n??"";return a`
========
  `}function An(e){const{schema:t,value:n,path:s,hints:i,disabled:l,onPatch:o,inputType:r}=e,d=e.showLabel??!0,v=V(s,i),p=v?.label??t.title??se(String(s.at(-1))),g=v?.help??t.description,h=v?.sensitive??us(s),$=v?.placeholder??(h?"••••":t.default!==void 0?`Default: ${Se(t.default)}`:""),b=n??"";return a`
>>>>>>>> origin/main:assets/godmode-ui/assets/views-settings-LOI5hGLS.js
    <div class="cfg-field">
...
<<<<<<<< HEAD:assets/godmode-ui/assets/views-settings-DjuQCK7K.js
  `}function ps(e){const{schema:t,value:n,path:s,hints:i,disabled:l,onPatch:o}=e,r=e.showLabel??!0,u=V(s,i),v=u?.label??t.title??ie(String(s.at(-1))),p=u?.help??t.description,g=n??t.default??"",h=typeof g=="number"?g:0;return a`
========
  `}function fs(e){const{schema:t,value:n,path:s,hints:i,disabled:l,onPatch:o}=e,r=e.showLabel??!0,d=V(s,i),v=d?.label??t.title??se(String(s.at(-1))),p=d?.help??t.description,g=n??t.default??"",h=typeof g=="number"?g:0;return a`
>>>>>>>> origin/main:assets/godmode-ui/assets/views-settings-LOI5hGLS.js
    <div class="cfg-field">
...
<<<<<<<< HEAD:assets/godmode-ui/assets/views-settings-DjuQCK7K.js
  `}function xn(e){const{schema:t,value:n,path:s,hints:i,disabled:l,options:o,onPatch:r}=e,u=e.showLabel??!0,v=V(s,i),p=v?.label??t.title??ie(String(s.at(-1))),g=v?.help??t.description,h=n??t.default,$=o.findIndex(y=>y===h||String(y)===String(h)),b="__unset__";return a`
========
  `}function Sn(e){const{schema:t,value:n,path:s,hints:i,disabled:l,options:o,onPatch:r}=e,d=e.showLabel??!0,v=V(s,i),p=v?.label??t.title??se(String(s.at(-1))),g=v?.help??t.description,h=n??t.default,$=o.findIndex(y=>y===h||String(y)===String(h)),b="__unset__";return a`
>>>>>>>> origin/main:assets/godmode-ui/assets/views-settings-LOI5hGLS.js
    <div class="cfg-field">
      ${d?a`<label class="cfg-field__label">${p}</label>`:u}
      ${g?a`<div class="cfg-field__help">${g}</div>`:u}
...
<<<<<<<< HEAD:assets/godmode-ui/assets/views-settings-DjuQCK7K.js
  ...
  `}function gs(e){const{schema:t,value:n,path:s,hints:i,unsupported:l,disabled:o,onPatch:r}=e,u=e.showLabel??!0,v=V(s,i),p=v?.label??t.title??ie(String(s.at(-1))),g=v?.help??t.description,h=Array.isArray(t.items)?t.items[0]:t.items;if(!h)return a`
========
        ${y.map(([E,k])=>ae({schema:k,value:h[E],path:[...s,E],hints:i,unsupported:l,disabled:o,onPatch:r}))}
        ${S?Cn({schema:w,value:h,path:s,hints:i,unsupported:l,disabled:o,reservedKeys:f,onPatch:r}):u}
      </div>
    </details>
  `}function ms(e){const{schema:t,value:n,path:s,hints:i,unsupported:l,disabled:o,onPatch:r}=e,d=e.showLabel??!0,v=V(s,i),p=v?.label??t.title??se(String(s.at(-1))),g=v?.help??t.description,h=Array.isArray(t.items)?t.items[0]:t.items;if(!h)return a`
>>>>>>>> origin/main:assets/godmode-ui/assets/views-settings-LOI5hGLS.js
      <div class="cfg-field cfg-field--error">
          ...
          ${$.map((b,y)=>a`
            <div class="cfg-array__item">
              ...
              <div class="cfg-array__item-content">
                ${se({schema:h,value:b,path:[...s,y],hints:i,unsupported:l,disabled:o,showLabel:!1,onPatch:r})}
              </div>
            </div>
          `)}
        </div>
              ...
              <div class="cfg-map__item">
                ...
                <div class="cfg-map__item-value">
                  ${v?a`
                        ...
                        ></textarea>
<<<<<<<< HEAD:assets/godmode-ui/assets/views-settings-DjuQCK7K.js
                      `:se({schema:t,value:h,path:$,hints:i,unsupported:l,disabled:o,showLabel:!1,onPatch:u})}
========
                      `:ae({schema:t,value:h,path:$,hints:i,unsupported:l,disabled:o,showLabel:!1,onPatch:d})}
>>>>>>>> origin/main:assets/godmode-ui/assets/views-settings-LOI5hGLS.js
                </div>
                <button
                  type="button"
...
<<<<<<<< HEAD:assets/godmode-ui/assets/views-settings-DjuQCK7K.js
      ${p?(()=>{const{sectionKey:g,subsectionKey:h,schema:$}=p,b=V([g,h],e.uiHints),y=b?.label??$.title??ie(h),f=b?.help??$.description??"",w=n[g],S=w&&typeof w=="object"?w[h]:void 0,T=`config-section-${g}-${h}`;return a`
              <section class="config-section-card" id=${T}>
========
      ${p?(()=>{const{sectionKey:g,subsectionKey:h,schema:$}=p,b=V([g,h],e.uiHints),y=b?.label??$.title??se(h),f=b?.help??$.description??"",w=n[g],S=w&&typeof w=="object"?w[h]:void 0,E=`config-section-${g}-${h}`;return a`
...
<<<<<<<< HEAD:assets/godmode-ui/assets/views-settings-DjuQCK7K.js
  `}function js(e,t=128){return new Promise((n,s)=>{const i=new Image;i.addEventListener("load",()=>{const l=document.createElement("canvas");l.width=t,l.height=t;const o=l.getContext("2d");if(!o){s(new Error("Could not get canvas context"));return}const r=Math.min(i.width,i.height),u=(i.width-r)/2,v=(i.height-r)/2;o.drawImage(i,u,v,r,r,0,0,t,t),n(l.toDataURL("image/png"))}),i.addEventListener("error",()=>s(new Error("Failed to load image"))),i.src=URL.createObjectURL(e)})}let xe="",Ie=null,ve=null,Cn=!1,oe=!1;function Ws(e){Cn||(xe=e.userName||"",Ie=e.userAvatar||null,ve=e.userAvatar||null,Cn=!0,oe=!1)}function Vs(e){Ws(e);const t=u=>{xe=u.target.value,oe=!0},n=async u=>{const p=u.target.files?.[0];if(p){if(!p.type.startsWith("image/")){alert("Please select an image file");return}if(p.size>5*1024*1024){alert("Image must be less than 5MB");return}try{const g=await js(p,128);Ie=g,ve=g,oe=!0,document.dispatchEvent(new CustomEvent("user-settings-updated"))}catch(g){console.error("Failed to process image:",g),alert("Failed to process image")}}},s=()=>{Ie=null,ve=null,oe=!0;const u=document.getElementById("user-avatar-input");u&&(u.value=""),document.dispatchEvent(new CustomEvent("user-settings-updated"))},i=()=>{e.onUpdate(xe,Ie||""),oe=!1;const u=document.querySelector(".user-settings__save");u&&(u.textContent="Saved!",setTimeout(()=>{u.textContent="Save"},1500))},l=()=>{xe=e.userName||"",Ie=e.userAvatar||null,ve=e.userAvatar||null,oe=!1,document.dispatchEvent(new CustomEvent("user-settings-updated"))},o=xe||"You",r=ve?a`<img src="${ve}" alt="${o}" class="user-settings__avatar-img" />`:a`<span class="user-settings__avatar-initial">${o.charAt(0).toUpperCase()}</span>`;return a`
========
  `}function Gs(e,t=128){return new Promise((n,s)=>{const i=new Image;i.addEventListener("load",()=>{const l=document.createElement("canvas");l.width=t,l.height=t;const o=l.getContext("2d");if(!o){s(new Error("Could not get canvas context"));return}const r=Math.min(i.width,i.height),d=(i.width-r)/2,v=(i.height-r)/2;o.drawImage(i,d,v,r,r,0,0,t,t),n(l.toDataURL("image/png"))}),i.addEventListener("error",()=>s(new Error("Failed to load image"))),i.src=URL.createObjectURL(e)})}let ke="",Oe=null,ge=null,Ln=!1,le=!1;function Ys(e){Ln||(ke=e.userName||"",Oe=e.userAvatar||null,ge=e.userAvatar||null,Ln=!0,le=!1)}function Ks(e){Ys(e);const t=d=>{ke=d.target.value,le=!0},n=async d=>{const p=d.target.files?.[0];if(p){if(!p.type.startsWith("image/")){alert("Please select an image file");return}if(p.size>5*1024*1024){alert("Image must be less than 5MB");return}try{const g=await Gs(p,128);Oe=g,ge=g,le=!0,document.dispatchEvent(new CustomEvent("user-settings-updated"))}catch(g){console.error("Failed to process image:",g),alert("Failed to process image")}}},s=()=>{Oe=null,ge=null,le=!0;const d=document.getElementById("user-avatar-input");d&&(d.value=""),document.dispatchEvent(new CustomEvent("user-settings-updated"))},i=()=>{e.onUpdate(ke,Oe||""),le=!1;const d=document.querySelector(".user-settings__save");d&&(d.textContent="Saved!",setTimeout(()=>{d.textContent="Save"},1500))},l=()=>{ke=e.userName||"",Oe=e.userAvatar||null,ge=e.userAvatar||null,le=!1,document.dispatchEvent(new CustomEvent("user-settings-updated"))},o=ke||"You",r=ge?a`<img src="${ge}" alt="${o}" class="user-settings__avatar-img" />`:a`<span class="user-settings__avatar-initial">${o.charAt(0).toUpperCase()}</span>`;return a`
>>>>>>>> origin/main:assets/godmode-ui/assets/views-settings-LOI5hGLS.js
      ...
      <div class="card">
        ...
        <div class="stat-grid" style="margin-top: 16px;">
          ...
          <div class="stat">
            ...
            <div class="stat-value">${li(e.status?.nextWakeAtMs??null)}</div>
          </div>
        </div>
        <div class="row" style="margin-top: 12px;">
            ...
            <div class="list" style="margin-top: 12px;">
              ${e.eventLog.map(d=>a`
                  <div class="list-item">
                    ...
                    <div class="list-meta">
                      <pre class="code-block">${ri(d.payload)}</pre>
                    </div>
                  </div>
                `)}
            </div>
...
<<<<<<<< HEAD:assets/godmode-ui/assets/views-settings-DjuQCK7K.js
            ${Mi(e)}
            ${Li(e)}
            ${e.selectedScope===re?d:Ri(e)}
========
            ${Ii(e)}
            ${zi(e)}
            ${e.selectedScope===re?u:Oi(e)}
>>>>>>>> origin/main:assets/godmode-ui/assets/views-settings-LOI5hGLS.js
          `:a`<div class="row" style="margin-top: 12px; gap: 12px;">
    ...
    <section class="card">
      ...
      ${i.map(l=>{const o=s.get(l),r=l==="_default"?"General":la(l);return a`
          <div style="margin-top: 20px;">
            ...
            <div class="list">
              ${o.map(d=>pl(d,e.expandedAgents.has(d.slug),e.onToggleExpand))}
            </div>
          </div>
        `})}
    </section>
  ...
  `}function Pl(e,t){const s=e.trustScore!==null?e.trustScore.toFixed(1):e.avgRating>0?e.avgRating.toFixed(1):"--",i=Ee(e.trustScore??(e.avgRating>0?e.avgRating:null)),l=e.count<10?10-e.count:0;return a`
    <div class="trust-card">
      ...
      <div class="trust-card-score-row">
        ...
        <span class="trust-trend ${Ml(e.trend)}">
          ${Ll(e.trend)} ${Tl(e.trend)}
        </span>
      </div>
