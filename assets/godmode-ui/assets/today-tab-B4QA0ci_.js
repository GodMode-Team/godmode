<<<<<<<< HEAD:assets/godmode-ui/assets/today-tab-4wYVVd1C.js
import{b as r,A as u,d as S,g as D,r as l,t as _}from"./lit-core-CTInmNPB.js";import{a as b,o as I}from"./index-DZwc15Ve.js";import{aa as h}from"./ctrl-settings-9Mbvofam.js";import{A as C}from"./views-settings-DjuQCK7K.js";import{s as L,a as m}from"./workspaces-EGuqiLGf.js";import"./markdown-i_gIkIP3.js";function x(t){const e=Date.now()-new Date(t).getTime(),a=Math.floor(e/6e4);if(a<1)return"just now";if(a<60)return`${a}m ago`;const o=Math.floor(a/60);return o<24?`${o}h ago`:`${Math.floor(o/24)}d ago`}function $(t){return t.source.persona?t.source.persona.replace(/-/g," ").replace(/\b\w/g,e=>e.toUpperCase()):t.source.skill?t.source.skill:t.type==="agent-execution"?"Agent":"Skill"}function B(t){return t<=2?"Poor":t<=4?"Below expectations":t<=6?"Okay":t<=8?"Good":"Excellent"}function v(t,e){if(t.scoringId!==e.id)return u;const a=t.scoringValue??7,o=t.feedbackText??"",i=a<=4,s=a<=4||a>=9;return r`
========
import{b as r,A as u,d as T,g as S,r as l,t as D}from"./lit-core-CTInmNPB.js";import{a as _,o as I}from"./index-BgMIOSVC.js";import{aa as h}from"./ctrl-settings-CXQpHQPk.js";import{B as C}from"./views-settings-LOI5hGLS.js";import{s as L,a as b}from"./workspaces-DaSnZcfS.js";import"./markdown-i_gIkIP3.js";function m(t){const e=Date.now()-new Date(t).getTime(),a=Math.floor(e/6e4);if(a<1)return"just now";if(a<60)return`${a}m ago`;const o=Math.floor(a/60);return o<24?`${o}h ago`:`${Math.floor(o/24)}d ago`}function $(t){return t.source.persona?t.source.persona.replace(/-/g," ").replace(/\b\w/g,e=>e.toUpperCase()):t.source.skill?t.source.skill:t.type==="agent-execution"?"Agent":"Skill"}function B(t){return t<=2?"Poor":t<=4?"Below expectations":t<=6?"Okay":t<=8?"Good":"Excellent"}function x(t,e){if(t.scoringId!==e.id)return u;const a=t.scoringValue??7,o=t.feedbackText??"",i=a<=4,s=a<=4||a>=9;return r`
>>>>>>>> origin/main:assets/godmode-ui/assets/today-tab-B4QA0ci_.js
  ...
  `}function R(t){const e=t.sortOrder??"newest",a=t.items.filter(i=>i.status==="pending").sort((i,s)=>{const n=new Date(s.createdAt).getTime()-new Date(i.createdAt).getTime();return e==="oldest"?-n:n}),o=t.count??a.length;return t.loading?r`<div class="inbox-loading">Loading inbox…</div>`:o===0?r`
      ...
      <div class="my-day-card-content">
        ${t.todayTasksLoading?r`<div class="brief-loading"><div class="spinner"></div><span>Loading tasks...</span></div>`:r`
              ...
              <div class="today-tasks-list">
                ${a.length===0&&o.length===0?r`<div class="today-tasks-empty">No tasks for today. Add one above or drop tasks in your daily brief.</div>`:a.map(i=>m(i,t.onToggleTaskComplete,t.onStartTask,t.editingTaskId,t.onEditTask,t.onUpdateTask,t.onViewTaskOutput))}
              </div>
              ${o.length>0?r`
  ...
  `}function ot(t){const e=h(),a=t.selectedDate??e,o=X(a),i=Z(a),s=t.viewMode??"brief";return r`
