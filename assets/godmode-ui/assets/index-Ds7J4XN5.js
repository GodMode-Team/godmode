      ...
      <div class="resource-strip__header">
        ...
        <div class="resource-strip__controls">
          ...
          <button
            ...
            @click=${e.onToggleCollapse}
            title=${n?"Show artifacts":"Hide artifacts"}
            aria-expanded=${!n}
          >${n?"▲":"▼"}</button>
        </div>
      </div>
