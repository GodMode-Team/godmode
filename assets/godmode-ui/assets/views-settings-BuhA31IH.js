import{A as u,b as n,o as _n}from"./lit-core-CTInmNPB.js";import{t as Sn,f as L,a as He,b as Ya,c as Dt,d as je}from"./ctrl-settings-DqZuTIbw.js";import{g as We}from"./markdown-i_gIkIP3.js";function Cn(e){const{values:t,original:a}=e;return t.name!==a.name||t.displayName!==a.displayName||t.about!==a.about||t.picture!==a.picture||t.banner!==a.banner||t.website!==a.website||t.nip05!==a.nip05||t.lud16!==a.lud16}function Tn(e){const{state:t,callbacks:a,accountId:s}=e,i=Cn(t),l=(r,d,v={})=>{const{type:p="text",placeholder:g,maxLength:h,help:$}=v,b=t.values[r]??"",y=t.fieldErrors[r],f=`nostr-profile-${r}`;return p==="textarea"?n`
