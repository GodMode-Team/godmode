(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function n(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(a){if(a.ep)return;a.ep=!0;const i=n(a);fetch(a.href,i)}})();const Wp="modulepreload",qp=function(e,t){return new URL(e,t).href},pr={},C=function(t,n,s){let a=Promise.resolve();if(n&&n.length>0){let u=function(p){return Promise.all(p.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};const o=document.getElementsByTagName("link"),l=document.querySelector("meta[property=csp-nonce]"),c=l?.nonce||l?.getAttribute("nonce");a=u(n.map(p=>{if(p=qp(p,s),p in pr)return;pr[p]=!0;const f=p.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(s)for(let k=o.length-1;k>=0;k--){const d=o[k];if(d.href===p&&(!f||d.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${p}"]${m}`))return;const w=document.createElement("link");if(w.rel=f?"stylesheet":Wp,f||(w.as="script"),w.crossOrigin="",w.href=p,c&&w.setAttribute("nonce",c),document.head.appendChild(w),f)return new Promise((k,d)=>{w.addEventListener("load",k),w.addEventListener("error",()=>d(new Error(`Unable to preload CSS for ${p}`)))})}))}function i(o){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=o,window.dispatchEvent(l),!l.defaultPrevented)throw o}return a.then(o=>{for(const l of o||[])l.status==="rejected"&&i(l.reason);return t().catch(i)})};const Ts=globalThis,Ki=Ts.ShadowRoot&&(Ts.ShadyCSS===void 0||Ts.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Wi=Symbol(),hr=new WeakMap;let Rc=class{constructor(t,n,s){if(this._$cssResult$=!0,s!==Wi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=n}get styleSheet(){let t=this.o;const n=this.t;if(Ki&&t===void 0){const s=n!==void 0&&n.length===1;s&&(t=hr.get(n)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&hr.set(n,t))}return t}toString(){return this.cssText}};const jp=e=>new Rc(typeof e=="string"?e:e+"",void 0,Wi),Vp=(e,...t)=>{const n=e.length===1?e[0]:t.reduce((s,a,i)=>s+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+e[i+1],e[0]);return new Rc(n,e,Wi)},Hp=(e,t)=>{if(Ki)e.adoptedStyleSheets=t.map(n=>n instanceof CSSStyleSheet?n:n.styleSheet);else for(const n of t){const s=document.createElement("style"),a=Ts.litNonce;a!==void 0&&s.setAttribute("nonce",a),s.textContent=n.cssText,e.appendChild(s)}},fr=Ki?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let n="";for(const s of t.cssRules)n+=s.cssText;return jp(n)})(e):e;const{is:Gp,defineProperty:Qp,getOwnPropertyDescriptor:Yp,getOwnPropertyNames:Jp,getOwnPropertySymbols:Xp,getPrototypeOf:Zp}=Object,Xs=globalThis,gr=Xs.trustedTypes,eh=gr?gr.emptyScript:"",th=Xs.reactiveElementPolyfillSupport,Kn=(e,t)=>e,Ds={toAttribute(e,t){switch(t){case Boolean:e=e?eh:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let n=e;switch(t){case Boolean:n=e!==null;break;case Number:n=e===null?null:Number(e);break;case Object:case Array:try{n=JSON.parse(e)}catch{n=null}}return n}},qi=(e,t)=>!Gp(e,t),mr={attribute:!0,type:String,converter:Ds,reflect:!1,useDefault:!1,hasChanged:qi};Symbol.metadata??=Symbol("metadata"),Xs.litPropertyMetadata??=new WeakMap;let Zt=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,n=mr){if(n.state&&(n.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((n=Object.create(n)).wrapped=!0),this.elementProperties.set(t,n),!n.noAccessor){const s=Symbol(),a=this.getPropertyDescriptor(t,s,n);a!==void 0&&Qp(this.prototype,t,a)}}static getPropertyDescriptor(t,n,s){const{get:a,set:i}=Yp(this.prototype,t)??{get(){return this[n]},set(o){this[n]=o}};return{get:a,set(o){const l=a?.call(this);i?.call(this,o),this.requestUpdate(t,l,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??mr}static _$Ei(){if(this.hasOwnProperty(Kn("elementProperties")))return;const t=Zp(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(Kn("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Kn("properties"))){const n=this.properties,s=[...Jp(n),...Xp(n)];for(const a of s)this.createProperty(a,n[a])}const t=this[Symbol.metadata];if(t!==null){const n=litPropertyMetadata.get(t);if(n!==void 0)for(const[s,a]of n)this.elementProperties.set(s,a)}this._$Eh=new Map;for(const[n,s]of this.elementProperties){const a=this._$Eu(n,s);a!==void 0&&this._$Eh.set(a,n)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const n=[];if(Array.isArray(t)){const s=new Set(t.flat(1/0).reverse());for(const a of s)n.unshift(fr(a))}else t!==void 0&&n.push(fr(t));return n}static _$Eu(t,n){const s=n.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,n=this.constructor.elementProperties;for(const s of n.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Hp(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,n,s){this._$AK(t,s)}_$ET(t,n){const s=this.constructor.elementProperties.get(t),a=this.constructor._$Eu(t,s);if(a!==void 0&&s.reflect===!0){const i=(s.converter?.toAttribute!==void 0?s.converter:Ds).toAttribute(n,s.type);this._$Em=t,i==null?this.removeAttribute(a):this.setAttribute(a,i),this._$Em=null}}_$AK(t,n){const s=this.constructor,a=s._$Eh.get(t);if(a!==void 0&&this._$Em!==a){const i=s.getPropertyOptions(a),o=typeof i.converter=="function"?{fromAttribute:i.converter}:i.converter?.fromAttribute!==void 0?i.converter:Ds;this._$Em=a;const l=o.fromAttribute(n,i.type);this[a]=l??this._$Ej?.get(a)??l,this._$Em=null}}requestUpdate(t,n,s,a=!1,i){if(t!==void 0){const o=this.constructor;if(a===!1&&(i=this[t]),s??=o.getPropertyOptions(t),!((s.hasChanged??qi)(i,n)||s.useDefault&&s.reflect&&i===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,s))))return;this.C(t,n,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,n,{useDefault:s,reflect:a,wrapped:i},o){s&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,o??n??this[t]),i!==!0||o!==void 0)||(this._$AL.has(t)||(this.hasUpdated||s||(n=void 0),this._$AL.set(t,n)),a===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(n){Promise.reject(n)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[a,i]of this._$Ep)this[a]=i;this._$Ep=void 0}const s=this.constructor.elementProperties;if(s.size>0)for(const[a,i]of s){const{wrapped:o}=i,l=this[a];o!==!0||this._$AL.has(a)||l===void 0||this.C(a,void 0,i,l)}}let t=!1;const n=this._$AL;try{t=this.shouldUpdate(n),t?(this.willUpdate(n),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(n)):this._$EM()}catch(s){throw t=!1,this._$EM(),s}t&&this._$AE(n)}willUpdate(t){}_$AE(t){this._$EO?.forEach(n=>n.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(n=>this._$ET(n,this[n])),this._$EM()}updated(t){}firstUpdated(t){}};Zt.elementStyles=[],Zt.shadowRootOptions={mode:"open"},Zt[Kn("elementProperties")]=new Map,Zt[Kn("finalized")]=new Map,th?.({ReactiveElement:Zt}),(Xs.reactiveElementVersions??=[]).push("2.1.2");const ji=globalThis,vr=e=>e,Ms=ji.trustedTypes,yr=Ms?Ms.createPolicy("lit-html",{createHTML:e=>e}):void 0,Ec="$lit$",ct=`lit$${Math.random().toFixed(9).slice(2)}$`,Pc="?"+ct,nh=`<${Pc}>`,Pt=document,Hn=()=>Pt.createComment(""),Gn=e=>e===null||typeof e!="object"&&typeof e!="function",Vi=Array.isArray,sh=e=>Vi(e)||typeof e?.[Symbol.iterator]=="function",Ra=`[ 	
\f\r]`,An=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,br=/-->/g,wr=/>/g,wt=RegExp(`>|${Ra}(?:([^\\s"'>=/]+)(${Ra}*=${Ra}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),kr=/'/g,$r=/"/g,Lc=/^(?:script|style|textarea|title)$/i,ah=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),r=ah(1),ht=Symbol.for("lit-noChange"),h=Symbol.for("lit-nothing"),Sr=new WeakMap,Rt=Pt.createTreeWalker(Pt,129);function Ic(e,t){if(!Vi(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return yr!==void 0?yr.createHTML(t):t}const ih=(e,t)=>{const n=e.length-1,s=[];let a,i=t===2?"<svg>":t===3?"<math>":"",o=An;for(let l=0;l<n;l++){const c=e[l];let u,p,f=-1,m=0;for(;m<c.length&&(o.lastIndex=m,p=o.exec(c),p!==null);)m=o.lastIndex,o===An?p[1]==="!--"?o=br:p[1]!==void 0?o=wr:p[2]!==void 0?(Lc.test(p[2])&&(a=RegExp("</"+p[2],"g")),o=wt):p[3]!==void 0&&(o=wt):o===wt?p[0]===">"?(o=a??An,f=-1):p[1]===void 0?f=-2:(f=o.lastIndex-p[2].length,u=p[1],o=p[3]===void 0?wt:p[3]==='"'?$r:kr):o===$r||o===kr?o=wt:o===br||o===wr?o=An:(o=wt,a=void 0);const w=o===wt&&e[l+1].startsWith("/>")?" ":"";i+=o===An?c+nh:f>=0?(s.push(u),c.slice(0,f)+Ec+c.slice(f)+ct+w):c+ct+(f===-2?l:w)}return[Ic(e,i+(e[n]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]};class Qn{constructor({strings:t,_$litType$:n},s){let a;this.parts=[];let i=0,o=0;const l=t.length-1,c=this.parts,[u,p]=ih(t,n);if(this.el=Qn.createElement(u,s),Rt.currentNode=this.el.content,n===2||n===3){const f=this.el.content.firstChild;f.replaceWith(...f.childNodes)}for(;(a=Rt.nextNode())!==null&&c.length<l;){if(a.nodeType===1){if(a.hasAttributes())for(const f of a.getAttributeNames())if(f.endsWith(Ec)){const m=p[o++],w=a.getAttribute(f).split(ct),k=/([.?@])?(.*)/.exec(m);c.push({type:1,index:i,name:k[2],strings:w,ctor:k[1]==="."?rh:k[1]==="?"?lh:k[1]==="@"?ch:ea}),a.removeAttribute(f)}else f.startsWith(ct)&&(c.push({type:6,index:i}),a.removeAttribute(f));if(Lc.test(a.tagName)){const f=a.textContent.split(ct),m=f.length-1;if(m>0){a.textContent=Ms?Ms.emptyScript:"";for(let w=0;w<m;w++)a.append(f[w],Hn()),Rt.nextNode(),c.push({type:2,index:++i});a.append(f[m],Hn())}}}else if(a.nodeType===8)if(a.data===Pc)c.push({type:2,index:i});else{let f=-1;for(;(f=a.data.indexOf(ct,f+1))!==-1;)c.push({type:7,index:i}),f+=ct.length-1}i++}}static createElement(t,n){const s=Pt.createElement("template");return s.innerHTML=t,s}}function ln(e,t,n=e,s){if(t===ht)return t;let a=s!==void 0?n._$Co?.[s]:n._$Cl;const i=Gn(t)?void 0:t._$litDirective$;return a?.constructor!==i&&(a?._$AO?.(!1),i===void 0?a=void 0:(a=new i(e),a._$AT(e,n,s)),s!==void 0?(n._$Co??=[])[s]=a:n._$Cl=a),a!==void 0&&(t=ln(e,a._$AS(e,t.values),a,s)),t}class oh{constructor(t,n){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=n}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:n},parts:s}=this._$AD,a=(t?.creationScope??Pt).importNode(n,!0);Rt.currentNode=a;let i=Rt.nextNode(),o=0,l=0,c=s[0];for(;c!==void 0;){if(o===c.index){let u;c.type===2?u=new Zs(i,i.nextSibling,this,t):c.type===1?u=new c.ctor(i,c.name,c.strings,this,t):c.type===6&&(u=new dh(i,this,t)),this._$AV.push(u),c=s[++l]}o!==c?.index&&(i=Rt.nextNode(),o++)}return Rt.currentNode=Pt,a}p(t){let n=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,n),n+=s.strings.length-2):s._$AI(t[n])),n++}}let Zs=class Dc{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,n,s,a){this.type=2,this._$AH=h,this._$AN=void 0,this._$AA=t,this._$AB=n,this._$AM=s,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const n=this._$AM;return n!==void 0&&t?.nodeType===11&&(t=n.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,n=this){t=ln(this,t,n),Gn(t)?t===h||t==null||t===""?(this._$AH!==h&&this._$AR(),this._$AH=h):t!==this._$AH&&t!==ht&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):sh(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==h&&Gn(this._$AH)?this._$AA.nextSibling.data=t:this.T(Pt.createTextNode(t)),this._$AH=t}$(t){const{values:n,_$litType$:s}=t,a=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=Qn.createElement(Ic(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===a)this._$AH.p(n);else{const i=new oh(a,this),o=i.u(this.options);i.p(n),this.T(o),this._$AH=i}}_$AC(t){let n=Sr.get(t.strings);return n===void 0&&Sr.set(t.strings,n=new Qn(t)),n}k(t){Vi(this._$AH)||(this._$AH=[],this._$AR());const n=this._$AH;let s,a=0;for(const i of t)a===n.length?n.push(s=new Dc(this.O(Hn()),this.O(Hn()),this,this.options)):s=n[a],s._$AI(i),a++;a<n.length&&(this._$AR(s&&s._$AB.nextSibling,a),n.length=a)}_$AR(t=this._$AA.nextSibling,n){for(this._$AP?.(!1,!0,n);t!==this._$AB;){const s=vr(t).nextSibling;vr(t).remove(),t=s}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},ea=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,n,s,a,i){this.type=1,this._$AH=h,this._$AN=void 0,this.element=t,this.name=n,this._$AM=a,this.options=i,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=h}_$AI(t,n=this,s,a){const i=this.strings;let o=!1;if(i===void 0)t=ln(this,t,n,0),o=!Gn(t)||t!==this._$AH&&t!==ht,o&&(this._$AH=t);else{const l=t;let c,u;for(t=i[0],c=0;c<i.length-1;c++)u=ln(this,l[s+c],n,c),u===ht&&(u=this._$AH[c]),o||=!Gn(u)||u!==this._$AH[c],u===h?t=h:t!==h&&(t+=(u??"")+i[c+1]),this._$AH[c]=u}o&&!a&&this.j(t)}j(t){t===h?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},rh=class extends ea{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===h?void 0:t}},lh=class extends ea{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==h)}},ch=class extends ea{constructor(t,n,s,a,i){super(t,n,s,a,i),this.type=5}_$AI(t,n=this){if((t=ln(this,t,n,0)??h)===ht)return;const s=this._$AH,a=t===h&&s!==h||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,i=t!==h&&(s===h||a);a&&this.element.removeEventListener(this.name,this,s),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},dh=class{constructor(t,n,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=n,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){ln(this,t)}};const uh={I:Zs},ph=ji.litHtmlPolyfillSupport;ph?.(Qn,Zs),(ji.litHtmlVersions??=[]).push("3.3.2");const hh=(e,t,n)=>{const s=n?.renderBefore??t;let a=s._$litPart$;if(a===void 0){const i=n?.renderBefore??null;s._$litPart$=a=new Zs(t.insertBefore(Hn(),i),i,void 0,n??{})}return a._$AI(e),a};const Hi=globalThis;let on=class extends Zt{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const n=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=hh(n,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return ht}};on._$litElement$=!0,on.finalized=!0,Hi.litElementHydrateSupport?.({LitElement:on});const fh=Hi.litElementPolyfillSupport;fh?.({LitElement:on});(Hi.litElementVersions??=[]).push("4.2.2");const Mc=e=>(t,n)=>{n!==void 0?n.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)};const gh={attribute:!0,type:String,converter:Ds,reflect:!1,hasChanged:qi},mh=(e=gh,t,n)=>{const{kind:s,metadata:a}=n;let i=globalThis.litPropertyMetadata.get(a);if(i===void 0&&globalThis.litPropertyMetadata.set(a,i=new Map),s==="setter"&&((e=Object.create(e)).wrapped=!0),i.set(n.name,e),s==="accessor"){const{name:o}=n;return{set(l){const c=t.get.call(this);t.set.call(this,l),this.requestUpdate(o,c,e,!0,l)},init(l){return l!==void 0&&this.C(o,void 0,e,l),l}}}if(s==="setter"){const{name:o}=n;return function(l){const c=this[o];t.call(this,l),this.requestUpdate(o,c,e,!0,l)}}throw Error("Unsupported decorator location: "+s)};function as(e){return(t,n)=>typeof n=="object"?mh(e,t,n):((s,a,i)=>{const o=a.hasOwnProperty(i);return a.constructor.createProperty(i,s),o?Object.getOwnPropertyDescriptor(a,i):void 0})(e,t,n)}function b(e){return as({...e,state:!0,attribute:!1})}async function Me(e,t){if(!(!e.client||!e.connected)&&!e.channelsLoading){e.channelsLoading=!0,e.channelsError=null;try{const n=await e.client.request("channels.status",{probe:t,timeoutMs:8e3});e.channelsSnapshot=n,e.channelsLastSuccess=Date.now()}catch(n){e.channelsError=String(n)}finally{e.channelsLoading=!1}}}async function vh(e,t){if(!(!e.client||!e.connected||e.whatsappBusy)){e.whatsappBusy=!0;try{const n=await e.client.request("web.login.start",{force:t,timeoutMs:3e4});e.whatsappLoginMessage=n.message??null,e.whatsappLoginQrDataUrl=n.qrDataUrl??null,e.whatsappLoginConnected=null}catch(n){e.whatsappLoginMessage=String(n),e.whatsappLoginQrDataUrl=null,e.whatsappLoginConnected=null}finally{e.whatsappBusy=!1}}}async function yh(e){if(!(!e.client||!e.connected||e.whatsappBusy)){e.whatsappBusy=!0;try{const t=await e.client.request("web.login.wait",{timeoutMs:12e4});e.whatsappLoginMessage=t.message??null,e.whatsappLoginConnected=t.connected??null,t.connected&&(e.whatsappLoginQrDataUrl=null)}catch(t){e.whatsappLoginMessage=String(t),e.whatsappLoginConnected=null}finally{e.whatsappBusy=!1}}}async function bh(e){if(!(!e.client||!e.connected||e.whatsappBusy)){e.whatsappBusy=!0;try{await e.client.request("channels.logout",{channel:"whatsapp"}),e.whatsappLoginMessage="Logged out.",e.whatsappLoginQrDataUrl=null,e.whatsappLoginConnected=null}catch(t){e.whatsappLoginMessage=String(t)}finally{e.whatsappBusy=!1}}}function Lt(e){return typeof structuredClone=="function"?structuredClone(e):JSON.parse(JSON.stringify(e))}function cn(e){return`${JSON.stringify(e,null,2).trimEnd()}
`}function Oc(e,t,n){if(t.length===0)return;let s=e;for(let i=0;i<t.length-1;i+=1){const o=t[i],l=t[i+1];if(typeof o=="number"){if(!Array.isArray(s))return;s[o]==null&&(s[o]=typeof l=="number"?[]:{}),s=s[o]}else{if(typeof s!="object"||s==null)return;const c=s;c[o]==null&&(c[o]=typeof l=="number"?[]:{}),s=c[o]}}const a=t[t.length-1];if(typeof a=="number"){Array.isArray(s)&&(s[a]=n);return}typeof s=="object"&&s!=null&&(s[a]=n)}function Fc(e,t){if(t.length===0)return;let n=e;for(let a=0;a<t.length-1;a+=1){const i=t[a];if(typeof i=="number"){if(!Array.isArray(n))return;n=n[i]}else{if(typeof n!="object"||n==null)return;n=n[i]}if(n==null)return}const s=t[t.length-1];if(typeof s=="number"){Array.isArray(n)&&n.splice(s,1);return}typeof n=="object"&&n!=null&&delete n[s]}async function Xe(e){if(!(!e.client||!e.connected)){e.configLoading=!0,e.lastError=null;try{const t=await e.client.request("config.get",{});kh(e,t)}catch(t){e.lastError=String(t)}finally{e.configLoading=!1}}}async function Nc(e){if(!(!e.client||!e.connected)&&!e.configSchemaLoading){e.configSchemaLoading=!0;try{const t=await e.client.request("config.schema",{});wh(e,t)}catch(t){e.lastError=String(t)}finally{e.configSchemaLoading=!1}}}function wh(e,t){e.configSchema=t.schema??null,e.configUiHints=t.uiHints??{},e.configSchemaVersion=t.version??null}function kh(e,t){e.configSnapshot=t;const n=typeof t.raw=="string"?t.raw:t.config&&typeof t.config=="object"?cn(t.config):e.configRaw;!e.configFormDirty||e.configFormMode==="raw"?e.configRaw=n:e.configForm?e.configRaw=cn(e.configForm):e.configRaw=n,e.configValid=typeof t.valid=="boolean"?t.valid:null,e.configIssues=Array.isArray(t.issues)?t.issues:[],e.configFormDirty||(e.configForm=Lt(t.config??{}),e.configFormOriginal=Lt(t.config??{}),e.configRawOriginal=n)}async function Os(e){if(!(!e.client||!e.connected)){e.configSaving=!0,e.lastError=null;try{const t=e.configFormMode==="form"&&e.configForm?cn(e.configForm):e.configRaw,n=e.configSnapshot?.hash;if(!n){e.lastError="Config hash missing; reload and retry.";return}await e.client.request("config.set",{raw:t,baseHash:n}),e.configFormDirty=!1,await Xe(e)}catch(t){e.lastError=String(t)}finally{e.configSaving=!1}}}async function $h(e){if(!(!e.client||!e.connected)){e.configApplying=!0,e.lastError=null;try{const t=e.configFormMode==="form"&&e.configForm?cn(e.configForm):e.configRaw,n=e.configSnapshot?.hash;if(!n){e.lastError="Config hash missing; reload and retry.";return}await e.client.request("config.apply",{raw:t,baseHash:n,sessionKey:e.applySessionKey}),e.configFormDirty=!1,await Xe(e)}catch(t){e.lastError=String(t)}finally{e.configApplying=!1}}}async function Ar(e){if(!(!e.client||!e.connected)){e.updateRunning=!0,e.lastError=null;try{await e.client.request("godmode.update.run",{})}catch(t){e.lastError=String(t)}finally{e.updateRunning=!1}}}async function Sh(e){if(!(!e.client||!e.connected)){e.pluginUpdateRunning=!0,e.lastError=null;try{await e.client.request("godmode.update.pluginRun",{})}catch(t){e.lastError=String(t)}finally{e.pluginUpdateRunning=!1}}}function tn(e,t,n){const s=Lt(e.configForm??e.configSnapshot?.config??{});Oc(s,t,n),e.configForm=s,e.configFormDirty=!0,e.configFormMode==="form"&&(e.configRaw=cn(s))}function xr(e,t){const n=Lt(e.configForm??e.configSnapshot?.config??{});Fc(n,t),e.configForm=n,e.configFormDirty=!0,e.configFormMode==="form"&&(e.configRaw=cn(n))}async function Ah(e,t,n){tn(e,["agents","defaults","model","primary"],t),tn(e,["agents","defaults","model","fallbacks"],n),await Os(e)}function xh(e){const{values:t,original:n}=e;return t.name!==n.name||t.displayName!==n.displayName||t.about!==n.about||t.picture!==n.picture||t.banner!==n.banner||t.website!==n.website||t.nip05!==n.nip05||t.lud16!==n.lud16}function Th(e){const{state:t,callbacks:n,accountId:s}=e,a=xh(t),i=(l,c,u={})=>{const{type:p="text",placeholder:f,maxLength:m,help:w}=u,k=t.values[l]??"",d=t.fieldErrors[l],g=`nostr-profile-${l}`;return p==="textarea"?r`
...
`+n.join(`
`),d=this.blockquote(k);i[i.length-1]=d,s=s.substring(0,s.length-w.raw.length)+d.raw,a=a.substring(0,a.length-w.text.length)+d.text;break}else if(m?.type==="list"){let w=m,k=w.raw+`
`+n.join(`
`),d=this.list(k);i[i.length-1]=d,s=s.substring(0,s.length-m.raw.length)+d.raw,a=a.substring(0,a.length-w.raw.length)+d.raw,n=k.substring(i.at(-1).raw.length).split(`
...
`,e=e.substring(m.length+1),c=!0),!c){let d=this.rules.other.nextBulletRegex(k),g=this.rules.other.hrRegex(k),$=this.rules.other.fencesBeginRegex(k),A=this.rules.other.headingBeginRegex(k),T=this.rules.other.htmlBeginRegex(k),x=this.rules.other.blockquoteBeginRegex(k);for(;e;){let _=e.split(`
`,1)[0],P;if(m=_,this.options.pedantic?(m=m.replace(this.rules.other.listReplaceNesting,"  "),P=m):P=m.replace(this.rules.other.tabCharGlobal,"    "),$.test(m)||A.test(m)||T.test(m)||x.test(m)||d.test(m)||g.test(m))break;if(P.search(this.rules.other.nonSpaceChar)>=k||!m.trim())p+=`
...
`)?"":`
`)+a.raw,o.text+=`
`+a.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=o.text):n.push(a);continue}if(t){let o="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(o);break}else throw new Error(o)}}return this.state.top=!0,n}inline(t,n=[]){return this.inlineQueue.push({src:t,tokens:n}),n}inlineTokens(t,n=[]){let s=t,a=null;if(this.tokens.links){let c=Object.keys(this.tokens.links);if(c.length>0)for(;(a=this.tokenizer.rules.inline.reflinkSearch.exec(s))!=null;)c.includes(a[0].slice(a[0].lastIndexOf("[")+1,-1))&&(s=s.slice(0,a.index)+"["+"a".repeat(a[0].length-2)+"]"+s.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(a=this.tokenizer.rules.inline.anyPunctuation.exec(s))!=null;)s=s.slice(0,a.index)+"++"+s.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let i;for(;(a=this.tokenizer.rules.inline.blockSkip.exec(s))!=null;)i=a[2]?a[2].length:0,s=s.slice(0,a.index+i)+"["+"a".repeat(a[0].length-i-2)+"]"+s.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);s=this.options.hooks?.emStrongMask?.call({lexer:this},s)??s;let o=!1,l="";for(;t;){o||(l=""),o=!1;let c;if(this.options.extensions?.inline?.some(p=>(c=p.call({lexer:this},t,n))?(t=t.substring(c.raw.length),n.push(c),!0):!1))continue;if(c=this.tokenizer.escape(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.tag(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.link(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.reflink(t,this.tokens.links)){t=t.substring(c.raw.length);let p=n.at(-1);c.type==="text"&&p?.type==="text"?(p.raw+=c.raw,p.text+=c.text):n.push(c);continue}if(c=this.tokenizer.emStrong(t,s,l)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.codespan(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.br(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.del(t,s,l)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.autolink(t)){t=t.substring(c.raw.length),n.push(c);continue}if(!this.state.inLink&&(c=this.tokenizer.url(t))){t=t.substring(c.raw.length),n.push(c);continue}let u=t;if(this.options.extensions?.startInline){let p=1/0,f=t.slice(1),m;this.options.extensions.startInline.forEach(w=>{m=w.call({lexer:this},f),typeof m=="number"&&m>=0&&(p=Math.min(p,m))}),p<1/0&&p>=0&&(u=t.substring(0,p+1))}if(c=this.tokenizer.inlineText(u)){t=t.substring(c.raw.length),c.raw.slice(-1)!=="_"&&(l=c.raw.slice(-1)),o=!0;let p=n.at(-1);p?.type==="text"?(p.raw+=c.raw,p.text+=c.text):n.push(c);continue}if(t){let p="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(p);break}else throw new Error(p)}}return n}},Us=class{options;parser;constructor(e){this.options=e||Ut}space(e){return""}code({text:e,lang:t,escaped:n}){let s=(t||"").match(fe.notSpaceStart)?.[0],a=e.replace(fe.endingNewline,"")+`
...
`;)p++;p<e.length&&(s.length===0||s[s.length-1]!==p)&&s.push(p)}a=i===-1?e.length:i+1}return s.length<2?-1:s[s.length-2]}const q={messageSquare:r`
  ...
  `},Bg=1500,Ug=2e3,pd="Copy as markdown",zg="Copied",Kg="Copy failed";async function Wg(e){if(!e)return!1;try{return await navigator.clipboard.writeText(e),!0}catch{return!1}}function Ss(e,t){e.title=t,e.setAttribute("aria-label",t)}function qg(e){const t=e.label??pd;return r`
    <button
      class="chat-copy-btn"
      type="button"
      title=${t}
      aria-label=${t}
      @click=${async n=>{const s=n.currentTarget;if(s?.querySelector(".chat-copy-btn__icon"),!s||s.dataset.copying==="1")return;s.dataset.copying="1",s.setAttribute("aria-busy","true"),s.disabled=!0;const a=await Wg(e.text());if(s.isConnected){if(delete s.dataset.copying,s.removeAttribute("aria-busy"),s.disabled=!1,!a){s.dataset.error="1",Ss(s,Kg),window.setTimeout(()=>{s.isConnected&&(delete s.dataset.error,Ss(s,t))},Ug);return}s.dataset.copied="1",Ss(s,zg),window.setTimeout(()=>{s.isConnected&&(delete s.dataset.copied,Ss(s,t))},Bg)}}}
    >
...
`).length:0,w=l&&(e.text?.length??0)<=bm,k=l&&!w&&m>km,d=l&&!k,g=!l,$=e.kind==="call"?"chat-tool-card--call":"chat-tool-card--result";return r`
    <div
...
`);)a=a.slice(1);return a.trim()}function Mm(e){return typeof e!="number"||!Number.isFinite(e)||e<=0?null:e>=1024*1024?`${(e/(1024*1024)).toFixed(1)} MB`:e>=1024?`${Math.round(e/1024)} KB`:`${Math.round(e)} B`}function $i(e){const t=e,n=t.content,s=[];if(Array.isArray(n))for(const i of n){if(typeof i!="object"||i===null)continue;const o=i;if(o.type==="image"){const l=o.source;if(l?.type==="base64"&&typeof l.data=="string"){const c=l.data,u=l.media_type||"image/png",p=c.startsWith("data:")?c:`data:${u};base64,${c}`;s.push({url:p})}else if(typeof o.data=="string"&&typeof o.mimeType=="string"){const c=o.data.startsWith("data:")?o.data:`data:${o.mimeType};base64,${o.data}`;s.push({url:c})}else typeof o.url=="string"?s.push({url:o.url}):o.omitted===!0&&s.push({omitted:!0,bytes:typeof o.bytes=="number"?o.bytes:void 0,mimeType:typeof o.mimeType=="string"?o.mimeType:void 0,alt:typeof o.fileName=="string"?o.fileName:void 0})}else if(o.type==="image_url"){const l=o.image_url;typeof l?.url=="string"&&s.push({url:l.url})}else o.type==="attachment"&&typeof o.content=="string"&&(o.mimeType||"").startsWith("image/")&&s.push({url:o.content,alt:o.fileName||void 0});if(o.type==="text"&&typeof o.text=="string"){const l=/data:image\/[^;]+;base64,[A-Za-z0-9+/=]+/g,c=o.text.match(l);if(c)for(const u of c)s.push({url:u})}if(Array.isArray(o.content))for(const l of o.content){if(typeof l!="object"||l===null)continue;const c=l;if(c.type==="image"){const u=c.source;if(u?.type==="base64"&&typeof u.data=="string"){const p=u.media_type||"image/png",f=u.data.startsWith("data:")?u.data:`data:${p};base64,${u.data}`;s.push({url:f})}else if(typeof c.data=="string"&&typeof c.mimeType=="string"){const p=c.data.startsWith("data:")?c.data:`data:${c.mimeType};base64,${c.data}`;s.push({url:p})}else c.omitted===!0&&s.push({omitted:!0,bytes:typeof c.bytes=="number"?c.bytes:void 0,mimeType:typeof c.mimeType=="string"?c.mimeType:void 0,alt:typeof c.fileName=="string"?c.fileName:void 0})}}}const a=t.attachments;if(Array.isArray(a))for(const i of a){if(typeof i!="object"||i===null)continue;const o=i;if(o.type==="image"&&typeof o.content=="string"){const l=o.mimeType||"image/png",c=o.content.startsWith("data:")?o.content:`data:${l};base64,${o.content}`;s.push({url:c,alt:o.fileName||void 0})}else o.type==="image"&&o.omitted===!0&&s.push({omitted:!0,bytes:typeof o.bytes=="number"?o.bytes:void 0,mimeType:typeof o.mimeType=="string"?o.mimeType:void 0,alt:typeof o.fileName=="string"?o.fileName:void 0})}return s}function Om(e){const t=e,n=t.content,s=[];if(Array.isArray(n))for(const i of n){if(typeof i!="object"||i===null)continue;const o=i;if(o.type==="attachment"&&typeof o.content=="string"){const l=o.mimeType||"application/octet-stream";l.startsWith("image/")||s.push({fileName:o.fileName||"file",mimeType:l,content:o.content})}}const a=t.attachments;if(Array.isArray(a))for(const i of a){if(typeof i!="object"||i===null)continue;const o=i;o.type==="file"&&typeof o.content=="string"&&s.push({fileName:o.fileName||"file",mimeType:o.mimeType||"application/octet-stream",content:o.content})}return s}function Fm(e,t){return r`
  ...
  `}function Bm(e,t){const n=po(e.role),s=t.assistantName??"Assistant",a=t.userName??"You",i=n==="user"?a:n==="assistant"?s:n,o=n==="user"?"user":n==="assistant"?"assistant":"other",l=new Date(e.timestamp).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"});return r`
    <div class="chat-group ${o}">
      ...
      <div class="chat-group-messages">
        ${e.messages.map((c,u)=>Sd(c.message,{isStreaming:e.isStreaming&&u===e.messages.length-1,showReasoning:t.showReasoning},t.onOpenSidebar,t.onOpenFile,t.onOpenProof,t.onImageClick,t.resolveImageUrl,t.onPushToDrive))}
        <div class="chat-group-footer">
  ...
  `}function ho(e,t){const n=po(e),s=t?.assistantName?.trim()||"Assistant",a=typeof t?.assistantAvatar=="string"?t.assistantAvatar.trim():"",i=t?.userName?.trim()||"You",o=typeof t?.userAvatar=="string"?t.userAvatar.trim():"",l=n==="user"?"user":n==="assistant"?"assistant":n==="tool"?"tool":"other";return n==="user"?o&&nl(o)?r`<img
    ...
    <div class="chat-message-images">
      ${s.map(i=>{const o=i.resolvedUrl||i.url;if(!o){const c=Mm(i.bytes),p=[i.mimeType?i.mimeType.replace("image/","").toUpperCase():null,c].filter(Boolean).join(" · ");return r`
            <div
...
Deletes the session entry and archives its transcript.`)&&(e.sessionsResult?.sessions&&(e.sessionsResult={...e.sessionsResult,sessions:e.sessionsResult.sessions.filter(d=>d.key!==w)}),e.client&&e.connected))try{await e.client.request("sessions.delete",{key:w,deleteTranscript:!0}),te(e)}catch(d){console.error("Failed to delete session:",d),te(e)}},u=m=>r`
  ...
  `};function et(e){const{schema:t,value:n,path:s,hints:a,unsupported:i,disabled:o,onPatch:l}=e,c=e.showLabel??!0,u=qe(t),p=_e(s,a),f=p?.label??t.title??nt(String(s.at(-1))),m=p?.help??t.description,w=va(s);if(i.has(w))return r`<div class="cfg-field cfg-field--error">
      <div class="cfg-field__label">${f}</div>
      <div class="cfg-field__error">Unsupported schema node. Use Raw mode.</div>
    </div>`;if(t.anyOf||t.oneOf){const d=(t.anyOf??t.oneOf??[]).filter(_=>!(_.type==="null"||Array.isArray(_.type)&&_.type.includes("null")));if(d.length===1)return et({...e,schema:d[0]});const g=_=>{if(_.const!==void 0)return _.const;if(_.enum&&_.enum.length===1)return _.enum[0]},$=d.map(g),A=$.every(_=>_!==void 0);if(A&&$.length>0&&$.length<=5){const _=n??t.default;return r`
        <div class="cfg-field">
  ...
  `}function Pl(e){const{schema:t,value:n,path:s,hints:a,disabled:i,onPatch:o,inputType:l}=e,c=e.showLabel??!0,u=_e(s,a),p=u?.label??t.title??nt(String(s.at(-1))),f=u?.help??t.description,m=u?.sensitive??Mw(s),w=u?.placeholder??(m?"••••":t.default!==void 0?`Default: ${rn(t.default)}`:""),k=n??"";return r`
    <div class="cfg-field">
      ...
      <div class="cfg-input-wrap">
        <input
          ...
          .value=${rn(k)}
          ?disabled=${i}
          @input=${d=>{const g=d.target.value;if(l==="number"){if(g.trim()===""){o(s,void 0);return}const $=Number(g);o(s,Number.isNaN($)?g:$);return}o(s,g)}}
  ...
  `}function Bw(e){const{schema:t,value:n,path:s,hints:a,disabled:i,onPatch:o}=e,l=e.showLabel??!0,c=_e(s,a),u=c?.label??t.title??nt(String(s.at(-1))),p=c?.help??t.description,f=n??t.default??"",m=typeof f=="number"?f:0;return r`
    <div class="cfg-field">
      ...
      <div class="cfg-number">
        ...
        <input
          ...
          .value=${rn(f)}
          ?disabled=${i}
          @input=${w=>{const k=w.target.value,d=k===""?void 0:Number(k);o(s,d)}}
        />
        <button
          type="button"
          class="cfg-number__btn"
  ...
  `}function Ll(e){const{schema:t,value:n,path:s,hints:a,disabled:i,options:o,onPatch:l}=e,c=e.showLabel??!0,u=_e(s,a),p=u?.label??t.title??nt(String(s.at(-1))),f=u?.help??t.description,m=n??t.default,w=o.findIndex(d=>d===m||String(d)===String(m)),k="__unset__";return r`
    <div class="cfg-field">
      ${c?r`<label class="cfg-field__label">${p}</label>`:h}
      ${f?r`<div class="cfg-field__help">${f}</div>`:h}
      <select
  ...
  `}function zw(e){const{schema:t,value:n,path:s,hints:a,unsupported:i,disabled:o,onPatch:l}=e,c=e.showLabel??!0,u=_e(s,a),p=u?.label??t.title??nt(String(s.at(-1))),f=u?.help??t.description,m=Array.isArray(t.items)?t.items[0]:t.items;if(!m)return r`
      <div class="cfg-field cfg-field--error">
            ...
            <div class="cfg-array__item">
              <div class="cfg-array__item-header">
                ...
                <button
                  ...
                  title="Remove item"
                  ?disabled=${o}
                  @click=${()=>{const g=[...w];g.splice(d,1),l(s,g)}}
                >
                  ${ss.trash}
                </button>
              </div>
              <div class="cfg-array__item-content">
                ${et({schema:m,value:k,path:[...s,d],hints:a,unsupported:i,disabled:o,showLabel:!1,onPatch:l})}
              </div>
            </div>
          `)}
        </div>
  ...
  `}function Il(e){const{schema:t,value:n,path:s,hints:a,unsupported:i,disabled:o,reservedKeys:l,onPatch:c}=e,u=Fw(t),p=Object.entries(n??{}).filter(([f])=>!l.has(f));return r`
    <div class="cfg-map">
      <div class="cfg-map__header">
        ...
        <button
          ...
          class="cfg-map__add"
          ?disabled=${o}
          @click=${()=>{const f={...n};let m=1,w=`custom-${m}`;for(;w in f;)m+=1,w=`custom-${m}`;f[w]=u?{}:Zu(t),c(s,f)}}
        >
              ...
              <div class="cfg-map__item">
                <div class="cfg-map__item-key">
                  <input
                    ...
                    .value=${f}
                    ?disabled=${o}
                    @change=${d=>{const g=d.target.value.trim();if(!g||g===f)return;const $={...n};g in $||($[g]=$[f],delete $[f],c(s,$))}}
                  />
                </div>
                <div class="cfg-map__item-value">
                  ${u?r`
                        <textarea
                          ...
                          .value=${k}
                          ?disabled=${o}
                          @change=${d=>{const g=d.target,$=g.value.trim();if(!$){c(w,void 0);return}try{c(w,JSON.parse($))}catch{g.value=k}}}
                        ></textarea>
                      `:et({schema:t,value:m,path:w,hints:a,unsupported:i,disabled:o,showLabel:!1,onPatch:c})}
                </div>
                <button
                  type="button"
  ...
  `},qo={env:{label:"Environment Variables",description:"Environment variables passed to the gateway process"},update:{label:"Updates",description:"Auto-update settings and release channel"},agents:{label:"Agents",description:"Agent configurations, models, and identities"},auth:{label:"Authentication",description:"API keys and authentication profiles"},channels:{label:"Channels",description:"Messaging channels (Telegram, Discord, Slack, etc.)"},messages:{label:"Messages",description:"Message handling and routing settings"},commands:{label:"Commands",description:"Custom slash commands"},hooks:{label:"Hooks",description:"Webhooks and event hooks"},skills:{label:"Skills",description:"Skill packs and capabilities"},tools:{label:"Tools",description:"Tool configurations (browser, search, etc.)"},gateway:{label:"Gateway",description:"Gateway server settings (port, auth, binding)"},wizard:{label:"Setup Wizard",description:"Setup wizard state and history"},meta:{label:"Metadata",description:"Gateway metadata and version information"},logging:{label:"Logging",description:"Log levels and output configuration"},browser:{label:"Browser",description:"Browser automation settings"},ui:{label:"UI",description:"User interface preferences"},models:{label:"Models",description:"AI model configurations and providers"},bindings:{label:"Bindings",description:"Key bindings and shortcuts"},broadcast:{label:"Broadcast",description:"Broadcast and notification settings"},audio:{label:"Audio",description:"Audio input/output settings"},session:{label:"Session",description:"Session management and persistence"},cron:{label:"Cron",description:"Scheduled tasks and automation"},web:{label:"Web",description:"Web server and API settings"},discovery:{label:"Discovery",description:"Service discovery and networking"},canvasHost:{label:"Canvas Host",description:"Canvas rendering and display"},talk:{label:"Talk",description:"Voice and speech settings"},plugins:{label:"Plugins",description:"Plugin management and extensions"},user:{label:"User Profile",description:"Your display name and avatar"}};function Ml(e){return Dl[e]??Dl.default}function Kw(e,t,n){if(!n)return!0;const s=n.toLowerCase(),a=qo[e];return e.toLowerCase().includes(s)||a&&(a.label.toLowerCase().includes(s)||a.description.toLowerCase().includes(s))?!0:Un(t,s)}function Un(e,t){if(e.title?.toLowerCase().includes(t)||e.description?.toLowerCase().includes(t)||e.enum?.some(s=>String(s).toLowerCase().includes(t)))return!0;if(e.properties){for(const[s,a]of Object.entries(e.properties))if(s.toLowerCase().includes(t)||Un(a,t))return!0}if(e.items){const s=Array.isArray(e.items)?e.items:[e.items];for(const a of s)if(a&&Un(a,t))return!0}if(e.additionalProperties&&typeof e.additionalProperties=="object"&&Un(e.additionalProperties,t))return!0;const n=e.anyOf??e.oneOf??e.allOf;if(n){for(const s of n)if(s&&Un(s,t))return!0}return!1}function Ww(e){if(!e.schema)return r`
    ...
    <div class="config-form config-form--modern">
      ${p?(()=>{const{sectionKey:f,subsectionKey:m,schema:w}=p,k=_e([f,m],e.uiHints),d=k?.label??w.title??nt(m),g=k?.help??w.description??"",$=n[f],A=$&&typeof $=="object"?$[m]:void 0,T=`config-section-${f}-${m}`;return r`
  ...
  `}const qw=new Set(["title","description","default","nullable"]);function jw(e){return Object.keys(e??{}).filter(n=>!qw.has(n)).length===0}function ep(e){const t=e.filter(a=>a!=null),n=t.length!==e.length,s=[];for(const a of t)s.some(i=>Object.is(i,a))||s.push(a);return{enumValues:s,nullable:n}}function tp(e){return!e||typeof e!="object"?{schema:null,unsupportedPaths:["<root>"]}:qn(e,[])}function qn(e,t){const n=new Set,s={...e},a=va(t)||"<root>";if(e.anyOf||e.oneOf||e.allOf){const l=Vw(e,t);return l||{schema:e,unsupportedPaths:[a]}}const i=Array.isArray(e.type)&&e.type.includes("null"),o=qe(e)??(e.properties||e.additionalProperties?"object":void 0);if(s.type=o??e.type,s.nullable=i||e.nullable,s.enum){const{enumValues:l,nullable:c}=ep(s.enum);s.enum=l,c&&(s.nullable=!0),l.length===0&&n.add(a)}if(o==="object"){const l=e.properties??{},c={};for(const[u,p]of Object.entries(l)){const f=qn(p,[...t,u]);f.schema&&(c[u]=f.schema);for(const m of f.unsupportedPaths)n.add(m)}if(s.properties=c,e.additionalProperties===!0)n.add(a);else if(e.additionalProperties===!1)s.additionalProperties=!1;else if(e.additionalProperties&&typeof e.additionalProperties=="object"&&!jw(e.additionalProperties)){const u=qn(e.additionalProperties,[...t,"*"]);s.additionalProperties=u.schema??e.additionalProperties,u.unsupportedPaths.length>0&&n.add(a)}}else if(o==="array"){const l=Array.isArray(e.items)?e.items[0]:e.items;if(!l)n.add(a);else{const c=qn(l,[...t,"*"]);s.items=c.schema??l,c.unsupportedPaths.length>0&&n.add(a)}}else o!=="string"&&o!=="number"&&o!=="integer"&&o!=="boolean"&&!s.enum&&n.add(a);return{schema:s,unsupportedPaths:Array.from(n)}}function Vw(e,t){if(e.allOf)return null;const n=e.anyOf??e.oneOf;if(!n)return null;const s=[],a=[];let i=!1;for(const l of n){if(!l||typeof l!="object")return null;if(Array.isArray(l.enum)){const{enumValues:c,nullable:u}=ep(l.enum);s.push(...c),u&&(i=!0);continue}if("const"in l){if(l.const==null){i=!0;continue}s.push(l.const);continue}if(qe(l)==="null"){i=!0;continue}a.push(l)}if(s.length>0&&a.length===0){const l=[];for(const c of s)l.some(u=>Object.is(u,c))||l.push(c);return{schema:{...e,enum:l,nullable:i,anyOf:void 0,oneOf:void 0,allOf:void 0},unsupportedPaths:[]}}if(a.length===1){const l=qn(a[0],t);return l.schema&&(l.schema.nullable=i||l.schema.nullable),l}const o=new Set(["string","number","integer","boolean"]);return a.length>0&&s.length===0&&a.every(l=>l.type&&o.has(String(l.type)))?{schema:{...e,nullable:i},unsupportedPaths:[]}:null}function Hw(e,t){let n=e;for(const s of t){if(!n)return null;const a=qe(n);if(a==="object"){const i=n.properties??{};if(typeof s=="string"&&i[s]){n=i[s];continue}const o=n.additionalProperties;if(typeof s=="string"&&o&&typeof o=="object"){n=o;continue}return null}if(a==="array"){if(typeof s!="number")return null;n=(Array.isArray(n.items)?n.items[0]:n.items)??null;continue}return null}return n}function Gw(e,t){const s=(e.channels??{})[t],a=e[t];return(s&&typeof s=="object"?s:null)??(a&&typeof a=="object"?a:null)??{}}function Qw(e){const t=tp(e.schema),n=t.schema;if(!n)return r`
  ...
  `}function Ol(e){return e?e.length<=20?e:`${e.slice(0,8)}...${e.slice(-8)}`:"n/a"}function Zw(e){const{props:t,nostr:n,nostrAccounts:s,accountCountLabel:a,profileFormState:i,profileFormCallbacks:o,onEditProfile:l}=e,c=s[0],u=n?.configured??c?.configured??!1,p=n?.running??c?.running??!1,f=n?.publicKey??c?.publicKey,m=n?.lastStartAt??c?.lastStartAt??null,w=n?.lastError??c?.lastError??null,k=s.length>1,d=i!=null,g=A=>{const T=A.publicKey,x=A.profile,_=x?.displayName??x?.name??A.name??A.accountId;return r`
    ...
    `},$=()=>{if(d&&o)return Th({state:i,callbacks:o,accountId:s[0]?.accountId??"default"});const A=c?.profile??n?.profile,{name:T,displayName:x,about:_,picture:P,nip05:E}=A??{},Z=T||x||_||P||E;return r`
...
`)?null:t.startsWith("/")||t.startsWith("~/")||t.startsWith("./")||t.startsWith("../")||/^[a-z]:[\\/]/i.test(t)||/^[^:\s]+\/[^\s]+$/.test(t)&&/\.[a-z0-9]{1,12}$/i.test(t)||/^[^\s/\\:*?"<>|]+\.[a-z0-9]{1,12}$/i.test(t)&&t.length<=100?t:null}async function Xk(e,t){const n=e.target,s=n instanceof Element?n:n instanceof Node?n.parentElement:null;if(!s||!t.onMessageLinkClick||!Qk(e))return;const a=s.closest("a");if(a instanceof HTMLAnchorElement){if(a.hasAttribute("download"))return;const c=a.getAttribute("href");if(!c)return;try{const p=new URL(c,window.location.href);if(/^https?:$/.test(p.protocol)&&p.origin!==window.location.origin){e.preventDefault(),window.open(p.href,"_blank","noopener,noreferrer");return}}catch{}e.preventDefault(),await t.onMessageLinkClick(c)||Yk(a);return}const i=s.closest("code");if(!(i instanceof HTMLElement))return;const o=(i.textContent??"").trim();if(/^https?:\/\/\S+$/i.test(o)){e.preventDefault(),window.open(o,"_blank","noopener,noreferrer");return}if(/^[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)+\.[a-z]{2,}(\/\S*)?$/i.test(o)){e.preventDefault(),window.open(`https://${o}`,"_blank","noopener,noreferrer");return}const l=Jk(o);l&&(e.preventDefault(),await t.onMessageLinkClick(l))}const Zk={html_report:"📊",plan:"📋",analysis:"🔍",code:"💻",doc:"📝",data:"📦",image:"🖼️",script:"⚙️"};function e$(e){const t=e.sessionResources;if(!t||t.length===0)return h;if(e.sessionResourcesCollapsed)return r`
  ...
  `}function f$(e){const t=e.valid==null?"unknown":e.valid?"valid":"invalid",n=tp(e.schema),s=n.schema?n.unsupportedPaths.length>0:!1,a=n.schema?.properties??{},i=si.filter(E=>E.key in a&&!ql.has(E.key)),o=new Set(si.map(E=>E.key)),l=Object.keys(a).filter(E=>!o.has(E)).map(E=>({key:E,label:E.charAt(0).toUpperCase()+E.slice(1)})),c=si.filter(E=>ql.has(E.key)),u=[...i,...l,...c],p=e.activeSection&&n.schema&&qe(n.schema)==="object"?n.schema.properties?.[e.activeSection]:void 0,f=e.activeSection?l$(e.activeSection,p):null,m=e.activeSection?c$({key:e.activeSection,schema:p,uiHints:e.uiHints}):[],w=e.formMode==="form"&&!!e.activeSection&&m.length>0,k=e.activeSubsection===jl,d=e.searchQuery||k?null:e.activeSubsection??m[0]?.key??null,g=e.formMode==="form"?d$(e.originalValue,e.formValue):[],$=e.formMode==="raw"&&e.raw!==e.originalRaw,A=e.formMode==="form"?g.length>0:$,T=!!e.formValue&&!e.loading&&!!n.schema,x=e.connected&&!e.saving&&A&&(e.formMode==="raw"?!0:T),_=e.connected&&!e.applying&&!e.updating&&A&&(e.formMode==="raw"?!0:T),P=e.connected&&!e.applying&&!e.updating;return r`
        ...
        <div class="config-content">
          ${e.activeSection==="model"?h$(e):e.activeSection==="user"?r$({userName:e.userName,userAvatar:e.userAvatar,onUpdate:e.onUserProfileUpdate}):e.formMode==="form"?r`
                  ${e.schemaLoading?r`
                        ...
                        `:Ww({schema:n.schema,uiHints:e.uiHints,value:e.formValue,disabled:e.loading||!e.formValue,unsupportedPaths:n.unsupportedPaths,onPatch:e.onFormPatch,searchQuery:e.searchQuery,activeSection:e.activeSection,activeSubsection:d})}
                  ${s?r`
            ...
            <div class="list" style="margin-top: 12px;">
              ${e.eventLog.map(c=>r`
                  <div class="list-item">
                    ...
                    <div class="list-meta">
                      <pre class="code-block">${y$(c.payload)}</pre>
                    </div>
                  </div>
                `)}
            </div>
...
`)}function q$(e){const t=new Date(e),s=new Date().getTime()-t.getTime(),a=Math.floor(s/(1e3*60));if(a<1)return"Just now";if(a<60)return`${a}m ago`;const i=Math.floor(a/60);return i<24?`${i}h ago`:t.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})}function j$(e){const t="VAULT",n=encodeURIComponent(`01-Daily/${e}`);return`obsidian://open?vault=${t}&file=${n}`}let Vn=null,fn=null;function Xl(e,t,n=1500){Vn&&clearTimeout(Vn),Vn=setTimeout(()=>{e!==fn&&(fn=e,t(e))},n)}function V$(e,t){Vn&&clearTimeout(Vn),e!==fn&&(fn=e,t(e))}function ai(e){for(const t of e.querySelectorAll('input[type="checkbox"]')){const n=t;n.checked?n.setAttribute("checked",""):n.removeAttribute("checked")}return U$(e.innerHTML)}function H$(e){const{data:t,loading:n,error:s,onRefresh:a,onGenerate:i,onOpenInObsidian:o,onSaveBrief:l,onToggleCheckbox:c,onOpenFile:u}=e;if(n)return r`
  ...
  `}function o0(e){const{browseEntries:t,breadcrumbs:n,browseSearchQuery:s,browseSearchResults:a,onBrowseFolder:i,onBrowseSearch:o,onBrowseBack:l,onCreateFolder:c,onItemClick:u}=e,p=a??t??[];return r`
  ...
  `}function r0(e){const{workspace:t,itemSearchQuery:n,expandedFolders:s=new Set,showCompletedTasks:a=!1,onItemSearch:i,onBack:o,onItemClick:l,onSessionClick:c,onPinToggle:u,onPinSessionToggle:p,onToggleFolder:f,onToggleTaskComplete:m,onCreateTask:w,onToggleCompletedTasks:k,onStartTask:d,editingTaskId:g,onEditTask:$,onUpdateTask:A,onBatchPushToDrive:T}=e,x=tc(n,t.pinned).toSorted((B,Oe)=>Oe.modified.getTime()-B.modified.getTime()),_=nc(n,t.pinnedSessions),P=tc(n,t.outputs).filter(B=>!t.pinned.some(Oe=>Oe.path===B.path)),E=(t.folderTree?.length??0)>0,Z=E?fp(n,t.folderTree):[],Y=nc(n,t.sessions),I=new Set(t.pinnedSessions.map(B=>B.key)),M=new Set(t.pinned.map(B=>B.path)),N=n.trim().length>0,U=x.length>0||_.length>0,O=Y.length>0||t.sessions.length===0||N,ie=n0(t.outputs),ke=ie.length>0&&!N,J={expandedFolders:s,pinnedPaths:M,workspaceId:t.id,onToggleFolder:f,onItemClick:l,onPinToggle:u};return r`
    <div class="workspaces-container">
      ...
      <div class="workspace-content">
        ...
        ${l0({tasks:t.tasks??[],workspaceName:t.name,showCompleted:a,onToggleTaskComplete:m,onCreateTask:w,onToggleCompletedTasks:k,onStartTask:d,editingTaskId:g,onEditTask:$,onUpdateTask:A})}
  ...
  `}function l0(e){const{tasks:t,workspaceName:n,showCompleted:s,onToggleTaskComplete:a,onCreateTask:i,onToggleCompletedTasks:o,onStartTask:l,editingTaskId:c,onEditTask:u,onUpdateTask:p}=e,f=Js(t.filter(w=>w.status==="pending")),m=Js(t.filter(w=>w.status==="complete"));return r`
    <section class="ws-section">
      <div class="ws-section__header">
        <h3>Tasks</h3>
      ...
      <div class="ws-list ws-list--scroll">
        ...
        ${f.map(w=>ec(w,a,l,c,u,p))}
        ${m.length>0?r`
              <button class="ws-task-completed-toggle" @click=${()=>o?.()}>
                ${s?"Hide":"Show"} ${m.length} completed
              </button>
              ${s?m.map(w=>ec(w,a,l,c,u,p)):h}
            `:h}
      </div>
      ${i?r`
            <form
              class="ws-task-create-form"
              @submit=${w=>{w.preventDefault();const d=w.currentTarget.querySelector("input"),g=d.value.trim();g&&(i(g,n),d.value="")}}
            >
              <input
                type="text"
      ...
      ${l?r`
            ...
            `:r`
              <div class="workspaces-body">
                ...
                ${d0({tasks:p,taskFilter:f,taskSort:m,taskSearch:w,onToggleTaskComplete:U,onSetTaskFilter:ie,onSetTaskSort:ke,onSetTaskSearch:J,onCreateTask:O,workspaceNames:g,onStartTask:Oe,editingTaskId:d,onEditTask:vn,onUpdateTask:X})}
              </div>
            `}
    </div>
  `}function d0(e){const{tasks:t,taskFilter:n,taskSort:s="due",taskSearch:a="",onToggleTaskComplete:i,onSetTaskFilter:o,onSetTaskSort:l,onSetTaskSearch:c,onCreateTask:u,workspaceNames:p=[],onStartTask:f,editingTaskId:m,onEditTask:w,onUpdateTask:k}=e;if(t.length===0&&!u)return r``;let d;if(n==="outstanding")d=t.filter($=>$.status==="pending");else if(n==="today"){const $=ce();d=t.filter(A=>A.status==="pending"&&A.dueDate!=null&&A.dueDate<=$)}else n==="complete"?d=t.filter($=>$.status==="complete"):d=t;if(a){const $=a.toLowerCase();d=d.filter(A=>A.title.toLowerCase().includes($)||A.project?.toLowerCase().includes($))}const g=Js(d,s);return r`
  ...
  `}function g0(e){const t=Js(e.todayTasks??[],"due"),n=t.filter(a=>a.status==="pending"),s=t.filter(a=>a.status==="complete");return r`
  ...
  `}const pt="__defaults__",sc=[{value:"deny",label:"Deny"},{value:"allowlist",label:"Allowlist"},{value:"full",label:"Full"}],A0=[{value:"off",label:"Off"},{value:"on-miss",label:"On miss"},{value:"always",label:"Always"}];function x0(e){const t=e.configForm,n=U0(e.nodes),{defaultBinding:s,agents:a}=K0(t),i=!!t,o=e.configSaving||e.configFormMode==="raw";return{ready:i,disabled:o,configDirty:e.configDirty,configLoading:e.configLoading,configSaving:e.configSaving,defaultBinding:s,agents:a,nodes:n,onBindDefault:e.onBindDefault,onBindAgent:e.onBindAgent,onSave:e.onSaveBindings,onLoadConfig:e.onLoadConfig,formMode:e.configFormMode}}function ac(e){return e==="allowlist"||e==="full"||e==="deny"?e:"deny"}function T0(e){return e==="always"||e==="off"||e==="on-miss"?e:"on-miss"}function _0(e){const t=e?.defaults??{};return{security:ac(t.security),ask:T0(t.ask),askFallback:ac(t.askFallback??"deny"),autoAllowSkills:!!(t.autoAllowSkills??!1)}}function C0(e){const t=e?.agents??{},n=Array.isArray(t.list)?t.list:[],s=[];return n.forEach(a=>{if(!a||typeof a!="object")return;const i=a,o=typeof i.id=="string"?i.id.trim():"";if(!o)return;const l=typeof i.name=="string"?i.name.trim():void 0,c=i.default===!0;s.push({id:o,name:l||void 0,isDefault:c})}),s}function R0(e,t){const n=C0(e),s=Object.keys(t?.agents??{}),a=new Map;n.forEach(o=>a.set(o.id,o)),s.forEach(o=>{a.has(o)||a.set(o,{id:o})});const i=Array.from(a.values());return i.length===0&&i.push({id:"main",isDefault:!0}),i.sort((o,l)=>{if(o.isDefault&&!l.isDefault)return-1;if(!o.isDefault&&l.isDefault)return 1;const c=o.name?.trim()?o.name:o.id,u=l.name?.trim()?l.name:l.id;return c.localeCompare(u)}),i}function E0(e,t){return e===pt?pt:e&&t.some(n=>n.id===e)?e:pt}function P0(e){const t=e.execApprovalsForm??e.execApprovalsSnapshot?.file??null,n=!!t,s=_0(t),a=R0(e.configForm,t),i=z0(e.nodes),o=e.execApprovalsTarget;let l=o==="node"&&e.execApprovalsTargetNodeId?e.execApprovalsTargetNodeId:null;o==="node"&&l&&!i.some(f=>f.id===l)&&(l=null);const c=E0(e.execApprovalsSelectedAgent,a),u=c!==pt?(t?.agents??{})[c]??null:null,p=Array.isArray(u?.allowlist)?u.allowlist??[]:[];return{ready:n,disabled:e.execApprovalsSaving||e.execApprovalsLoading,dirty:e.execApprovalsDirty,loading:e.execApprovalsLoading,saving:e.execApprovalsSaving,form:t,defaults:s,selectedScope:c,selectedAgent:u,agents:a,allowlist:p,target:o,targetNodeId:l,targetNodes:i,onSelectScope:e.onExecApprovalsSelectAgent,onSelectTarget:e.onExecApprovalsTargetChange,onPatch:e.onExecApprovalsPatch,onRemove:e.onExecApprovalsRemove,onLoad:e.onLoadExecApprovals,onSave:e.onSaveExecApprovals}}function L0(e){const t=e.nodes.length>0,n=e.defaultBinding??"";return r`
    <section class="card">
  ...
  `}function N0(e,t,n){const s=t.lastUsedAt?K(t.lastUsedAt):"never",a=t.lastUsedCommand?Zn(t.lastUsedCommand,120):null,i=t.lastResolvedPath?Zn(t.lastResolvedPath,120):null;return r`
    <div class="list-item">
      <div class="list-main">
  ...
  `}function iS(e,t,n,s,a,i){const o=e.updatedAt?K(e.updatedAt):"n/a",l=e.thinkingLevel??"",c=vp(e.modelProvider),u=J0(l,c),p=Y0(e.modelProvider),f=e.verboseLevel??"",m=e.reasoningLevel??"",w=e.displayName??e.key,k=e.kind!=="global",d=k?`${Gi("chat",t)}?session=${encodeURIComponent(e.key)}`:null;return r`
    <div class="table-row">
      <div class="mono">${k?r`<a href=${d} class="session-link">${w}</a>`:w}</div>
      <div>
        <input
          .value=${e.label??""}
          ?disabled=${i}
      ...
      <div>
        <select
          .value=${u}
          ?disabled=${i}
          @change=${g=>{const $=g.target.value;n(e.key,{thinkingLevel:X0($,c)})}}
        >
...
`).find(i=>i.trim().length>0)??"",a=!!e.schedule;return r`
    ...
    >
      <div class="list-main">
        ...
        <div class="list-sub" style="margin-left: 18px;">${Zn(s,120)}</div>
  ...
  `}function hS(e,t){const n=t.busyKey===e.skillKey,s=t.edits[e.skillKey]??"",a=t.messages[e.skillKey]??null,i=e.install.length>0&&e.missing.bins.length>0,o=[...e.missing.bins.map(c=>`bin:${c}`),...e.missing.env.map(c=>`env:${c}`),...e.missing.config.map(c=>`config:${c}`),...e.missing.os.map(c=>`os:${c}`)],l=[];return e.disabled&&l.push("disabled"),e.blockedByAllowlist&&l.push("blocked by allowlist"),r`
    <div class="list-item">
      <div class="list-main">
        ...
        <div class="list-sub">${Zn(e.description,140)}</div>
        <div class="chip-row" style="margin-top: 6px;">
    ...
    <section class="card">
      ...
      ${a.map(i=>{const o=s.get(i),l=i==="_default"?"General":yp(i);return r`
          <div style="margin-top: 20px;">
            ...
            <div class="list">
              ${o.map(c=>mS(c,e.expandedAgents.has(c.slug),e.onToggleExpand))}
            </div>
          </div>
        `})}
    </section>
  `}function yp(e){return e.replace(/[-_]/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function mS(e,t,n){return r`
    ...
    >
      <div class="list-main">
        ...
        ${e.mission?r`<div class="list-sub" style="margin-left: 18px;">${Zn(e.mission,120)}</div>`:h}
        <div class="chip-row" style="margin-top: 6px; margin-left: 18px;">
  ...
  `}function YS(e,t){const s=Math.min(100,Math.max(0,(e??t)/10*100)),a=mn(e??(t>0?t:null));return r`
    <div class="trust-progress">
      <div
        class="trust-progress-fill ${us(a)}"
        style="width: ${s}%"
      ></div>
    </div>
  `}function JS(e,t){const s=e.trustScore!==null?e.trustScore.toFixed(1):e.avgRating>0?e.avgRating.toFixed(1):"--",a=mn(e.trustScore??(e.avgRating>0?e.avgRating:null)),i=e.count<10?10-e.count:0;return r`
    <div class="trust-card">
      ...
      <div class="trust-card-score-row">
        <span class="trust-card-score ${us(a)}">${s}</span>
  ...
  `}function XS(){return[{workflow:"Code Reviews",avgRating:8.2,count:14,trustScore:8.2,needsFeedback:!1,trend:"improving",recentNotes:[],recentFeedback:[]},{workflow:"Email Drafts",avgRating:6.5,count:11,trustScore:6.5,needsFeedback:!0,trend:"stable",recentNotes:[],recentFeedback:["Be more concise","Match my tone"]},{workflow:"Research",avgRating:7.8,count:3,trustScore:null,needsFeedback:!1,trend:"new",recentNotes:[],recentFeedback:[]}]}function ZS(){const e=XS();return{workflows:e.map(t=>t.workflow),summaries:e,ratings:[],total:0,overallScore:7.6,totalRatings:28,totalUses:28}}function e1(e){const t=mn(e.rating);return r`
    <div class="trust-rating-row">
      <span class="trust-rating-score ${us(t)}">${e.rating}</span>
  ...
  `}function i1(e){const t=e.data,n=t?.todayRating??null,s=t?.recentDaily??[],a=t?.dailyStreak??0,i=t?.dailyAverage??null;if(!e.onDailyRate)return h;if(n){const o=mn(n.rating),l=n.rating<7&&!n.note;return r`
      <div class="trust-daily">
        ...
        <div class="trust-daily-result">
          <div class="trust-daily-result-score ${us(o)}">
  ...
  `}function u1(e){const{connected:t,loading:n,data:s,onRemoveWorkflow:a,onRefresh:i}=e;if(!t)return r`
    ...
    `;const l=!(s?.summaries??[]).some(f=>f.count>0),c=l?ZS():s,u=c.summaries,p=l?[]:s?.ratings??[];return r`
    <section class="tab-body trust-section">
      ${s1(e)}
  ...
  `}function y1(e){const{connected:t,loading:n,data:s,onToggle:a,onThresholdChange:i,onCustomToggle:o,onCustomDelete:l,onToggleAddForm:c,onOpenAllyChat:u}=e;if(!t)return r`
    ...
    `;const p=s?.gates??[],f=s?.activity??[],m=s?.custom??[],w=p.filter(g=>g.enabled).length,k=m.filter(g=>g.enabled).length,d=[`${w}/${p.length} gates active`];return m.length>0&&d.push(`${k} custom rule${m.length===1?"":"s"}`),r`
    <section class="tab-body guardrails-section">
  ...
  `}function j1(e,t,n){const{state:s,onAssignLane:a,onSendInLane:i}=n,o=s.sessionsResult?.sessions??[],l=Te(o,t),c=l?.key??t,u=s.workingSessions.has(t)||s.workingSessions.has(c),p=z1(l,t),f=Ks.get(t)??Ks.get(c),m=l?.model??"",w=l?.totalTokens??0,k=s.settings.tabLastViewed[c]??s.settings.tabLastViewed[t]??0,d=l?.updatedAt??0,g=!u&&d>k,A=t===s.sessionKey?s.chatMessages:We.get(t)??We.get(c)??[],T=x=>{x instanceof HTMLElement&&x.dispatchEvent(new CustomEvent("lane-viewed",{detail:{sessionKey:c},bubbles:!0,composed:!0}))};return r`
    <div
  ...
  `}function a2(e){const{resources:t=[],resourcesLoading:n,resourceFilter:s="all",onResourceFilterChange:a,onResourceClick:i,onResourcePin:o,onResourceDelete:l}=e,c=n2(t,s);return c.sort((u,p)=>u.pinned!==p.pinned?u.pinned?-1:1:p.createdAt.localeCompare(u.createdAt)),r`
  ...
  `}function i2(e){const{projects:t,loading:n,error:s,expandedProjects:a=new Set,projectFiles:i={},detailLoading:o=new Set,onRefresh:l,onToggleProject:c,onPersonClick:u,onFileClick:p,onSkillClick:f}=e;if(n)return r`
      <div class="my-day-container">
        <div class="my-day-loading">
          <div class="spinner"></div>
      ...
      <div class="work-workspaces-section">
        ...
        <div class="my-day-grid" style="grid-template-columns: 1fr;">
          ${m.length===0&&w.length===0?r`
                ...
                `:h}
          ${m.map(k=>X1(k,a.has(k.id),i[k.id]??[],o.has(k.id),()=>c?.(k.id),u,p,f))}
          ${w.length>0?r`
  ...
  `}function r2(e){const{memoryBank:t,selectedEntry:n,searchQuery:s,browsingFolder:a,folderEntries:i,folderName:o}=e;if(n)return r`
    ...
    `;if(!t)return ya("No memory bank files found","Start building your memory bank by telling your ally about the people, companies, and projects in your life.");const l=(s??"").toLowerCase().trim(),c=u=>l?u.filter(p=>p.name.toLowerCase().includes(l)||p.excerpt.toLowerCase().includes(l)):u;return r`
    <div class="second-brain-panel">
  ...
  `}const gc={connected:{dot:"●",label:"Connected",cls:"second-brain-source--connected"},available:{dot:"○",label:"Available",cls:"second-brain-source--available"}};function c2(e){const{sourcesData:t}=e;if(!t||t.sources.length===0)return ya("No sources detected","Connect data sources to build your context universe.");const n=t.sources.filter(a=>a.status==="connected"),s=t.sources.filter(a=>a.status==="available");return r`
    <div class="second-brain-panel">
  ...
  `}function T2(e){const{loading:t,dashboards:n}=e,s=e.categoryFilter??"all",a=e.templates??k2,o=[...s==="all"?n??[]:(n??[]).filter(u=>Lp(u)===s)].sort((u,p)=>u.pinned&&!p.pinned?-1:!u.pinned&&p.pinned?1:new Date(p.updatedAt).getTime()-new Date(u.updatedAt).getTime()),l=s==="all"?a:a.filter(u=>u.category===s),c=(n??[]).length>0;return r`
    <section class="dashboards-container">
      ...
      ${c&&e.onCategoryFilter?x2(s,n??[],e.onCategoryFilter):h}
  ...
  `}function _2(e){return e.error?r`
	...
	`}function O2(e){let t="",n="",s="";const a=["rocket","lightning","fire","star","brain","crown","diamond","target","compass","mountain"],i={rocket:"🚀",lightning:"⚡",fire:"🔥",star:"⭐",brain:"🧠",crown:"👑",diamond:"💎",target:"🎯",compass:"🧭",mountain:"⛰️"};function o(l){l.preventDefault();const c=l.target,u=new FormData(c);t=u.get("name")?.trim()??"",n=u.get("mission")?.trim()??"",s=u.get("emoji")?.trim()||"🚀",t&&e({name:t,mission:n,emoji:s})}return r`
		<div class="onboarding-fullscreen">
  ...
  `:r`
    ...
    `}function bc(e){const{connected:t,integrations:n,coreProgress:s,expandedCard:a,activeGuide:i,loadingGuide:o,testingId:l,testResult:c,configValues:u}=e;if(!t)return r`
  ...
  `}function wc(e,t){const{expandedCard:n,activeGuide:s,loadingGuide:a,testingId:i,testResult:o,configValues:l}=t,c=n===e.id,u=e.status.working||e.status.configured,p=i===e.id,f=o?.id===e.id,m=e.id==="messaging-channel";return r`
                                  ...
                                  <div class="guide-inputs">
                                    ${s.envVars.map(w=>r`
                                        <label class="input-group">
                                          ...
                                          <input
                                            ...
                                            placeholder="${w.label}"
                                            .value=${l[w.key]??""}
                                            @input=${k=>{const d=k.target.value;t.onUpdateConfigValue(w.key,d)}}
                                          />
                                        </label>
                                      `)}
                                    <div class="guide-actions">
                                      <button
                                        ...
                                        @click=${()=>{const w={};for(const k of s.envVars){const d=l[k.key];d&&(w[k.key]=d)}t.onConfigureIntegration(e.id,w)}}
                                      >
                                        Save & Test
                                      </button>
  ...
  `:h}function Sc(e){const t=e.trim();if(!t)return t;const n=t.split(/\s+/);if(n.length>=2&&n.length%2===0){const l=n.length/2,c=n.slice(0,l).join(" "),u=n.slice(l).join(" ");if(c.toLowerCase()===u.toLowerCase())return c}const s=t.replace(/\s+/g," ").toLowerCase(),a=Math.floor(s.length/2),i=s.slice(0,a).trim(),o=s.slice(a).trim();return i&&i===o?t.slice(0,Math.ceil(t.length/2)).trim():t}function zi(e,t){const n=t?.sessionId?.trim();return n?`session:${n}`:`key:${e.trim().toLowerCase()}`}function Ac(e){if(e===Q)return!0;const t=e.toLowerCase();return!!(t==="agent:main:main"||t.endsWith(":main"))}function Y2(e){const t=e.sessionsResult?.sessions,n=[...new Set(e.settings.openTabs.map(l=>l.trim()).filter(Boolean))].filter(l=>!Ac(l)),s=Te(t,e.sessionKey),a=zi(e.sessionKey,s),i=new Map;for(const l of n){const c=Te(t,l),u=zi(l,c);if(!i.has(u)){i.set(u,l);continue}l===e.sessionKey&&i.set(u,l)}const o=[...i.values()];if(o.length===0){const l=e.sessionKey.trim()||"main";Ac(l)||o.push(l)}return{tabKeys:o,activeIdentity:a}}function J2(e){const t=e.onboardingActive&&e.onboarding,n=e.onboardingPhase??0,s=e.onboardingData;if(t&&n===0)return M2(()=>{e.handleOnboardingStart?.()},s?.assessment);if(t&&n===1)return O2(d=>{e.handleOnboardingIdentitySubmit?.(d)});if(t&&n===6)return N2(s?.summary??null,s?.identity??null,()=>{e.handleOnboardingComplete?.()});if(e.wizardActive&&e.wizardState)return $p(e.wizardState,{onStepChange:d=>{e.handleWizardStepChange?.(d)},onAnswerChange:(d,g)=>{e.handleWizardAnswerChange?.(d,g)},onPreview:()=>{e.handleWizardPreview?.()},onGenerate:()=>{e.handleWizardGenerate?.()},onClose:()=>{e.handleWizardClose?.()},onFileToggle:(d,g)=>{e.handleWizardFileToggle?.(d,g)},onConfigToggle:(d,g)=>{e.handleWizardConfigToggle?.(d,g)}});const a=e.presenceEntries.length,i=e.sessionsResult?.count??null,o=e.cronStatus?.nextWakeAtMs??null,l=e.connected?null:"Disconnected from gateway.",c=e.tab==="chat",u=c&&(e.settings.chatFocusMode||e.onboarding||t&&n>=2),p=e.onboarding?!1:e.settings.chatShowThinking,f=Q2(e),m=e.chatAvatarUrl??f??null,{tabKeys:w,activeIdentity:k}=Y2(e);return r`
    <div class="shell ${c?"shell--chat":""} ${u?"shell--chat-focus":""} ${e.settings.navCollapsed?"shell--nav-collapsed":""} ${e.onboarding?"shell--onboarding":""}">
      ...
      <aside class="nav ${e.settings.navCollapsed?"nav--collapsed":""}">
        ${jh.map(d=>{const g=e.settings.navGroupsCollapsed[d.label]??!1,$=d.tabs.some(T=>T===e.tab),A=!d.label||d.tabs.length===1&&Jn(d.tabs[0])===d.label;return r`
          ...
          `})}
        ${Vh.map(d=>{const g=e.settings.navGroupsCollapsed[d.label]??!0,$=d.tabs.some(A=>A===e.tab);return r`
          ...
          <div>
            ...
            `:e.tab==="chat"?r`
              <div class="session-tabs">
                ...
                ${ga(w,d=>d,(d,g)=>{const $=Te(e.sessionsResult?.sessions,d),A=zi(d,$)===k,x=(()=>{if($?.label||$?.displayName)return Sc($.label??$.displayName);const I=be.get(d);if(I)return Sc(I);if(d==="agent:main:support")return"Support";if(d.includes("webchat")){const N=d.match(/webchat[:-](\d+)/);return N?`Chat ${N[1]}`:"Chat"}if(d.includes("main"))return"MAIN";const M=d.split(/[:-]/);return M[M.length-1]||d})(),_=e.workingSessions.has(d),P=e.settings.tabLastViewed[d]??0,E=$?.updatedAt??0,Z=!A&&!_&&E>P,Y=e.editingTabKey===d;return r`
                      <div
                        ...
                        @click=${()=>{if(!Y){if(A){e.applySettings({...e.settings,tabLastViewed:{...e.settings.tabLastViewed,[d]:Date.now()}});return}$e(e),e.sessionKey=d,Le(e,d),e.chatLoading=!0,e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.resetToolStream(),e.resetChatScroll(),e.applySettings({...e.settings,sessionKey:d,lastActiveSessionKey:d,tabLastViewed:{...e.settings.tabLastViewed,[d]:Date.now()}}),e.loadAssistantIdentity(),ye(e,d,!0),se(e),e.loadSessionResources(),te(e)}}}
                      ...
                      >
                        ...
                        `:(()=>{let I=null;return r`
                          <span
                            ...
                            draggable="false"
                            @click=${M=>{M.stopPropagation(),I&&clearTimeout(I),I=setTimeout(()=>{I=null,e.editingTabKey!==d&&(d===e.sessionKey?e.applySettings({...e.settings,tabLastViewed:{...e.settings.tabLastViewed,[d]:Date.now()}}):($e(e),e.sessionKey=d,e.chatPrivateMode=!!e.privateSessions?.has(d),Le(e,d),e.chatLoading=!0,e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.resetToolStream(),e.resetChatScroll(),e.applySettings({...e.settings,sessionKey:d,lastActiveSessionKey:d,tabLastViewed:{...e.settings.tabLastViewed,[d]:Date.now()}}),e.loadAssistantIdentity(),ye(e,d,!0),se(e),e.loadSessionResources(),te(e)))},250)}}
                            @dblclick=${M=>{M.preventDefault(),M.stopPropagation(),I&&(clearTimeout(I),I=null),e.editingTabKey=d;const N=M.target.closest(".session-tab"),U=O=>{const ie=O.target;N&&!N.contains(ie)&&(e.editingTabKey=null,document.removeEventListener("mousedown",U,!0))};document.addEventListener("mousedown",U,!0),requestAnimationFrame(()=>{requestAnimationFrame(()=>{const O=N?.querySelector(".session-tab__name-input");O&&(O.focus(),O.select())})})}}
                          >${x}</span>
                        `})()}
                        ${e.privateSessions?.has(d)?(()=>{const I=e.privateSessions.get(d),M=Math.max(0,I-Date.now()),N=Math.floor(M/36e5),U=Math.floor(M%36e5/6e4),O=N>0?`${N}h ${U}m`:`${U}m`;return r`
                        ...
                        ${r`
                          <button
                            ...
                            @click=${I=>{if(I.stopPropagation(),e.privateSessions?.has(d)){e._destroyPrivateSession(d);return}const M=e.settings.openTabs.filter(O=>O!==d),N=d===e.sessionKey,U=M[0]||Q;e.applySettings({...e.settings,openTabs:M,...N?{sessionKey:U,lastActiveSessionKey:U}:{}}),N&&(e.sessionKey=U,e.sessionResources=[],ye(e,U,!0),se(e),e.loadSessionResources())}}
...
4. Ask me for an overall GodMode score (1-10) for today and any feedback. Submit it with the daily rating tool.`)}}):h}
        ...
        ${e.tab==="sessions"?sS({loading:e.sessionsLoading,result:e.sessionsResult,error:e.sessionsError,activeMinutes:e.sessionsFilterActive,limit:e.sessionsFilterLimit,includeGlobal:e.sessionsIncludeGlobal,includeUnknown:e.sessionsIncludeUnknown,basePath:e.basePath,archivedSessions:e.archivedSessions,archivedSessionsLoading:e.archivedSessionsLoading,archivedSessionsExpanded:e.archivedSessionsExpanded,onFiltersChange:d=>{e.sessionsFilterActive=d.activeMinutes,e.sessionsFilterLimit=d.limit,e.sessionsIncludeGlobal=d.includeGlobal,e.sessionsIncludeUnknown=d.includeUnknown},onRefresh:()=>{te(e),Ft(e)},onPatch:async(d,g)=>{const $=await Ps(e,d,g);if($.ok&&$.canonicalKey!==d&&e.settings.openTabs.includes(d)){const A=e.settings.openTabs.map(x=>x===d?$.canonicalKey:x),T=d===e.sessionKey;e.applySettings({...e.settings,openTabs:A,tabLastViewed:{...e.settings.tabLastViewed,[$.canonicalKey]:e.settings.tabLastViewed[d]??Date.now()},...T?{sessionKey:$.canonicalKey,lastActiveSessionKey:$.canonicalKey}:{}}),T&&(e.sessionKey=$.canonicalKey,ye(e,$.canonicalKey,!0))}},onDelete:d=>Xd(e,d),onArchive:d=>Zd(e,d),onUnarchive:d=>eu(e,d),onToggleArchived:()=>{e.archivedSessionsExpanded=!e.archivedSessionsExpanded,e.archivedSessionsExpanded&&e.archivedSessions.length===0&&Ft(e)},onAutoArchive:()=>tu(e)}):h}

        ${e.tab==="cron"?A$({loading:e.cronLoading,status:e.cronStatus,jobs:e.cronJobs,error:e.cronError,busy:e.cronBusy,form:e.cronForm,channels:e.channelsSnapshot?.channelMeta?.length?e.channelsSnapshot.channelMeta.map(d=>d.id):e.channelsSnapshot?.channelOrder??[],channelLabels:e.channelsSnapshot?.channelLabels??{},channelMeta:e.channelsSnapshot?.channelMeta??[],runsJobId:e.cronRunsJobId,runs:e.cronRuns,onFormChange:d=>e.cronForm={...e.cronForm,...d},onRefresh:()=>e.loadCron(),onAdd:()=>zy(e),onToggle:(d,g)=>Ky(e,d,g),onRun:d=>Wy(e,d),onRemove:d=>qy(e,d),onLoadRuns:d=>vu(e,d)}):h}

        ${e.tab==="skills"?lS({loading:e.skillsLoading,report:e.skillsReport,error:e.skillsError,filter:e.skillsFilter,edits:e.skillEdits,messages:e.skillMessages,busyKey:e.skillsBusyKey,subTab:e.skillsSubTab,godmodeSkills:e.godmodeSkills??null,godmodeSkillsLoading:e.godmodeSkillsLoading??!1,expandedSkills:e.expandedSkills??new Set,onFilterChange:d=>e.skillsFilter=d,onRefresh:()=>{rs(e,{clearMessages:!0}),Li(e)},onToggle:(d,g)=>ub(e,d,g),onEdit:(d,g)=>db(e,d,g),onSaveKey:d=>pb(e,d),onInstall:(d,g,$)=>hb(e,d,g,$),onSubTabChange:d=>{e.skillsSubTab=d,d==="godmode"&&!e.godmodeSkills&&Li(e),d==="clawhub"&&e.clawhubExploreItems},onToggleExpand:d=>{const g=new Set(e.expandedSkills);g.has(d)?g.delete(d):g.add(d),e.expandedSkills=g},clawhub:{loading:e.clawhubLoading,error:e.clawhubError,query:e.clawhubQuery,results:e.clawhubResults,exploreItems:e.clawhubExploreItems,exploreSort:e.clawhubExploreSort,detailSlug:e.clawhubDetailSlug,detail:e.clawhubDetail,importing:e.clawhubImporting,message:e.clawhubMessage,onSearch:d=>{e.clawhubQuery=d},onExplore:d=>void 0,onDetail:d=>void 0,onCloseDetail:()=>void 0,onImport:d=>Tl(),onImportAndPersonalize:async d=>{if(!await Tl())return;const $=await ww();$&&(Fo(e,"chat"),ma(e),e.chatMessage=$)}}}):h}

        ${e.tab==="agents"?gS({loading:e.rosterLoading,error:e.rosterError,roster:e.rosterData??[],filter:e.rosterFilter??"",expandedAgents:e.expandedAgents??new Set,onFilterChange:d=>e.rosterFilter=d,onRefresh:()=>xd(e),onToggleExpand:d=>{const g=new Set(e.expandedAgents);g.has(d)?g.delete(d):g.add(d),e.expandedAgents=g}}):h}

        ${e.tab==="nodes"?b0({loading:e.nodesLoading,nodes:e.nodes,devicesLoading:e.devicesLoading,devicesError:e.devicesError,devicesList:e.devicesList,configForm:e.configForm??e.configSnapshot?.config,configLoading:e.configLoading,configSaving:e.configSaving,configDirty:e.configFormDirty,configFormMode:e.configFormMode,execApprovalsLoading:e.execApprovalsLoading,execApprovalsSaving:e.execApprovalsSaving,execApprovalsDirty:e.execApprovalsDirty,execApprovalsSnapshot:e.execApprovalsSnapshot,execApprovalsForm:e.execApprovalsForm,execApprovalsSelectedAgent:e.execApprovalsSelectedAgent,execApprovalsTarget:e.execApprovalsTarget,execApprovalsTargetNodeId:e.execApprovalsTargetNodeId,onRefresh:()=>ra(e),onDevicesRefresh:()=>gt(e),onDeviceApprove:d=>Tv(e,d),onDeviceReject:d=>_v(e,d),onDeviceRotate:(d,g,$)=>Cv(e,{deviceId:d,role:g,scopes:$}),onDeviceRevoke:(d,g)=>Rv(e,{deviceId:d,role:g}),onLoadConfig:()=>Xe(e),onLoadExecApprovals:()=>{const d=e.execApprovalsTarget==="node"&&e.execApprovalsTargetNodeId?{kind:"node",nodeId:e.execApprovalsTargetNodeId}:{kind:"gateway"};return Lo(e,d)},onBindDefault:d=>{d?tn(e,["tools","exec","node"],d):xr(e,["tools","exec","node"])},onBindAgent:(d,g)=>{const $=["agents","list",d,"tools","exec","node"];g?tn(e,$,g):xr(e,$)},onSaveBindings:()=>Os(e),onExecApprovalsTargetChange:(d,g)=>{e.execApprovalsTarget=d,e.execApprovalsTargetNodeId=g,e.execApprovalsSnapshot=null,e.execApprovalsForm=null,e.execApprovalsDirty=!1,e.execApprovalsSelectedAgent=null},onExecApprovalsSelectAgent:d=>{e.execApprovalsSelectedAgent=d},onExecApprovalsPatch:(d,g)=>eb(e,d,g),onExecApprovalsRemove:d=>tb(e,d),onSaveExecApprovals:()=>{const d=e.execApprovalsTarget==="node"&&e.execApprovalsTargetNodeId?{kind:"node",nodeId:e.execApprovalsTargetNodeId}:{kind:"gateway"};return Zy(e,d)}}):h}
        ...
        ${e.tab==="chat"&&e.settings.chatParallelView?V1({state:e,onAssignLane:(d,g)=>{const $=g?Te(e.sessionsResult?.sessions,g)?.key??g:null,A=[...e.settings.parallelLanes];A[d]=$,e.applySettings({...e.settings,parallelLanes:A}),$&&e.client&&fo(e.client,$).then(()=>{e.applySettings({...e.settings})})},onReorderLanes:(d,g)=>{if(d===g||d<0||g<0||d>=e.settings.parallelLanes.length||g>=e.settings.parallelLanes.length)return;const $=[...e.settings.parallelLanes],[A]=$.splice(d,1);$.splice(g,0,A),e.applySettings({...e.settings,parallelLanes:$})},onLaneViewed:d=>{const g=Te(e.sessionsResult?.sessions,d)?.key??d,$=Date.now(),T=Te(e.sessionsResult?.sessions,g)?.updatedAt??0,x=Math.max(e.settings.tabLastViewed[d]??0,e.settings.tabLastViewed[g]??0);T>0&&x>=T||e.applySettings({...e.settings,tabLastViewed:{...e.settings.tabLastViewed,[d]:$,[g]:$}})},onSendInLane:(d,g)=>{d!==e.sessionKey?($e(e),e.sessionKey=d,Le(e,d),e.chatLoading=!0,e.chatMessages=[],e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.resetToolStream(),e.applySettings({...e.settings,sessionKey:d,lastActiveSessionKey:d}),e.loadAssistantIdentity(),ye(e,d,!0),se(e).then(()=>{e.loadSessionResources(),e.chatMessage=g,e.handleSendChat(g)})):(e.chatMessage=g,e.handleSendChat(g))}}):h}

        ${e.tab==="chat"&&!e.settings.chatParallelView?t$({basePath:e.basePath,sessionKey:e.sessionKey,onSessionKeyChange:d=>{$e(e),e.sessionKey=d,Le(e,d),e.chatLoading=!0,e.chatMessages=[],e.chatAttachments=[],e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.chatQueue=[],e.resetToolStream(),e.resetChatScroll(),e.applySettings({...e.settings,sessionKey:d,lastActiveSessionKey:d}),e.loadAssistantIdentity(),se(e),Qs(e),e.loadSessionResources(),Vs(e)},thinkingLevel:e.chatThinkingLevel,showThinking:p,loading:e.chatLoading,sending:e.chatSending,sendingSessionKey:e.chatSendingSessionKey,compactionStatus:e.compactionStatus,assistantAvatarUrl:m,messages:e.chatMessages,toolMessages:e.chatToolMessages,stream:e.chatStream,streamStartedAt:e.chatStreamStartedAt,draft:e.chatMessage,queue:e.chatQueue,connected:e.connected,canSend:e.connected,disabledReason:l,error:e.lastError,sessions:e.sessionsResult,focusMode:u,onRefresh:()=>(e.resetToolStream(),e.loadSessionResources(),Vs(e),Promise.all([se(e),Qs(e)])),onToggleFocusMode:()=>{e.onboarding||e.applySettings({...e.settings,chatFocusMode:!e.settings.chatFocusMode})},onChatScroll:d=>e.handleChatScroll(d),onDraftChange:d=>e.chatMessage=d,attachments:e.chatAttachments,onAttachmentsChange:d=>e.chatAttachments=d,showToast:(d,g)=>e.showToast(d,g),onSend:d=>e.handleSendChat(void 0,{queue:d}),canAbort:!!e.chatRunId,onAbort:()=>{e.handleAbortChat()},onCompact:()=>{e.handleCompactChat()},pendingRetry:e.pendingRetry,onRetry:()=>{e.handleRetryMessage()},onClearRetry:()=>e.handleClearRetry(),onQueueRemove:d=>e.removeQueuedMessage(d),onNewSession:()=>e.handleSendChat("/new",{restoreDraft:!0}),onConsciousnessFlush:()=>{e.handleConsciousnessFlush()},consciousnessStatus:e.consciousnessStatus,sidebarOpen:e.sidebarOpen,sidebarContent:e.sidebarContent,sidebarError:e.sidebarError,sidebarMimeType:e.sidebarMimeType,sidebarFilePath:e.sidebarFilePath,sidebarTitle:e.sidebarTitle,sidebarMode:e.sidebarMode,sidebarProofSlug:e.sidebarProofSlug,sidebarProofUrl:e.sidebarProofUrl,sidebarProofHtml:e.sidebarProofHtml,splitRatio:e.splitRatio,onOpenSidebar:(d,g)=>e.handleOpenSidebar(d,g),onMessageLinkClick:d=>e.handleOpenMessageFileLink(d),onCloseSidebar:()=>e.handleCloseSidebar(),onOpenProof:d=>{e.handleOpenProofDoc(d)},onOpenFile:d=>e.handleOpenFile(d),onSplitRatioChange:d=>e.handleSplitRatioChange(d),onPushToDrive:(d,g)=>e.handlePushToDrive(d,g),driveAccounts:e.driveAccounts,showDrivePicker:e.showDrivePicker,driveUploading:e.driveUploading,onToggleDrivePicker:()=>e.handleToggleDrivePicker(),onImageClick:(d,g,$)=>e.handleImageClick(d,g,$),resolveImageUrl:(d,g)=>Zv(e.sessionKey,d,g),assistantName:e.assistantName,assistantAvatar:e.assistantAvatar,userName:e.userName,userAvatar:e.userAvatar,currentToolName:e.currentToolName,currentToolInfo:e.currentToolInfo,privateMode:e.chatPrivateMode,onTogglePrivateMode:()=>e.handlePrivateModeToggle(),isWorking:e.workingSessions.has(e.sessionKey),showScrollButton:!e.chatUserNearBottom,showNewMessages:e.chatNewMessagesBelow,onScrollToBottom:()=>{const d=document.querySelector(".chat-thread");d&&(d.scrollTo({top:d.scrollHeight,behavior:"smooth"}),e.chatUserNearBottom=!0,e.chatNewMessagesBelow=!1)},allyPanelOpen:e.allyPanelOpen??!1,allyProps:e.allyPanelOpen?{allyName:e.assistantName,allyAvatar:e.assistantAvatar??null,open:!0,messages:e.allyMessages??[],stream:e.allyStream??null,draft:e.allyDraft??"",sending:e.allySending??!1,isWorking:e.allyWorking??!1,unreadCount:0,connected:e.connected,compact:!0,attachments:e.allyAttachments??[],onToggle:()=>e.handleAllyToggle(),onDraftChange:d=>e.handleAllyDraftChange(d),onSend:()=>e.handleAllySend(),onOpenFullChat:()=>e.handleAllyOpenFull(),onAttachmentsChange:d=>e.handleAllyAttachmentsChange(d),onAction:(d,g,$,A)=>e.handleAllyAction(d,g,$,A)}:null,sessionResources:e.sessionResources,sessionResourcesCollapsed:e.sessionResourcesCollapsed,onToggleSessionResources:()=>e.handleToggleSessionResources(),onSessionResourceClick:d=>e.handleSessionResourceClick(d),onViewAllResources:()=>e.handleViewAllResources()}):h}

        ${e.tab==="options"?CS({connected:e.connected,loading:e.godmodeOptionsLoading,options:e.godmodeOptions,onToggle:(d,g)=>e.handleOptionToggle(d,g),onOpenWizard:e.handleWizardOpen?()=>e.handleWizardOpen?.():void 0}):h}

        ${e.tab==="guardrails"?y1({connected:e.connected,loading:e.guardrailsLoading,data:e.guardrailsData,showAddForm:e.guardrailsShowAddForm,onToggle:(d,g)=>e.handleGuardrailToggle(d,g),onThresholdChange:(d,g,$)=>e.handleGuardrailThresholdChange(d,g,$),onCustomToggle:(d,g)=>e.handleCustomGuardrailToggle(d,g),onCustomDelete:d=>e.handleCustomGuardrailDelete(d),onToggleAddForm:()=>e.handleToggleGuardrailAddForm(),onOpenAllyChat:d=>{e.handleAllyToggle(),d&&e.handleAllyDraftChange(d)}}):h}

        ${e.tab==="mission-control"?U1({connected:e.connected,loading:e.missionControlLoading,error:e.missionControlError,data:e.missionControlData??null,fullControl:e.missionControlFullControl,onToggleFullControl:()=>e.handleMissionControlToggleFullControl(),onRefresh:()=>e.handleMissionControlRefresh(),onCancelTask:d=>e.handleMissionControlCancelTask(d),onApproveItem:d=>e.handleMissionControlApproveItem(d),onRetryItem:d=>e.handleMissionControlRetryItem(d),onViewDetail:d=>e.handleMissionControlViewDetail(d),onOpenSession:d=>e.handleMissionControlOpenSession(d),onOpenTaskSession:d=>e.handleMissionControlOpenTaskSession(d),onStartQueueItem:d=>e.handleMissionControlStartQueueItem(d),onViewTaskFiles:d=>e.handleMissionControlViewTaskFiles(d),onSelectSwarmProject:d=>e.handleSwarmSelectProject(d),onSteerSwarmAgent:(d,g,$)=>e.handleSwarmSteer(d,g,$),onViewProofDoc:d=>e.handleSwarmViewProofDoc(d),onAskAlly:()=>{e.handleAllyToggle(),e.handleAllyDraftChange("What should I focus on next?")},allyName:e.assistantName}):h}

        ${e.tab==="trust"?u1({connected:e.connected,loading:e.trustTrackerLoading,data:e.trustTrackerData,onAddWorkflow:d=>e.handleTrustAddWorkflow(d),onRemoveWorkflow:d=>e.handleTrustRemoveWorkflow(d),onRefresh:()=>e.handleTrustLoad(),guardrailsData:e.guardrailsData,consciousnessStatus:e.consciousnessStatus,sessionsCount:i,gatewayUptimeMs:e.hello?.snapshot?.uptimeMs??null,onDailyRate:(d,g)=>e.handleDailyRate(d,g),updateStatus:e.updateStatus?{openclawUpdateAvailable:e.updateStatus.openclawUpdateAvailable,pluginUpdateAvailable:e.updateStatus.pluginUpdateAvailable,openclawVersion:e.updateStatus.openclawVersion,pluginVersion:e.updateStatus.pluginVersion,openclawLatest:e.updateStatus.openclawLatest,pluginLatest:e.updateStatus.pluginLatest}:null}):h}
        ...
        ${e.tab==="config"?f$({raw:e.configRaw,originalRaw:e.configRawOriginal,valid:e.configValid,issues:e.configIssues,loading:e.configLoading,saving:e.configSaving,applying:e.configApplying,updating:e.updateRunning,connected:e.connected,schema:e.configSchema,schemaLoading:e.configSchemaLoading,uiHints:e.configUiHints,formMode:e.configFormMode,formValue:e.configForm,originalValue:e.configFormOriginal,searchQuery:e.configSearchQuery,activeSection:e.configActiveSection,activeSubsection:e.configActiveSubsection,onRawChange:d=>{e.configRaw=d},onFormModeChange:d=>e.configFormMode=d,onFormPatch:(d,g)=>tn(e,d,g),onSearchChange:d=>e.configSearchQuery=d,onSectionChange:d=>{e.configActiveSection=d,e.configActiveSubsection=null},onSubsectionChange:d=>e.configActiveSubsection=d,onReload:()=>Xe(e),onSave:()=>Os(e),onApply:()=>$h(e),onUpdate:()=>Ar(e),userName:e.userName||"",userAvatar:e.userAvatar,onUserProfileUpdate:(d,g)=>e.handleUpdateUserProfile(d,g),onModelSwitch:(d,g)=>Ah(e,d,g)}):h}

        ${e.tab==="debug"?C$({loading:e.debugLoading,status:e.debugStatus,health:e.debugHealth,models:e.debugModels,heartbeat:e.debugHeartbeat,eventLog:e.eventLog,callMethod:e.debugCallMethod,callParams:e.debugCallParams,callResult:e.debugCallResult,callError:e.debugCallError,onCallMethodChange:d=>e.debugCallMethod=d,onCallParamsChange:d=>e.debugCallParams=d,onRefresh:()=>la(e),onCall:()=>ky(e)}):h}

        ${e.tab==="logs"?F$({loading:e.logsLoading,error:e.logsError,file:e.logsFile,entries:e.logsEntries,filterText:e.logsFilterText,levelFilters:e.logsLevelFilters,autoFollow:e.logsAutoFollow,truncated:e.logsTruncated,onFilterTextChange:d=>e.logsFilterText=d,onLevelToggle:(d,g)=>{e.logsLevelFilters={...e.logsLevelFilters,[d]:g}},onToggleAutoFollow:d=>e.logsAutoFollow=d,onRefresh:()=>Ao(e,{reset:!0}),onExport:(d,g)=>e.exportLogs(d,g),onScroll:d=>e.handleLogsScroll(d)}):h}
      </main>
      ${e.tab!=="chat"?Iw({allyName:e.assistantName,allyAvatar:e.assistantAvatar??null,open:e.allyPanelOpen??!1,messages:e.allyMessages??[],stream:e.allyStream??null,draft:e.allyDraft??"",sending:e.allySending??!1,isWorking:e.allyWorking??!1,unreadCount:e.allyUnread??0,connected:e.connected,compact:!1,attachments:e.allyAttachments??[],onToggle:()=>e.handleAllyToggle(),onDraftChange:d=>e.handleAllyDraftChange(d),onSend:()=>e.handleAllySend(),onOpenFullChat:()=>e.handleAllyOpenFull(),onAttachmentsChange:d=>e.handleAllyAttachmentsChange(d),onAction:(d,g,$,A)=>e.handleAllyAction(d,g,$,A)}):h}
      ${E$(e)}
      ${P$(e)}
      ${L$(e)}
