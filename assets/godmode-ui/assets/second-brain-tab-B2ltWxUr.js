import{b as s,A as c,o as x,d as C,g as E,r as l,t as _}from"./lit-core-CTInmNPB.js";import{a as $,o as A}from"./index-bTHFA6ns.js";import{a as T}from"./views-settings-COCxblgi.js";import{f as D}from"./ctrl-settings-CzLVBbt9.js";import{loadSecondBrain as R,loadSecondBrainEntry as L,browseFolder as N,syncSecondBrain as P}from"./second-brain-cP3vM8ym.js";import"./markdown-i_gIkIP3.js";function p(e){if(!e)return"";try{return D(new Date(e).getTime())}catch{return""}}function m(e){return s`<div class="second-brain-md-body">${x(T(e))}</div>`}function H(e){const{identity:n}=e;return!n||n.files.length===0?s`
