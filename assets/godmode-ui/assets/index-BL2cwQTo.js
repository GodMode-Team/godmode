...
`)?"":`
`)+a.raw,o.text+=`
`+a.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=o.text):n.push(a);continue}if(t){let o="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(o);break}else throw new Error(o)}}return this.state.top=!0,n}inline(t,n=[]){return this.inlineQueue.push({src:t,tokens:n}),n}inlineTokens(t,n=[]){let s=t,a=null;if(this.tokens.links){let c=Object.keys(this.tokens.links);if(c.length>0)for(;(a=this.tokenizer.rules.inline.reflinkSearch.exec(s))!=null;)c.includes(a[0].slice(a[0].lastIndexOf("[")+1,-1))&&(s=s.slice(0,a.index)+"["+"a".repeat(a[0].length-2)+"]"+s.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(a=this.tokenizer.rules.inline.anyPunctuation.exec(s))!=null;)s=s.slice(0,a.index)+"++"+s.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let i;for(;(a=this.tokenizer.rules.inline.blockSkip.exec(s))!=null;)i=a[2]?a[2].length:0,s=s.slice(0,a.index+i)+"["+"a".repeat(a[0].length-i-2)+"]"+s.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);s=this.options.hooks?.emStrongMask?.call({lexer:this},s)??s;let o=!1,l="";for(;t;){o||(l=""),o=!1;let c;if(this.options.extensions?.inline?.some(p=>(c=p.call({lexer:this},t,n))?(t=t.substring(c.raw.length),n.push(c),!0):!1))continue;if(c=this.tokenizer.escape(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.tag(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.link(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.reflink(t,this.tokens.links)){t=t.substring(c.raw.length);let p=n.at(-1);c.type==="text"&&p?.type==="text"?(p.raw+=c.raw,p.text+=c.text):n.push(c);continue}if(c=this.tokenizer.emStrong(t,s,l)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.codespan(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.br(t)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.del(t,s,l)){t=t.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.autolink(t)){t=t.substring(c.raw.length),n.push(c);continue}if(!this.state.inLink&&(c=this.tokenizer.url(t))){t=t.substring(c.raw.length),n.push(c);continue}let u=t;if(this.options.extensions?.startInline){let p=1/0,f=t.slice(1),m;this.options.extensions.startInline.forEach(v=>{m=v.call({lexer:this},f),typeof m=="number"&&m>=0&&(p=Math.min(p,m))}),p<1/0&&p>=0&&(u=t.substring(0,p+1))}if(c=this.tokenizer.inlineText(u)){t=t.substring(c.raw.length),c.raw.slice(-1)!=="_"&&(l=c.raw.slice(-1)),o=!0;let p=n.at(-1);p?.type==="text"?(p.raw+=c.raw,p.text+=c.text):n.push(c);continue}if(t){let p="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(p);break}else throw new Error(p)}}return n}},Ds=class{options;parser;constructor(e){this.options=e||Nt}space(e){return""}code({text:e,lang:t,escaped:n}){let s=(t||"").match(he.notSpaceStart)?.[0],a=e.replace(he.endingNewline,"")+`
...
Deletes the session entry and archives its transcript.`)&&(e.sessionsResult?.sessions&&(e.sessionsResult={...e.sessionsResult,sessions:e.sessionsResult.sessions.filter(d=>d.key!==v)}),e.client&&e.connected))try{await e.client.request("sessions.delete",{key:v,deleteTranscript:!0}),Z(e)}catch(d){console.error("Failed to delete session:",d),Z(e)}},u=m=>r`
        ...
        <div class="cfg-field">
          ...
          <div class="cfg-segmented">
            ${S.map((E,P)=>r`
              <button
                type="button"
                class="cfg-segmented__btn ${E===x||an(E)===an(x)?"active":""}"
                ?disabled=${o}
                @click=${()=>l(s,E)}
              >
                ${an(E)}
  ...
  `}function Sl(e){const{schema:t,value:n,path:s,hints:a,disabled:i,onPatch:o,inputType:l}=e,c=e.showLabel??!0,u=xe(s,a),p=u?.label??t.title??et(String(s.at(-1))),f=u?.help??t.description,m=u?.sensitive??sw(s),v=u?.placeholder??(m?"••••":t.default!==void 0?`Default: ${an(t.default)}`:""),$=n??"";return r`
    <div class="cfg-field">
...
`)}function lk(e){const t=new Date(e),s=new Date().getTime()-t.getTime(),a=Math.floor(s/(1e3*60));if(a<1)return"Just now";if(a<60)return`${a}m ago`;const i=Math.floor(a/60);return i<24?`${i}h ago`:t.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})}function ck(e){const t="VAULT",n=encodeURIComponent(`01-Daily/${e}`);return`obsidian://open?vault=${t}&file=${n}`}let zn=null,un=null;function ql(e,t,n=1500){zn&&clearTimeout(zn),zn=setTimeout(()=>{e!==un&&(un=e,t(e))},n)}function dk(e,t){zn&&clearTimeout(zn),e!==un&&(un=e,t(e))}function Xa(e){for(const t of e.querySelectorAll('input[type="checkbox"]')){const n=t;n.checked?n.setAttribute("checked",""):n.removeAttribute("checked")}return ak(e.innerHTML)}function uk(e){const{data:t,loading:n,error:s,onRefresh:a,onGenerate:i,onOpenInObsidian:o,onSaveBrief:l,onToggleCheckbox:c,onOpenFile:u}=e;if(n)return r`
      ...
      <div class="workspace-content">
        ...
        ${we?r`
              <section class="ws-section">
                ...
                <div class="ws-list">
                  ${F.map(D=>vk({workspaceId:t.id,entry:D,pinned:R.has(D.path),onOpen:l,onPinToggle:u}))}
                </div>
              </section>
            `:h}
        ...
        <section class="ws-section">
          <div class="ws-section__header">
            ...
            ${T&&E.length>0?r`<button class="ws-export-drive-btn" @click=${()=>{const D=E.map(De=>De.path);T(D)}}>Export to Drive</button>`:h}
          </div>
          <div class="ws-list ws-list--scroll">
            ${P?Q.length===0?r`<div class="ws-empty">
                    ...
                    </div>`:Q.map(D=>Zu(D,0,Se)):E.length===0?r`<div class="ws-empty">
                      <span class="ws-empty-hint">No artifacts yet. Ask your ally to create a document, plan, or analysis — it'll appear here.</span>
                    </div>`:E.map(D=>Za({workspaceId:t.id,entry:D,pinned:!1,onOpen:l,onPinToggle:u}))}
          </div>
        </section>
      ...
      ${l?r`
            ...
            `:r`
              <div class="workspaces-body">
                ...
                ${Sk({tasks:p,taskFilter:f,taskSort:m,onToggleTaskComplete:N,onSetTaskFilter:W,onSetTaskSort:F,onCreateTask:B,workspaceNames:d,onStartTask:Se,editingTaskId:$,onEditTask:D,onUpdateTask:De})}
              </div>
            `}
    </div>
  ...
  `}function Mk(e){const t=e.goals?.filter(n=>n.status==="active")??[];return e.goalsLoading?r`<div class="my-day-card goals-section">
      <div class="my-day-card-header">
        <div class="my-day-card-title">
          <span class="my-day-card-icon">\uD83C\uDFAF</span>
          <span>GOALS</span>
  ...
  `}function Ok(e){const t=re(),n=e.selectedDate??t,s=e.viewMode??"brief",a=e.agentLog??null;if(e.loading)return r`
    ...
    <div class="my-day-container">
      ${s==="brief"?r`<div class="my-day-brief-full">
            ${Mk(e)}
            ${uk(i)}
          </div>`:s==="command-center"?Dk(e):r`<div class="my-day-brief-full">${Ck(e,a,ep(n))}</div>`}
    </div>
  ...
  `}function np(){return{open:!1,images:[],currentIndex:0}}function E0(e,t,n){return{open:!0,images:t,currentIndex:n}}function L0(){return np()}function R0(e,t){const n=e.currentIndex+t;return n<0||n>=e.images.length?e:{...e,currentIndex:n}}const P0=r`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>`,I0=r`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>`,M0=r`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 6 15 12 9 18"/></svg>`;function D0(e,t){if(!e.open||e.images.length===0)return h;const n=e.images[e.currentIndex];if(!n)return h;const s=e.images.length>1,a=e.currentIndex>0,i=e.currentIndex<e.images.length-1;return r`
    ...
    >
      ...
      ${s&&i?r`<button class="lightbox-nav lightbox-nav--next" @click=${()=>t.onNav(1)} aria-label="Next image">${M0}</button>`:h}
  ...
  `}function qS(e){if(!e.connected)return r`<div class="mc-section"><div class="mc-empty">Not connected to gateway.</div></div>`;if(e.loading&&!e.data)return r`<div class="mc-section"><div class="mc-loading">Loading agent data...</div></div>`;if(e.error&&!e.data)return r`
    ...
    <div class="mc-section">
      ...
      ${e.fullControl?DS(t.stats):MS(t.stats)}
