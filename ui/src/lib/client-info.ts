// IMPORTANT: These IDs must EXACTLY match src/gateway/protocol/client-info.ts
// The gateway validates client IDs during WebSocket handshake.
// Mismatch causes error 1008 "invalid connect params: at /client/id"
export const GATEWAY_CLIENT_IDS = {
  WEBCHAT_UI: "webchat-ui",
  CONTROL_UI: "openclaw-control-ui",
  GODMODE_WEBCHAT: "godmode-webchat",
  WEBCHAT: "webchat",
  CLI: "cli",
  ...
  // Backwards compatibility aliases (gateway accepts both)
  MOLTBOT_MACOS: "moltbot-macos",
  MOLTBOT_IOS: "moltbot-ios",
  MOLTBOT_ANDROID: "moltbot-android",
