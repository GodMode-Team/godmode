/**
 * Tab Components — extracted from the God Component.
 *
 * Each tab is a self-contained LitElement that owns its own state,
 * consumes AppContext for shared data, and delegates rendering to
