      ...
      <div class="card">
        ...
        <div class="stat-grid" style="margin-top: 16px;">
          ...
          <div class="stat">
            ...
            <div class="stat-value">
              ${props.updateLastChecked ? formatAgo(props.updateLastChecked) : "Never"}
            </div>
          </div>
        </div>
        <div class="row" style="margin-top: 14px;">
          <button
            class="btn"
            ?disabled=${props.updateLoading || !props.connected}
            @click=${() => props.onCheckUpdates()}
          >
            ${props.updateLoading ? "Checking..." : "Check for Updates"}
          </button>
        </div>
        ${
                  ...
                  ${
                    props.onUpdateNow
                      ? html`<button
                        ...
                        >
                          ${props.updateRunning ? "Updating..." : "Update Now"}
                        </button>`
                      : nothing
                  }
                </div>
