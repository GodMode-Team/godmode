---
description: "[gstack] Design consultation: understands your product, researches the landscape, proposes a complete design system, and creates DESIGN.md."
---
...
If the codebase is empty and purpose is unclear, say: *"I don't have a clear picture of what you're building yet. Can you describe the product? Once we know the product direction, we can set up the design system."*

**Check for browser tool availability (optional -- enables visual competitive research):**

If the `browser` tool is available, visual competitive research is enabled. If not, that's fine -- visual research is optional. The skill works without it using `web_search` and your built-in design knowledge.
...
**Prompt the user -- include ALL of these:**
...
If the `browser` tool is available, visit the top 3-5 sites in the space and capture visual evidence:

```
browser goto "https://example-site.com"
browser screenshot "/tmp/design-research-site-name.png"
browser snapshot
```
...
If `browser` is not available, rely on `web_search` results and your built-in design knowledge -- this is fine.
...
**Prompt the user -- present the full proposal with SAFE/RISK breakdown:**
...
Each drill-down is one focused user prompt. After the user decides, re-check coherence with the rest of the system.
...
Use `exec` to set up the preview file:
```bash
...
**Update project config** (or create it if it doesn't exist) -- append this section:
...
**Prompt the user for final confirmation -- show summary and confirm:**

List all decisions. Flag any that used agent defaults without explicit user confirmation (the user should know what they're shipping). Options:
- A) Ship it -- write DESIGN.md and project config
